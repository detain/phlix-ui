import { a as e, h as t, i as n, n as r, o as i, r as a, t as ee } from "./Button-C86XulWV.js";
...
var ce = {
	...
	role: "list"
}, Fe = { class: "admin-dash__activity-user" }, O = ["title"], Ie = ["datetime", "title"], k = 20, Le = 3e4, A = /*#__PURE__*/ t(/* @__PURE__ */ h({
	__name: "DashboardPage",
	props: { client: {} },
	setup(t) {
		let h = t, A = re("apiBase", ""), Re = c(() => typeof A == "string" ? A : A?.value ?? ""), j = new ne(h.client ?? new i({
			baseUrl: Re.value,
			tokenStore: new e()
		})), M = n();
		function N(e) {
...
//# sourceMappingURL=DashboardPage-BdoEPd8t.js.map