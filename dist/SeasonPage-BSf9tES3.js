...
import { n as s } from "./useApiBase-DHZp4E4v.js";
import { t as ee } from "./series-grouping-BTZK8Agh.js";
import { t as c } from "./useSeriesSeasons-CHNYJz8g.js";
...
var w = {
	...
	__name: "SeasonPage",
	setup(e) {
		let _ = s(), b = re(), w = ie(), T = y(null), E = y(null), D = y(!0), O = y(null), k = u(() => String(b.params.id ?? "")), A = u(() => String(b.params.season ?? ""));
		i(() => {
		...
		return (e, n) => (v(), p("div", I, [D.value ? (v(), p("div", L, [g(a, {
			variant: "text",
			width: "40%",
			height: "1.6rem"
		}), g(a, {
...
//# sourceMappingURL=SeasonPage-BSf9tES3.js.map