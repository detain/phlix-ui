...
}, ne = { class: "admin-syncplay__name" }, M = { class: "admin-syncplay__media" }, re = { class: "admin-syncplay__field" }, ie = { class: "admin-syncplay__field" }, ae = { class: "admin-syncplay__field" }, oe = { class: "admin-syncplay__field" }, N = /*#__PURE__*/ t(/* @__PURE__ */ _({
	__name: "SyncPlayPage",
	props: { client: {} },
	setup(t) {
		let _ = t, N = v("apiBase", ""), P = u(() => typeof N == "string" ? N : N?.value ?? ""), F = new l(_.client ?? new n({
			baseUrl: P.value,
			tokenStore: new ee()
		...
		async function B() {
			...
			try {
				...
				z.value = e(t, "Failed to load groups."), I.error(z.value);
			} finally {
				R.value = !1;
			}
		}
		...
		async function q() {
			...
			try {
				...
				I.error(e(t, "Failed to create group."));
			} finally {
				W.value = !1;
			}
		}
		...
		async function $() {
			...
			try {
				...
				I.error(e(t, "Failed to join group."));
			} finally {
				Z.value = !1;
			}
		}
...
//# sourceMappingURL=SyncPlayPage-BlRp2Uh6.js.map