...
var g = "metadata.tmdb_unconfigured";
function _(t) {
...
var v = class {
	...
	async searchByMarker(e, t, n = 30, r = 20) {
		let i = {
			type: e,
			position: String(t),
			around: String(n),
		...
		return this.get("/api/v1/media/search/by-marker", i);
	}
	async getTrickplay(e) {
		return this.get(`/api/v1/media/${encodeURIComponent(e)}/trickplay`);
	}
	logout(e = !0) {
...
//#endregion
export { _ as a, c, n as d, r as f, m as i, e as l, g as n, h as o, i as p, y as r, p as s, v as t, t as u };

//# sourceMappingURL=client-DH50wjeq.js.map