...
import { n as a } from "./ThumbRating-DL3IV5ps.js";
...
import { n as u } from "./media-query-DKjhlX8r.js";
import { t as ee } from "./Player-CD93fLnl.js";
...
var se = { class: "player-page__stage" }, ce = {
	...
	__name: "PlayerPage",
	setup(e) {
		let y = /* @__PURE__ */ new Map(), k = n(), le = r(), ue = ae(), A = oe(), j = i(), de = a(), M = T(null), N = T(""), P = T([]), F = T(null), I = T(null), L = T(!0), R = T(null), z = T(!1), B = T(null), V = T(null), H = p(() => String(ue.params.id ?? ""));
		o(() => M.value?.name);
		let U = p(() => {
...
}), [["__scopeId", "data-v-d85b6049"]]);
//#endregion
export { k as default };

//# sourceMappingURL=PlayerPage-DJ3Pq6-d.js.map