...
var D = class {
	...
	async getArtist(e, t) {
		return v((await this.get(`/api/v1/music/artists/${encodeURIComponent(e)}`, void 0, t)).artist);
	}
	...
	async getAlbum(e, t, n) {
		...
		return b((await this.get(`/api/v1/music/albums/${encodeURIComponent(e)}`, r, n)).album);
	}
...
//# sourceMappingURL=client-CkSYnkSD.js.map