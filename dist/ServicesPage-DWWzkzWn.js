...
var T = {
	...
	props: { client: {} },
	setup(e) {
		let v = e, L = y("apiBase", ""), R = d(() => typeof L == "string" ? L : L?.value ?? ""), z = new l(v.client ?? new t({
			baseUrl: R.value,
			tokenStore: new i()
		...
		async function K() {
			...
			try {
				...
				U.value = r(e, "Failed to load Trakt status."), B.error(U.value);
			} finally {
				H.value = !1;
			}
		}
		...
		async function J() {
			if (!W.value) {
				...
				try {
					...
					B.error(r(e, "Failed to disconnect Trakt."));
				} finally {
					W.value = !1;
				}
			}
		...
		async function $() {
			...
			try {
				...
				Z.value = r(e, "Failed to load Last.fm status."), B.error(Z.value);
			} finally {
				X.value = !1;
			}
		}
		...
		async function re() {
			if (!Q.value) {
				...
				try {
					...
					B.error(r(e, "Failed to disconnect Last.fm."));
				} finally {
					Q.value = !1;
				}
			}
		...
		return b(() => {
			...
			h("section", E, [h("div", D, [t[0] ||= h("h2", {
				...
				h("div", M, [V.value.connected ? (x(), f(n, {
					key: 1,
					variant: "outline",
					loading: W.value,
					onClick: J
			...
			])) : p("", !0), h("div", I, [Y.value.connected ? (x(), f(n, {
				key: 1,
				variant: "outline",
				loading: Q.value,
				onClick: re
...
//# sourceMappingURL=ServicesPage-DWWzkzWn.js.map