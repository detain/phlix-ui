...
var d = c("auth", () => {
	...
	async function w(e, t) {
		...
		try {
			...
			return g.value = e instanceof Error ? e.message : "Login failed", !1;
		} finally {
			h.value = !1;
		}
	}
	async function T(e, t, n) {
		...
		try {
			...
			return g.value = e instanceof Error ? e.message : "Registration failed", !1;
		} finally {
			h.value = !1;
		}
	}
	async function E() {
		if (x.value) try {
			...
			m.value = null, n.clear(), v.value = null;
		}
	}
	async function D() {
...
//# sourceMappingURL=useAuthStore-XHU2iXIc.js.map