...
import { t as n } from "./useAuthStore-Ds0NVhBP.js";
import { i as r, r as i } from "./usePlayerStore-Dgw0JCWb.js";
import { t as a } from "./useToastStore-BDoKlU6N.js";
import { t as o } from "./MediaRow-G_8v2rsv.js";
...
var D = /*#__PURE__*/ e(/* @__PURE__ */ f({
	...
	setup(e, { emit: n }) {
		...
		return b(() => r.appliedItem, (e) => {
			...
			onEditMetadata: n[9] ||= (e) => i("edit-metadata", e),
			onExploreData: n[10] ||= (e) => i("explore-data", e)
		}, u({ _: 2 }, [e.showSeeAll ? {
			name: "action",
			fn: x(() => [l("button", {
				type: "button",
...
}), [["__scopeId", "data-v-4202e710"]]);
//#endregion
export { E as n, D as t };

//# sourceMappingURL=HomeRow-CNb3wcn6.js.map