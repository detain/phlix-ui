...
function r(n) {
	return {
		...
		media_name: e(n.media_name),
		media_type: e(n.media_type),
		library_id: e(n.library_id),
		user_id: e(n.user_id),
		username: e(n.username),
		display_name: e(n.display_name),
		profile_name: e(n.profile_name),
		last_watched_at: e(n.last_watched_at),
		completed_at: e(n.completed_at),
		playback_status: e(n.playback_status),
...
var i = class {
	...
	async getAllWatchHistory(e) {
		let t = {};
		e?.limit !== void 0 && (t.limit = String(e.limit)), e?.userId && (t.userId = e.userId), e?.libraryId && (t.libraryId = e.libraryId);
		let { data: i } = await this.client.get("/api/v1/admin/watch-history", Object.keys(t).length ? t : void 0);
		return n(i).map(r);
	}
};
//#endregion
...
//# sourceMappingURL=history-Cz9DDbWX.js.map