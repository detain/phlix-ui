...
var W = { class: "media-card__poster" }, G = ["href", "aria-label"], K = { class: "visually-hidden" }, q = [
	...
	setup(e, { emit: n }) {
		let r = e, i = n, a = c(), o = d(() => r.to ?? (r.item.type === "series" ? `/app/media/${r.item.id}` : `/app/player/${r.item.id}`)), { prefetch: s } = L();
		function l() {
			s(o.value);
		}
		let f = T(!1), v = T(null);
...
}), [["__scopeId", "data-v-aaba1147"]]), he = { class: "match-modal" }, ge = {
	key: 0,
...
//# sourceMappingURL=MetadataMatchModal-BHe9IKxt.js.map