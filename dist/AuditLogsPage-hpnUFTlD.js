...
var C = {
	...
	props: { client: {} },
	setup(e) {
		let g = e.client ?? t, F = r(), I = y([]), L = y(!0), R = y(null), z = y(1), B = y(1);
		async function V(e = 1) {
			...
			try {
				...
				R.value = n(e, "Failed to load audit logs."), F.error(R.value);
			} finally {
				L.value = !1;
			}
		}
...
//# sourceMappingURL=AuditLogsPage-hpnUFTlD.js.map