...
var ue = {
	...
	setup(e) {
		let h = {
			oidc: "OIDC",
			ldap: "LDAP"
		}, w = ["oidc", "ldap"], qe = e, T = ae("apiBase", ""), Je = ie(() => typeof T == "string" ? T : T?.value ?? ""), E = new re(qe.client ?? new t({
			baseUrl: Je.value,
			tokenStore: new ee()
			...
			m(o, {
				...
				default: x(() => [f("form", {
					...
					f("label", Oe, [
						...
						}, null, 8, je), [[y, U.value.client_secret]]), m(n, {
							variant: "ghost",
							size: "sm",
				...
				default: x(() => [f("form", {
					...
					f("label", ze, [
						...
						f("div", Ve, [S(f("input", {
							...
							autocomplete: "new-password"
						}, null, 8, He), [[y, J.value.bind_pw]]), m(n, {
							variant: "ghost",
							size: "sm",
...
//# sourceMappingURL=IntegrationsPage-inEWLI4s.js.map