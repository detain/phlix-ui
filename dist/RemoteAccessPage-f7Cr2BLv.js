...
import { t as ne } from "./Modal-D0ntqq7y.js";
import { t as re } from "./Badge-wMoO7SFO.js";
...
var fe = {
	...
	setup(ee) {
		...
		return se(() => {
			...
			u("header", pe, [u("h1", me, [f(t, {
				name: "monitor",
				class: "admin-remote__title-icon"
			}), n[7] ||= d(" Remote Access ", -1)])]),
			u("section", he, [u("button", {
				...
				onClick: n[0] ||= (e) => S("hub")
			}, [u("span", _e, [n[8] ||= u("h2", { id: "remote-hub-heading" }, "Hub Pairing", -1), f(t, {
				name: x.value.hub ? "chevron-up" : "chevron-down",
				class: "admin-remote__chevron"
			}, null, 8, ["name"])]), u("span", ve, h(at.value), 1)], 8, ge), x.value.hub ? (p(), l("div", ye, [w.value ? (p(), l("div", be, [f(i, {
				variant: "text",
				lines: 3
			})])) : C.value === null ? (p(), l("p", xe, " Unable to load hub status. ")) : (p(), l(a, { key: 2 }, [C.value.paired ? (p(), l("dl", Se, [
				C.value.serverId ? (p(), l(a, { key: 0 }, [n[9] ||= u("dt", null, "Server ID", -1), u("dd", null, h(C.value.serverId), 1)], 64)) : c("", !0),
				C.value.hubUrl ? (p(), l(a, { key: 1 }, [n[10] ||= u("dt", null, "Hub URL", -1), u("dd", null, h(C.value.hubUrl), 1)], 64)) : c("", !0),
				C.value.enrolledAt ? (p(), l(a, { key: 2 }, [n[11] ||= u("dt", null, "Enrolled at", -1), u("dd", null, h(it(C.value.enrolledAt)), 1)], 64)) : c("", !0)
			])) : c("", !0), u("div", Ce, [C.value.paired ? (p(), l(a, { key: 1 }, [f(r, {
				variant: "outline",
				size: "sm",
				loading: E.value,
				onClick: ut
			}, {
				default: g(() => [...n[13] ||= [d(" Send Heartbeat ", -1)]]),
				_: 1
			}, 8, ["loading"]), f(r, {
				variant: "ghost",
				size: "sm",
				...
				default: g(() => [...n[12] ||= [d(" Initiate Pairing ", -1)]]),
				_: 1
			}))])], 64))])) : c("", !0)]),
			u("section", we, [u("button", {
			...
			}, [u("span", Ee, [n[15] ||= u("h2", { id: "remote-subdomain-heading" }, "Subdomain", -1), f(t, {
				name: x.value.subdomain ? "chevron-up" : "chevron-down",
				class: "admin-remote__chevron"
			}, null, 8, ["name"])]), u("span", De, h(dt.value), 1)], 8, Te), x.value.subdomain ? (p(), l("div", Oe, [L.value ? (p(), l("div", ke, [f(i, {
				variant: "text",
				lines: 2
			})])) : I.value === null ? (p(), l("p", Ae, " Unable to load subdomain status. ")) : (p(), l(a, { key: 2 }, [I.value.claimed ? (p(), l("dl", je, [I.value.subdomain ? (p(), l(a, { key: 0 }, [n[16] ||= u("dt", null, "Subdomain", -1), u("dd", null, h(I.value.subdomain), 1)], 64)) : c("", !0), I.value.fqdn ? (p(), l(a, { key: 1 }, [n[17] ||= u("dt", null, "FQDN", -1), u("dd", null, h(I.value.fqdn), 1)], 64)) : c("", !0)])) : c("", !0), u("div", Me, [I.value.claimed ? (p(), s(r, {
				key: 1,
				variant: "ghost",
				size: "sm",
				loading: z.value,
				...
				default: g(() => [...n[19] ||= [d(" Release Subdomain ", -1)]]),
				_: 1
			}, 8, ["loading"])) : (p(), s(r, {
				key: 0,
				variant: "solid",
				...
				default: g(() => [...n[18] ||= [d(" Claim Subdomain ", -1)]]),
				_: 1
			}, 8, ["loading"]))])], 64))])) : c("", !0)]),
			u("section", Ne, [u("button", {
			...
			}, [u("span", Fe, [n[20] ||= u("h2", { id: "remote-relay-heading" }, "Relay Tunnel", -1), f(t, {
				name: x.value.relay ? "chevron-up" : "chevron-down",
				class: "admin-remote__chevron"
			}, null, 8, ["name"])]), u("span", Ie, h(mt.value), 1)], 8, Pe), x.value.relay ? (p(), l("div", Le, [H.value ? (p(), l("div", Re, [f(i, {
				variant: "text",
				lines: 2
			})])) : V.value === null ? (p(), l("p", ze, " Unable to load relay status. ")) : (p(), l(a, { key: 2 }, [u("dl", Be, [
				n[22] ||= u("dt", null, "Status", -1),
				u("dd", null, [f(re, { tone: V.value.connected ? "success" : "neutral" }, {
					default: g(() => [d(h(V.value.connected ? "Connected" : "Disconnected"), 1)]),
					_: 1
				}, 8, ["tone"])]),
				n[23] ||= u("dt", null, "Active", -1),
				u("dd", null, h(V.value.active ? "Yes" : "No"), 1),
				K.value === null ? c("", !0) : (p(), l(a, { key: 0 }, [n[21] ||= u("dt", null, "Latency", -1), u("dd", null, h(K.value) + "ms", 1)], 64))
			]), u("div", Ve, [f(r, {
				variant: "outline",
				size: "sm",
				loading: G.value,
				...
				default: g(() => [...n[24] ||= [d(" Ping ", -1)]]),
				_: 1
			}, 8, ["loading", "disabled"]), V.value.connected ? (p(), s(r, {
				key: 1,
				variant: "ghost",
				size: "sm",
				loading: W.value,
				...
				default: g(() => [...n[26] ||= [d(" Disable ", -1)]]),
				_: 1
			}, 8, ["loading", "disabled"])) : (p(), s(r, {
				key: 0,
				variant: "solid",
				size: "sm",
				loading: U.value,
			...
			}, [u("span", We, [n[27] ||= u("h2", { id: "remote-portforward-heading" }, "Port Forward", -1), f(t, {
				name: x.value.portforward ? "chevron-up" : "chevron-down",
				class: "admin-remote__chevron"
			}, null, 8, ["name"])]), u("span", Ge, h(yt.value), 1)], 8, Ue), x.value.portforward ? (p(), l("div", Ke, [Y.value ? (p(), l("div", qe, [f(i, {
				variant: "text",
				lines: 3
			})])) : J.value === null ? (p(), l("p", Je, " Unable to load port-forward status. ")) : (p(), l(a, { key: 2 }, [
				u("dl", Ye, [
					n[31] ||= u("dt", null, "Enabled", -1),
					u("dd", null, [f(re, { tone: J.value.enabled ? "success" : "neutral" }, {
						default: g(() => [d(h(J.value.enabled ? "Yes" : "No"), 1)]),
						_: 1
					}, 8, ["tone"])]),
					J.value.method ? (p(), l(a, { key: 0 }, [n[28] ||= u("dt", null, "Method", -1), u("dd", null, h(J.value.method), 1)], 64)) : c("", !0),
					J.value.externalIp ? (p(), l(a, { key: 1 }, [n[29] ||= u("dt", null, "External IP", -1), u("dd", null, h(J.value.externalIp), 1)], 64)) : c("", !0),
					J.value.externalPort ? (p(), l(a, { key: 2 }, [n[30] ||= u("dt", null, "External port", -1), u("dd", null, h(J.value.externalPort), 1)], 64)) : c("", !0)
				]),
				Q.value.length > 0 ? (p(), l("div", Xe, [n[32] ||= u("h3", { class: "admin-remote__candidates-title" }, "Hostname Candidates", -1), u("ul", Ze, [(p(!0), l(a, null, ce(Q.value, (e, t) => (p(), l("li", { key: t }, h(e.hostname), 1))), 128))])])) : c("", !0),
				u("div", Qe, [J.value.enabled ? (p(), s(r, {
					key: 1,
					variant: "ghost",
					size: "sm",
					loading: Z.value,
			...
			f(ne, {
				...
				footer: g(() => [f(r, {
					...
					default: g(() => [...n[39] ||= [d(" Poll for Completion ", -1)]]),
					_: 1
				}, 8, ["loading"])) : (p(), s(r, {
					key: 1,
					variant: "solid",
					...
					default: g(() => [...n[40] ||= [d(" Initiate Pairing ", -1)]]),
					_: 1
				}, 8, ["loading", "disabled"]))]),
				default: g(() => [A.value ? (p(), l("div", $e, [n[35] ||= u("p", null, "Enter this claim code on the hub:", -1), u("p", et, h(A.value), 1)])) : (p(), l("form", {
					key: 1,
					class: "admin-remote__form",
					onSubmit: de(st, ["prevent"])
				}, [u("label", tt, [n[36] ||= u("span", { class: "admin-remote__label" }, "Hub URL", -1), ue(u("input", {
					...
					required: ""
				}, null, 512), [[le, O.value]])]), u("label", nt, [n[37] ||= u("span", { class: "admin-remote__label" }, "Server name", -1), ue(u("input", {
...
//# sourceMappingURL=RemoteAccessPage-f7Cr2BLv.js.map