...
import { c as n, n as r, t as i } from "./Button-GJ9vHE0J.js";
import { t as a } from "./tokenStore-CGMYSpg6.js";
import { t as o } from "./Badge-ArWL5-WE.js";
import { t as ee } from "./Modal-BB_vB1RK.js";
...
var T = {
	...
	emits: ["continue"],
	setup(e, { emit: v }) {
		let L = e, R = v, z = y("apiBase", ""), B = d(() => typeof z == "string" ? z : z?.value ?? ""), V = new l(L.client ?? new r({
			baseUrl: B.value,
			tokenStore: new a()
		...
		async function J() {
			...
			try {
				...
				G.value = n(e, "Failed to load watch history."), H.error(G.value);
			} finally {
				W.value = !1;
			}
		}
		async function ce(e) {
			try {
				...
				H.error(n(e, "Failed to remove item."));
			}
		}
		async function le() {
			q.value = !0;
			try {
				...
				H.error(n(e, "Failed to clear history."));
			} finally {
				q.value = !1;
			}
		}
...
//# sourceMappingURL=HistoryPage-DNQYdWcR.js.map