...
import { f as i, l as a, t as o } from "./client-D7B7SMZj.js";
import { n as s, t as c } from "./media-query-BdY2RILB.js";
import { t as l } from "./Badge-BYoKxJan.js";
import { t as u } from "./Chip-C_0Ir8Wz.js";
import { n as d, r as f, t as p } from "./listbox-htyKA_G5.js";
import { t as m } from "./Select-BuaZ3Wk0.js";
...
var H = { class: "phlix-combobox__field" }, U = [
	...
	setup(e, { emit: n }) {
		let i = e, { t: a } = r(), o = n, s = _(() => f(i.options)), c = ee(), l = A(!1), u = A(-1), m = A(""), g = A(!1), w = A(null), O = A(null), P = A(null), L = _(() => s.value.find((e) => e.value === i.modelValue)?.label ?? ""), z = _(() => {
			if (!g.value || m.value.trim() === "") return s.value;
			let e = m.value.toLowerCase();
			return s.value.filter((t) => t.label.toLowerCase().includes(e));
		}), B = _(() => u.value >= 0 ? `${c}-opt-${u.value}` : void 0);
		I(() => i.modelValue, () => {
			l.value || (m.value = L.value);
		}, { immediate: !0 });
		function V() {
			i.disabled || l.value || (l.value = !0, u.value = z.value.findIndex((e) => e.value === i.modelValue), u.value < 0 && (u.value = z.value.findIndex((e) => !e.disabled)), T(Y));
		}
		function K() {
			m.value = L.value, g.value = !1, l.value = !1;
		}
		function q(e) {
			let t = z.value[e];
			!t || t.disabled || (t.value !== i.modelValue && (o("update:modelValue", t.value), o("change", t.value)), m.value = t.label, g.value = !1, l.value = !1, O.value?.focus());
		}
		function J(e) {
			z.value.length !== 0 && (u.value = d(z.value, u.value, e), T(Y));
		}
		function Y() {
			P.value?.querySelector(".is-active")?.scrollIntoView?.({ block: "nearest" });
		}
		function re(e) {
			m.value = e.target.value, g.value = !0, l.value = !0, u.value = p(z.value, "first");
		}
		function ie(e) {
			if (!i.disabled) switch (e.key) {
				case "ArrowDown":
					e.preventDefault(), l.value ? J(1) : V();
					break;
				case "ArrowUp":
					e.preventDefault(), l.value ? J(-1) : V();
					break;
				case "Enter":
					l.value && u.value >= 0 && (e.preventDefault(), q(u.value));
					break;
				case "Escape":
					l.value && (e.preventDefault(), K());
					break;
				case "Tab":
					l.value && K();
					break;
		...
		function X(e) {
			l.value && w.value && !w.value.contains(e.target) && K();
		}
		return I(l, (e) => {
			...
			x("input", {
				...
				"aria-controls": l.value ? `${N(c)}-list` : void 0,
				"aria-activedescendant": l.value ? B.value : void 0,
				"aria-label": e.label,
			...
			key: 0,
			name: "check"
		})) : y("", !0)]), S(" " + M(n.label), 1)], 42, te))), 128)), z.value.length === 0 ? (k(), b("li", ne, M(N(a)("common.noMatches")), 1)) : y("", !0)], 8, W), [[F, l.value]])], 2));
	}
}), [["__scopeId", "data-v-9909c9c2"]]), q = 6e4, J = 100, Y = 250;
function re(e) {
	return typeof e == "object" && !!e && e.name === "AbortError";
}
var ie = V("media", () => {
	let e = A([]), t = A(0), n = A(!1), r = A(null), l = A(null), u = null, d = A(""), f = A([]), p = A(void 0), m = A(void 0), h = A([]), g = A([]), v = A(""), y = A([]), b = A([]), x = A("name"), S = A("asc"), C = A(24), w = A(0), T = A(void 0), E = A(!1), D = A(void 0), O = A(void 0), k = _(() => e.value.length < t.value), j = _(() => {
		let e = {};
		return T.value && (e.libraryId = T.value), E.value && (e.topLevel = !0), d.value && (e.search = d.value), f.value.length && (e.genres = f.value), p.value !== void 0 && (e.yearFrom = p.value), m.value !== void 0 && (e.yearTo = m.value), h.value.length && (e.ratings = h.value), g.value.length && (e.types = g.value), v.value && (e.match = v.value), y.value.length && (e.actors = y.value), b.value.length && (e.companies = b.value), D.value !== void 0 && (e.minRating = D.value), O.value !== void 0 && (e.maxRating = O.value), e.sort = x.value, e.order = S.value, e.limit = C.value, e.offset = w.value, e;
	}), M = _(() => {
		if (l.value?.genres) return [...l.value.genres].sort();
	...
	function W(e, t, n, r) {
		...
		r && (B = a), u ? u.setBaseUrl(e) : u = new o({ baseUrl: e });
		let s = u.get(P(e, t), void 0, a.signal).then((e) => {
			if (I.set(n, {
				items: e.items,
				total: e.total,
				ts: Date.now()
	...
	async function le(e) {
		let t = ce(T.value), n = L.get(t);
		if (n && Date.now() - n.ts < q) {
			l.value = n.facets;
			return;
		}
		u ? u.setBaseUrl(e) : u = new o({ baseUrl: e });
		try {
			let e = {};
			T.value && (e.libraryId = T.value);
			let n = await u.get("/api/v1/media/facets", Object.keys(e).length ? e : void 0);
			l.value = n, L.set(t, {
				facets: n,
				ts: Date.now()
			});
		} catch (e) {
			e instanceof a && e.status === 404 && (l.value = null);
		}
	}
	function ue() {
		let e = {};
		return d.value && (e.search = d.value), f.value.length && (e.genres = [...f.value]), p.value !== void 0 && (e.yearFrom = String(p.value)), m.value !== void 0 && (e.yearTo = String(m.value)), h.value.length && (e.ratings = [...h.value]), g.value.length && (e.types = [...g.value]), v.value && (e.match = v.value), y.value.length && (e.actors = [...y.value]), b.value.length && (e.companies = [...b.value]), x.value !== "name" && (e.sort = x.value), S.value !== "asc" && (e.order = S.value), e;
	}
	function Z(e) {
		return e == null ? [] : Array.isArray(e) ? e.filter((e) => e != null) : [e];
	}
	function de(e) {
		d.value = (Array.isArray(e.search) ? e.search[0] : e.search) ?? "", f.value = Z(e.genres), h.value = Z(e.ratings), g.value = Z(e.types);
		...
		p.value = n ? Number(n) : void 0, m.value = r ? Number(r) : void 0;
	...
	function fe() {
		e.value = [], t.value = 0, w.value = 0, r.value = null, u = null;
	}
	function pe(e) {
		d.value = e, w.value = 0;
	}
	...
	function Se(e, t) {
		x.value = e, S.value = t ?? xe[e], w.value = 0;
	}
	function Ce(e) {
	...
	function Te() {
		d.value = "", f.value = [], p.value = void 0, m.value = void 0, h.value = [], g.value = [], v.value = "", y.value = [], b.value = [], D.value = void 0, O.value = void 0, x.value = "name", S.value = "asc", w.value = 0;
	}
	function Ee(e) {
		D.value = e, w.value = 0;
	}
...
}), X = { class: "filterbar__main" }, ae = { class: "filterbar__search" }, oe = { class: "filterbar__sort" }, se = ["aria-label"], ce = ["aria-expanded"], le = { class: "filterbar__advanced" }, ue = { class: "filterbar__field" }, Z = { class: "filterbar__field" }, de = {
	class: "filterbar__chips",
	role: "group",
	"aria-label": "Rating"
}, fe = { class: "filterbar__field" }, pe = {
	class: "filterbar__chips",
	role: "group",
	"aria-label": "Type"
}, me = { class: "filterbar__field" }, he = {
	class: "filterbar__chips",
	role: "group",
	"aria-label": "Metadata match status"
}, ge = { class: "filterbar__field" }, _e = { class: "filterbar__years" }, ve = { class: "filterbar__field" }, ye = { class: "filterbar__ratings" }, be = { class: "filterbar__rating-input" }, xe = ["value"], Se = { class: "filterbar__rating-input" }, Ce = ["value"], we = { class: "filterbar__field filterbar__presets" }, Te = { class: "filterbar__chips" }, Ee = {
	key: 0,
	...
	"aria-live": "polite"
}, Me = { class: "filterbar__pills" }, Ne = /*#__PURE__*/ e(/* @__PURE__ */ w({
	__name: "FilterBar",
	props: {
	...
	setup(e, { emit: r }) {
		...
		let Q = A(!1), Ve = _(() => s.filterPresets), He = A(!1), $ = A("");
		function Ue() {
			He.value = !0, $.value = "";
		}
		function We() {
			let e = $.value.trim();
			e && (s.saveFilterPreset(e, o.toQuery()), He.value = !1, $.value = "");
		}
		function Ge(e) {
			o.applyQuery(e.query), d.value = o.search, a("change");
		}
		function Ke(e) {
			s.removeFilterPreset(e.id);
		}
		let qe = A(!1);
		function Je() {
		...
		return O(() => {
			...
			clearTimeout(f), typeof window < "u" && window.removeEventListener("scroll", Je);
			...
			x("div", X, [
				...
				x("div", oe, [C(m, {
					...
					onClick: Ie
				}, [C(t, { name: N(o).order === "asc" ? "arrow-up" : "arrow-down" }, null, 8, ["name"])], 8, se)]),
				x("button", {
					type: "button",
			...
			C(g, { name: "filterbar-panel" }, {
				default: L(() => [R(x("div", le, [
					x("div", ue, [r[7] ||= x("span", { class: "filterbar__field-label" }, "Genres", -1), (k(), v(K, {
						key: ee.value,
						"model-value": T.value,
						options: V.value,
					...
					x("div", Z, [r[8] ||= x("span", { class: "filterbar__field-label" }, "Rating", -1), x("div", de, [(k(!0), b(h, null, j(N(o).availableRatings, (e) => (k(), v(u, {
						key: e,
					...
					x("div", fe, [r[9] ||= x("span", { class: "filterbar__field-label" }, "Type", -1), x("div", pe, [(k(!0), b(h, null, j(N(o).availableTypes, (e) => (k(), v(u, {
						key: e,
					...
					x("div", me, [r[10] ||= x("span", { class: "filterbar__field-label" }, "Metadata", -1), x("div", he, [(k(), b(h, null, j(te, (e) => C(u, {
						key: e.value,
					...
					x("div", ge, [r[12] ||= x("span", { class: "filterbar__field-label" }, "Year", -1), x("div", _e, [
						C(K, {
					...
					x("div", ve, [r[16] ||= x("span", { class: "filterbar__field-label" }, "Rating range", -1), x("div", ye, [
						x("label", be, [r[13] ||= x("span", null, "Min", -1), x("input", {
							type: "number",
						...
						x("label", Se, [r[14] ||= x("span", null, "Max", -1), x("input", {
							type: "number",
							class: "filterbar__rating-number",
							value: N(o).maxRating ?? "",
							placeholder: "10",
					...
					x("div", we, [
						...
						x("div", Te, [(k(!0), b(h, null, j(Ve.value, (e) => (k(), v(u, {
							key: e.id,
							removable: "",
							...
							"onClick",
							"onRemove"
						]))), 128)), Ve.value.length ? y("", !0) : (k(), b("span", Ee, "No saved presets"))]),
						He.value ? (k(), b("div", De, [R(x("input", {
							...
							disabled: !Re.value,
							onClick: Ue
						}, [C(t, { name: "plus" }), r[18] ||= S(" Save current ", -1)], 8, ke))
					])
				], 512), [[F, Q.value]])]),
				_: 1
			}),
			x("div", Ae, [x("span", je, [x("b", null, M(N(o).total.toLocaleString()), 1), S(" " + M(N(o).total === 1 ? "title" : "titles"), 1)]), Re.value ? (k(), b(h, { key: 0 }, [x("div", Me, [(k(!0), b(h, null, j(Le.value, (e) => (k(), v(u, {
				key: e.key,
				removable: "",
...
//#endregion
export { ie as n, K as r, Ne as t };

//# sourceMappingURL=FilterBar-DN1Adj2t.js.map