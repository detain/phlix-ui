...
var E = {
	...
	props: { client: {} },
	setup(e) {
		let v = e, R = y("apiBase", ""), z = d(() => typeof R == "string" ? R : R?.value ?? ""), B = new l(v.client ?? new r({
			baseUrl: z.value,
			tokenStore: new t()
		})), V = i(), H = S(null), U = S([]), W = S(!0), G = S(!0), K = S(null), q = S(null), J = d(() => {
			let e = H.value;
			return [
				{
					key: "servers",
		...
		async function Z() {
			...
			try {
				...
				K.value = n(e, "Failed to load hub summary."), V.error(K.value);
			} finally {
				W.value = !1;
			}
		}
		async function Q() {
			...
			try {
				...
				q.value = n(e, "Failed to load recent activity."), V.error(q.value);
			} finally {
				G.value = !1;
			}
		}
...
//# sourceMappingURL=HubDashboardPage-J_-VsZjV.js.map