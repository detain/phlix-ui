...
import { n as s, o as c, t as l } from "./LoveButton-Cfe3jzXL.js";
...
var te = { class: "media-card__poster" }, ne = ["href", "aria-label"], re = { class: "visually-hidden" }, ie = [
...
}, ye = { class: "media-card__actions" }, be = ["aria-label", "aria-pressed"], xe = {
	type: "button",
	class: "media-card__iconbtn",
	"aria-label": "More actions"
}, Se = { class: "media-card__caption" }, Ce = ["title"], we = { class: "media-card__caption-sub numeric" }, Te = /*#__PURE__*/ e(/* @__PURE__ */ S({
	__name: "MediaCard",
	props: {
		item: {},
		to: {},
			...
			y("div", ue, [
				...
				y("div", ye, [
					...
					x(G, {
						...
						default: L(() => [y("button", xe, [x(t, { name: "more" })])]),
						_: 1
					}, 8, ["open", "items"]),
...
}), [["__scopeId", "data-v-5a714e33"]]), Ee = { class: "match-modal" }, De = {
	key: 0,
	class: "match-modal__subject"
}, Oe = {
	key: 0,
	class: "numeric"
}, ke = { class: "match-modal__field match-modal__field--query" }, Ae = { class: "match-modal__field match-modal__field--year" }, je = {
	key: 1,
	...
	class: "match-modal__state",
	role: "alert"
}, Ne = { class: "match-modal__state-title" }, Pe = {
	key: 3,
	...
	role: "alert"
}, Ie = { class: "match-modal__results" }, Le = { class: "match-modal__poster" }, Re = ["src", "alt"], ze = {
	key: 1,
	class: "match-modal__poster-fallback",
	"aria-hidden": "true"
}, Be = { class: "match-modal__result-body" }, Ve = { class: "match-modal__result-title" }, He = {
	key: 0,
	class: "match-modal__result-year numeric"
}, Ue = { class: "match-modal__result-type" }, We = {
	key: 0,
	class: "match-modal__result-overview"
}, Ge = /*#__PURE__*/ e(/* @__PURE__ */ S({
		...
		return I(() => s.modelValue, (e) => {
			...
			default: L(() => [y("div", Ee, [
				e.item ? (k(), v("p", De, [
					...
					e.item.year ? (k(), v("span", Oe, "(" + N(e.item.year) + ")", 1)) : _("", !0),
					r[4] ||= b(". ", -1)
				])) : _("", !0),
				y("form", {
				...
				])) : C.value ? (k(), v("div", Pe, [x(H, { label: "Searching TMDB" })])) : w.value && S.value.length === 0 ? (k(), v("div", $, [
					x(t, {
						name: "search",
						class: "match-modal__state-icon"
					}),
				...
				])) : S.value.length ? (k(), v(f, { key: 5 }, [M.value ? (k(), v("p", Fe, N(M.value), 1)) : _("", !0), y("ul", Ie, [(k(!0), v(f, null, j(S.value, (e) => (k(), v("li", {
					key: U(e),
					class: "match-modal__result"
				}, [
					y("div", Le, [e.poster_url ? (k(), v("img", {
						key: 0,
						src: e.poster_url,
						alt: e.title,
						loading: "lazy",
						decoding: "async"
					}, null, 8, Re)) : (k(), v("div", ze, [x(t, { name: e.type === "tv" ? "tv" : "film" }, null, 8, ["name"])]))]),
					y("div", Be, [y("p", Ve, [
						b(N(e.title) + " ", 1),
						e.year ? (k(), v("span", He, N(e.year), 1)) : _("", !0),
						y("span", Ue, N(e.type), 1)
					]), e.overview ? (k(), v("p", We, N(e.overview), 1)) : _("", !0)]),
					x(u, {
						variant: "solid",
						size: "sm",
						loading: O.value === U(e),
...
//#endregion
export { G as a, K as i, Te as n, H as o, Q as r, Ge as t };

//# sourceMappingURL=MetadataMatchModal-vCPqVr65.js.map