...
import { t as r } from "./MediaCard-8CBbyG6o.js";
	...
	setup(e, { expose: f, emit: x }) {
		...
		return y(() => A.value, (e) => {
			...
			l("div", {
				...
				onEditMetadata: (e) => D("edit-metadata", t.item),
				onExploreData: (e) => D("explore-data", t.item)
			}, null, 8, [
				"item",
				"can-match",
				"onPlay",
...
}), [["__scopeId", "data-v-e7c25ff9"]]);
//#endregion
export { E as t };

//# sourceMappingURL=MediaGrid-CzOSbyHM.js.map