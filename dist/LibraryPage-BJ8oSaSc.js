...
import { n as r, r as i, t as a } from "./FilterBar-DbkALxC0.js";
...
var T = { class: "library-page" }, E = {
	...
	setup(e) {
		...
		function L() {
			F.value && (N.clearFilters(), N.setLibraryId(F.value), N.reset(), N.fetchMedia(A.value));
		}
		function R() {
		...
		_(() => {
			...
			N.setLibraryId(void 0), N.clearFilters(), N.reset();
		});
		function z() {
			R();
		}
...
}), [["__scopeId", "data-v-8d6f0f02"]]);
//#endregion
export { A as default };

//# sourceMappingURL=LibraryPage-BJ8oSaSc.js.map