...
var ee = { class: "media-card__poster" }, te = [
	...
	setup(e, { emit: c }) {
		let l = e, _ = c, y = r(), S = n(), A = a(), F = v("phlixConfig", null), I = v(P, null), z = u(() => A.isFavorite(l.item.id)), B = u(() => A.likeLevel(l.item.id)), V = u(() => S.isAdmin), H = u(() => A.isWatched(l.item.id)), U = T(!1), q = u(() => l.item.type === "series" || l.item.type === "season"), De = u(() => (V.value, U.value ? K(l.item, {
			isAdmin: V.value,
			isWatched: H.value,
...
}), [["__scopeId", "data-v-b362ceb0"]]);
//#endregion
export { L as a, R as i, G as n, K as r, q as t };

//# sourceMappingURL=MediaCard-g40amwmP.js.map