...
import { t as r } from "./useAuthStore-CAHTCZvf.js";
import { o as i } from "./media-query-BdY2RILB.js";
import { t as ee } from "./useToastStore-BDoKlU6N.js";
import { n as te } from "./ThumbRating-Da67Lpax.js";
import { t as ne } from "./Spinner-BzsmsoQs.js";
import { t as re } from "./useLibrariesStore-mabc4pZx.js";
import { n as ie, t as a } from "./HomeRow-Cu_qHykY.js";
import { t as ae } from "./Button-Bi3-A35D.js";
import { t as o } from "./EmptyState-qUL7hIJh.js";
import { t as s } from "./MediaRow-CvA16cL9.js";
import { t as oe } from "./MetadataMatchModal-DlmqGe0p.js";
import { t as se } from "./PosterPicker-6y9RdHaN.js";
import { r as ce } from "./useResolvePlayable-DoBQlt-O.js";
...
var ve = { class: "browse-page" }, ye = { class: "browse-toolbar" }, be = {
	...
	setup(e) {
		...
		let F = l(() => {
			let e = S.resumeMap;
			return we.filter((t) => (e[t.id] ?? 0) > 0).sort((t, n) => (e[n.id] ?? 0) - (e[t.id] ?? 0)).slice(0, 12);
...
}), [["__scopeId", "data-v-2c492ed8"]]);
//#endregion
export { b as default };

//# sourceMappingURL=BrowsePage-BTvIoNjh.js.map