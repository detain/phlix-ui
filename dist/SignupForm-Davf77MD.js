import { n as e, t } from "./AuthField-BQ-yA5Kw.js";
import { n, t as r } from "./Icon-ax5k7_G2.js";
import { t as i } from "./useMessages-C_NXwkrd.js";
import { t as a } from "./Button-BFaMKqH5.js";
import { t as o } from "./useAuthStore-C0zrA0HV.js";
	...
	setup(n, { emit: g }) {
		...
		return (n, i) => {
			...
			return v(), u(e, {
				...
				footer: w(() => [m(S(C(P)("auth.signupFooterPrompt")) + " ", 1), h(o, {
					to: L.value,
					class: "signup__link"
				}, {
...
//# sourceMappingURL=SignupForm-Davf77MD.js.map