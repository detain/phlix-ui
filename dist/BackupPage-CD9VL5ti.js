...
import { t as o } from "./Modal-DEuPeh-g.js";
...
var ae = { class: "admin-backup" }, oe = {
	...
	props: { client: {} },
	setup(e) {
		let g = e, T = re("apiBase", ""), E = ne(() => typeof T == "string" ? T : T?.value ?? ""), D = new te(g.client ?? new r({
			baseUrl: E.value,
			tokenStore: new t()
		})), O = i();
		function Oe(e) {
		...
		return _(() => {
			...
			p("section", ge, [t[17] ||= p("header", { class: "admin-backup__head" }, [p("h2", {
				...
				class: "admin-backup__input",
				required: ""
			}, null, 512), [[x, X.value]])])]), p("div", Ee, [h(a, {
				variant: "solid",
				size: "sm",
				loading: Z.value,
				onClick: $
...
//# sourceMappingURL=BackupPage-CD9VL5ti.js.map