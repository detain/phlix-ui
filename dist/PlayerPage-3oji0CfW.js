...
import { t as s } from "./Player-BB-aS_WN.js";
...
var O = { class: "player-page__stage" }, k = {
	...
	__name: "PlayerPage",
	setup(e) {
		let h = g("apiBase", ""), A = c(() => typeof h == "string" ? h : h?.value ?? ""), j = E(), M = D(), N = i(), P = S(null), F = S(""), I = S(!0), L = S(null), R = S(!1), z = c(() => String(j.params.id ?? "")), B = c(() => {
...
//# sourceMappingURL=PlayerPage-3oji0CfW.js.map