...
import { t as r } from "./useMessages-DCJifN0R.js";
import { c as i, n as a } from "./Button-BFaMKqH5.js";
...
import { i as d, n as f, r as p, t as m } from "./Select-DVZcB66c.js";
...
var G = { class: "phlix-combobox__field" }, K = [
	...
	setup(e, { emit: n }) {
		let i = e, { t: a } = r(), o = n, s = v(() => d(i.options)), c = L(), l = M(!1), u = M(-1), m = M(""), h = M(!1), _ = M(null), T = M(null), O = M(null), A = v(() => s.value.find((e) => e.value === i.modelValue)?.label ?? ""), P = v(() => {
		...
		function W(e) {
			P.value.length !== 0 && (u.value = p(P.value, u.value, e), E(Y));
		}
		function Y() {
			O.value?.querySelector(".is-active")?.scrollIntoView?.({ block: "nearest" });
		}
		function re(e) {
			m.value = e.target.value, h.value = !0, l.value = !0, u.value = f(P.value, "first");
		}
		function ie(e) {
...
//# sourceMappingURL=FilterBar-CiORq9Ck.js.map