...
import { t as r } from "./useMessages-C21WhqOh.js";
import { t as i } from "./useToastStore-BDoKlU6N.js";
import { t as ee } from "./Button-CInT03Lp.js";
import { t as a } from "./Slider-CaOjV5mW.js";
import { t as o } from "./Switch-D-Y4B9p8.js";
import { t as s } from "./Select-DHe4oeCr.js";
import { t as c } from "./Tabs-Cx4iZtlC.js";
import { i as te, n as ne, r as re, t as ie } from "./captions-COgPp5bH.js";
import { t as l } from "./SettingsForm-DFUGxP5T.js";
...
var se = {
	...
	class: "aps__label",
	id: "aps-density"
}, j = { class: "aps__row" }, M = { class: "aps__label" }, N = { class: "aps__row" }, P = { class: "aps__label" }, F = { class: "aps__value" }, I = { class: "aps__slider" }, L = { class: "aps__group" }, R = { class: "aps__title" }, ge = { class: "aps__row aps__row--switch" }, _e = { class: "aps__row aps__row--switch" }, ve = { class: "aps__row" }, ye = { class: "aps__label" }, be = { class: "aps__foot" }, xe = {
	...
	key: 1,
	class: "aps"
}, Ce = { class: "aps__group" }, we = { class: "aps__title" }, Te = { class: "aps__row aps__row--switch" }, Ee = { class: "aps__row aps__row--switch" }, De = { class: "aps__row" }, z = { class: "aps__label" }, Oe = { class: "aps__value" }, ke = { class: "aps__slider" }, Ae = { class: "aps__row" }, je = { class: "aps__label" }, Me = { class: "aps__group" }, Ne = { class: "aps__title" }, Pe = { class: "aps__row" }, Fe = { class: "aps__label" }, Ie = { class: "aps__row" }, Le = { class: "aps__label" }, Re = { class: "aps__row" }, ze = { class: "aps__label" }, Be = { class: "aps__row" }, Ve = { class: "aps__label" }, He = { class: "aps__row" }, Ue = { class: "aps__label" }, B = /*#__PURE__*/ e(/* @__PURE__ */ v({
	...
	setup(e) {
		...
		let Y = d(() => Math.max(0, B.findIndex((e) => e.value === c.theme))), X = d(() => Math.max(0, V.findIndex((e) => e.value === c.accent)));
		function Z(e, t, n) {
			if (t === 0) return null;
			let r = n;
			switch (e.key) {
		...
		function Ke(e) {
			let t = Z(e, B.length, Y.value);
			t !== null && (c.theme = B[t].value);
		}
		function qe(e) {
			let t = Z(e, V.length, X.value);
			t !== null && (c.accent = V[t].value);
		}
		let Q = x(!1), $;
		function Je() {
			if (!Q.value) {
		...
		return oe(() => clearTimeout($)), (n, r) => e.panel === "appearance" ? (b(), m("div", se, [
			...
			}, [r[14] ||= h("span", { class: "aps__preview" }, [h("span", { class: "aps__preview-bar" }), h("span", { class: "aps__preview-card" })], -1), h("span", fe, [g(C(e.label) + " ", 1), w(c).theme === e.value ? (b(), f(t, {
				key: 0,
				name: "check",
			...
			h("section", D, [
				...
				h("div", N, [h("span", P, [g(C(w(v)("settings.cardSize")) + " ", 1), h("span", F, C(q(w(c).cardSize)), 1)]), h("div", I, [_(a, {
			...
			h("section", L, [
				...
				r[15] ||= h("p", { class: "aps__hint" }, "Larger controls and a visible focus outline for TV / remote navigation.", -1),
				h("div", ve, [h("span", ye, C(w(v)("settings.motion")), 1), _(s, {
			...
			h("div", be, [_(ee, {
				...
				_: 1
			}, 8, ["left-icon"]), h("span", xe, C(Q.value ? w(v)("settings.resetConfirm") : ""), 1)])
		])) : (b(), m("div", Se, [h("section", Ce, [
			h("h3", we, C(w(v)("settings.playback")), 1),
			h("div", Te, [_(o, {
			...
			h("div", Ee, [_(o, {
				"model-value": w(c).seriesThemeAutoplay,
				label: w(v)("settings.seriesThemeAutoplay"),
				"onUpdate:modelValue": r[7] ||= (e) => w(c).seriesThemeAutoplay = e
			}, null, 8, ["model-value", "label"])]),
			h("div", De, [h("span", z, [g(C(w(v)("settings.defaultVolume")) + " ", 1), h("span", Oe, C(K(w(c).defaultVolume)), 1)]), h("div", ke, [_(a, {
				...
				"format-value": K,
				"onUpdate:modelValue": r[8] ||= (e) => w(c).defaultVolume = e
			}, null, 8, ["model-value", "label"])])]),
			h("div", Ae, [h("span", je, C(w(v)("settings.defaultQuality")), 1), _(s, {
				"model-value": w(c).defaultQuality,
				options: G,
				label: w(v)("settings.defaultQuality"),
				"onUpdate:modelValue": r[9] ||= (e) => w(c).defaultQuality = String(e)
			}, null, 8, ["model-value", "label"])])
		]), h("section", Me, [
			h("h3", Ne, C(w(v)("settings.subtitles")), 1),
			h("div", Pe, [h("span", Fe, C(w(v)("settings.defaultLanguage")), 1), _(s, {
				"model-value": w(c).defaultSubtitleLang ?? "",
				options: We,
				label: w(v)("settings.defaultSubtitleLanguage"),
				"onUpdate:modelValue": Ge
			}, null, 8, ["model-value", "label"])]),
			h("div", Ie, [h("span", Le, C(w(v)("settings.captionSize")), 1), _(s, {
				"model-value": w(c).captionStyle.size,
				options: w(te),
				label: w(v)("settings.captionSize"),
				"onUpdate:modelValue": r[10] ||= (e) => J("size", e)
			}, null, 8, [
				"model-value",
				"options",
				"label"
			])]),
			h("div", Re, [h("span", ze, C(w(v)("settings.captionColor")), 1), _(s, {
				"model-value": w(c).captionStyle.textColor,
				options: w(ne),
				label: w(v)("settings.captionColor"),
				"onUpdate:modelValue": r[11] ||= (e) => J("textColor", String(e))
			}, null, 8, [
				"model-value",
				"options",
				"label"
			])]),
			h("div", Be, [h("span", Ve, C(w(v)("settings.captionBackground")), 1), _(s, {
				"model-value": w(c).captionStyle.background,
				options: w(ie),
				label: w(v)("settings.captionBackground"),
				"onUpdate:modelValue": r[12] ||= (e) => J("background", e)
			}, null, 8, [
				"model-value",
				"options",
				"label"
			])]),
			h("div", He, [h("span", Ue, C(w(v)("settings.captionEdge")), 1), _(s, {
				"model-value": w(c).captionStyle.edge,
				options: w(re),
				label: w(v)("settings.captionEdge"),
				"onUpdate:modelValue": r[13] ||= (e) => J("edge", e)
			}, null, 8, [
				"model-value",
				"options",
				"label"
...
}), [["__scopeId", "data-v-dd8c3706"]]), V = { class: "settings-page" }, H = { class: "settings-page__head" }, U = { class: "settings-page__eyebrow" }, W = { class: "settings-page__title" }, G = /*#__PURE__*/ e(/* @__PURE__ */ v({
	__name: "SettingsPage",
	setup(e) {
		let { t } = r(), n = [
			{
		...
		return (e, r) => (b(), m("div", V, [h("header", H, [h("p", U, C(w(t)("settings.preferences")), 1), h("h1", W, C(w(t)("settings.title")), 1)]), _(c, {
			modelValue: i.value,
			"onUpdate:modelValue": r[0] ||= (e) => i.value = e,
			tabs: n,
			label: w(t)("settings.sectionsLabel")
		}, {
			appearance: T(() => [_(B, { panel: "appearance" })]),
			playback: T(() => [_(B, { panel: "playback" })]),
			server: T(() => [_(l)]),
			_: 1
		}, 8, ["modelValue", "label"])]));
	}
...
//# sourceMappingURL=SettingsPage-CK4gr5bi.js.map