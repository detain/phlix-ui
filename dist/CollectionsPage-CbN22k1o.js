...
import { c as t, n, t as r } from "./Button-GJ9vHE0J.js";
...
var w = {
	...
	props: { client: {} },
	setup(e) {
		let h = e, D = ie("apiBase", ""), pe = l(() => typeof D == "string" ? D : D?.value ?? ""), O = new ne(h.client ?? new n({
			baseUrl: pe.value,
			tokenStore: new i()
...
//# sourceMappingURL=CollectionsPage-CbN22k1o.js.map