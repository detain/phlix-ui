...
var te = {
...
}, re = { class: "admin-services__section-head" }, ie = { class: "admin-services__card" }, ae = {
	key: 0,
	...
	props: { client: {} },
	setup(e) {
		let v = e, F = y("apiBase", ""), I = d(() => typeof F == "string" ? F : F?.value ?? ""), L = new l(v.client ?? new t({
			baseUrl: I.value,
			tokenStore: new i()
		...
		async function K() {
			...
			try {
				...
				U.value = r(e, "Failed to load Trakt status."), R.error(U.value);
			} finally {
				H.value = !1;
			}
		}
		...
		async function ce() {
			if (!W.value) {
				...
				try {
					...
					R.error(r(e, "Failed to disconnect Trakt."));
				} finally {
					W.value = !1;
				}
			}
		...
		async function Q() {
			...
			try {
				...
				Y.value = r(e, "Failed to load Last.fm status."), R.error(Y.value);
			} finally {
				J.value = !1;
			}
		}
		...
		async function ue() {
			if (!X.value) {
				...
				try {
					...
					R.error(r(e, "Failed to disconnect Last.fm."));
				} finally {
					X.value = !1;
				}
			}
		...
		return b(() => {
			...
			h("section", ne, [h("div", re, [t[0] ||= h("h2", {
				id: "trakt-heading",
				...
				_: 1
			}, 8, ["tone", "label"]))]), h("div", ie, [H.value ? (x(), m("div", ae, [_(s, {
				variant: "text",
				lines: 2
			})])) : V.value === null ? (x(), f(c, {
				key: 1,
				...
				V.value.connected && V.value.username !== null ? (x(), m("dl", E, [t[2] ||= h("dt", null, "Username", -1), h("dd", null, C(V.value.username), 1)])) : p("", !0),
				...
				h("div", O, [V.value.connected ? (x(), f(n, {
					key: 1,
					variant: "outline",
					loading: W.value,
					onClick: ce
			...
			h("section", k, [h("div", A, [t[5] ||= h("h2", {
				...
				q.value.connected && q.value.username !== null ? (x(), m("dl", oe, [
				...
				!q.value.connected && Z.value ? (x(), m("p", N, [...t[9] ||= [
				...
				h("div", P, [q.value.connected ? (x(), f(n, {
					key: 1,
					variant: "outline",
					loading: X.value,
					onClick: ue
...
//# sourceMappingURL=ServicesPage-Bih3oFQz.js.map