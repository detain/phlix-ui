...
import { n as ee, t as te } from "./ThumbRating-DL3IV5ps.js";
import { t as o } from "./Button-CnyfCnhY.js";
import { t as s } from "./Chip-CnJPGjy7.js";
import { a as ne, n as re, r as ie } from "./MediaCard-Yv4Ir8Uo.js";
import { t as ae } from "./MediaRow-ZmhICHIp.js";
...
var ue = { class: "media-detail" }, de = {
	...
	setup(e, { emit: g }) {
		let D = e, O = g, k = ee(), A = oe("phlixConfig", null), lt = i(), j = l(() => k.isFavorite(D.item.id));
		function ut() {
		...
		let F = l(() => {
			...
			return r;
		}), I = b(!1), ft = l(() => D.item.type === "series" || D.item.type === "season"), pt = l(() => ie(D.item, {
			isAdmin: M.value,
			isWatched: N.value,
...
}), [["__scopeId", "data-v-3ead8724"]]);
//#endregion
export { D as t };

//# sourceMappingURL=MediaDetail-2nhnOOUF.js.map