...
import { t as r } from "./useMessages--P0Tza-Y.js";
...
var se = {
	...
	setup(e) {
		...
		return oe(() => clearTimeout($)), (n, r) => e.panel === "appearance" ? (b(), m("div", se, [
			...
			}, [r[13] ||= h("span", { class: "aps__preview" }, [h("span", { class: "aps__preview-bar" }), h("span", { class: "aps__preview-card" })], -1), h("span", fe, [g(C(e.label) + " ", 1), w(c).theme === e.value ? (b(), f(t, {
				key: 0,
				name: "check",
			...
			h("section", L, [
				...
				r[14] ||= h("p", { class: "aps__hint" }, "Larger controls and a visible focus outline for TV / remote navigation.", -1),
			...
			h("h3", z, C(w(v)("settings.playback")), 1),
			h("div", we, [_(o, {
				"model-value": w(c).autoplay,
				label: w(v)("settings.autoplayNext"),
				"onUpdate:modelValue": r[6] ||= (e) => w(c).autoplay = e
			}, null, 8, ["model-value", "label"])]),
			h("div", Te, [h("span", Ee, [g(C(w(v)("settings.defaultVolume")) + " ", 1), h("span", De, C(K(w(c).defaultVolume)), 1)]), h("div", Oe, [_(a, {
			...
			h("div", Fe, [h("span", Ie, C(w(v)("settings.captionSize")), 1), _(s, {
				...
				"onUpdate:modelValue": r[9] ||= (e) => J("size", e)
			}, null, 8, [
				"model-value",
				"options",
				"label"
			...
			h("div", Le, [h("span", Re, C(w(v)("settings.captionColor")), 1), _(s, {
				...
				"onUpdate:modelValue": r[10] ||= (e) => J("textColor", String(e))
			}, null, 8, [
				"model-value",
				"options",
				"label"
			...
			h("div", ze, [h("span", Be, C(w(v)("settings.captionBackground")), 1), _(s, {
				...
				"onUpdate:modelValue": r[11] ||= (e) => J("background", e)
			}, null, 8, [
				"model-value",
				"options",
				"label"
			...
			h("div", Ve, [h("span", He, C(w(v)("settings.captionEdge")), 1), _(s, {
				...
				"onUpdate:modelValue": r[12] ||= (e) => J("edge", e)
			}, null, 8, [
				"model-value",
				"options",
				"label"
...
}), [["__scopeId", "data-v-b5352ee3"]]), V = { class: "settings-page" }, H = { class: "settings-page__head" }, U = { class: "settings-page__eyebrow" }, W = { class: "settings-page__title" }, G = /*#__PURE__*/ e(/* @__PURE__ */ v({
	__name: "SettingsPage",
	setup(e) {
		let { t } = r(), n = [
			{
...
//# sourceMappingURL=SettingsPage-szWHK4Lg.js.map