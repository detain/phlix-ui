...
var ce = {
	...
	props: { client: {} },
	setup(e) {
		let g = e, C = re("apiBase", ""), Ke = l(() => typeof C == "string" ? C : C?.value ?? ""), w = new ne(g.client ?? new t({
			baseUrl: Ke.value,
			tokenStore: new i()
		})), T = te();
		function E(e) {
		...
		async function J() {
			...
			try {
				...
				H.value = r(e, "Failed to load now playing."), T.error(H.value);
			} finally {
				F.value = !1;
			}
		}
		async function Y(e) {
			...
			try {
				...
				U.value = r(e, "Failed to load top users."), T.error(U.value);
			} finally {
				I.value = !1;
			}
		}
		async function X(e) {
			...
			try {
				...
				W.value = r(e, "Failed to load top media."), T.error(W.value);
			} finally {
				L.value = !1;
			}
		}
		async function Z() {
			...
			try {
				...
				G.value = r(e, "Failed to load storage."), T.error(G.value);
			} finally {
				R.value = !1;
			}
		}
		async function Q(e, t = !1) {
			...
			try {
				...
				let n = r(e, "Failed to load activity.");
				t || (K.value = n), T.error(n);
			} finally {
				z.value = !1, B.value = !1;
			}
		}
...
//# sourceMappingURL=DashboardPage-CD5K7uzK.js.map