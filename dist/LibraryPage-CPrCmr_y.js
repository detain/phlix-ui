...
import { n as i, o as a } from "./ThumbRating-uWe6prMH.js";
...
import { n as ne, r as re, t as ie } from "./FilterBar-BFZqAv_C.js";
import { t as ae } from "./MetadataMatchModal-ozGAKR2V.js";
import { t as c } from "./EmptyState-0XgHKEGf.js";
import { n as oe, r as l } from "./useResolvePlayable-DHId_bIB.js";
...
}), [["__scopeId", "data-v-55645c12"]]), A = /* @__PURE__ */ new Map();
function j(e) {
...
var N = { class: "library-page" }, P = {
	...
	__name: "LibraryPage",
	setup(e) {
		let u = n(), _ = ue(), v = de(), x = ne(), E = s(), D = r(), O = a(), k = o(), A = i(), j = b(null), M = b([]), R = null, z = d(() => M.value.some((e) => e.count > 0));
		async function B() {
			R?.abort();
		...
		async function Q(e) {
			...
			let r = () => n !== X;
			try {
				let i = await oe(new t({ baseUrl: u.value }), u.value, e, O.resumeMap, n?.signal);
				if (r()) return;
				if (!i) {
...
}), [["__scopeId", "data-v-7fc2ea0a"]]);
//#endregion
export { R as default };

//# sourceMappingURL=LibraryPage-CPrCmr_y.js.map