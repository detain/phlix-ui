...
import { f as t, r as n } from "./client-cUL8r-1I.js";
...
var S = {
	...
	props: { client: {} },
	setup(e) {
		let h = e.client ?? n, P = r(), F = v([]), I = v(!0), L = v(null), R = v(1), z = v(1);
		async function B(e = 1) {
			...
			try {
				...
				L.value = t(e, "Failed to load audit logs."), P.error(L.value);
			} finally {
				I.value = !1;
			}
		}
		...
		return g(() => B()), (e, t) => (_(), d("section", S, [t[7] ||= f("header", { class: "audit__head" }, [f("h1", {
			...
			f("td", null, [f("span", { "data-testid": `action-${e.id}` }, [m(a, { tone: H(e.action) }, {
...
//# sourceMappingURL=AuditLogsPage-CGbFV6_C.js.map