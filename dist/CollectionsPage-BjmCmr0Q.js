...
var w = {
	...
	props: { client: {} },
	setup(e) {
		let h = e, D = ie("apiBase", ""), pe = l(() => typeof D == "string" ? D : D?.value ?? ""), O = new ne(h.client ?? new t({
			baseUrl: pe.value,
			tokenStore: new i()
		...
		async function N() {
			...
			try {
				...
				M.value = r(e, "Failed to load collections."), k.error(M.value);
			} finally {
				j.value = !1;
			}
		}
		...
		async function H() {
			...
			try {
				...
				k.error(r(e, "Failed to save collection."));
			} finally {
				R.value = !1;
			}
		}
		...
		async function he() {
			...
			if (e) try {
				...
				k.error(r(e, "Failed to delete collection.")), U.value = null;
			}
		}
		...
		async function X(e) {
			...
			try {
				...
				k.error(r(e, "Failed to load items."));
			} finally {
				K.value = !1;
			}
		}
		...
		async function ve(e) {
			...
			if (t) try {
				...
				k.error(r(e, "Failed to remove item."));
			}
		}
		async function Q() {
			let e = W.value;
			if (e) {
				...
				try {
					...
					k.error(r(e, "Failed to bulk-add items."));
				} finally {
					J.value = !1;
				}
			}
		...
		async function ye(e) {
			try {
				...
				k.error(r(e, "Failed to refresh collection."));
			}
		}
		function $(e) {
		...
		return ae(N), (e, t) => (g(), d("section", w, [
			...
			m(a, {
				...
				default: x(() => [K.value ? (g(), d("div", ue, [m(o, {
					...
					scope: "col",
					class: "admin-collections__actions-col"
				}, "Actions")])], -1), f("tbody", null, [(g(!0), d(c, null, v(G.value, (e) => (g(), d("tr", { key: e.id }, [f("td", null, y($(e)), 1), f("td", null, [m(n, {
					variant: "ghost",
					size: "sm",
					"left-icon": "x",
					"aria-label": `Remove ${$(e)}`,
...
//# sourceMappingURL=CollectionsPage-BjmCmr0Q.js.map