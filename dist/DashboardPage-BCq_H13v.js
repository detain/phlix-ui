...
var ce = {
	...
	role: "list"
}, He = { class: "admin-dash__activity-user" }, Ue = ["title"], We = ["datetime", "title"], S = 20, Ge = 3e4, C = /*#__PURE__*/ t(/* @__PURE__ */ g({
	__name: "DashboardPage",
	props: { client: {} },
	setup(t) {
		let g = t, C = re("apiBase", ""), Ke = l(() => typeof C == "string" ? C : C?.value ?? ""), w = new ne(g.client ?? new n({
			baseUrl: Ke.value,
			tokenStore: new i()
		})), T = te();
		function E(e) {
		...
		async function J() {
			...
			try {
				...
				H.value = e(t, "Failed to load now playing."), T.error(H.value);
			} finally {
				F.value = !1;
			}
		}
		async function Y(t) {
			...
			try {
				j.value = await w.getTopUsers(10, t);
			} catch (t) {
				U.value = e(t, "Failed to load top users."), T.error(U.value);
			} finally {
				I.value = !1;
			}
		}
		async function X(t) {
			...
			try {
				M.value = await w.getTopMedia(10, t);
			} catch (t) {
				W.value = e(t, "Failed to load top media."), T.error(W.value);
			} finally {
				L.value = !1;
			}
		}
		async function Z() {
			...
			try {
				...
				G.value = e(t, "Failed to load storage."), T.error(G.value);
			} finally {
				R.value = !1;
			}
		}
		async function Q(t, n = !1) {
			...
			try {
				let e = await w.getActivity(t);
				n ? P.value = [...P.value, ...e] : P.value = e, V.value = e.length === S;
			} catch (t) {
				let r = e(t, "Failed to load activity.");
...
//# sourceMappingURL=DashboardPage-BCq_H13v.js.map