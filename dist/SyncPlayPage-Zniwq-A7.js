...
import { t as s } from "./Modal-C23ujDyU.js";
...
var j = {
	...
	props: { client: {} },
	setup(e) {
		let b = e, M = x("apiBase", ""), N = p(() => typeof M == "string" ? M : M?.value ?? ""), P = new d(b.client ?? new r({
			baseUrl: N.value,
			tokenStore: new t()
		})), F = i(), I = w([]), L = w(!0), R = w(null);
		async function z() {
			L.value = !0, R.value = null;
			try {
				I.value = await P.listGroups();
			} catch (e) {
				R.value = n(e, "Failed to load groups."), F.error(R.value);
			} finally {
				L.value = !1;
			}
		}
		...
		async function K() {
			...
			try {
				...
				F.error(n(e, "Failed to create group."));
			} finally {
				U.value = !1;
			}
		}
		...
		async function Q() {
			...
			try {
				...
				F.error(n(e, "Failed to join group."));
			} finally {
				X.value = !1;
			}
		}
		...
		return S(z), (e, t) => (C(), g("section", j, [
			_("header", ee, [t[7] ||= _("div", { class: "admin-syncplay__heading-group" }, [_("h1", {
				id: "syncplay-heading",
				class: "admin-syncplay__title"
			}, "SyncPlay"), _("p", { class: "admin-syncplay__subtitle" }, " Watch together with synchronized playback for multiple viewers. ")], -1), y(a, {
				variant: "solid",
				size: "sm",
				"left-icon": "plus",
				onClick: W
			}, {
				default: O(() => [...t[6] ||= [v(" Create group ", -1)]]),
				_: 1
			})]),
			y(u, null, {
				default: O(() => [...t[8] ||= [
			...
			L.value ? (C(), g("div", te, [y(c, {
				...
				actions: O(() => [y(a, {
					...
					default: O(() => [...t[10] ||= [v(" Create group ", -1)]]),
					_: 1
				})]),
				_: 1
			})) : (C(), g("table", ne, [t[13] ||= _("thead", null, [_("tr", null, [
				_("th", { scope: "col" }, "Name"),
				...
				_("td", null, [_("span", re, E(e.name), 1), e.has_password ? (C(), m(o, {
					key: 0,
					tone: "warning"
				}, {
					default: O(() => [...t[11] ||= [v("Password", -1)]]),
					_: 1
				})) : h("", !0)]),
				_("td", null, E($(e.member_count)), 1),
				_("td", null, [y(o, { tone: e.is_playing ? "accent" : "neutral" }, {
			...
			y(s, {
				...
				footer: O(() => [y(a, {
					...
					default: O(() => [...t[17] ||= [v(" Create group ", -1)]]),
					_: 1
				}, 8, ["loading"])]),
				default: O(() => [_("form", {
					class: "admin-syncplay__form",
					onSubmit: A(K, ["prevent"])
				}, [_("label", ae, [t[14] ||= _("span", { class: "admin-syncplay__label" }, "Group name", -1), k(_("input", {
					...
					required: ""
				}, null, 512), [[D, V.value]])]), _("label", oe, [t[15] ||= _("span", { class: "admin-syncplay__label" }, "Password (optional)", -1), k(_("input", {
			...
			y(s, {
				...
				footer: O(() => [y(a, {
					...
					default: O(() => [...t[21] ||= [v(" Join group ", -1)]]),
					_: 1
				}, 8, ["loading"])]),
				default: O(() => [_("form", {
					class: "admin-syncplay__form",
					onSubmit: A(Q, ["prevent"])
				}, [_("label", se, [t[18] ||= _("span", { class: "admin-syncplay__label" }, "Group ID", -1), k(_("input", {
					...
					required: ""
				}, null, 512), [[D, J.value]])]), _("label", ce, [t[19] ||= _("span", { class: "admin-syncplay__label" }, "Password (if required)", -1), k(_("input", {
...
}), [["__scopeId", "data-v-63196fca"]]);
//#endregion
export { M as default };

//# sourceMappingURL=SyncPlayPage-Zniwq-A7.js.map