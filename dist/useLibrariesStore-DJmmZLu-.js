import { l as e, n as t, p as n } from "./Button-MsRePfWv.js";
...
var d = i("libraries", () => {
	let e = r([]), t = r(!1), i = r(!1), a = r(null), o = null;
	async function s(r, s = !1) {
		if (!(i.value && !s)) return o || (t.value = !0, a.value = null, o = (async () => {
			try {
				e.value = await u(r), i.value = !0;
			} catch (e) {
				a.value = n(e, "Failed to load libraries");
			} finally {
				t.value = !1, o = null;
			}
		})(), o);
...
//# sourceMappingURL=useLibrariesStore-DJmmZLu-.js.map