...
function p(e) {
	return e.replace(/&(#x?[0-9a-f]+|[a-z]+);/gi, (e, t) => {
		if (t[0] === "#") {
			...
			return Number.isFinite(n) && f(n) || e;
		}
		let n = t.toLowerCase();
		return Object.prototype.hasOwnProperty.call(d, n) ? d[n] : e;
	});
}
function m(e) {
	return e ? e.replace(/<[^>]*>/g, "").split(/\r?\n/).map((e) => p(e).trim()).filter((e) => e.length > 0) : [];
}
function h(t) {
	if (!t) return [];
	let n = e(t.activeCues), r = [];
	for (let e of n) r.push(...m(e.text));
	return r;
}
var g = {
	sm: .75,
...
function C(e) {
	return {
		"--cap-scale": String(g[e.size] ?? 1),
		"--cap-color": e.textColor,
		"--cap-bg": x(e.background),
		"--cap-pad": e.background === "none" ? "0" : "0.12em 0.42em",
		"--cap-shadow": S(e.edge)
	};
}
//#endregion
export { g as a, c, S as d, s as f, o as g, h, _ as i, C as l, i as m, v as n, u as o, a as p, b as r, l as s, y as t, m as u };

//# sourceMappingURL=captions-COgPp5bH.js.map