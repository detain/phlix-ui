...
import { t as o } from "./Select-B0YIBPe2.js";
...
var D = {
	...
	setup(a) {
		let g = [
			...
			baseUrl: I.value,
			tokenStore: new i()
		})), R = t(), z = S([]), B = S(""), V = S(200), H = S([]), U = S(!1), W = S(!1), G = S(null), K = null, q = u(() => z.value.length === 0 ? [{
			value: "",
			label: "(no log files)"
		}] : [{
			value: l,
...
//# sourceMappingURL=LogsPage-BlizE1rS.js.map