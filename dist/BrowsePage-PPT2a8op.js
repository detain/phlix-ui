...
import { t as n } from "./useAuthStore-TsBE0ENb.js";
import { i as r } from "./usePlayerStore-DmNlaYQc.js";
import { t as i } from "./useLibrariesStore-DSTfYXV0.js";
import { t as a } from "./Button-k7aQagzg.js";
import { t as ee } from "./useToastStore-BDoKlU6N.js";
import { i as o, t as s } from "./MetadataMatchModal-A_zEqVV0.js";
import { t as c } from "./EmptyState-B2QnGIQT.js";
import { t as l } from "./MediaRow-D-byFhY1.js";
import { t as u } from "./HomeRow-BLsr3pd-.js";
...
var te = { class: "browse-page" }, ne = { class: "browse-toolbar" }, re = {
	...
	__name: "BrowsePage",
	setup(e) {
		let y = t(), j = b("phlixConfig", null), ie = f(() => j?.homeRows ?? []), M = i(), N = r(), P = ee(), F = n(), I = A(), L = w(null), R = w(!1), z = w(null);
		function B(e) {
			L.value = e, R.value = !0;
		}
		function V(e) {
		...
		return (e, t) => (S(), h("div", te, [
			g("div", ne, [E(e.$slots, "toolbar-extra", {}, void 0, !0)]),
			G.value.length ? (S(), p(l, {
				key: 0,
...
//# sourceMappingURL=BrowsePage-PPT2a8op.js.map