import { a as e, i as t, n, r as ee, t as r, u as te } from "./Button-DFtuAYup.js";
import { t as i } from "./Modal-3-gao3sJ.js";
import { t as ne } from "./EmptyState-DPlVvQLn.js";
import { t as re } from "./Select-BYtr8Wen.js";
import { t as a } from "./Badge-DypgiWDB.js";
import { t as ie } from "./Switch-DzAvcqfb.js";
...
var fe = {
	...
	key: 4,
	class: "admin-users__subform"
}, Be = { class: "admin-users__subform-title" }, Ve = { class: "admin-users__field" }, He = { class: "admin-users__subform-actions" }, Ue = 5, x = /*#__PURE__*/ te(/* @__PURE__ */ ce({
	__name: "UsersPage",
	props: { client: {} },
	setup(te) {
		let ce = te, x = le("apiBase", ""), We = s(() => typeof x == "string" ? x : x?.value ?? ""), S = new se(ce.client ?? new e({
			baseUrl: We.value,
			tokenStore: new t()
		})), C = ee();
		function w(e, t) {
		...
		return ue(D), (e, t) => (m(), u("section", fe, [
			...
			p(i, {
				...
				default: v(() => [V.value ? (m(), u("div", Oe, [p(n, {
					variant: "text",
					lines: 4
				})])) : (m(), u(o, { key: 1 }, [
					d("div", ke, [p(r, {
...
//# sourceMappingURL=UsersPage-Dop-xeqE.js.map