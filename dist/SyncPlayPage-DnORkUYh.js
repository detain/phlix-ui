...
var D = {
	...
	setup(n) {
		...
		return v(B), (e, t) => (y(), f("section", D, [
			...
			}, "SyncPlay"), p("p", { class: "admin-syncplay__subtitle" }, " Watch together with synchronized playback for multiple viewers. ")], -1), h(a, {
				variant: "solid",
				size: "sm",
				"left-icon": "plus",
				onClick: G
...
//# sourceMappingURL=SyncPlayPage-DnORkUYh.js.map