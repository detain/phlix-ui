...
import { t as o } from "./Select-BYtr8Wen.js";
...
var D = {
	...
	setup(a) {
		let g = [
			...
			1e3,
			2e3
		], P = a, F = _("apiBase", ""), I = u(() => typeof F == "string" ? F : F?.value ?? ""), L = new c(P.client ?? new e({
			baseUrl: I.value,
			tokenStore: new t()
		})), R = r(), z = S([]), B = S(""), V = S(200), H = S([]), U = S(!1), W = S(!1), G = S(null), K = null, q = u(() => z.value.length === 0 ? [{
			value: "",
			label: "(no log files)"
		}] : [{
			value: l,
		...
		return T([B, V], () => void X()), T([
			...
			W.value && H.value.length === 0 ? (x(), f("div", M, [h(n, {
				variant: "text",
				lines: 8
			})])) : (x(), f("pre", {
				key: 2,
...
//# sourceMappingURL=LogsPage-DOrNU1kL.js.map