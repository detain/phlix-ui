import { c as e, d as t, n, u as r } from "./Button-C4PyCjLX.js";
import { a as i } from "./usePreferencesStore-BFFMWKZp.js";
import { n as a } from "./media-query-DowsWq-z.js";
import { t as o } from "./Badge-D9Tdn6WP.js";
import { n as s, r as c, t as l } from "./MediaRow-BAqF6Sqv.js";
import { i as u, n as d, r as f, t as p } from "./Select-CmN-4YbZ.js";
...
var W = { class: "phlix-combobox__field" }, G = [
	...
	setup(e, { emit: t }) {
		let n = e, i = t, a = _(() => u(n.options)), o = I(), s = j(!1), c = j(-1), l = j(""), p = j(!1), m = j(null), g = j(null), w = j(null), D = _(() => a.value.find((e) => e.value === n.modelValue)?.label ?? ""), k = _(() => {
		...
		function L() {
			n.disabled || s.value || (s.value = !0, c.value = k.value.findIndex((e) => e.value === n.modelValue), c.value < 0 && (c.value = k.value.findIndex((e) => !e.disabled)), T(U));
		}
		function z() {
		...
		function V(e) {
			let t = k.value[e];
			!t || t.disabled || (t.value !== n.modelValue && (i("update:modelValue", t.value), i("change", t.value)), l.value = t.label, p.value = !1, s.value = !1, g.value?.focus());
		}
		function H(e) {
		...
		return R(s, (e) => {
		...
		}), O(() => document.removeEventListener("pointerdown", X, !0)), (t, n) => (A(), b("div", {
			ref_key: "rootEl",
			ref: m,
			...
			role: "listbox",
			"aria-label": e.label
		}, [(A(!0), b(h, null, M(k.value, (t, n) => (A(), b("li", {
			id: `${F(o)}-opt-${n}`,
			key: t.value,
		...
		}, [x("span", J, [t.value === e.modelValue ? (A(), v(r, {
			key: 0,
			name: "check"
		})) : y("", !0)]), S(" " + P(t.label), 1)], 42, q))), 128)), k.value.length === 0 ? (A(), b("li", te, "No matches")) : y("", !0)], 8, K), [[ee, s.value]])], 2));
	}
...
var Z = { class: "media-grid-root" }, oe = {
	...
	setup(e, { emit: t }) {
		let n = e, a = t, o = i(), c = _(() => n.cardSize ?? o.cardSize ?? 180), l = j(null), u = j(null), d = j(0), f = j(0), p = j(0);
		function m() {
			let e = l.value;
		...
		let E = _(() => X(d.value, c.value, 20)), P = _(() => ie(re(d.value, E.value, 20))), F = _(() => d.value > 0 && P.value > 0), I = _(() => ae({
			...
			if (!F.value) return n.items.map((e, t) => ({
				item: e,
				index: t
			}));
			let { startIndex: e, endIndex: t } = I.value, r = [];
		...
		function K() {
			G || typeof IntersectionObserver > "u" || (G = new IntersectionObserver((e) => {
				e.some((e) => e.isIntersecting) && n.hasMore && !n.loading && !n.loadingMore && a("load-more");
		...
		return R(() => l.value, (e) => {
		...
		}), R(() => n.items.length, () => T(w)), (t, n) => (A(), b("div", Z, [e.loading && e.items.length === 0 ? (A(), b("div", {
			key: 0,
		...
		]]))), 128))], 4)) : e.items.length === 0 ? (A(), b("div", oe, [N(t.$slots, "empty", {}, () => [
			C(r, {
				name: "film",
				class: "media-grid-empty__icon"
			}),
			n[1] ||= x("p", { class: "media-grid-empty__title" }, "No media found", -1),
			n[2] ||= x("p", { class: "media-grid-empty__hint" }, "Try adjusting your filters.", -1)
		], !0)])) : (A(), b(h, { key: 2 }, [
			x("div", {
				ref_key: "sizerEl",
				ref: l,
			...
			}, [(A(!0), b(h, null, M(L.value, (e) => N(t.$slots, "card", {
				key: e.item.id,
				item: e.item,
				index: e.index
			}, () => [C(s, {
			...
			e.loadingMore ? (A(), b("div", Q, [...n[3] ||= [x("span", {
			...
			default: z(() => [U.value ? (A(), b("button", {
				...
				onClick: W
			}, [C(r, { name: "arrow-up" })])) : y("", !0)]),
			_: 1
		})]));
	}
}), [["__scopeId", "data-v-b9e31bb0"]]), se = /*#__PURE__*/ t(/* @__PURE__ */ w({
	__name: "HomeRow",
	props: {
		row: {},
		apiBase: {},
	...
	setup(e, { emit: t }) {
		let r = e, i = t, o = m(), s = j([]), c = j(null), u = j(!1), d = j(null), f = j(!1), p = j(null), h = null, g = null, _ = !1;
		function v(e) {
		...
		async function y() {
			if (!u.value) {
				...
				try {
					let e = new n({ baseUrl: r.apiBase }), t = a(r.apiBase, {
						...r.row.query,
						limit: r.limit,
						offset: 0
					}), o = await e.get(t, void 0, g?.signal);
					if (_) return;
					s.value = o.items ?? [], c.value = typeof o.total == "number" ? o.total : s.value.length, f.value = !0, i("items-loaded", s.value);
				} catch (e) {
					if (_ || v(e)) return;
					d.value = e instanceof Error ? e.message : "Failed to load", o.error(`Couldn't load "${r.row.title}"`);
				} finally {
					_ || (u.value = !1);
				}
			}
...
var de = U("media", () => {
	let t = j([]), r = j(0), i = j(!1), a = j(null), o = j(""), s = j([]), c = j(void 0), l = j(void 0), u = j([]), d = j([]), f = j("name"), p = j("asc"), m = j(24), h = j(0), g = _(() => t.value.length < r.value), v = _(() => {
		let e = {};
	...
	function M(e, t, r, i) {
		i && (O && r !== D && O.abort(), D = r);
		let a = E.get(r);
		if (a) return i && (O = a.controller), a.promise;
		let o = new AbortController();
		i && (O = o);
		let s = new n({ baseUrl: e }).get(C(e, t), void 0, o.signal).then((e) => (T.set(r, {
			items: e.items,
			total: e.total,
			ts: Date.now()
		}), e)).finally(() => {
	...
	async function P(t, n = !1) {
		...
		try {
			let e = await M(t, r, o, !n);
			if (!n && o !== D) return;
			N(e, n);
		} catch (t) {
			if (ue(t)) return;
			(n || o === D) && (a.value = e(t, "Failed to load media"));
		} finally {
			(n || o === D) && (i.value = !1);
		}
	}
	...
	async function I(e) {
		i.value || !g.value || (h.value = t.value.length, await P(e, !0));
	}
	...
	"aria-live": "polite"
}, Ne = { class: "filterbar__pills" }, Pe = /*#__PURE__*/ t(/* @__PURE__ */ w({
	__name: "FilterBar",
	props: {
	...
	setup(e, { emit: t }) {
		...
		return k(() => {
			n.sticky && typeof window < "u" && (window.addEventListener("scroll", Fe, { passive: !0 }), Fe());
		}), O(() => {
			clearTimeout(f), typeof window < "u" && window.removeEventListener("scroll", Fe);
		}), (t, n) => (A(), b("div", { class: E(["filterbar", {
			"is-sticky": e.sticky,
			...
			x("div", fe, [
				...
				x("div", me, [C(p, {
					...
					onClick: ne
				}, [C(r, { name: F(s).order === "asc" ? "arrow-up" : "arrow-down" }, null, 8, ["name"])], 8, he)]),
				x("button", {
					type: "button",
			...
			C(g, { name: "filterbar-panel" }, {
				default: z(() => [B(x("div", _e, [
					x("div", ve, [n[5] ||= x("span", { class: "filterbar__field-label" }, "Genres", -1), (A(), v(Y, {
						key: D.value,
						"model-value": T.value,
						options: N.value,
					...
					x("div", ye, [n[6] ||= x("span", { class: "filterbar__field-label" }, "Rating", -1), x("div", be, [(A(!0), b(h, null, M(F(s).availableRatings, (e) => (A(), v(c, {
						key: e,
					...
					x("div", xe, [n[7] ||= x("span", { class: "filterbar__field-label" }, "Type", -1), x("div", Se, [(A(!0), b(h, null, M(F(s).availableTypes, (e) => (A(), v(c, {
						key: e,
					...
					x("div", Ce, [n[9] ||= x("span", { class: "filterbar__field-label" }, "Year", -1), x("div", we, [
						C(Y, {
					...
					x("div", Te, [
						n[12] ||= x("span", { class: "filterbar__field-label" }, "Presets", -1),
						...
						Q.value ? (A(), b("div", Oe, [B(x("input", {
							...
							onKeydown: [V(H(ce, ["prevent"]), ["enter"]), n[3] ||= V((e) => Q.value = !1, ["esc"])]
						}, null, 40, ke), [[L, $.value]]), x("button", {
							type: "button",
							class: "filterbar__preset-confirm",
							onClick: ce
						}, [C(r, { name: "check" }), n[10] ||= S(" Save ", -1)])])) : (A(), b("button", {
							key: 1,
							type: "button",
							class: "filterbar__preset-add",
							disabled: !re.value,
							onClick: se
						}, [C(r, { name: "plus" }), n[11] ||= S(" Save current ", -1)], 8, Ae))
					])
				], 512), [[ee, Z.value]])]),
				_: 1
			}),
...
//# sourceMappingURL=FilterBar-CygG3KWY.js.map