import { a as e, f as t, h as n, i as ee, n as r, o as te, r as ne, t as i } from "./Button-C86XulWV.js";
import { t as re } from "./Modal-DaapuyD8.js";
import { t as a } from "./Badge-BiYXL5Nz.js";
import { t as o } from "./Switch-BRVGpfuc.js";
...
var ue = {
	...
	class: "admin-integrations__error",
	role: "alert"
}, Ke = 3e4, C = "openid profile email", w = /*#__PURE__*/ n(/* @__PURE__ */ m({
	...
	setup(n) {
		let m = {
			oidc: "OIDC",
			ldap: "LDAP"
		}, w = ["oidc", "ldap"], qe = n, T = oe("apiBase", ""), Je = ae(() => typeof T == "string" ? T : T?.value ?? ""), E = new ie(qe.client ?? new te({
			baseUrl: Je.value,
			tokenStore: new e()
		})), D = ee(), O = g(null), k = g(!0), A = g(null), j = g(!1), M = null;
		function N() {
		...
		async function Ze(e, n) {
			try {
				n ? (await E.disableProvider(e), D.success(`${m[e]} disabled.`)) : (await E.enableProvider(e), D.success(`${m[e]} enabled.`)), await B();
			} catch (n) {
				D.error(t(n, `Failed to update ${m[e]}.`));
			}
		}
		let H = g(!1), U = g({
			provider_url: "",
		...
		return ce(() => {
			...
			d("section", be, [t[22] ||= d("div", { class: "admin-integrations__section-head" }, [d("h2", {
				...
				class: "admin-integrations__section-title"
			}, " Authentication providers ")], -1), I.value ? (h(), u("div", xe, [p(r, {
				variant: "text",
				lines: 4
			})])) : L.value ? (h(), c(ne, {
				key: 1,
			...
			}, [d("div", Ce, [d("span", we, _(m[e]), 1), p(a, { tone: V(e) ? "success" : "neutral" }, {
				default: b(() => [f(_(V(e) ? "Enabled" : "Disabled"), 1)]),
				_: 2
			}, 1032, ["tone"])]), d("div", Te, [p(o, {
				"model-value": V(e),
				label: `Enable ${m[e]}`,
			...
			p(re, {
				...
				default: b(() => [d("form", {
					...
					d("label", Oe, [
						...
						}, null, 8, je), [[v, U.value.client_secret]]), p(i, {
							variant: "ghost",
							size: "sm",
				...
				default: b(() => [d("form", {
					...
					d("label", ze, [
						...
						d("div", Ve, [x(d("input", {
							...
							autocomplete: "new-password"
						}, null, 8, He), [[v, J.value.bind_pw]]), p(i, {
							variant: "ghost",
							size: "sm",
...
//# sourceMappingURL=IntegrationsPage-BVHVExLL.js.map