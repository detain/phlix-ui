...
var E = [
	...
	"onClick",
	"onPointermove"
], k = { class: "phlix-select__check" }, A = /*#__PURE__*/ t(/* @__PURE__ */ u({
	__name: "Select",
	props: {
		modelValue: {},
		options: {},
	...
	setup(t, { emit: u }) {
		let A = t, j = u, M = r(() => C(A.options)), N = y(), P = h(!1), F = h(-1), I = h(null), L = h(null), R = "", z, B = r(() => M.value.findIndex((e) => e.value === A.modelValue)), V = r(() => M.value[B.value]?.label ?? ""), H = r(() => F.value >= 0 ? `${N}-opt-${F.value}` : void 0);
		function U() {
		...
		return x(P, (e) => {
			...
			onKeydown: J
		}, [s("span", { class: f(["phlix-select__value", { "is-placeholder": B.value < 0 }]) }, _(B.value >= 0 ? V.value : t.placeholder), 3), l(e, {
			name: "chevron-down",
			...
			role: "option",
			"aria-selected": n.value === t.modelValue,
			"aria-disabled": n.disabled || void 0,
			onClick: (e) => G(r),
			onPointermove: (e) => !n.disabled && (F.value = r)
		}, [s("span", k, [n.value === t.modelValue ? (m(), i(e, {
			key: 0,
			name: "check"
...
//# sourceMappingURL=Select-BYtr8Wen.js.map