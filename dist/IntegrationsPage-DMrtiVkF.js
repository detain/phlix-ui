import { a as e, i as t, n, r as ee, t as r, u as i } from "./Button-DFtuAYup.js";
import { t as a } from "./Modal-3-gao3sJ.js";
import { t as o } from "./Badge-DypgiWDB.js";
import { t as s } from "./Switch-DzAvcqfb.js";
...
var ce = {
	...
	class: "admin-integrations__error",
	role: "alert"
}, We = 3e4, C = "openid profile email", w = /*#__PURE__*/ i(/* @__PURE__ */ m({
	...
	setup(i) {
		let m = {
			oidc: "OIDC",
			ldap: "LDAP"
		}, w = ["oidc", "ldap"], Ge = i, T = ie("apiBase", ""), Ke = ne(() => typeof T == "string" ? T : T?.value ?? ""), E = new te(Ge.client ?? new e({
			baseUrl: Ke.value,
			tokenStore: new t()
		})), D = ee();
		function O(e, t) {
		...
		return oe(() => {
			...
			d("section", le, [d("div", ue, [t[16] ||= d("h2", {
				...
				_: 1
			}, 8, ["tone"])) : l("", !0)]), d("div", de, [A.value ? (h(), u("div", fe, [p(n, {
				variant: "text",
				lines: 3
			...
			d("section", ve, [t[20] ||= d("div", { class: "admin-integrations__section-head" }, [d("h2", {
				...
				class: "admin-integrations__section-title"
			}, " Authentication providers ")], -1), I.value ? (h(), u("div", ye, [p(n, {
				variant: "text",
				lines: 4
			...
			p(a, {
				...
				default: b(() => [d("form", {
					...
					d("label", Ee, [
						...
						}, null, 8, ke), [[v, H.value.client_secret]]), p(r, {
							variant: "ghost",
							size: "sm",
				...
				default: b(() => [d("form", {
					...
					d("label", Le, [
						...
						d("div", ze, [x(d("input", {
							...
							autocomplete: "new-password"
						}, null, 8, Be), [[v, J.value.bind_pw]]), p(r, {
							variant: "ghost",
							size: "sm",
...
//# sourceMappingURL=IntegrationsPage-DMrtiVkF.js.map