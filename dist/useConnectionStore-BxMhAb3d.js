...
var h = n("connection", () => {
	...
	function m(e) {
		c.value = p(e) || null, o(i, c.value);
	}
	function h(e) {
		n.value = s(e) || null, o(r, n.value), n.value && m(n.value), l?.(n.value);
	}
	function g() {
...
//# sourceMappingURL=useConnectionStore-BxMhAb3d.js.map