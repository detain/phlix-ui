...
import { n } from "./media-query-IVKvZvWX.js";
import { t as r } from "./useToastStore-BDoKlU6N.js";
import { t as i } from "./MediaRow-BzBPBeRa.js";
...
var g = /*#__PURE__*/ e(/* @__PURE__ */ l({
	...
	setup(e, { emit: l }) {
		let g = e, _ = l, v = r(), y = p([]), b = p(null), x = p(!1), S = p(null), C = p(!1), w = p(null), T = null, E = null, D = !1;
		function O(e) {
		...
		async function k() {
			if (!x.value) {
				...
				try {
					let e = new t({ baseUrl: g.apiBase }), r = n(g.apiBase, {
						...g.row.query,
						limit: g.limit,
						offset: 0
					}), i = await e.get(r, void 0, E?.signal);
					if (D) return;
					y.value = i.items ?? [], b.value = typeof i.total == "number" ? i.total : y.value.length, C.value = !0, _("items-loaded", y.value);
				} catch (e) {
					if (D || O(e)) return;
...
//# sourceMappingURL=HomeRow-DP1rKC00.js.map