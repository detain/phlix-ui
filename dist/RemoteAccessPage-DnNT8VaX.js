...
import { t as ne } from "./Modal-CoXJKJI4.js";
...
}, et = { class: "admin-remote__claim-code" }, tt = { class: "admin-remote__field" }, nt = { class: "admin-remote__field" }, _ = /*#__PURE__*/ te(/* @__PURE__ */ ae({
	__name: "RemoteAccessPage",
	props: { client: {} },
	setup(te) {
		let ae = te, _ = oe("apiBase", ""), rt = o(() => typeof _ == "string" ? _ : _?.value ?? ""), v = new ie(ae.client ?? new e({
			baseUrl: rt.value,
			tokenStore: new ee()
		})), y = t();
		function b(e, t) {
		...
		return se(() => {
			...
			u("section", he, [u("button", {
				...
				onClick: t[0] ||= (e) => S("hub")
			}, [u("span", _e, [t[8] ||= u("h2", { id: "remote-hub-heading" }, "Hub Pairing", -1), f(n, {
			...
			u("section", we, [u("button", {
			...
			}, [u("span", Ee, [t[15] ||= u("h2", { id: "remote-subdomain-heading" }, "Subdomain", -1), f(n, {
				...
				variant: "text",
				lines: 2
			})])) : I.value === null ? (p(), l("p", Ae, " Unable to load subdomain status. ")) : (p(), l(a, { key: 2 }, [I.value.claimed ? (p(), l("dl", je, [I.value.subdomain ? (p(), l(a, { key: 0 }, [t[16] ||= u("dt", null, "Subdomain", -1), u("dd", null, h(I.value.subdomain), 1)], 64)) : c("", !0), I.value.fqdn ? (p(), l(a, { key: 1 }, [t[17] ||= u("dt", null, "FQDN", -1), u("dd", null, h(I.value.fqdn), 1)], 64)) : c("", !0)])) : c("", !0), u("div", Me, [I.value.claimed ? (p(), s(r, {
				key: 1,
				variant: "ghost",
				size: "sm",
				loading: z.value,
			...
			}, [u("span", Fe, [t[20] ||= u("h2", { id: "remote-relay-heading" }, "Relay Tunnel", -1), f(n, {
			...
			}, [u("span", We, [t[27] ||= u("h2", { id: "remote-portforward-heading" }, "Port Forward", -1), f(n, {
...
//# sourceMappingURL=RemoteAccessPage-DnNT8VaX.js.map