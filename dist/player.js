...
var ce = R("phlix-player", () => {
	let e = te(), t = S(null), n = S(""), i = S([]), a = S(!1), o = S(0), s = S(0), c = S(0), l = S(e.defaultVolume), u = S(!1), d = S(1), f = S(e.defaultQuality), p = S(e.defaultSubtitleLang), m = S(""), h = S(!1), g = S(se()), _ = S(W()), v = S(null), y = 0, b = r(() => s.value > 0 ? o.value / s.value : 0), x = r(() => i.value[0] ?? null);
	function C(e) {
		_.value[e] = Date.now();
	}
	function w(e) {
...
var me = "access_token", he = "refresh_token", G = "user", ge = class {
	storage;
	...
	clear() {
		this.storage.removeItem(me), this.storage.removeItem(he), this.storage.removeItem(G);
	}
};
//#endregion
...
var uo = ["aria-label"], fo = { class: "shortcuts__head" }, po = { class: "shortcuts__title" }, mo = { class: "shortcuts__grid" }, ho = { class: "shortcuts__keys" }, go = {
	...
	setup(e) {
		let t = ce(), n = te(), { t: i } = X(), a = r(() => t.muted ? 0 : t.volume), s = r(() => t.muted || t.volume <= 0 ? "mute" : t.volume < .5 ? "volume-low" : "volume");
		function c(e) {
...
var Uo = /*#__PURE__*/ Y(/* @__PURE__ */ d({
	...
	setup(e, { expose: t, emit: n }) {
		...
		let u = n, d = ce(), f = te(), { t: p } = X(), m = r(() => Lo(o.levels)), h = r(() => {
...
var ms = /*#__PURE__*/ Y(/* @__PURE__ */ d({
	...
	setup(t, { emit: n }) {
		let c = t, l = n, d = ce(), f = te(), { t: p } = X(), m = S(null), h = S(null), _ = r(() => d.subtitleLang), y = r(() => c.tracks.some((e) => e.language === _.value)), b = r(() => y.value ? "captions" : "captions-off"), w = r(() => y.value ? c.tracks.findIndex((e) => e.language === _.value) + 1 : 0), T = r(() => c.activeAudio >= 0 ? c.activeAudio : 0);
		function k(e) {
			l("update:open", e);
		}
		function A() {
...
function vl(e, t) {
	if (typeof t != "string" || t === "" || !_l(t)) return t;
	let n = e.replace(/\/+$/, "");
	return n === "" ? t : n + t;
}
function yl(e, t) {
...
function bl() {
	let e = gl();
	return {
		imgSrc: (t) => vl(e.value, t),
		imgSrcset: (t) => yl(e.value, t)
	};
}
//#endregion
//#region src/components/player/UpNext.vue?vue&type=script&setup=true&lang.ts
var xl = ["aria-label"], Sl = ["src"], Cl = { class: "upnext__body" }, wl = { class: "upnext__eyebrow" }, Tl = { class: "upnext__title" }, El = {
	key: 0,
	class: "upnext__cd numeric"
}, Dl = { class: "upnext__actions" }, Ol = {
	key: 1,
	class: "upnext__ring",
	viewBox: "0 0 36 36",
	"aria-hidden": "true"
	...
	setup(e, { emit: t }) {
		let { t: n } = X(), { imgSrc: i } = bl(), c = e, l = t, d = r(() => c.posterUrl ?? c.media.poster_url ?? null), f = r(() => nl(c.remaining, c.total));
		return (t, r) => (x(), o("aside", {
			...
			s("div", Cl, [
				s("p", wl, E(O(n)("player.upNext")), 1),
				s("h4", Tl, E(e.media.name), 1),
				e.counting ? (x(), o("p", El, E(O(n)("player.startsIn", { seconds: Math.max(0, e.remaining) })), 1)) : a("", !0),
				s("div", Dl, [s("button", {
					type: "button",
			...
			e.counting ? (x(), o("svg", Ol, [s("circle", {
				cx: "18",
				cy: "18",
				r: O(15),
				fill: "none",
...
}), [["__scopeId", "data-v-9115aa2b"]]), Ml = {
	class: "transcode",
	role: "alert"
}, Nl = { class: "transcode__card" }, Pl = { class: "transcode__heading" }, Fl = { class: "transcode__body" }, Il = /*#__PURE__*/ Y(/* @__PURE__ */ d({
	__name: "TranscodeNotice",
	props: { title: {} },
	emits: ["back"],
	setup(e, { emit: t }) {
		let n = t, { t: r } = X();
		return (t, i) => (x(), o("div", Ml, [s("div", Nl, [
			u(J, {
				name: "alert",
				class: "transcode__icon"
			}),
			s("h3", Pl, E(O(r)("player.transcodeHeading")), 1),
			s("p", Fl, E(e.title ? O(r)("player.transcodeBodyTitled", { title: e.title }) : O(r)("player.transcodeBodyUntitled")), 1),
			s("button", {
				type: "button",
...
}), [["__scopeId", "data-v-8a5efb50"]]), Ll = {
	class: "prep",
	role: "status",
	"aria-live": "polite"
}, Rl = { class: "prep__card" }, zl = { class: "prep__heading" }, Bl = { class: "prep__body" }, Vl = ["aria-valuenow"], Hl = /*#__PURE__*/ Y(/* @__PURE__ */ d({
	...
	setup(e) {
		...
		return (t, i) => (x(), o("div", Ll, [s("div", Rl, [
			u(J, {
				name: "spinner",
				class: "prep__spinner"
			}),
			s("h3", zl, E(O(n)("player.transcodePreparingHeading")), 1),
			s("p", Bl, E(e.title ? O(n)("player.transcodePreparingTitled", { title: e.title }) : O(n)("player.transcodePreparingUntitled")), 1),
			s("div", {
				class: "prep__bar",
				role: "progressbar",
				"aria-valuenow": r(),
...
}), [["__scopeId", "data-v-e3ea0ebf"]]), Ul = /*#__PURE__*/ Y(/* @__PURE__ */ d({
	__name: "SkipButton",
	props: {
		position: {},
		introMarker: {},
...
}), [["__scopeId", "data-v-d3fc1b53"]]), Wl = {
	key: 0,
	class: "skip-controls",
	"aria-label": "Skip controls"
}, Gl = ["aria-label", "onClick"], Kl = { class: "skip-controls__label" }, ql = 5, Jl = 30, Yl = /*#__PURE__*/ Y(/* @__PURE__ */ d({
	__name: "SkipControls",
	props: {
		position: {},
		markers: {}
	...
	setup(t, { emit: n }) {
		...
		function p(e, t) {
			if (f(e, t)) return !1;
			let n = d(e.startMs), r = n - ql, i = n + Jl;
			return t >= r && t < i;
		}
		let m = [
			"intro",
		...
		return (t, n) => g.value.length > 0 ? (x(), o("div", Wl, [(x(!0), o(e, null, C(g.value, (e) => (x(), o("button", {
			key: e.id,
			type: "button",
			class: "skip-controls__btn",
			"aria-label": `Skip ${h(e.type)}`,
			onClick: L((t) => _(e), ["stop"])
		}, [s("span", Kl, E(h(e.type)), 1), u(J, { name: "skip-forward" })], 8, Gl))), 128))])) : a("", !0);
	}
}), [["__scopeId", "data-v-27a6c637"]]), Xl = ["aria-label", "aria-expanded"], Zl = ["aria-label"], Ql = { class: "chapterlist__head" }, $l = { class: "chapterlist__title" }, eu = ["aria-label"], tu = ["onClick"], nu = { class: "chapterlist__index" }, ru = { class: "chapterlist__name" }, iu = { class: "chapterlist__meta" }, au = { class: "chapterlist__time" }, ou = {
	key: 0,
	...
	setup(t, { emit: n }) {
		...
		return (n, r) => (x(), o("div", {
			...
			tabindex: "-1"
		}, [s("div", Ql, [s("h3", $l, E(O(l)("player.chapters")), 1), u(Xa, {
			name: "x",
			...
			s("span", nu, E(e.index), 1),
			s("span", ru, E(e.label), 1),
			s("span", iu, [s("span", au, E(e.startLabel), 1), e.durationLabel ? (x(), o("span", ou, "· " + E(e.durationLabel), 1)) : a("", !0)])
		], 8, tu)]))), 128))], 8, eu)) : (x(), o("p", su, E(O(l)("player.noChapters")), 1))], 8, Zl)) : a("", !0)], 512));
	}
}), [["__scopeId", "data-v-177e91a7"]]), lu = {
	key: 0,
	class: "marker-timeline__ad-badge",
	"aria-live": "polite"
}, uu = { class: "marker-timeline__ticks" }, du = [
	"title",
	"aria-label",
	"onClick"
], fu = { class: "marker-timeline__tooltip" }, pu = { class: "marker-timeline__tooltip-label" }, mu = { class: "marker-timeline__tooltip-time numeric" }, hu = ["onClick"], gu = /*#__PURE__*/ Y(/* @__PURE__ */ d({
...
}), [["__scopeId", "data-v-52c56b64"]]), _u = ["aria-label", "aria-expanded"], vu = {
	key: 0,
	class: "sleep-timer__remaining numeric"
}, yu = ["aria-label"], bu = ["aria-selected", "onClick"], xu = /*#__PURE__*/ Y(/* @__PURE__ */ d({
	__name: "SleepTimer",
	...
	setup(t, { expose: i }) {
		...
		return v(() => {
			...
			"aria-haspopup": "listbox",
			onClick: D
		}, [u(J, { name: "moon" }), m.value ? (x(), o("span", vu, E(w(p.value)), 1)) : a("", !0)], 10, _u), u(n, { name: "dropdown" }, {
...
var Tu = .1, Eu = .99, Du = 1.01, Ou = class {
	samples = [];
	driftRate = 1;
	now;
	samplesVersion = 0;
	...
	updateDriftRate() {
		...
		this.driftRate = 1 + Tu * i / 1e3, this.driftRate = Math.min(Du, Math.max(Eu, this.driftRate));
	}
	getDriftRate() {
	...
	constructor(e) {
		this.options = e, this.send = e.send, this.now = e.now, this.memberId = e.memberId, this.memberName = e.memberName ?? "User", this.timeSync = new Ou(e.now);
	}
	getTimeSync() {
...
function Fu(e) {
	...
	return {
		...
		memberCount: Au(t.member_count, Nu(t).length),
		roomId: n,
		hostUserId: t.host_id ?? void 0,
		createdAt: ju(t.created_at)
	};
}
function Iu(e) {
	let t = e ?? {}, n = Mu(t), r = Pu(t);
	return {
		id: n,
		roomId: n,
		serverId: "",
		...
		createdAt: ju(t.created_at),
		state: r,
		playbackPosition: Au(t.playback_position),
		playbackRate: +(r === "playing"),
		serverTime: Au(t.last_activity_at, Math.floor(Date.now() / 1e3)),
		lastSync: ju(t.last_activity_at),
		activeUsers: Nu(t),
		roles: Object.fromEntries(Nu(t).map((e) => [e.id, e.role])),
		permissions: {}
	};
}
var Lu = class {
	...
	async createRoom(e) {
		return Fu((await this.client.post("/api/v1/syncplay/groups", e)).group);
	}
	async joinRoom(e) {
		return Iu((await this.client.post(`/api/v1/syncplay/groups/${encodeURIComponent(e)}/join`)).group);
	}
	async leaveRoom(e) {
	...
	async getMembers(e) {
		return Nu((await this.client.get(`/api/v1/syncplay/groups/${encodeURIComponent(e)}`)).group);
	}
	async listGroups() {
		let e = await this.client.get("/api/v1/syncplay/groups");
		return Array.isArray(e.groups) ? e.groups.map(Fu) : [];
	}
...
function zu(e) {
	return Ru ||= new Lu(e), Ru;
}
var Q = null, Bu = null, Vu = 0, Hu = 5, Uu = 1e3, $ = null, Wu = null, Gu = null, Ku = null;
function qu() {
	try {
...
function Ju(e) {
	let t = typeof window < "u" ? window.location.hostname : "localhost", n = qu() ?? "";
...
function Xu() {
	if (Q = null, $ && $.onDisconnect(), Bu && Vu < Hu) {
		let e = Uu * 2 ** Vu;
		Vu++, console.log(`[SyncPlay] WebSocket closed, reconnecting in ${e}ms (attempt ${Vu})`), setTimeout(() => {
			Bu && Zu(Bu);
		}, e);
	} else Vu >= Hu && (console.warn("[SyncPlay] Max reconnect attempts reached, giving up"), Bu = null, Vu = 0, $ = null);
}
function Zu(e, t, n, r) {
	if (t && (Ku = t), Q && Bu !== e && (Q.close(), Q = null, Bu = null, Vu = 0, $ = null), Q && Bu === e) return;
	Bu = e, Vu = 0;
	let i = n ?? Wu ?? `member_${Date.now()}_${Math.random().toString(36).slice(2, 9)}`, a = r ?? Gu ?? "Anonymous";
	Wu = i, Gu = a, $ = new ku({
		send: (e) => {
			Q && Q.readyState === WebSocket.OPEN && Q.send(wu(e));
		},
		now: () => Date.now(),
		memberId: i,
		memberName: a,
	...
	console.log(`[SyncPlay] Opening WebSocket to ${o}`), Q = new WebSocket(o), Q.onopen = () => {
		console.log("[SyncPlay] WebSocket connected"), Vu = 0, $ && Bu && $.joinGroup(Bu);
	}, Q.onmessage = Yu, Q.onclose = Xu, Q.onerror = (e) => {
		console.error("[SyncPlay] WebSocket error", e);
	};
}
function Qu() {
	Q &&= (Q.close(), null), $ &&= ($.leaveGroup(), $.onDisconnect(), null), Bu = null, Vu = 0;
}
function $u(e) {
...
var ed = R("phlix-syncplay", () => {
	...
	async function p(r, o) {
		...
		try {
			let i = zu(r), a = await i.createRoom(o);
			e.value = a;
	...
	async function m(r, o) {
		a.value = !0, i.value = null;
		try {
			let i = await zu(r).joinRoom(o);
			t.value = i, s = Date.now(), e.value &&= {
				...e.value,
				currentSession: i
			}, n.value = i.activeUsers, Zu(o, (e) => {
				g(e);
			});
		} catch (e) {
	...
	async function h(r) {
		if (e.value) {
			a.value = !0, i.value = null;
			try {
				await zu(r).leaveRoom(e.value.id), Qu(), e.value = null, t.value = null, n.value = [];
			} catch (e) {
	...
	async function v(e) {
		if (t.value) try {
			let n = await zu(e).getState(t.value.id);
	...
	async function y(t) {
		if (e.value) try {
			let r = await zu(t).getMembers(e.value.id);
			n.value = r;
		} catch (e) {
...
}, nd = { class: "syncplay-overlay__badge" }, rd = { class: "syncplay-overlay__label" }, id = { class: "syncplay-overlay__status-label" }, ad = { class: "syncplay-overlay__members" }, od = { class: "syncplay-overlay__member-count" }, sd = { class: "syncplay-overlay__member-list" }, cd = { class: "syncplay-overlay__member-name" }, ld = {
	key: 0,
	class: "syncplay-overlay__member syncplay-overlay__member--more"
}, ud = /*#__PURE__*/ Y(/* @__PURE__ */ d({
	__name: "SyncPlayOverlay",
	props: { apiBase: {} },
	setup(t) {
		let n = t, { t: i } = X(), c = ed(), d = gl(), f = r(() => n.apiBase ?? d.value), p = r(() => c.currentRoom?.name ?? "SyncPlay"), m = r(() => c.onlineMembers.length), h = r(() => c.syncStatus), _ = r(() => {
			switch (h.value) {
		...
		return (t, n) => O(c).isInRoom ? (x(), o("div", td, [
			s("div", nd, [u(J, {
				name: "user",
				class: "syncplay-overlay__icon"
			}), s("span", rd, "SyncPlay: " + E(p.value), 1)]),
			...
			s("div", ad, [s("span", od, [u(J, { name: "user" }), l(" " + E(O(i)("syncplay.members", { count: m.value })), 1)]), s("ul", sd, [(x(!0), o(e, null, C(O(c).onlineMembers.slice(0, 5), (e) => (x(), o("li", {
				key: e.id,
				class: "syncplay-overlay__member"
			}, [n[0] ||= s("span", { class: "syncplay-overlay__member-dot" }, null, -1), s("span", cd, E(e.name), 1)]))), 128)), O(c).onlineMembers.length > 5 ? (x(), o("li", ld, " +" + E(O(c).onlineMembers.length - 5) + " more ", 1)) : a("", !0)])]),
			u($s, {
				variant: "ghost",
				size: "sm",
				onClick: y
...
}), [["__scopeId", "data-v-3f63f0ac"]]), dd = [
	"aria-checked",
	"aria-label",
	"aria-labelledby",
	"disabled"
], fd = ["id"], pd = /*#__PURE__*/ Y(/* @__PURE__ */ d({
	__name: "Switch",
	props: {
		modelValue: { type: Boolean },
		label: {},
	...
	setup(e, { emit: t }) {
		...
		return (t, n) => (x(), o("span", { class: g(["phlix-switch", { "is-disabled": e.disabled }]) }, [s("button", {
			...
			disabled: e.disabled,
			onClick: c
		}, [...n[0] ||= [s("span", { class: "phlix-switch__thumb" }, null, -1)]], 10, dd), e.label ? (x(), o("label", {
			key: 0,
			id: O(i),
			class: "phlix-switch__label",
			onClick: c
		}, E(e.label), 9, fd)) : a("", !0)], 2));
	}
}), [["__scopeId", "data-v-0725d51f"]]), md = {
	class: "syncplay-modal__tabs",
	role: "tablist"
}, hd = ["aria-selected"], gd = ["aria-selected"], _d = {
	key: 0,
	class: "syncplay-modal__fields"
}, vd = { class: "syncplay-modal__field" }, yd = {
	class: "syncplay-modal__label",
	for: "room-name"
}, bd = ["placeholder"], xd = { class: "syncplay-modal__field syncplay-modal__field--toggle" }, Sd = { class: "syncplay-modal__toggle-hint" }, Cd = {
	key: 1,
	class: "syncplay-modal__fields"
}, wd = { class: "syncplay-modal__field" }, Td = {
	class: "syncplay-modal__label",
	for: "room-id"
}, Ed = ["placeholder"], Dd = {
	key: 2,
...
}, kd = { class: "syncplay-modal__rooms-title" }, Ad = { class: "syncplay-modal__rooms-list" }, jd = ["onClick"], Md = { class: "syncplay-modal__room-name" }, Nd = { class: "syncplay-modal__room-count" }, Pd = {
	key: 4,
	class: "syncplay-modal__loading",
	role: "status"
}, Fd = /*#__PURE__*/ Y(/* @__PURE__ */ d({
	...
	setup(t, { emit: n }) {
		let c = t, d = n, { t: f } = X(), p = ed(), m = gl(), h = r(() => c.apiBase ?? m.value), _ = S("create"), v = S(""), y = S(""), b = S(!0), w = S(!1), T = S(null), D = S([]), k = S(!1), A = r(() => v.value.trim().length > 0), M = r(() => y.value.trim().length > 0), I = r(() => (_.value === "create" ? A.value : M.value) && !w.value);
		...
		return (n, r) => (x(), i(Ys, {
			...
			default: P(() => [s("form", {
				...
				}, E(O(f)("syncplay.createRoom")), 11, hd), s("button", {
					type: "button",
					role: "tab",
				...
				_.value === "create" ? (x(), o("div", _d, [s("div", vd, [s("label", yd, E(O(f)("syncplay.roomName")), 1), F(s("input", {
					id: "room-name",
					...
					autocomplete: "off"
				}, null, 8, bd), [[j, v.value]])]), s("div", xd, [u(pd, {
					modelValue: b.value,
					"onUpdate:modelValue": r[3] ||= (e) => b.value = e,
					label: O(f)("syncplay.publicRoom")
				}, null, 8, ["modelValue", "label"]), s("span", Sd, E(b.value ? O(f)("syncplay.publicHint") : O(f)("syncplay.privateHint")), 1)])])) : (x(), o("div", Cd, [s("div", wd, [s("label", Td, E(O(f)("syncplay.roomId")), 1), F(s("input", {
					id: "room-id",
				...
				T.value ? (x(), o("p", Dd, E(T.value), 1)) : a("", !0),
				_.value === "join" && D.value.length > 0 ? (x(), o("div", Od, [s("h3", kd, E(O(f)("syncplay.publicRooms")), 1), s("ul", Ad, [(x(!0), o(e, null, C(D.value, (e) => (x(), o("li", {
					key: e.id,
					...
					s("span", Md, E(e.name), 1),
					s("span", Nd, E(O(f)("syncplay.members", { count: e.memberCount })), 1)
				], 8, jd)]))), 128))])])) : a("", !0),
...
}), [["__scopeId", "data-v-6ff70b4f"]]), Id = {
	key: 0,
	class: "syncplay-controls"
}, Ld = ["aria-label"], Rd = { class: "syncplay-controls__wait-label" }, zd = {
	key: 0,
	class: "syncplay-controls__wait-members"
}, Bd = { key: 0 }, Vd = { class: "syncplay-controls__transport" }, Hd = ["aria-label"], Ud = ["aria-label"], Wd = ["aria-label"], Gd = { class: "syncplay-controls__status-label" }, Kd = 10, qd = /*#__PURE__*/ Y(/* @__PURE__ */ d({
	...
	setup(e, { emit: t }) {
		let n = e, i = t, { t: c } = X(), d = ed(), f = gl(), p = r(() => n.apiBase ?? f.value), m = S(!1), h = S([]), _ = r(() => m.value || d.syncStatus === "re-syncing");
		async function v() {
			if (d.isInRoom) try {
		...
		async function w() {
			await C(Math.max(0, n.position - Kd));
		}
		async function T() {
			await C(Math.min(n.duration, n.position + Kd));
		}
		return N(() => d.syncStatus, (e) => {
			e === "re-syncing" ? m.value = !0 : e === "synced" && (m.value = !1, h.value = []);
		}), (t, n) => O(d).isInRoom ? (x(), o("div", Id, [
			_.value ? (x(), o("div", {
				key: 0,
				...
				s("span", Rd, E(O(c)("syncplay.waitingForMembers")), 1),
				h.value.length > 0 ? (x(), o("span", zd, [l(E(h.value.slice(0, 3).join(", ")) + " ", 1), h.value.length > 3 ? (x(), o("span", Bd, "+" + E(h.value.length - 3), 1)) : a("", !0)])) : a("", !0)
			], 8, Ld)) : a("", !0),
			s("div", Vd, [
				s("button", {
					type: "button",
				...
				s("button", {
					...
					onClick: b
				}, [u(J, { name: e.isPlaying ? "pause" : "play" }, null, 8, ["name"])], 8, Ud),
				s("button", {
					type: "button",
					class: "syncplay-controls__btn",
			...
			}, null, 8, ["name"]), s("span", Gd, E(O(d).syncStatus === "synced" ? O(c)("syncplay.synced") : O(d).syncStatus === "outOfSync" ? O(c)("syncplay.outOfSync") : O(c)("syncplay.reSyncing")), 1)], 2)
		])) : a("", !0);
	}
...
var Xd = { class: "player__stage" }, Zd = ["src", "poster"], Qd = [
	"src",
	"srclang",
	"label"
], $d = { class: "player__meta" }, ef = ["aria-label"], tf = { class: "player__meta-text" }, nf = { class: "player__eyebrow" }, rf = { class: "player__title" }, af = { class: "player__sub numeric" }, of = {
	key: 0,
	class: "player__dot",
	"aria-hidden": "true"
}, sf = {
...
}, cf = ["aria-label"], lf = { class: "player__btnrow" }, uf = ["aria-label"], df = ["aria-label"], ff = ["aria-label"], pf = { class: "player__time numeric" }, mf = ["aria-label", "aria-pressed"], hf = ["title"], gf = ["aria-label"], _f = ["aria-label"], vf = ["aria-label", "aria-pressed"], yf = ["aria-label", "aria-pressed"], bf = ["aria-label"], xf = { class: "similar-modal" }, Sf = {
	key: 0,
	...
	role: "alert"
}, wf = { class: "similar-modal__state-title" }, Tf = {
	key: 2,
	class: "similar-modal__state",
	role: "status"
}, Ef = {
...
}, Df = { class: "similar-modal__poster" }, Of = ["src", "alt"], kf = {
	key: 1,
	class: "similar-modal__poster-fallback",
	"aria-hidden": "true"
}, Af = { class: "similar-modal__result-body" }, jf = { class: "similar-modal__result-title" }, Mf = {
	key: 0,
	class: "similar-modal__result-meta numeric"
}, Nf = { key: 0 }, Pf = /*#__PURE__*/ Y(/* @__PURE__ */ d({
	__name: "Player",
	props: {
		media: {},
		streamUrl: {},
	...
	setup(t, { emit: n }) {
		let { imgSrc: c } = bl(), d = t, p = n, m = ce(), _ = te(), { t: b } = X(), w = ed(), T = Me(), D = r(() => T.isFavorite(d.media.id)), k = r(() => T.likeLevel(d.media.id));
		function A() {
			T.toggleFavorite(d.media.id, he());
		}
		function j(e) {
			T.setLike(d.media.id, e, he());
		}
		let M = [
			.25,
			.5,
			...
			1.75,
			2
		], F = S(null), I = S(null), R = S(!0), z = S(!1), B = S(!1), V = S(!1), H = S(!1), U = S(!1), ee = S(!1), ne = S(null), re = S(null), ie = S(!1), ae = Ae(), oe = S(!1), se = r(() => H.value ? 1.35 : 1), W = S(Xc(d.streamUrl, d.media.path)), le = r(() => cl(d.media.streams)), ue = 0;
		async function de() {
			let e = ++ue;
			if (W.value) return;
			let t = await ml([d.streamUrl, d.media.path], d.playbackAudioTracks ?? [], le.value);
			e === ue && (!t || W.value || (W.value = !0, Ce(F.value?.currentTime ?? 0)));
		}
		N([() => d.playbackAudioTracks, le], () => {
			de();
		}, { immediate: !0 });
		...
		}), ge = Ja({ apiBase: () => d.apiBase ?? "" }), _e = null;
		function ve(e) {
			_e !== null && clearTimeout(_e), _e = setTimeout(() => {
				_e = null, ge.fetch(e);
			}, 0);
		}
		let ye = r(() => d.thumbnailAt ?? ge.thumbnailAt), be = r(() => W.value ? void 0 : d.streamUrl), xe = r(() => W.value && G.state.value !== "ready"), K = r(() => W.value && (G.state.value === "preparing" || G.state.value === "idle")), Se = r(() => W.value && G.state.value === "error");
		function Ce(e = 0) {
			let t = F.value;
		...
		function De() {
			...
			if (t === "original") {
				...
				if (Vo(e, t)) G.loadVariantPlaylist(Po);
					...
					let t = Bo(e);
					t >= 0 && G.setNextLevel(t), Ee();
				}
				return !0;
			}
			let n = Ro(e, t);
			return n >= 0 ? G.setNextLevel(n) : Ee(), !0;
		}
		N(() => G.levels.value, (e) => {
			Te || e.length === 0 || De() && (Te = !0);
		}), N(() => G.variants.value, (e) => {
			Te || !e?.length || h(() => {
				Te || De() && (Te = !0);
			});
		}, { deep: !0 });
		let Oe = S(m.resumePositionFor(d.media.id) ?? 0), je = S(!W.value && Oe.value > 0), Ne = null, Pe = S(!1), Fe = S(8), Ie, Le = S(null), Re = S(0), ze = S(!1), Be = S([]), Ve = S(!1), He = S(null);
		function Ue(e, t) {
			Le.value = e, Re.value = t, Be.value = [], He.value = null, ze.value = !0, Je(e, t);
		}
		let We = null, Ge = null, Ke = null;
		function qe() {
			let e = d.apiBase ?? "";
			return (Ge === null || Ke !== e) && (Ge = new ke({ baseUrl: e }), Ke = e), Ge;
		}
		async function Je(e, t) {
			We?.abort(), We = new AbortController(), Ve.value = !0, He.value = null;
			try {
				let n = await qe().searchByMarker(e, t, 30, 20, We.signal);
				Be.value = Array.isArray(n.items) ? n.items : [];
			} catch (e) {
				if (e instanceof Error && e.name === "AbortError") return;
				He.value = "Failed to load similar media. Please try again.", Be.value = [];
			} finally {
				Ve.value = !1;
			}
		}
		function Ye() {
			We?.abort(), ze.value = !1, Be.value = [], He.value = null, Le.value = null;
		}
		let Xe = r(() => m.upNext);
		function Ze() {
			W.value = Xc(d.streamUrl, d.media.path), de(), Oe.value = m.resumePositionFor(d.media.id) ?? 0, je.value = !W.value && Oe.value > 0, Ne = null, Lt = !1, Tt = !1, St.value = [], xt.value = !1, Et = !1, mt.value = -1, Mt = null, Te = !1, me = !1, tt(), Pe.value = !1, G.reset(), F.value && (F.value.currentTime = 0), W.value && Ce(), ve(d.media.id);
		}
		function Qe(e) {
			let t = F.value;
			t && (t.duration && t.duration > 0 ? t.currentTime = Math.min(t.duration, Math.max(0, e)) : Ne = Math.max(0, e));
		}
		function $e() {
			Qe(Oe.value), je.value = !1, F.value?.play()?.catch(() => {});
		}
		function et() {
			Ne = null, Qe(0), m.clearResume(d.media.id), je.value = !1, F.value?.play()?.catch(() => {});
		}
		function tt() {
			Ie &&= (clearInterval(Ie), void 0);
		}
		function nt() {
			Fe.value = 8, tt(), Ie = setInterval(() => {
				--Fe.value, Fe.value <= 0 && (tt(), it());
			}, 1e3);
		}
		function rt() {
			me || (me = !0, pe?.finish()), hn(), R.value = !0, m.upNext && (Pe.value = !0, _.autoplay && nt());
		}
		function it() {
			tt(), Pe.value = !1;
		...
		function ot() {
			...
			(Zc(e) || t) && (W.value = !0, Ce(e?.currentTime ?? 0));
		}
		let st = S([]), ct = S([]), lt = S(-1), ut = S(!1), dt = r(() => G.state.value === "ready" && G.audioTracks.value.length > 0), ft = r(() => G.audioTracks.value.map((e) => ({
			index: e.index,
			language: e.lang || `audio-${e.index}`,
			label: e.name || `Audio ${e.index + 1}`,
			kind: "audio"
		}))), pt = r(() => (d.playbackAudioTracks ?? []).map((e) => ({
			index: e.index,
			language: e.language || `audio-${e.index}`,
			label: e.label,
			kind: "audio"
		}))), mt = S(-1), ht = r(() => !dt.value && !W.value && ct.value.length === 0 && pt.value.length > 1), gt = r(() => dt.value ? ft.value : ht.value ? pt.value : ct.value), _t = r(() => {
			if (dt.value) return G.currentAudioTrack.value;
			if (ht.value) {
			...
			let e = d.apiBase ?? "", t = W.value ? G.subtitleTracks.value : Yd(e, d.playbackSubtitleTracks ?? []);
			if (St.value.length === 0) return t;
			let n = (e) => e.url.split("?")[0], r = Yd(e, St.value), i = new Set(t.map(n)), a = r.filter((e) => !i.has(n(e)));
		...
		function wt(e) {
			St.value.some((t) => t.url === e.url) || (St.value = [...St.value, e]);
		}
		let Tt = !1, Et = !1;
		function Dt() {
			if (Tt) return;
			...
			t && (m.setSubtitle(t.language), yt = t.language, Tt = !0);
		}
		function Ot() {
			if (Et) return;
			...
			if (n < 0) return;
			let r = _t.value;
			r >= 0 && r < t.length || (Nt(n), Et = !0);
		}
		let kt = r(() => st.value.some((e) => e.language === m.subtitleLang));
		function At() {
			let e = F.value;
			st.value = Jo(e), ct.value = Yo(e), lt.value = es(e), Dt(), Ot();
		}
		function jt() {
			if (kt.value) yt = m.subtitleLang, m.setSubtitle(null);
			else {
		...
		let Mt = null;
		function Nt(e) {
			if (dt.value) G.setAudioTrack(e);
			else if (ht.value) {
				if (e === _t.value) return;
				mt.value = e, Mt = e, W.value = !0, Ce(F.value?.currentTime ?? 0);
			} else $o(F.value, e), lt.value = e;
		}
		N(dt, (e) => {
			if (!e || Mt === null) return;
			let t = Mt;
			Mt = null, t >= 0 && t < G.audioTracks.value.length && G.setAudioTrack(t);
		}), N(bt, () => {
			h(() => At());
		}, { deep: !0 });
		let Pt = null, Ft, It = r(() => {
		...
		function Rt() {
			if (!d.autoplay || Lt || je.value || xe.value) return;
			let e = F.value;
		...
		function Kt() {
			let e = F.value;
			e && m.updateProgress(e.currentTime, e.duration, Ut(e));
		}
		function qt() {
			let e = F.value;
			e && (e.volume = m.volume, e.muted = m.muted, e.playbackRate = m.rate, Ne !== null && (e.currentTime = e.duration ? Math.min(e.duration, Ne) : Ne, Ne = null), m.updateProgress(e.currentTime, e.duration, Ut(e)), m.setMediaPositionState(), At());
		}
		function Jt() {
			let e = F.value;
			e && m.updateProgress(e.currentTime, e.duration, Ut(e));
		...
		function sn() {
			...
			on !== null && (clearInterval(on), on = null);
			let t = .05;
			on = setInterval(() => {
				e.volume > t ? e.volume = Math.max(0, e.volume - t) : (clearInterval(on), on = null, e.volume = 0, e.pause(), m.pause());
			}, 50);
		}
		lo({
			playPause: Ht,
		...
		}, { enabled: () => !V.value && !ut.value && !vt.value });
		function cn() {
			m.toggleMute();
		}
		function ln() {
		...
		N(() => m.muted, (e) => {
			...
			e && (e.type === "seekTo" ? Qe(e.value) : e.type === "seekBy" && Qe(m.position + e.value));
		});
		function un() {
		...
		function hn() {
			Ft &&= (clearTimeout(Ft), void 0);
		}
		function gn() {
			hn(), !(!m.playing || B.value) && (Ft = setTimeout(() => {
		...
		N(() => m.playing, (e) => {
			e ? (je.value = !1, at(), gn()) : (hn(), R.value = !0);
		});
		let vn = null;
		return y(() => {
			...
			}), T.hydrate(d.media), typeof document < "u" && (document.addEventListener("fullscreenchange", dn), ee.value = document.pictureInPictureEnabled === !0), vn = m.bindMediaSession({
				onPlay: () => void F.value?.play()?.catch(() => {}),
				onPause: () => F.value?.pause(),
				onSeek: (e) => q(e)
			}), Pt = F.value?.textTracks ?? null, Pt?.addEventListener?.("addtrack", At), Pt?.addEventListener?.("removetrack", At), At(), W.value && Ce(), ve(d.media.id);
		}), N(() => d.media, (e) => {
			m.setCurrent(e, {
				resetPosition: !1,
				streamUrl: d.streamUrl
			...
			e && (e.state === "playing" ? (F.value?.play(), m.play()) : e.state === "paused" && (F.value?.pause(), m.pause()), w.updateLocalPosition(m.position), Math.abs(w.driftAmount) > 2 && Qe(e.playbackPosition));
		}), v(() => {
			hn(), tt(), G.cleanup(), typeof document < "u" && document.removeEventListener("fullscreenchange", dn), vn?.(), Pt?.removeEventListener?.("addtrack", At), Pt?.removeEventListener?.("removetrack", At), on !== null && (clearInterval(on), on = null), _e !== null && (clearTimeout(_e), _e = null);
		}), (n, r) => (x(), o("div", {
			...
			s("video", {
				...
				onEnded: rt,
				onError: ot,
				onEnterpictureinpicture: pn,
				onLeavepictureinpicture: mn,
				onClick: Ht
			}, [(x(!0), o(e, null, C(bt.value, (e) => (x(), o("track", {
				key: e.url,
				kind: "subtitles",
				src: e.url,
			...
			}, [u(J, { name: "arrow-left" })], 8, ef), s("div", tf, [
				s("p", nf, E(O(b)("player.nowPlaying")), 1),
				s("h2", rf, E(t.media.name), 1),
				s("div", af, [(x(!0), o(e, null, C(It.value, (t, n) => (x(), o(e, { key: n }, [n > 0 && !t.cert ? (x(), o("span", of, "·")) : a("", !0), s("span", { class: g({ player__cert: t.cert }) }, E(t.text), 3)], 64))), 128))])
			])]),
			xe.value ? a("", !0) : (x(), o("div", sf, [s("button", {
				type: "button",
			...
			xe.value ? a("", !0) : (x(), o("div", {
				...
				O(_).showMarkerTimeline && t.markers && t.markers.length > 0 ? (x(), i(gu, {
					key: 0,
					position: O(m).position,
					duration: O(m).duration,
					markers: t.markers,
				...
				s("div", lf, [
					...
					s("button", {
						...
						"aria-label": O(m).playing ? O(b)("player.pause") : O(b)("player.play"),
						onClick: Ht
					}, [u(J, { name: O(m).playing ? "pause" : "play" }, null, 8, ["name"])], 8, df),
					t.nextEpisode ? (x(), o("button", {
						...
						onClick: Vt
					}, [u(J, { name: "skip-forward" })], 8, ff)) : a("", !0),
					s("span", pf, [
					...
					s("button", {
						...
						onClick: A
					}, [u(J, { name: D.value ? "bookmark" : "bookmark-plus" }, null, 8, ["name"])], 10, mf),
					u(ta, {
						level: k.value,
						onCycle: j
					}, null, 8, ["level"]),
					...
					u(Us, {
						...
						onSelectAudio: Nt,
						onAddSubtitles: r[3] ||= (e) => xt.value = !0
					}, null, 8, [
						"open",
						"tracks",
						"audio-tracks",
					...
					u(cu, {
						open: vt.value,
						"onUpdate:open": r[4] ||= (e) => vt.value = e,
						chapters: t.chapters ?? [],
						onSeek: q
					...
					s("button", {
						...
						onClick: ln
					}, [u(J, { name: "theater" })], 10, yf),
					s("button", {
						type: "button",
						class: "player__iconbtn",
						"aria-label": z.value ? O(b)("player.exitFullscreen") : O(b)("player.fullscreen"),
						onClick: un
					}, [u(J, { name: z.value ? "fullscreen-exit" : "fullscreen" }, null, 8, ["name"])], 8, bf)
				])
			])),
			xe.value ? a("", !0) : (x(), i(Ul, {
				key: 2,
			...
			je.value && !xe.value ? (x(), i(Gc, {
				key: 4,
				seconds: Oe.value,
				onResume: $e,
				onRestart: et
			}, null, 8, ["seconds"])) : a("", !0),
			Pe.value && Xe.value && !xe.value ? (x(), i(jl, {
				key: 5,
				media: Xe.value,
				remaining: Fe.value,
				total: O(8),
			...
			u(Ys, {
				modelValue: ze.value,
				"onUpdate:modelValue": r[8] ||= (e) => ze.value = e,
				title: `Similar ${Le.value ?? "marker"}s`,
				size: "lg",
				onClose: Ye
			}, {
				default: P(() => [s("div", xf, [Ve.value ? (x(), o("div", Sf, [u(ac, { label: "Finding similar media" })])) : He.value ? (x(), o("div", Cf, [u(J, {
					name: "error",
					class: "similar-modal__state-icon"
				}), s("p", wf, E(He.value), 1)])) : !Ve.value && Be.value.length === 0 ? (x(), o("div", Tf, [
					u(J, {
						name: "search",
						class: "similar-modal__state-icon"
					}),
				...
				])) : (x(), o("ul", Ef, [(x(!0), o(e, null, C(Be.value, (e) => (x(), o("li", {
					key: e.id,
					class: "similar-modal__result"
				}, [s("div", Df, [e.poster_url ? (x(), o("img", {
					key: 0,
					src: O(c)(e.poster_url),
					alt: e.name,
					loading: "lazy",
					decoding: "async"
				}, null, 8, Of)) : (x(), o("div", kf, [u(J, { name: "film" })]))]), s("div", Af, [s("p", jf, E(e.name), 1), e.year ? (x(), o("p", Mf, [l(E(e.year) + " ", 1), e.runtime ? (x(), o("span", Nf, " · " + E(e.runtime) + "m", 1)) : a("", !0)])) : a("", !0)])]))), 128))]))])]),
				_: 1
			}, 8, ["modelValue", "title"]),
			K.value ? (x(), i(Hl, {
				key: 6,
			...
			u(kc, {
				open: xt.value,
				"onUpdate:open": r[15] ||= (e) => xt.value = e,
				"media-id": t.media.id,
				"api-base": t.apiBase ?? "",
				"preferred-langs": Ct.value,
				onAdded: wt
			}, null, 8, [
				"open",
				"media-id",
...
}), [["__scopeId", "data-v-9aee8ea6"]]), Ff = ["aria-label"], If = ["src", "poster"], Lf = { class: "mini__body" }, Rf = { class: "mini__title" }, zf = { class: "mini__controls" }, Bf = ["aria-label"], Vf = ["aria-label", "aria-pressed"], Hf = ["aria-label"], Uf = ["aria-label"], Wf = {
	class: "mini__progress",
	"aria-hidden": "true"
}, Gf = /*#__PURE__*/ Y(/* @__PURE__ */ d({
	__name: "MiniPlayer",
	emits: ["expand"],
	setup(e, { emit: t }) {
		let { imgSrc: c } = bl(), l = t, d = ce(), { t: p } = X(), m = S(null), h = S(null), b = f("resumeReporter", null), C = !1, w = Me(), T = f("phlixConfig", null), D = r(() => d.current ? w.isFavorite(d.current.id) : !1);
		function k() {
			let e = d.current?.id;
		...
		return N(() => A.value, async (e) => {
			...
			default: P(() => [A.value ? (x(), o("div", {
				...
				s("div", Lf, [s("p", Rf, E(j.value), 1), s("div", zf, [
					s("button", {
						type: "button",
						class: "mini__btn",
						"aria-label": O(d).playing ? O(p)("player.pause") : O(p)("player.play"),
						onClick: B
					}, [u(J, { name: O(d).playing ? "pause" : "play" }, null, 8, ["name"])], 8, Bf),
					O(d).current ? (x(), o("button", {
						...
						"aria-pressed": D.value ? "true" : "false",
						onClick: k
					}, [u(J, { name: D.value ? "bookmark" : "bookmark-plus" }, null, 8, ["name"])], 10, Vf)) : a("", !0),
					s("button", {
						type: "button",
						class: "mini__btn",
						"aria-label": O(p)("player.expand"),
						onClick: V
					}, [u(J, { name: "expand" })], 8, Hf),
					s("button", {
						type: "button",
