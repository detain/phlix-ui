...
import { t as re } from "./Select-DLwgQInL.js";
...
var he = {
	...
	props: { client: {} },
	setup(e) {
		let se = e, C = ce("apiBase", ""), jt = l(() => typeof C == "string" ? C : C?.value ?? ""), w = new oe(se.client ?? new n({
			baseUrl: jt.value,
			tokenStore: new ee()
		})), T = ie();
		function Mt(e, t) {
		...
		async function Vt() {
			...
			try {
				...
				N.value = i(e, "Failed to load tuners."), T.error(N.value);
			} finally {
				j.value = !1;
			}
		}
		...
		async function Ut(e) {
			if (!Bt[e.tuner_id]) {
				...
				try {
					...
					T.error(i(e, "Failed to update tuner."));
				} finally {
					Bt[e.tuner_id] = !1;
				}
			}
		...
		async function Wt() {
			...
			if (e) try {
				...
				T.error(i(e, "Failed to delete tuner.")), P.value = null;
			}
		}
		...
		async function Xt(e) {
			...
			try {
				...
				R.value = i(e, "Failed to load guide."), T.error(R.value);
			} finally {
				Kt.value = !1;
			}
		}
		...
		async function $t() {
			if (!Jt.value) {
				...
				try {
					...
					T.error(i(e, "Guide refresh failed."));
				} finally {
					Jt.value = !1;
				}
			}
		...
		async function cn() {
			...
			try {
				...
				V.value = i(e, "Failed to load recordings."), T.error(V.value);
			} finally {
				tn.value = !1;
			}
		}
		...
		async function ln() {
			...
			if (e) try {
				...
				T.error(i(e, "Failed to delete recording.")), H.value = null;
			}
		}
		function un(e) {
		...
		async function _n() {
			...
			try {
				...
				T.error(i(e, "Failed to schedule recording."));
			} finally {
				mn.value = !1;
			}
		}
		...
		async function bn() {
			...
			try {
				...
				X.value = i(e, "Failed to load series rules."), T.error(X.value);
			} finally {
				vn.value = !1;
			}
		}
		...
		async function xn() {
			...
			if (e) try {
				...
				T.error(i(e, "Failed to delete rule.")), Z.value = null;
			}
		}
		...
		async function An() {
			...
			try {
				...
				T.error(i(e, "Failed to create rule."));
			} finally {
				En.value = !1;
			}
		}
		return fe(() => D.tuners, (e) => {
			...
			]), p("span", ye, y(Gt.value), 1)], 8, _e), D.tuners ? (g(), f("div", be, [p("div", xe, [h(r, {
				variant: "solid",
				size: "sm",
				"left-icon": "monitor",
				loading: M.value,
			...
			]), p("span", ut, y(Sn.value), 1)], 8, ct), D.seriesRules ? (g(), f("div", dt, [p("div", ft, [h(r, {
				variant: "solid",
				size: "sm",
				"left-icon": "plus",
				onClick: On
...
//# sourceMappingURL=LiveTvPage-ISFW1d9Y.js.map