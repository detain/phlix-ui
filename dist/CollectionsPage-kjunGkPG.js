import { a as e, i as t, n, r, t as ee, u as i } from "./tokenStore-DfQvvLGI.js";
...
}, E = /*#__PURE__*/ i(/* @__PURE__ */ h({
	__name: "CollectionsPage",
	props: { client: {} },
	setup(i) {
		let h = i, E = re("apiBase", ""), D = l(() => typeof E == "string" ? E : E?.value ?? ""), O = new s(h.client ?? new e({
			baseUrl: D.value,
			tokenStore: new ee()
		})), k = t();
		function A(e, t) {
...
//# sourceMappingURL=CollectionsPage-kjunGkPG.js.map