...
import { t as d } from "./MetadataMatchModal-vCPqVr65.js";
import { t as ee } from "./EmptyState-B2QnGIQT.js";
import { n as te } from "./media-query-C8oxSF4h.js";
import { t as f } from "./MediaDetail-D3QnGZWi.js";
import { i as p } from "./series-grouping-Bbs1zX87.js";
import { t as ne } from "./useSeriesSeasons-ezSOXOgO.js";
import { t as re } from "./useResolvePlayable-CDFCMfKq.js";
...
var A = { class: "series-detail" }, j = {
	...
	setup(e, { emit: n }) {
		...
		return (n, r) => {
			...
			return C(), v("div", A, [x(f, {
				...
				"resume-seconds",
				"can-match"
			]), y("section", j, [r[10] ||= y("h2", { class: "series-detail__seasons-title" }, "Seasons", -1), e.loading ? (C(), v("div", M)) : c.value ? (C(), v("ul", N, [(C(!0), v(m, null, T(e.seasons, (e) => (C(), v("li", {
				key: e.key,
...
}), [["__scopeId", "data-v-a36e15f5"]]), de = { class: "media-detail-page" }, fe = {
	key: 0,
	...
	setup(e) {
		let t = r(), p = ie("phlixConfig", void 0), S = h(() => p?.routerBase || "/app"), T = ce(), E = le(), D = o(), A = s(), j = i(), M = a(), N = w(null), P = w([]), F = w([]), I = w(!0), L = w(!1), R = w(!1), z = w(null), B = h(() => String(T.params.id ?? "")), V = h(() => D.resumePositionFor(B.value)), he = h(() => N.value?.type === "series");
		c(() => N.value?.name);
		let H = null, U = !1;
		function W(e) {
		...
		async function G(e, n) {
			...
			R.value = !0, F.value = [];
			try {
				let a = await ne(e, t.value, n.id, r?.signal);
				if (i()) return;
				F.value = a;
			} catch (e) {
				if (i() || W(e)) return;
...
}), [["__scopeId", "data-v-7702f9a9"]]);
//#endregion
export { V as default };

//# sourceMappingURL=MediaDetailPage-BUTlCAJt.js.map