import { d as e, t, u as n } from "./Button-C4PyCjLX.js";
import { a as r } from "./usePreferencesStore-BFFMWKZp.js";
import { t as i } from "./Slider-f9S4ziJW.js";
import { t as a } from "./Switch-R1pbcsd-.js";
import { t as o } from "./Select-CmN-4YbZ.js";
import { t as s } from "./useToastStore-BDoKlU6N.js";
import { n as c, t as l } from "./SettingsForm-SYvhnJww.js";
import { i as u, n as ee, r as te, t as ne } from "./captions-COgPp5bH.js";
...
var ae = {
	...
	key: 1,
	class: "aps"
}, R = { class: "aps__group" }, z = { class: "aps__row aps__row--switch" }, B = { class: "aps__row" }, V = { class: "aps__label" }, H = { class: "aps__value" }, fe = { class: "aps__slider" }, pe = { class: "aps__row" }, me = { class: "aps__group" }, he = { class: "aps__row" }, ge = { class: "aps__row" }, _e = { class: "aps__row" }, ve = { class: "aps__row" }, ye = { class: "aps__row" }, U = /*#__PURE__*/ e(/* @__PURE__ */ y({
	...
	setup(e) {
		...
		function Ee() {
			...
			clearTimeout($), Q.value = !1, c.reset(), l.info("Preferences reset to defaults.");
		}
		return ie(() => clearTimeout($)), (r, s) => e.panel === "appearance" ? (x(), h("div", ae, [
			g("section", oe, [s[13] ||= g("h3", { class: "aps__title" }, "Theme", -1), g("div", {
				class: "aps__themes",
				role: "radiogroup",
				"aria-label": "Theme",
				onKeydown: we
			}, [(x(), h(d, null, C(y, (e, t) => g("button", {
				key: e.value,
				type: "button",
				role: "radio",
				class: b(["aps__theme", { "is-active": T(c).theme === e.value }]),
				"aria-checked": T(c).theme === e.value,
				tabindex: Y.value === t ? 0 : -1,
				"data-theme": e.value,
				onClick: (t) => T(c).theme = e.value
			}, [s[12] ||= g("span", { class: "aps__preview" }, [g("span", { class: "aps__preview-bar" }), g("span", { class: "aps__preview-card" })], -1), g("span", ce, [_(w(e.label) + " ", 1), T(c).theme === e.value ? (x(), p(n, {
				key: 0,
				name: "check",
			...
			g("div", B, [g("span", V, [s[21] ||= _("Default volume ", -1), g("span", H, w(K(T(c).defaultVolume)), 1)]), g("div", fe, [v(i, {
			...
			g("div", pe, [s[22] ||= g("span", { class: "aps__label" }, "Default quality", -1), v(o, {
...
}), [["__scopeId", "data-v-2a591f61"]]), W = { class: "settings-page" }, G = /*#__PURE__*/ e(/* @__PURE__ */ y({
	__name: "SettingsPage",
	setup(e) {
		let t = [
			{
...
//# sourceMappingURL=SettingsPage-DbTAhPQp.js.map