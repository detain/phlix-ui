import { a as e, c as t, i as n, l as r, n as i, r as a, t as o } from "./tokenStore-SjxKwmod.js";
import { t as s } from "./Modal-D0ntqq7y.js";
...
var ie = {
	...
	role: "note"
}, I = /*#__PURE__*/ r(/* @__PURE__ */ g({
	__name: "HistoryPage",
	props: { client: {} },
	emits: ["continue"],
	setup(r, { emit: g }) {
		let I = r, L = g, R = _("apiBase", ""), z = l(() => typeof R == "string" ? R : R?.value ?? ""), B = new ne(I.client ?? new e({
			baseUrl: z.value,
			tokenStore: new o()
		})), V = n();
		function H(e, t) {
		...
		return y(q), (e, n) => (b(), f("section", ie, [
			p("header", w, [n[5] ||= p("h1", {
				id: "history-heading",
				class: "admin-history__title"
			}, "Watch History", -1), $.value ? (b(), u(i, {
				key: 0,
				variant: "outline",
				size: "sm",
				"left-icon": "x",
				onClick: n[0] ||= (e) => G.value = !0
			}, {
				default: C(() => [...n[4] ||= [m(" Clear All ", -1)]]),
				_: 1
			})) : d("", !0)]),
			W.value ? (b(), f("div", T, [h(a, {
				variant: "text",
				lines: 6
				...
				}, null, 8, O)) : (b(), f("span", ae, [h(t, { name: "film" })]))]),
				p("div", oe, [
				...
				p("div", P, [Z(e) ? (b(), u(i, {
					...
					default: C(() => [...n[6] ||= [m(" Continue ", -1)]]),
					_: 1
				}, 8, ["aria-label", "onClick"])) : d("", !0), h(i, {
					variant: "ghost",
					size: "sm",
					"left-icon": "x",
			...
			h(s, {
				...
				size: "sm",
				onClose: n[3] ||= (e) => G.value = !1
			}, {
				footer: C(() => [h(i, {
					variant: "ghost",
					size: "sm",
					disabled: K.value,
					onClick: n[1] ||= (e) => G.value = !1
				}, {
					default: C(() => [...n[8] ||= [m(" Cancel ", -1)]]),
					_: 1
				}, 8, ["disabled"]), h(i, {
					variant: "solid",
					size: "sm",
					...
					default: C(() => [...n[9] ||= [m(" Clear All ", -1)]]),
					_: 1
				}, 8, ["loading"])]),
				default: C(() => [n[10] ||= p("p", null, "Clear all items from your watch history? This cannot be undone.", -1)]),
				_: 1
			}, 8, ["modelValue"])
		]));
	}
...
//# sourceMappingURL=HistoryPage-PwKWCsCA.js.map