import { n as e } from "./Button-GJ9vHE0J.js";
...
var o = a("auth", () => {
	...
	async function m(e, t) {
		...
		try {
			let n = await o.post("/api/v1/auth/login", {
				email: e,
				password: t
			});
			return p(n.access_token, n.refresh_token), await g(), !0;
		} catch (e) {
...
//# sourceMappingURL=useAuthStore-qz0h59p0.js.map