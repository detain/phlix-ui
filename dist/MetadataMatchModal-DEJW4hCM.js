...
import { a as r, c as i, d as a, t as o } from "./Button-5ZSsUmsI.js";
import { t as s } from "./useAuthStore-DWVaTITC.js";
	...
	setup(e, { emit: n }) {
		...
		async function G() {
			...
			try {
				...
				if (t() || V(e)) return;
				C.value = [], r(e) ? F.value = !0 : P.value = a(e, "Search failed. Please try again.");
			} finally {
				t() || (D.value = !1);
			}
		}
		...
		async function q(e) {
			if (!(!c.item || L.value)) {
				...
				try {
					...
					r(e) ? F.value = !0 : e instanceof i && e.status === 422 ? R.value = "No match details were found for that result. Try another." : R.value = a(e, "Could not apply that match. Please try again.");
				} finally {
					L.value = null;
				}
			}
...
//# sourceMappingURL=MetadataMatchModal-DEJW4hCM.js.map