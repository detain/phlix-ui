...
import { t as o } from "./Modal-BJKZOPpV.js";
...
var O = {
	...
	props: { client: {} },
	setup(e) {
		let _ = e, P = v("apiBase", ""), oe = u(() => typeof P == "string" ? P : P?.value ?? ""), F = new l(_.client ?? new n({
			baseUrl: oe.value,
			tokenStore: new t()
...
//# sourceMappingURL=SyncPlayPage-CVbEy_L4.js.map