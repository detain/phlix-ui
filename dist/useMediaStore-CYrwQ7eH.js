...
import { p as r, t as i, u as a } from "./client-BoVYipAG.js";
...
var W = N("media", () => {
	...
	function X(e, t, n, r) {
		r && (G && n !== W && G.abort(), W = n);
		let a = L.get(n);
		if (a) return r && (G = a.controller), a.promise;
		let o = new AbortController();
		r && (G = o), l ? l.setBaseUrl(e) : l = new i({ baseUrl: e });
	...
	async function pe(e) {
		...
		l ? l.setBaseUrl(e) : l = new i({ baseUrl: e });
		try {
			let e = {};
			...
			e instanceof a && e.status === 404 && (c.value = null);
		}
	}
	function me() {
		let e = {};
...
//# sourceMappingURL=useMediaStore-CYrwQ7eH.js.map