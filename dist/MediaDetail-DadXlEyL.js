...
import { t as n } from "./Button-9cUUJmnN.js";
import { t as r } from "./Chip-2HcSZF4a.js";
import { t as i } from "./MediaRow-9b6UqMkE.js";
	...
	setup(e, { emit: p }) {
		...
		return g(() => {
			...
			u("div", w, [u("div", T, [e.item.poster_url ? (_(), l("img", {
				...
				u("div", L, [
					...
					q.value ? (_(), s(n, {
						...
						default: x(() => [p[10] ||= d(" Resume ", -1), u("span", R, b(q.value), 1)]),
						_: 1
					})) : c("", !0),
					f(n, {
						variant: "ghost",
					...
					e.canMatch ? (_(), s(n, {
						...
						variant: "ghost",
						"left-icon": "search",
						onClick: p[4] ||= (t) => W("match", e.item)
					}, {
						default: x(() => [...p[12] ||= [d("Match metadata", -1)]]),
						_: 1
					})) : c("", !0)
				]),
				e.item.director || K.value.length ? (_(), l("dl", z, [e.item.director ? (_(), l("div", B, [p[13] ||= u("dt", null, "Director", -1), u("dd", null, b(e.item.director), 1)])) : c("", !0), K.value.length ? (_(), l("div", V, [p[14] ||= u("dt", null, "Cast", -1), u("dd", H, [(_(!0), l(a, null, y(K.value, (e) => (_(), s(r, {
					key: e,
					size: "sm",
					icon: "user"
				}, {
			...
			e.similarLoading || e.similar.length ? (_(), s(i, {
				...
				"hide-when-empty": "",
				onPlay: p[5] ||= (e) => W("play", e),
				onWatchlist: p[6] ||= (e) => W("watchlist", e),
				onInfo: p[7] ||= (e) => W("info", e)
			}, null, 8, ["items", "loading"])) : c("", !0)
		]));
	}
}), [["__scopeId", "data-v-975465b4"]]);
//#endregion
export { U as t };

//# sourceMappingURL=MediaDetail-DadXlEyL.js.map