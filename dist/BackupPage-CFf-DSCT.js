...
import { t as o } from "./Modal-ovdBg3Sx.js";
...
var oe = { class: "admin-backup" }, se = {
	...
	props: { client: {} },
	setup(e) {
		let _ = e, T = re("apiBase", ""), ke = ne(() => typeof T == "string" ? T : T?.value ?? ""), E = new l(_.client ?? new r({
			baseUrl: ke.value,
			tokenStore: new t()
		})), D = i();
		function Ae(e) {
		...
		async function N() {
			...
			try {
				...
				j.value = n(e, "Failed to load backups."), D.error(j.value);
			} finally {
				A.value = !1;
			}
		}
		...
		async function z() {
			...
			try {
				...
				D.error(n(e, "Failed to create backup."));
			} finally {
				I.value = !1;
			}
		}
		...
		async function Ne() {
			...
			if (e) {
				...
				try {
					...
					D.error(n(e, "Failed to delete backup.")), G();
				}
			}
		}
		async function Pe(e) {
		...
		async function Q() {
			...
			try {
				...
				J.value = n(e, "Failed to load schedule."), D.error(J.value);
			} finally {
				q.value = !1;
			}
		}
		async function $() {
			...
			try {
				...
				D.error(n(e, "Failed to save schedule."));
			} finally {
				Z.value = !1;
			}
		}
		return ie(() => {
			...
			m("section", se, [
				...
				A.value ? (v(), p("div", le, [g(s, {
					...
					actions: S(() => [g(a, {
						...
						default: S(() => [...t[8] ||= [h("Create backup", -1)]]),
						_: 1
					})]),
					_: 1
				})) : (v(), p("table", ue, [t[12] ||= m("thead", null, [m("tr", null, [
					...
					m("td", me, [m("span", { title: e.created_at }, b(O(e.created_at)), 9, he)]),
					...
					m("td", null, [m("div", ge, [
						...
						e.is_s3 ? f("", !0) : (v(), d(a, {
							...
							default: S(() => [...t[10] ||= [h(" Upload to S3 ", -1)]]),
							_: 1
						}, 8, [
							"loading",
							"aria-label",
						...
						g(a, {
							...
							default: S(() => [...t[11] ||= [h(" Delete ", -1)]]),
							_: 1
						}, 8, ["aria-label", "onClick"])
					])])
				]))), 128))])]))
			]),
			m("section", _e, [t[18] ||= m("header", { class: "admin-backup__head" }, [m("h2", {
				id: "schedule-heading",
				...
				_: 1
			}, 8, ["description"])) : K.value ? (v(), p("div", ye, [m("p", be, [t[14] ||= m("span", { class: "admin-backup__next-label" }, "Next scheduled backup:", -1), K.value.next_scheduled_backup === null ? (v(), p("span", Ce, "Not scheduled")) : (v(), p(u, { key: 0 }, [m("span", { title: K.value.next_scheduled_backup_iso ?? "" }, b(je(K.value.next_scheduled_backup)), 9, xe), K.value.next_scheduled_backup_iso ? (v(), p("span", Se, " (" + b(K.value.next_scheduled_backup_iso) + ") ", 1)) : f("", !0)], 64))]), m("form", {
				class: "admin-backup__form",
				onSubmit: w($, ["prevent"])
			}, [m("div", we, [m("label", Te, [t[15] ||= m("span", { class: "admin-backup__label" }, "Backup interval (days)", -1), C(m("input", {
				"onUpdate:modelValue": t[0] ||= (e) => Y.value = e,
				type: "number",
				min: "0",
				class: "admin-backup__input",
				required: ""
			}, null, 512), [[x, Y.value]])]), m("label", Ee, [t[16] ||= m("span", { class: "admin-backup__label" }, "Retention count", -1), C(m("input", {
				"onUpdate:modelValue": t[1] ||= (e) => X.value = e,
				type: "number",
				min: "1",
				class: "admin-backup__input",
				required: ""
			}, null, 512), [[x, X.value]])])]), m("div", De, [g(a, {
				variant: "solid",
				size: "sm",
				loading: Z.value,
				onClick: $
			}, {
				default: S(() => [...t[17] ||= [h(" Save schedule ", -1)]]),
				_: 1
			}, 8, ["loading"])])], 32)])) : f("", !0)]),
			g(o, {
				modelValue: P.value,
				...
				footer: S(() => [g(a, {
					...
					default: S(() => [...t[21] ||= [h("Create", -1)]]),
					_: 1
				}, 8, ["loading"])]),
				default: S(() => [m("form", {
					class: "admin-backup__form",
					onSubmit: w(z, ["prevent"])
				}, [m("label", Oe, [t[19] ||= m("span", { class: "admin-backup__label" }, "Label (optional)", -1), C(m("input", {
			...
			g(o, {
				...
				footer: S(() => [g(a, {
					...
					default: S(() => [...t[23] ||= [h(" Restore ", -1)]]),
					_: 1
				}, 8, ["loading"])]),
				default: S(() => [t[24] ||= m("p", null, [h("This will overwrite your current data. "), m("strong", null, "Continue?")], -1)]),
				_: 1
			}, 8, ["model-value"]),
			g(o, {
...
//# sourceMappingURL=BackupPage-CFf-DSCT.js.map