...
import { t as a } from "./EmptyState-sJb64K4c.js";
	...
	setup(n) {
		...
		return se(I, (e) => {
			...
			f("section", de, [f("header", fe, [t[2] ||= f("h2", {
				...
				_: 1
			}, 8, ["label"])) : u("", !0)]), H.value ? (g(), d("div", pe, [m(i, {
				variant: "text",
				lines: 4
			...
			f("section", xe, [t[4] ||= f("header", { class: "admin-dash__card-head" }, [f("h2", {
				id: "tu-heading",
				class: "admin-dash__card-title"
			}, "Top Users")], -1), U.value ? (g(), d("div", Se, [m(i, {
				variant: "text",
				lines: 4
			...
			f("section", Te, [t[5] ||= f("header", { class: "admin-dash__card-head" }, [f("h2", {
				id: "tm-heading",
				class: "admin-dash__card-title"
			}, "Top Media")], -1), W.value ? (g(), d("div", Ee, [m(i, {
				variant: "text",
				lines: 4
			...
			f("section", E, [t[6] ||= f("header", { class: "admin-dash__card-head" }, [f("h2", {
				id: "st-heading",
				class: "admin-dash__card-title"
			}, "Storage")], -1), G.value ? (g(), d("div", D, [m(i, {
				variant: "text",
				lines: 3
			...
			f("section", je, [t[8] ||= f("header", { class: "admin-dash__card-head" }, [f("h2", {
				id: "act-heading",
				class: "admin-dash__card-title"
			}, "Recent Activity")], -1), K.value ? (g(), d("div", Me, [m(i, {
				variant: "text",
				lines: 5
...
//# sourceMappingURL=DashboardPage-C0fVGeGd.js.map