...
import { r, t as i } from "./MediaRow-BAqF6Sqv.js";
	...
	setup(e, { emit: p }) {
		...
		return g(() => {
			...
			u("div", w, [u("div", T, [e.item.poster_url ? (_(), l("img", {
				...
				decoding: "async",
				onLoad: X
			}, null, 42, E)) : (_(), l("div", D, [f(n, { name: G.value }, null, 8, ["name"])]))]), u("div", O, [
				u("h1", k, b(e.item.name), 1),
				u("div", A, [
					e.item.year ? (_(), l("span", j, [f(n, {
						name: "calendar",
...
//# sourceMappingURL=MediaDetail-BYiRtjC7.js.map