...
import { t } from "./client-Dywsiudr.js";
import { n } from "./useApiBase-CV_r-Kk4.js";
import { t as ee } from "./useAuthStore-BDivyavD.js";
import { i as te } from "./usePlayerStore-iTjrRIZa.js";
import { t as r } from "./useLibrariesStore-DWgvv56W.js";
import { t as i } from "./Button-k7aQagzg.js";
import { t as a } from "./useToastStore-BDoKlU6N.js";
import { a as o, i as s, t as ne } from "./MetadataMatchModal-CIp61Nci.js";
import { t as c } from "./EmptyState-B2QnGIQT.js";
import { t as l } from "./MediaRow-BGNk2enu.js";
import { t as u } from "./HomeRow-B7yeNT7a.js";
...
var se = { class: "browse-page" }, ce = { class: "browse-toolbar" }, le = {
	...
	__name: "BrowsePage",
	setup(e) {
		let _ = n(), D = ae("phlixConfig", null), O = f(() => D?.homeRows ?? []), k = r(), de = te(), A = a(), j = ee(), M = s(), N = oe(), P = x(null), F = x(!1), I = x(null);
		function L(e) {
			P.value = e, F.value = !0;
		}
		function R(e) {
		...
		return (e, t) => (y(), h("div", se, [
			...
			ge.value ? (y(), h("div", le, [g(o, { label: "Loading libraries" })])) : m("", !0),
			w(k).error ? (y(), p(c, {
				key: 3,
				icon: "alert",
...
//# sourceMappingURL=BrowsePage-Dp1sdLzd.js.map