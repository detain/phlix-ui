...
import { i as re, r as l, t as ie } from "./plugins-AypKHiis.js";
...
var pe = {
	...
	props: { client: {} },
	setup(e) {
		let ae = e, C = oe("apiBase", ""), He = d(() => typeof C == "string" ? C : C?.value ?? ""), w = new ie(ae.client ?? new n({
			baseUrl: He.value,
			tokenStore: new ee()
...
//# sourceMappingURL=PluginsPage-xztlu8Yf.js.map