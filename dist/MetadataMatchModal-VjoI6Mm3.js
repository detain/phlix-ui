...
import { t as ee } from "./Modal-BnAzb9-y.js";
import { a as r, f as i, l as te } from "./client-C0AMSEun.js";
import { t as ne } from "./useAuthStore-DWTuTW8p.js";
import { t as re } from "./Spinner-DxxkAO-G.js";
	...
	setup(e, { emit: t }) {
		...
		async function Te(e) {
			if (!(!f.item || U.value)) {
				...
				try {
					P("applied", (await F.client.matchApply(f.item.id, {
						tmdb_id: e.tmdb_id,
						type: e.type
					})).item), q.value = !1;
				} catch (e) {
...
//# sourceMappingURL=MetadataMatchModal-VjoI6Mm3.js.map