...
import { t as a } from "./Modal-CBoJ1z1N.js";
...
var pe = {
...
}, C = { class: "admin-webhooks__secret-row" }, Te = ["type", "placeholder"], w = { class: "admin-webhooks__events" }, T = { class: "admin-webhooks__events-category-label" }, E = ["checked", "onChange"], D = { class: "admin-webhooks__checkbox-label" }, O = { class: "admin-webhooks__event-id" }, Ee = {
	key: 0,
	...
	setup(e) {
		...
		return le(F), (e, n) => (g(), d("section", pe, [
			f("header", me, [n[9] ||= f("h1", {
				id: "webhooks-heading",
			...
			N.value ? (g(), d("div", he, [m(re, {
				...
				actions: x(() => [m(i, {
					...
					default: x(() => [...n[12] ||= [p("Add webhook", -1)]]),
					_: 1
				})]),
				_: 1
			})) : (g(), d("table", ge, [n[16] ||= f("thead", null, [f("tr", null, [
				f("th", { scope: "col" }, "Name"),
				f("th", { scope: "col" }, "URL"),
			...
			m(a, {
				...
				default: x(() => [f("form", {
					...
					f("label", ye, [n[17] ||= f("span", { class: "admin-webhooks__label" }, "Name", -1), S(f("input", {
					...
					f("label", be, [n[18] ||= f("span", { class: "admin-webhooks__label" }, "URL", -1), S(f("input", {
					...
					f("div", xe, [
						f("span", Se, [n[19] ||= p(" Secret", -1), L.value ? u("", !0) : (g(), d("span", Ce, " *"))]),
					...
					f("fieldset", w, [n[20] ||= f("legend", { class: "admin-webhooks__label" }, [p("Events"), f("span", { "aria-hidden": "true" }, " *")], -1), (g(!0), d(s, null, v(ue(ae), (e) => (g(), d("div", {
						key: e.label,
						class: "admin-webhooks__events-category"
					}, [f("span", T, y(e.label), 1), (g(!0), d(s, null, v(e.events, (e) => (g(), d("label", {
						key: e.id,
						...
						f("span", D, y(e.label), 1),
						f("span", O, y(e.id), 1)
					]))), 128))]))), 128))]),
					W.value ? (g(), d("p", Ee, y(W.value), 1)) : u("", !0)
				], 32)]),
				_: 1
			}, 8, ["modelValue", "title"]),
			m(a, {
				...
				footer: x(() => [m(i, {
					...
					default: x(() => [...n[25] ||= [p("Delete", -1)]]),
					_: 1
				})]),
				default: x(() => [f("p", null, [
					n[22] ||= p(" Delete webhook ", -1),
					f("strong", null, y(J.value?.name), 1),
					n[23] ||= p("? This cannot be undone. ", -1)
				])]),
				_: 1
			}, 8, ["model-value"]),
			m(a, {
...
}), [["__scopeId", "data-v-8c688d96"]]);
//#endregion
export { k as default };

//# sourceMappingURL=WebhooksPage-XJ6bEId1.js.map