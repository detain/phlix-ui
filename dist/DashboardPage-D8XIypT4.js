...
import { t as te } from "./Select-CjbYOZGH.js";
...
var ce = {
	...
	role: "list"
}, He = { class: "admin-dash__activity-user" }, Ue = ["title"], We = ["datetime", "title"], S = 20, Ge = 3e4, C = /*#__PURE__*/ n(/* @__PURE__ */ g({
	__name: "DashboardPage",
	props: { client: {} },
	setup(n) {
		let g = n, C = re("apiBase", ""), Ke = l(() => typeof C == "string" ? C : C?.value ?? ""), w = new ne(g.client ?? new ee({
			baseUrl: Ke.value,
			tokenStore: new e()
		})), T = r();
		function E(e) {
		...
		return se(k, (e) => {
			...
			p("section", de, [p("header", fe, [t[5] ||= p("h2", {
			...
			}, "Now Playing", -1), A.value.length > 0 ? (_(), u(s, {
				key: 0,
				tone: "accent",
				...
				_: 1
			}, 8, ["label"])) : d("", !0)]), F.value ? (_(), f("div", pe, [h(i, {
				variant: "text",
				lines: 4
			})])) : H.value ? (_(), u(a, {
				key: 1,
			...
			p("section", xe, [t[9] ||= p("header", { class: "admin-dash__card-head" }, [p("h2", {
				id: "tu-heading",
				class: "admin-dash__card-title"
			}, "Top Users")], -1), I.value ? (_(), f("div", Se, [h(i, {
				variant: "text",
				lines: 4
			})])) : U.value ? (_(), u(a, {
				key: 1,
				...
				_: 1
			}, 8, ["description"])) : j.value.length === 0 ? (_(), u(a, {
				key: 2,
				icon: "user",
			...
			p("section", Te, [t[11] ||= p("header", { class: "admin-dash__card-head" }, [p("h2", {
				id: "tm-heading",
				class: "admin-dash__card-title"
			}, "Top Media")], -1), L.value ? (_(), f("div", Ee, [h(i, {
				variant: "text",
				lines: 4
			})])) : W.value ? (_(), u(a, {
				key: 1,
				...
				_: 1
			}, 8, ["description"])) : M.value.length === 0 ? (_(), u(a, {
				key: 2,
				icon: "film",
				...
				p("div", ke, [p("span", {
					...
					title: e.media_title
				}, b(e.media_title), 9, Ae), h(s, { tone: O(e.media_type) }, {
					default: x(() => [m(b(e.media_type), 1)]),
					_: 2
				}, 1032, ["tone"])]),
			...
			p("section", Me, [t[13] ||= p("header", { class: "admin-dash__card-head" }, [p("h2", {
				id: "st-heading",
				class: "admin-dash__card-title"
			}, "Storage")], -1), R.value ? (_(), f("div", Ne, [h(i, {
				variant: "text",
				lines: 3
			})])) : G.value ? (_(), u(a, {
				key: 1,
				...
				_: 1
			}, 8, ["description"])) : N.value.length === 0 ? (_(), u(a, {
				key: 2,
				icon: "image",
			...
			p("section", Re, [t[16] ||= p("header", { class: "admin-dash__card-head" }, [p("h2", {
				id: "act-heading",
				class: "admin-dash__card-title"
			}, "Recent Activity")], -1), z.value ? (_(), f("div", ze, [h(i, {
				variant: "text",
				lines: 5
			})])) : K.value ? (_(), u(a, {
				key: 1,
				...
				_: 1
			}, 8, ["description"])) : P.value.length === 0 ? (_(), u(a, {
				key: 2,
				icon: "list",
...
//# sourceMappingURL=DashboardPage-D8XIypT4.js.map