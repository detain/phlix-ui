...
var ge = {
	...
	props: { client: {} },
	setup(e) {
		let se = e, b = ce("apiBase", ""), Nt = l(() => typeof b == "string" ? b : b?.value ?? ""), x = new ae(se.client ?? new ee({
			baseUrl: Nt.value,
			tokenStore: new n()
		})), Pt = new ne(se.client ?? new ee({
			baseUrl: Nt.value,
			tokenStore: new n()
		})), S = te();
		function C(e) {
...
//# sourceMappingURL=RemoteAccessPage-D646_QDB.js.map