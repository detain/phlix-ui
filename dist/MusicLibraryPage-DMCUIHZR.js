...
import { t as n } from "./useMessages-CWq429TV.js";
import { t as r } from "./client-BoVYipAG.js";
import { n as i, r as a } from "./useApiBase-CV_r-Kk4.js";
import { t as o } from "./useImageSrc-KnN1T9Ga.js";
import { i as s, n as c, r as ee, t as te } from "./MusicAlbumCard-Cg6B_9pv.js";
...
var S = { class: "artist-card__image-wrap" }, C = ["src", "alt"], w = {
	...
	setup(e) {
		let r = e, { t: i } = n(), { imgSrc: a } = o(), s = u(() => {
			...
			return i("music.albumsTotal", { count: e.toLocaleString() });
		});
...
}), [["__scopeId", "data-v-79ad5ff9"]]), ae = { class: "music-page" }, oe = { class: "music-page__head" }, se = { class: "music-page__breadcrumb" }, ce = ["aria-label"], le = {
	key: 1,
	...
	role: "status",
	"aria-live": "polite"
}, Ce = { class: "music-bar__controls" }, we = ["disabled", "aria-label"], Te = ["aria-label"], Ee = ["disabled", "aria-label"], De = { class: "music-bar__progress" }, F = { class: "music-bar__time" }, Oe = [
	"max",
	"value",
	"aria-label"
	...
	setup(e) {
		...
		let X = u(() => o.value === "artists" ? W("music.artists") : o.value === "albums" && g.value ? g.value.name : o.value === "tracks" && S.value ? S.value.title : W("music.title")), Me = u(() => W("music.artistsTotal", { count: R.value.toLocaleString() })), Ne = u(() => W("music.albumsTotal", { count: V.value.toLocaleString() }));
		function Z(e) {
		...
		return (e, n) => (_(), p("div", ae, [
			...
			x(K).currentTrack.value ? (_(), p("footer", {
				...
				m("div", De, [
					m("span", F, b(Q(x(K).position.value)), 1),
					m("input", {
						type: "range",
...
}), [["__scopeId", "data-v-051a034d"]]);
//#endregion
export { I as default };

//# sourceMappingURL=MusicLibraryPage-DMCUIHZR.js.map