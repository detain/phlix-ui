...
var le = {
	...
	props: { client: {} },
	setup(e) {
		let _ = e, T = ae("apiBase", ""), we = u(() => typeof T == "string" ? T : T?.value ?? ""), E = new ie(_.client ?? new i({
			baseUrl: we.value,
			tokenStore: new t()
		})), D = te(), O = [
			{
...
//# sourceMappingURL=SettingsPage-T7S0S9k1.js.map