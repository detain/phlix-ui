...
import { l as n, p as r, t as ee, u as te } from "./client-COHWZ2KC.js";
...
import { t as ie } from "./Select-D5GWWuWl.js";
import { t as o } from "./Modal-BUR3rht6.js";
import { t as ae } from "./Skeleton-DhQmxeNg.js";
import { t as oe } from "./EmptyState-DERkIIRd.js";
import { t as se } from "./PageHint-DVe81aMu.js";
import { t as ce } from "./HelpText-CMd9gM8h.js";
import { i as le, r as ue, t as de } from "./plugins-Cl9v5JFf.js";
...
var Ce = {
	...
	props: { client: {} },
	setup(e) {
		let pe = e, pt = me("apiBase", ""), mt = c(() => typeof pt == "string" ? pt : pt?.value ?? ""), b = new de(pe.client ?? new ee({
			baseUrl: mt.value,
			tokenStore: new n()
		...
		async function St(e) {
			...
			try {
				...
				E.value = n, x.error(r(e, "Failed to change the catalog channel."));
			} finally {
				yt.value = !1;
			}
		}
		...
		let N = g(!1), P = g(""), Ft = g(!1), It = g(null);
		function Lt() {
			P.value = "", N.value = !0;
		}
		function Rt() {
		...
		async function zt() {
			...
			Ft.value = !0;
			try {
				await b.addCatalogSource(e), x.success("Catalog added."), Rt(), await w();
			} catch (e) {
				let t = ue(e);
		...
		let F = g({}), Vt = g(!1), Ht = g(!1), I = g(null), L = g(!1), Ut = c(() => Object.values(F.value).filter((e) => e.update_available).length);
		function R(e) {
			let t = F.value[e];
		...
		async function En() {
			...
			if (!(!e || X.value)) {
				...
				try {
					...
					ue(e) === "plugin.test_not_supported" || e instanceof te && e.status === 501 ? Y.value = {
						tone: "unsupported",
		...
		return ge(() => {
			...
			f("div", Ee, [n[14] ||= f("span", { class: "admin-plugins__sources-label" }, "Catalogs", -1), (h(!0), d(s, null, _(C.value.sources, (e) => (h(), l(a, {
				key: e,
				tone: "neutral"
			}, {
				default: y(() => [f("a", {
			...
			D.value.length > 0 ? (h(), d("div", ke, [f("div", Ae, [
				...
				O.value?.advanced ? (h(), l(a, {
					key: 0,
					tone: "warning"
				}, {
					default: y(() => [...n[15] ||= [p("Opt-in · advanced", -1)]]),
					_: 1
				})) : u("", !0)
			...
			M.value ? (h(), d("div", je, [
				...
				f("div", Me, [n[17] ||= f("strong", null, "Couldn't install the plugin.", -1), f("span", null, v(M.value), 1)]),
				f("button", {
					type: "button",
			...
			vt.value ? (h(), d("div", Fe, [m(ae, {
				...
				actions: y(() => [m(i, {
					...
					default: y(() => [...n[19] ||= [p("Install from URL", -1)]]),
					_: 1
				})]),
				_: 1
			...
			Tt.value.length ? (h(), d("section", We, [
				...
				f("table", Ge, [n[30] ||= f("thead", null, [f("tr", null, [
					...
					f("td", Ke, [p(v(e.version) + " ", 1), R(e.name) ? (h(), l(a, {
						key: 0,
						tone: "warning",
						class: "admin-plugins__update-badge"
					}, {
			...
			m(o, {
				...
				footer: y(() => [m(i, {
					...
					default: y(() => [...n[41] ||= [p("Add", -1)]]),
					_: 1
				}, 8, ["loading"])]),
				default: y(() => [f("form", {
					class: "admin-plugins__form",
					onSubmit: Se(zt, ["prevent"])
				}, [f("label", Ye, [
			...
			m(o, {
				...
				footer: y(() => [
					...
					sn.value ? (h(), l(i, {
						...
						default: y(() => [...n[59] ||= [p(" Test credentials ", -1)]]),
						_: 1
					}, 8, [
						"loading",
						"disabled",
				...
				default: y(() => [en.value ? (h(), d("div", Xe, [m(ae, {
					...
					f("div", et, [f("code", tt, v(cn.value), 1), m(i, {
						variant: "outline",
						size: "sm",
						"aria-label": `Copy the redirect URL for ${H.value?.name}`,
						onClick: ln
					}, {
						default: y(() => [...n[46] ||= [p(" Copy ", -1)]]),
						_: 1
					}, 8, ["aria-label"])]),
					...
					(h(!0), d(s, null, _(on.value, ([e, t]) => (h(), d("div", {
						...
						t.type === "bool" || t.type === "boolean" ? (h(), l(re, {
							...
							f("div", st, [xe(f("input", {
							...
							}, null, 10, ct), [[ve, W.value[e]]]), t.secret && Q(e) ? (h(), l(i, {
								key: 0,
								variant: "ghost",
								size: "sm",
								...
								default: y(() => [...n[48] ||= [p(" Undo ", -1)]]),
								_: 1
							}, 8, ["aria-label", "onClick"])) : gn(e, t) ? (h(), l(i, {
								key: 1,
								variant: "ghost",
								size: "sm",
							...
							t.secret ? (h(), d("span", {
								...
								default: y(() => [...n[50] ||= [p("Will be removed", -1)]]),
								_: 1
							}), n[51] ||= p(" The stored value will be deleted when you save. Undo to keep it. ", -1)], 64)) : Z(e) === null ? (h(), d(s, { key: 1 }, [m(a, {
								tone: "neutral",
								class: "admin-plugins__secret-state"
							}, {
								default: y(() => [...n[52] ||= [p("Unknown", -1)]]),
								_: 1
							}), n[53] ||= p(" This server did not report whether a value is stored. Type a new one to replace whatever is there; leave it blank to keep it. ", -1)], 64)) : Z(e)?.set ? (h(), d(s, { key: 2 }, [
								m(a, {
									tone: "success",
									class: "admin-plugins__secret-state"
								}, {
									default: y(() => [...n[54] ||= [p("Configured", -1)]]),
									_: 1
								}),
						...
						yn(t) ? (h(), d("span", dt, [n[57] ||= p(" Default: ", -1), f("code", null, v(yn(t)), 1)])) : u("", !0),
...
//# sourceMappingURL=PluginsPage-CYtwq0x3.js.map