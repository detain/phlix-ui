...
import { t as n } from "./client-CkSYnkSD.js";
import { n as r } from "./useApiBase-CV_r-Kk4.js";
import { t as i } from "./useAuthStore-BwuHy-08.js";
import { i as a } from "./usePlayerStore-DhgapSoa.js";
import { t as o } from "./useToastStore-BDoKlU6N.js";
import { n as s } from "./ThumbRating-ClFY8tyW.js";
import { t as c } from "./useLibrariesStore-Dmwv-lMs.js";
import { i as l } from "./usePageTitle-BO3GGF3M.js";
import { t as ee } from "./Button-CsFYgW7R.js";
import { t as te } from "./useMediaStore-DKWeq5bp.js";
import { t as u } from "./EmptyState-CxJYcONU.js";
import { t as ne } from "./MediaCard-CCE_8Vpm.js";
import { n as d, t as re } from "./MediaGrid-DZEnqo4u.js";
import { t as ie } from "./FilterBar-CLV6bVnm.js";
import { t as ae } from "./MetadataMatchModal-D0v9g5dI.js";
import { t as oe } from "./PosterPicker-BSLUiq8o.js";
import { n as se, t as ce } from "./useItemInspector-BcBsm89p.js";
...
var _e = ["aria-label"], j = { class: "media-list-row__poster" }, M = { class: "media-list-row__body" }, N = { class: "media-list-row__title" }, ve = ["href", "onClick"], ye = ["href"], be = { class: "media-list-row__meta" }, xe = {
...
}, Pe = 20, Fe = /*#__PURE__*/ e(/* @__PURE__ */ y({
	...
	setup(e, { emit: t }) {
		...
		})), oe = `calc(100vw - ${2 * Pe}px)`, se = p(() => n.item.genres?.slice(0, 3) ?? []);
		return (t, n) => (C(), g("article", {
			...
			_("div", Oe, [
				...
				_("div", ke, [
					...
					(C(!0), g(f, null, T(se.value, (e) => (C(), g("span", {
						key: e,
...
}), [["__scopeId", "data-v-1cd4d615"]]), Ie = ["aria-label"], Le = [
	"disabled",
	"aria-label",
	"onClick"
], G = { class: "index-rail__label" }, K = {
	...
	setup(e, { emit: t }) {
		...
		}, [_("span", G, E(t.label), 1), _("span", K, E(t.label), 1)], 10, Le))), 128))], 8, Ie));
	}
}), [["__scopeId", "data-v-4b01327c"]]), q = /* @__PURE__ */ new Map();
function J(e) {
...
var Be = { class: "library-page" }, Ve = {
	key: 1,
	class: "library"
}, He = { class: "library-header" }, Ue = { class: "library-title" }, We = { class: "library-count numeric" }, Ge = 1, X = /*#__PURE__*/ e(/* @__PURE__ */ y({
	__name: "LibraryPage",
	setup(e) {
		...
		async function q(e) {
			...
			let r = () => t !== G;
			try {
				let i = await le(new n({ baseUrl: f.value }), f.value, e, me.resumeMap, t?.signal);
				if (r()) return;
				if (!i) {
...
//# sourceMappingURL=LibraryPage-DHSmoGa6.js.map