...
import { f as i, l as a, t as o } from "./client-B65CbqT7.js";
import { n as s, t as c } from "./media-query-IVKvZvWX.js";
import { t as l } from "./Badge-Dq-pYhrz.js";
import { t as u } from "./Chip-CnJPGjy7.js";
import { n as d, r as f, t as p } from "./listbox-htyKA_G5.js";
import { t as m } from "./Select-Jxt3ozRc.js";
...
var re = V("media", () => {
	...
	function W(e, t, n, r) {
		...
		let s = u.get(P(e, t), void 0, a.signal).then((e) => (I.set(n, {
			items: e.items,
			total: e.total,
			ts: Date.now()
		}), e)).finally(() => {
		...
		return O(() => {
			...
			C(g, { name: "filterbar-panel" }, {
				default: L(() => [R(x("div", ce, [
					...
					x("div", Z, [r[8] ||= x("span", { class: "filterbar__field-label" }, "Rating", -1), x("div", ue, [(k(!0), b(h, null, j(N(o).availableRatings, (e) => (k(), v(u, {
						key: e,
					...
					x("div", de, [r[9] ||= x("span", { class: "filterbar__field-label" }, "Type", -1), x("div", fe, [(k(!0), b(h, null, j(N(o).availableTypes, (e) => (k(), v(u, {
						key: e,
					...
					x("div", pe, [r[10] ||= x("span", { class: "filterbar__field-label" }, "Metadata", -1), x("div", me, [(k(), b(h, null, j(te, (e) => C(u, {
						key: e.value,
					...
					x("div", Ce, [
						...
						x("div", we, [(k(!0), b(h, null, j(Ve.value, (e) => (k(), v(u, {
							key: e.id,
							removable: "",
			...
			x("div", ke, [x("span", Ae, [x("b", null, M(N(o).total.toLocaleString()), 1), S(" " + M(N(o).total === 1 ? "title" : "titles"), 1)]), Re.value ? (k(), b(h, { key: 0 }, [x("div", je, [(k(!0), b(h, null, j(Le.value, (e) => (k(), v(u, {
				key: e.key,
				removable: "",
...
//# sourceMappingURL=FilterBar-DRjRnf8t.js.map