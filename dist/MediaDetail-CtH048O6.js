...
import { t as r } from "./Modal-BJEvG52w.js";
...
import { n as re, t as ie } from "./ThumbRating-6vDNKJU1.js";
import { t as o } from "./Button-8mVXxqAA.js";
import { t as s } from "./Chip-BVp0lh_7.js";
import { t as ae } from "./Menu-DRkKveJV.js";
import { i as oe, n as se, r as ce } from "./MediaCard-D0gQW4kW.js";
import { t as le } from "./MediaRow-Bj6hNyFt.js";
...
var me = { class: "media-detail" }, he = {
	...
	setup(e, { emit: t }) {
		let g = e, E = t, D = re(), O = ue("phlixConfig", null), _t = te(), k = l(() => D.isFavorite(g.item.id));
		function vt() {
		...
		return v(() => {
			...
			H.value ? (y(), f("div", he, [p("img", {
				...
				fetchpriority: "high",
				onLoad: kt
			}, null, 42, ge), i[9] ||= p("div", { class: "media-detail__backdrop-scrim" }, null, -1)])) : d("", !0),
			J.value ? (y(), f("audio", {
				key: 1,
			...
			p("div", ye, [p("div", be, [e.item.poster_url ? (y(), f("img", {
				...
				L.value.length ? (y(), f("div", Me, [i[11] ||= p("span", { class: "media-detail__companies-label" }, "Studios", -1), p("div", Ne, [(y(!0), f(c, null, x(L.value, (e) => (y(), u(s, {
					key: e.name,
					size: "sm",
				...
				p("div", Ie, [
					...
					z.value ? (y(), u(o, {
						...
						default: w(() => [i[13] ||= m(" Resume ", -1), p("span", Le, S(z.value), 1)]),
						_: 1
					})) : d("", !0),
					At.value ? (y(), u(o, {
						key: 1,
...
//# sourceMappingURL=MediaDetail-CtH048O6.js.map