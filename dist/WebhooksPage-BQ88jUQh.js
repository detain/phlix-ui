import { a as e, d as t, i as n, m as r, n as ee, p as te, r as ne, t as i } from "./Button-DjEQ9y17.js";
import { t as a } from "./Modal-BkSAbwHm.js";
import { t as re } from "./EmptyState-bbKd8GNA.js";
import { t as ie } from "./Badge-DobVc76J.js";
import { r as ae, t as oe } from "./webhooks-BBTLnFKm.js";
import { Fragment as o, computed as s, createBlock as se, createCommentVNode as c, createElementBlock as l, createElementVNode as u, createTextVNode as d, createVNode as f, defineComponent as p, inject as ce, normalizeClass as le, onMounted as ue, openBlock as m, ref as h, renderList as g, toDisplayString as _, unref as de, vModelDynamic as fe, vModelText as v, withCtx as y, withDirectives as b, withModifiers as pe } from "vue";
...
var me = {
...
}, he = { class: "admin-webhooks__head" }, ge = {
	key: 0,
	...
	"aria-label": "Webhooks"
}, ve = { class: "admin-webhooks__url" }, ye = { class: "admin-webhooks__actions" }, be = { class: "admin-webhooks__field" }, xe = { class: "admin-webhooks__field" }, Se = { class: "admin-webhooks__field" }, Ce = { class: "admin-webhooks__label" }, we = {
	key: 0,
	"aria-hidden": "true"
}, Te = {
	key: 0,
	class: "admin-webhooks__hint"
}, x = { class: "admin-webhooks__secret-row" }, S = ["type", "placeholder"], C = { class: "admin-webhooks__events" }, w = { class: "admin-webhooks__events-category-label" }, T = ["checked", "onChange"], E = { class: "admin-webhooks__checkbox-label" }, D = { class: "admin-webhooks__event-id" }, O = {
	key: 0,
	...
	"aria-hidden": "true"
}, Oe = { class: "admin-webhooks__test-status" }, ke = { class: "admin-webhooks__test-message" }, k = /*#__PURE__*/ r(/* @__PURE__ */ p({
	__name: "WebhooksPage",
	props: { client: {} },
	setup(r) {
		let p = r, k = ce("apiBase", ""), Ae = s(() => typeof k == "string" ? k : k?.value ?? ""), A = new oe(p.client ?? new e({
			baseUrl: Ae.value,
			tokenStore: new n()
		})), j = ne();
		function M(e) {
		...
		async function F() {
			...
			try {
				...
				j.error(t(e, "Failed to load webhooks."));
			} finally {
				P.value = !1;
			}
		}
		...
		async function Pe() {
			...
			if (e) try {
				...
				j.error(t(e, "Failed to delete webhook.")), J.value = null;
			}
		}
		...
		return ue(F), (e, t) => (m(), l("section", me, [
			u("header", he, [t[9] ||= u("h1", {
				id: "webhooks-heading",
			...
			P.value ? (m(), l("div", ge, [f(ee, {
				variant: "text",
				lines: 6
			})])) : N.value.length === 0 ? (m(), se(re, {
				key: 1,
				icon: "settings",
				...
				_: 1
			})) : (m(), l("table", _e, [t[14] ||= u("thead", null, [u("tr", null, [
				u("th", { scope: "col" }, "Name"),
				u("th", { scope: "col" }, "URL"),
			...
			f(a, {
				...
				default: y(() => [u("form", {
					...
					onSubmit: pe(q, ["prevent"])
				}, [
					u("label", be, [t[15] ||= u("span", { class: "admin-webhooks__label" }, "Name", -1), b(u("input", {
					...
					u("label", xe, [t[16] ||= u("span", { class: "admin-webhooks__label" }, "URL", -1), b(u("input", {
					...
					u("div", Se, [
						u("span", Ce, [t[17] ||= d(" Secret", -1), L.value ? c("", !0) : (m(), l("span", we, " *"))]),
						L.value ? (m(), l("p", Te, "Leave blank to keep the current secret.")) : c("", !0),
						u("div", x, [b(u("input", {
					...
					u("fieldset", C, [t[18] ||= u("legend", { class: "admin-webhooks__label" }, [d("Events"), u("span", { "aria-hidden": "true" }, " *")], -1), (m(!0), l(o, null, g(de(ae), (e) => (m(), l("div", {
						key: e.label,
						class: "admin-webhooks__events-category"
					}, [u("span", w, _(e.label), 1), (m(!0), l(o, null, g(e.events, (e) => (m(), l("label", {
						key: e.id,
						...
						u("span", E, _(e.label), 1),
						u("span", D, _(e.id), 1)
					]))), 128))]))), 128))]),
					W.value ? (m(), l("p", O, _(W.value), 1)) : c("", !0)
				], 32)]),
				_: 1
			}, 8, ["modelValue", "title"]),
			f(a, {
			...
			f(a, {
				...
				default: y(() => [Z.value ? (m(), l("p", Ee, "Sending test payload…")) : X.value ? (m(), l("div", {
					key: 1,
					class: le(["admin-webhooks__test-result", X.value.success ? "admin-webhooks__test-result--ok" : "admin-webhooks__test-result--fail"])
				}, [u("span", De, [f(te, { name: X.value.success ? "success" : "error" }, null, 8, ["name"])]), u("div", null, [u("p", Oe, _(X.value.success ? "Delivery succeeded" : "Delivery failed"), 1), u("p", ke, _(X.value.message), 1)])], 2)) : c("", !0)]),
				_: 1
			}, 8, ["modelValue", "title"])
		]));
	}
...
//# sourceMappingURL=WebhooksPage-BQ88jUQh.js.map