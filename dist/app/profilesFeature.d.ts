...
export declare const PROFILES_FEATURE_KEY = "profiles";
/**
 ...
 */
export declare const S462PROFENABLEDX9K3 = "profiles-feature-gate";
/** Resolve the profiles feature flag for a host config (null/absent ⇒ default). */
export declare function profilesFeatureEnabled(config: PhlixAppConfig | null | undefined): boolean;
