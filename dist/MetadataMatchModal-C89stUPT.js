...
import { o as r, p as i, t as a, u as o } from "./Button-MsRePfWv.js";
import { t as s } from "./useAuthStore-BNs-pZEK.js";
import { i as c } from "./usePlayerStore-dMohDTWc.js";
import { t as l } from "./Modal-BJKZOPpV.js";
		...
		async function J(e) {
			if (!(!c.item || R.value)) {
				...
				try {
					...
					r(e) ? I.value = !0 : e instanceof o && e.status === 422 ? z.value = "No match details were found for that result. Try another." : z.value = i(e, "Could not apply that match. Please try again.");
				} finally {
					R.value = null;
				}
			}
...
//# sourceMappingURL=MetadataMatchModal-C89stUPT.js.map