...
import { t as a } from "./useMessages-B0Tbpmx-.js";
...
import { t as x } from "./Spinner-Cmo5Cu-f.js";
...
import { t as D } from "./Select-D9cHdhdD.js";
import { t as ee } from "./Modal-BEwyjeSP.js";
...
import { n as ge, t as _e } from "./SyncPlayModal-DObGR2Xd.js";
...
var Un = ["aria-label"], Wn = ["src"], Gn = { class: "upnext__body" }, Kn = { class: "upnext__eyebrow" }, qn = { class: "upnext__title" }, Jn = {
	...
	setup(e, { emit: n }) {
		let r = e, o = n, c = d(), l = i(), { t: u } = a(), g = ge(), _ = p(), v = I(() => _.isFavorite(r.media.id)), y = I(() => _.likeLevel(r.media.id));
		function b() {
		...
		let Le = K(c.resumePositionFor(r.media.id) ?? 0), Q = K(!N.value && Le.value > 0), Re = null, ze = K(!1), Be = K(8), Ve, He = K(null), Ue = K(0), We = K(!1), Ge = K([]), Ke = K(!1), qe = K(null);
		function Je(e, t) {
		...
		function $e() {
			let e = r.apiBase ?? "";
			return (Ze === null || Qe !== e) && (Ze = new s({ baseUrl: e }), Qe = e), Ze;
		}
		...
		let rt = I(() => c.upNext);
		function it() {
			N.value = jn(r.streamUrl, r.media.path), ce(), Le.value = c.resumePositionFor(r.media.id) ?? 0, Q.value = !N.value && Le.value > 0, Re = null, tn = !1, Ht = !1, zt.value = [], Rt.value = !1, Ut = !1, jt.value = -1, Yt = null, Ne = !1, pe = !1, ct(), ze.value = !1, P.reset(), w.value && (w.value.currentTime = 0), N.value && Ae(), be(r.media.id);
		}
		function at(e) {
			let t = w.value;
		...
		function st() {
			Re = null, at(0), c.clearResume(r.media.id), Q.value = !1, w.value?.play()?.catch(() => {});
		}
		function ct() {
		...
		function ht() {
			pe || (pe = !0, de?.finish()), zn(), E.value = !0, c.upNext && (ze.value = !0, l.autoplay && ut());
		}
		function gt() {
			ct(), ze.value = !1;
		...
		function Bn() {
			zn(), !(!c.playing || O.value) && (Qt = setTimeout(() => {
		...
		return we(() => {
			...
			}), _.hydrate(r.media), typeof document < "u" && (document.addEventListener("fullscreenchange", Fn), M.value = document.pictureInPictureEnabled === !0), Un = c.bindMediaSession({
			...
			e && (e.state === "playing" ? (w.value?.play(), c.play()) : e.state === "paused" && (w.value?.pause(), c.pause()), g.updateLocalPosition(c.position), Math.abs(g.driftAmount) > 2 && at(e.playbackPosition));
		}), Ce(() => {
...
//# sourceMappingURL=PlayerPage-DW8KzYjJ.js.map