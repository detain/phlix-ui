...
import { t } from "./useMessages-ClxxG1xp.js";
import { o as n } from "./client-7SOKWho6.js";
...
var D = { class: "setform" }, O = {
	...
	emits: ["saved"],
	setup(e, { emit: _ }) {
		let P = e, F = _, I = r(), L = o(), { t: R } = t(), z = x({}), B = x({}), V = x(!0), H = x(null), U = x(null), W = [
			"transcoding",
			"metadata",
			"markers",
			"subtitles",
...
//# sourceMappingURL=SettingsForm-Da8VHciy.js.map