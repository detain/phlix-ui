...
import { t as c } from "./Modal-BJKZOPpV.js";
import { t as ee } from "./useToastStore-BDoKlU6N.js";
import { t as te } from "./Skeleton-DkSoWF3C.js";
import { t as ne } from "./EmptyState-B2QnGIQT.js";
import { i as re, r as l, t as ie } from "./plugins-UjYR2rXk.js";
...
var pe = {
	...
	setup(e) {
		...
		return ce(() => {
			...
			h("div", ge, [n[12] ||= h("span", { class: "admin-plugins__sources-label" }, "Catalogs", -1), (v(!0), m(u, null, b(k.value.sources, (e) => (v(), f(o, {
				key: e,
				tone: "neutral"
			}, {
				default: S(() => [h("a", {
			...
			We.value ? (v(), m("div", xe, [_(te, {
				...
				g(" — " + x(e.error), 1)
			]))), 128)), Ge.value.length === 0 && k.value.errors.length === 0 ? (v(), f(ne, {
				key: 0,
				icon: "settings",
			...
			qe.value.length ? (v(), m("section", Ae, [
				...
				h("table", je, [n[26] ||= h("thead", null, [h("tr", null, [
					...
					h("td", Me, [g(x(e.version) + " ", 1), G(e.name) ? (v(), f(o, {
						key: 0,
						tone: "warning",
						class: "admin-plugins__update-badge"
					}, {
			...
			_(c, {
				...
				default: S(() => [_t.value ? (v(), m("div", Ie, [_(te, {
					variant: "text",
					lines: 4
...
//# sourceMappingURL=PluginsPage-CV0VPZpH.js.map