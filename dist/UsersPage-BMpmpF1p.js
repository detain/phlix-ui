import { a as e, f as t, h as n, i as ee, n as te, o as ne, r, t as i } from "./Button-C86XulWV.js";
...
var fe = {
	...
	key: 4,
	class: "admin-users__subform"
}, Be = { class: "admin-users__subform-title" }, Ve = { class: "admin-users__field" }, He = { class: "admin-users__subform-actions" }, Ue = 5, S = /*#__PURE__*/ n(/* @__PURE__ */ ce({
	__name: "UsersPage",
	props: { client: {} },
	setup(n) {
		let ce = n, S = le("apiBase", ""), We = c(() => typeof S == "string" ? S : S?.value ?? ""), C = new se(ce.client ?? new ne({
			baseUrl: We.value,
			tokenStore: new e()
		})), w = ee(), Ge = c(() => oe.map((e) => ({
			value: e.value,
		...
		return ue(O), (e, t) => (h(), d("section", fe, [
			...
			E.value ? (h(), d("div", me, [m(te, {
				...
				_: 1
			}, 8, ["description"])) : T.value.length === 0 ? (h(), l(r, {
				key: 2,
				icon: "user",
				title: "No users yet"
			}, {
				...
				f("td", null, [m(o, { tone: e.is_admin ? "accent" : "neutral" }, {
			...
			m(a, {
				...
				default: y(() => [H.value ? (h(), d("div", Oe, [m(te, {
					variant: "text",
					lines: 4
				})])) : (h(), d(s, { key: 1 }, [
					f("div", ke, [m(i, {
					...
					V.value.length === 0 ? (h(), l(r, {
						...
						f("td", null, [m(o, { tone: e.pin_hash === null ? "neutral" : "success" }, {
					...
					G.value ? (h(), d("div", Me, [f("h3", Ne, _(K.value ? "Edit profile" : "Add profile"), 1), f("form", {
						...
						f("label", Fe, [t[39] ||= f("span", { class: "admin-users__label" }, "Rating", -1), m(re, {
							"model-value": J.value,
							options: Ge.value,
							label: "Rating",
...
//# sourceMappingURL=UsersPage-BMpmpF1p.js.map