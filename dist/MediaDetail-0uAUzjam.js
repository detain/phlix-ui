...
import { n, t as r } from "./useUserItemDataStore-q9SuHhBR.js";
import { t as i } from "./Button-k7aQagzg.js";
import { t as a } from "./Chip-2HcSZF4a.js";
import { t as o } from "./MediaRow-Doxi0Wxp.js";
...
var S = { class: "media-detail" }, re = { class: "media-detail__bar" }, ie = { class: "media-detail__hero" }, ae = { class: "media-detail__poster" }, oe = ["src", "alt"], se = {
	...
	setup(e, { emit: h }) {
		let H = e, U = h, W = r(), G = ee("phlixConfig", null), K = c(() => W.isFavorite(H.item.id));
		function Se() {
...
//# sourceMappingURL=MediaDetail-0uAUzjam.js.map