...
import { r as n, t as r } from "./client-DH50wjeq.js";
...
import { t as u } from "./useSeriesSeasons-Dga2EzCU.js";
	...
	setup(e, { emit: r }) {
		...
		return (n, r) => (C(), h("section", N, [(C(!0), h(d, null, T(e.seasons, (e, n) => (C(), h("details", {
			...
			g("button", {
				...
				g("span", V, E(x(e)), 1),
				D(e) || S(e) ? (C(), h("span", H, [
					D(e) ? (C(), h(d, { key: 0 }, [_(E(D(e)), 1)], 64)) : m("", !0),
					D(e) && S(e) ? (C(), h(d, { key: 1 }, [_(" · ")], 64)) : m("", !0),
					S(e) ? (C(), h(d, { key: 2 }, [_(E(S(e)), 1)], 64)) : m("", !0)
				])) : m("", !0),
				O(e) ? (C(), h("span", U, E(O(e)), 1)) : m("", !0)
			], 8, B),
			M.value ? (C(), h("button", {
				key: 0,
				type: "button",
			...
			M.value && u(e.id) ? (C(), h("div", G, [l(e.id) === void 0 ? (C(), h("span", K, " Loading… ")) : l(e.id)?.length ? (C(!0), h(d, { key: 1 }, T(l(e.id), (e, t) => (C(), h("span", {
				key: t,
				class: "series-seasons__file-row"
			}, [g("span", q, E(e.path), 1), g("span", J, [
				_(E(j(e.size_bytes)) + " ", 1),
...
}), [["__scopeId", "data-v-1b54aeb2"]]), Z = { class: "season-page" }, Q = {
	key: 0,
...
}), [["__scopeId", "data-v-f4414db9"]]);
//#endregion
export { ue as default };

//# sourceMappingURL=SeasonPage-CAF2B8SN.js.map