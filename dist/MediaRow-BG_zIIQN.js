...
import { t } from "./Skeleton-BUq2D39t.js";
import { n } from "./MetadataMatchModal-ozGAKR2V.js";
import { t as r } from "./EmptyState-0XgHKEGf.js";
...
var _ = ["aria-label"], v = { class: "media-row__head" }, y = { class: "media-row__title" }, b = {
	...
	setup(e, { emit: d }) {
		...
		return (a, d) => k.value ? s("", !0) : (f(), c("section", {
			...
			onMarkWatched: d[5] ||= (e) => D("mark-watched", e),
			onRefresh: d[6] ||= (e) => D("refresh", e),
			onChoosePoster: d[7] ||= (e) => D("choose-poster", e),
			onRemove: d[8] ||= (e) => D("remove", e)
		}, null, 8, [
			"item",
			"to",
			"can-match"
...
}), [["__scopeId", "data-v-ed36888c"]]);
//#endregion
export { E as t };

//# sourceMappingURL=MediaRow-BG_zIIQN.js.map