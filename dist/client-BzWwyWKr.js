...
function v(e) {
	let t = e && typeof e == "object" ? e : {}, n = g(t.name) ?? "Unknown Artist", r = _(t.album_count);
	return {
		id: n,
		name: n,
...
function b(e) {
	...
	return {
		...
		year: _(t.year),
		totalTracks: _(t.track_count) ?? r.length,
		tracks: r.map(y)
	};
}
var x = "metadata.tmdb_unconfigured";
function S(t) {
...
var w = class {
	...
	async searchSubtitles(e, t, n) {
		...
		return Array.isArray(a.candidates) ? a.candidates.map(C) : [];
	}
	...
	async listArtists(e) {
		...
		return (Array.isArray(t.artists) ? t.artists : []).map(v);
	}
	async getArtist(e, t) {
	...
	async listAlbums(e, t) {
		...
		return (e === void 0 || e === "" ? r : r.filter((t) => g((t && typeof t == "object" ? t : {}).artist) === e)).map(b);
	}
	async getAlbum(e, t) {
		return b((await this.get(`/api/v1/music/albums/${encodeURIComponent(e)}`, void 0, t)).album);
	}
	async listTracks(e, t) {
		let n = await this.get("/api/v1/music/tracks", void 0, t), r = Array.isArray(n.tracks) ? n.tracks : [];
		return (e === void 0 || e === "" ? r : r.filter((t) => g((t && typeof t == "object" ? t : {}).album) === e)).map(y);
	}
	async getTrack(e, t) {
...
//#endregion
export { S as a, c, n as d, r as f, m as i, e as l, x as n, h as o, i as p, T as r, p as s, w as t, t as u };

//# sourceMappingURL=client-BzWwyWKr.js.map