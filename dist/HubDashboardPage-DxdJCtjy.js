...
var E = {
	...
	props: { client: {} },
	setup(e) {
		let v = e, R = y("apiBase", ""), z = d(() => typeof R == "string" ? R : R?.value ?? ""), B = new l(v.client ?? new t({
			baseUrl: z.value,
			tokenStore: new i()
		...
		async function Z() {
			...
			try {
				...
				K.value = r(e, "Failed to load hub summary."), V.error(K.value);
			} finally {
				W.value = !1;
			}
		}
		async function Q() {
			...
			try {
				...
				q.value = r(e, "Failed to load recent activity."), V.error(q.value);
			} finally {
				G.value = !1;
			}
		}
...
//# sourceMappingURL=HubDashboardPage-DxdJCtjy.js.map