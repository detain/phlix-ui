...
import { n as t, t as n } from "./Button-C1kpaQyo.js";
import { t as r } from "./useAuthStore-DmWD93w-.js";
import { t as i } from "./useLibrariesStore-SM3lj2GQ.js";
import { i as a } from "./usePageTitle-BO3GGF3M.js";
import { n as o, r as s, t as c } from "./FilterBar-Cfr1-jHv.js";
import { t as l } from "./MetadataMatchModal-DgBfVIuE.js";
import { t as u } from "./EmptyState-B2QnGIQT.js";
import { i as d, n as f } from "./useApiBase-DhSHB6Qp.js";
...
var L = { class: "library-page" }, R = {
	...
	__name: "LibraryPage",
	setup(e) {
		let t = f(), d = j(), p = M(), x = o(), S = i(), E = r(), N = T(null), P = T([]), F = null, H = m(() => P.value.some((e) => e.count > 0));
		async function U() {
		...
		function ne() {
			let e = d.query.actors, t = Array.isArray(e) ? e.filter((e) => !!e) : e ? [e] : [];
			t.length && x.setActors(t);
			let n = d.query.genres, r = Array.isArray(n) ? n.filter((e) => !!e) : n ? [n] : [];
			r.length && x.setGenres(r);
			let i = d.query.companies, a = Array.isArray(i) ? i.filter((e) => !!e) : i ? [i] : [];
			a.length && x.setCompanies(a);
			let o = Array.isArray(d.query.match) ? d.query.match[0] : d.query.match;
...
//# sourceMappingURL=LibraryPage-D4rlsK__.js.map