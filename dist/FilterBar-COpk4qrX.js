...
var pe = U("media", () => {
	...
	function I(e, t, n, r) {
		r && (N && n !== M && N.abort(), M = n);
		let a = j.get(n);
		if (a) return r && (N = a.controller), a.promise;
		let o = new AbortController();
		r && (N = o);
		let s = new i({ baseUrl: e }).get(ee(e, t), void 0, o.signal).then((e) => (k.set(n, {
			items: e.items,
			total: e.total,
			ts: Date.now()
		}), e)).finally(() => {
	...
	async function R(e, t = !1) {
		...
		try {
			let n = await I(e, i, o, !t);
			if (!t && o !== M) return;
			L(n, t);
		} catch (e) {
			if (fe(e)) return;
			(t || o === M) && (r.value = a(e, "Failed to load media"));
		} finally {
			(t || o === M) && (n.value = !1);
		}
	}
...
//# sourceMappingURL=FilterBar-COpk4qrX.js.map