...
import { c as t, f as n, l as r, t as i } from "./client-cUL8r-1I.js";
...
var fe = {
	...
	setup(e) {
		let g = e, E = ce("apiBase", ""), Pe = l(() => typeof E == "string" ? E : E?.value ?? ""), D = g.client ?? new i({
			baseUrl: Pe.value,
			tokenStore: new t()
		}), O = new ae(D), Fe = new se(D), k = te(), Ie = [{
			value: "first",
		...
		return ue(R, (e) => {
			...
			default: C(() => [p("div", me, [He.value.length === 0 ? (_(), f("p", he, " No settings in this group. ")) : (_(), f("form", {
				...
				}, null, 8, ["model-value", "label"])], 64)) : X(e) === "bool" ? (_(), f("div", Se, [h(ee, {
...
//# sourceMappingURL=SettingsPage-BGLw51_w.js.map