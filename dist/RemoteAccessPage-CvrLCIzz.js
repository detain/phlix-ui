...
import { t as ie } from "./Modal-Y_WFD5LO.js";
import { t as o } from "./Skeleton-DhQmxeNg.js";
import { t as s } from "./EmptyState-C0gWPlCE.js";
import { t as ae } from "./PageHint-CLQcn6yF.js";
...
var ye = {
	...
	props: { client: {} },
	setup(e) {
		let le = e, b = ue("apiBase", ""), Rt = l(() => typeof b == "string" ? b : b?.value ?? ""), x = new oe(le.client ?? new te({
			baseUrl: Rt.value,
			tokenStore: new n()
		})), zt = new re(le.client ?? new te({
			baseUrl: Rt.value,
			tokenStore: new n()
		})), S = ne();
		function C(e) {
		...
		async function fn() {
			if (!B.value) {
				...
				try {
					...
					if (V.value = null, e instanceof ee && e.status === 409) {
...
//# sourceMappingURL=RemoteAccessPage-CvrLCIzz.js.map