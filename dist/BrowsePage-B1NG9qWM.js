...
import { t } from "./client-CGSA6iT0.js";
import { n } from "./useApiBase-CV_r-Kk4.js";
import { t as r } from "./useAuthStore-BBQ_EsYH.js";
import { i } from "./usePlayerStore-C0izJMh8.js";
import { t as ee } from "./useToastStore-BDoKlU6N.js";
import { n as te } from "./ThumbRating-DL3IV5ps.js";
import { t as ne } from "./Spinner-C1ovN881.js";
import { t as re } from "./useLibrariesStore-CLVbLTvE.js";
import { t as ie } from "./Button-CnyfCnhY.js";
import { t as a } from "./EmptyState-588Z_81C.js";
import { t as o } from "./MediaRow-ZmhICHIp.js";
import { t as s } from "./HomeRow-D3vfLWAa.js";
import { t as ae } from "./MetadataMatchModal-55LHSAXt.js";
import { t as oe } from "./PosterPicker-9PSCTnwn.js";
import { n as se } from "./useResolvePlayable-Dnhx822M.js";
...
var _e = { class: "browse-page" }, ve = { class: "browse-toolbar" }, ye = {
	...
	__name: "BrowsePage",
	setup(e) {
		let m = n(), b = ue("phlixConfig", null), xe = l(() => b?.homeRows ?? []), x = re(), S = i(), C = ee(), w = r(), T = te(), E = he(), D = g(null), O = g(!1), k = g(null), A = g(!1), j = g(null);
		function M(e) {
			D.value = e, O.value = !0;
		}
		function Se(e) {
		...
		async function K(e) {
			...
			let r = () => n !== W;
			try {
				let i = await se(new t({ baseUrl: m.value }), m.value, e, S.resumeMap, n?.signal);
				if (r()) return;
				if (!i) {
		...
		return (e, t) => (h(), f("div", _e, [
			...
			ke.value ? (h(), f("div", ye, [p(ne, { label: "Loading libraries" })])) : d("", !0),
			_(x).error ? (h(), u(a, {
				key: 3,
				icon: "alert",
				title: H.value.title,
...
}), [["__scopeId", "data-v-82afa92f"]]);
//#endregion
export { b as default };

//# sourceMappingURL=BrowsePage-B1NG9qWM.js.map