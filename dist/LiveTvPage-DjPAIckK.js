...
import { t as re } from "./Select-MLr8Xr5n.js";
import { t as o } from "./Modal-Slll0YtS.js";
import { t as ie } from "./useToastStore-BDoKlU6N.js";
import { n as ae, t as s } from "./EmptyState-Ds4WcVdG.js";
...
var he = {
	...
	props: { client: {} },
	setup(e) {
		let se = e, C = ce("apiBase", ""), jt = l(() => typeof C == "string" ? C : C?.value ?? ""), w = new oe(se.client ?? new r({
			baseUrl: jt.value,
			tokenStore: new ee()
		})), T = ie();
		function Mt(e, t) {
		...
		async function Vt() {
			...
			try {
				...
				N.value = n(e, "Failed to load tuners."), T.error(N.value);
			} finally {
				j.value = !1;
			}
		}
		...
		async function Ut(e) {
			if (!Bt[e.tuner_id]) {
				...
				try {
					...
					T.error(n(e, "Failed to update tuner."));
				} finally {
					Bt[e.tuner_id] = !1;
				}
			}
		...
		async function Wt() {
			...
			if (e) try {
				...
				T.error(n(e, "Failed to delete tuner.")), P.value = null;
			}
		}
		...
		async function Xt(e) {
			...
			try {
				...
				R.value = n(e, "Failed to load guide."), T.error(R.value);
			} finally {
				Kt.value = !1;
			}
		}
		...
		async function $t() {
			if (!Jt.value) {
				...
				try {
					...
					T.error(n(e, "Guide refresh failed."));
				} finally {
					Jt.value = !1;
				}
			}
		...
		async function cn() {
			...
			try {
				...
				V.value = n(e, "Failed to load recordings."), T.error(V.value);
			} finally {
				tn.value = !1;
			}
		}
		...
		async function ln() {
			...
			if (e) try {
				...
				T.error(n(e, "Failed to delete recording.")), H.value = null;
			}
		}
		function un(e) {
		...
		async function _n() {
			...
			try {
				...
				T.error(n(e, "Failed to schedule recording."));
			} finally {
				mn.value = !1;
			}
		}
		...
		async function bn() {
			...
			try {
				...
				X.value = n(e, "Failed to load series rules."), T.error(X.value);
			} finally {
				vn.value = !1;
			}
		}
		...
		async function xn() {
			...
			if (e) try {
				...
				T.error(n(e, "Failed to delete rule.")), Z.value = null;
			}
		}
		...
		async function An() {
			...
			try {
				...
				T.error(n(e, "Failed to create rule."));
			} finally {
				En.value = !1;
			}
		}
...
//# sourceMappingURL=LiveTvPage-DjPAIckK.js.map