...
import { a as t } from "./usePreferencesStore-DqGc5jlA.js";
...
import { n as a, o } from "./ThumbRating-CEhvLFWq.js";
import { t as s } from "./useToastStore-BDoKlU6N.js";
import { i as c } from "./usePageTitle-BO3GGF3M.js";
import { t as l } from "./Button-CInT03Lp.js";
import { t as u } from "./Skeleton-BUq2D39t.js";
import { n as ee, t as d } from "./MetadataMatchModal-BGNvfEb7.js";
import { t as te } from "./EmptyState-0XgHKEGf.js";
import { n as ne } from "./media-query-C8oxSF4h.js";
import { t as f } from "./MediaDetail-eAL4HpRw.js";
import { r as re, t as ie } from "./useResolvePlayable-BQXDt-BO.js";
import { i as p } from "./series-grouping-Bbs1zX87.js";
import { t as ae } from "./useSeriesSeasons-ezSOXOgO.js";
...
var k = { class: "series-detail" }, A = {
	...
	setup(e, { emit: n }) {
		...
		let l = h(() => r.seasons.length > 0), u = t(), d = h(() => u.cardSize ?? 200);
		return (t, n) => (w(), v("div", k, [x(f, {
			...
			style: C({ gridTemplateColumns: `repeat(auto-fill, minmax(${d.value}px, 1fr))` })
...
}), [["__scopeId", "data-v-6407b41d"]]), pe = { class: "media-detail-page" }, me = {
	key: 0,
	...
	setup(e) {
		let t = r(), ee = oe("phlixConfig", void 0), p = h(() => ee?.routerBase || "/app"), S = ue(), C = de(), E = o(), k = s(), A = i(), j = a(), M = T(null), N = T([]), P = T([]), F = T(!0), I = T(!1), L = T(!1), R = T(null), z = h(() => String(S.params.id ?? "")), B = h(() => E.resumePositionFor(z.value)), _e = h(() => M.value?.type === "series");
		c(() => M.value?.name);
		let V = null, H = !1;
		function U(e) {
...
//# sourceMappingURL=MediaDetailPage-CNaUOczT.js.map