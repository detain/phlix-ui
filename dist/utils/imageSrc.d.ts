 ...
 */
export declare function isRewritableImagePath(url: string): boolean;
/**
 ...
 */
export declare function resolveImageSrc<T extends string | null | undefined>(base: string, url: T): T | string;
/**
 ...
 *         non-empty string.
 */
export declare function resolveImageSrcset<T extends string | null | undefined>(base: string, srcset: T): T | string;
