...
import { o as a, t as o } from "./useUserItemDataStore-q9SuHhBR.js";
...
import { t as ee } from "./MetadataMatchModal-Br5h32VY.js";
import { t as te } from "./EmptyState-B2QnGIQT.js";
import { n as ne } from "./media-query-C8oxSF4h.js";
import { t as d } from "./MediaDetail-0uAUzjam.js";
...
var A = { class: "series-detail" }, j = {
	...
	setup(e) {
		let t = r(), f = ie("phlixConfig", void 0), S = h(() => f?.routerBase || "/app"), T = ce(), E = le(), D = a(), A = l(), j = i(), M = o(), N = w(null), P = w([]), F = w([]), I = w(!0), L = w(!1), R = w(!1), z = w(null), B = h(() => String(T.params.id ?? "")), V = h(() => D.resumePositionFor(B.value)), he = h(() => N.value?.type === "series");
		s(() => N.value?.name);
		let H = null, U = !1;
		function W(e) {
...
//# sourceMappingURL=MediaDetailPage-1KXopRsH.js.map