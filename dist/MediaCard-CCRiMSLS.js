...
import { r as n } from "./client-D1nDQ0cP.js";
...
import { n as o, t as s } from "./ThumbRating-Db3pVsxe.js";
...
var te = { class: "media-card__poster" }, ne = [
	...
	setup(e, { emit: l }) {
		...
		let He = d(() => W(u.posterSrcset ?? u.item.poster_srcset, u.posterSizes)), Ue = d(() => {
			...
			if (!e) return !1;
			let t = Date.parse(e);
			return !Number.isNaN(t) && Date.now() - t <= u.newWithinDays * 24 * 60 * 60 * 1e3;
		}), $ = d(() => {
...
//# sourceMappingURL=MediaCard-CCRiMSLS.js.map