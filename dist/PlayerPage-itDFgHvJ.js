...
import { H as re, m as u, t as ie } from "./Player-DrHp3Cbs.js";
import { r as ae } from "./series-grouping-Bbs1zX87.js";
import { n as oe, r as se, t as ce } from "./episode-order-BMC9lH44.js";
...
var ge = { class: "player-page__stage" }, _e = {
	...
	__name: "PlayerPage",
	setup(e) {
		let v = /* @__PURE__ */ new Map(), T = i(), ye = a(), be = me(), E = he(), D = o(), xe = ee(), O = C(null), k = C(""), A = C([]), j = C(null), M = C(null), N = C([]), P = C([]), F = C(!0), I = C(null), L = C(!1), R = C(null), z = C(!1), B = C(null), V = C(null), H = d(() => String(be.params.id ?? ""));
		s(() => O.value?.name);
		let U = d(() => {
		...
		async function Y(e, t) {
			...
			try {
				...
				if (i()) return;
				D.setQueue((o.items ?? []).filter((e) => e.id !== t.id).slice(0, 12));
			} catch (e) {
				if (i() || K(e)) return;
				D.setQueue([]);
			}
...
//# sourceMappingURL=PlayerPage-itDFgHvJ.js.map