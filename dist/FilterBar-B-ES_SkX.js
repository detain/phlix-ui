...
import { t as f } from "./Select-DHe4oeCr.js";
import { n as p } from "./MetadataMatchModal-6zRG2fyA.js";
...
var X = { class: "media-grid-root" }, ue = {
	...
	setup(e, { expose: r, emit: i }) {
		let a = e, o = i, s = n(), c = v(() => a.cardSize ?? s.cardSize ?? 200), l = A(null), u = A(null), d = A(0), f = A(0), m = A(0);
		function h() {
			let e = l.value;
...
}), [["__scopeId", "data-v-c884e037"]]), $ = 6e4, fe = 250;
function pe(e) {
...
//# sourceMappingURL=FilterBar-B-ES_SkX.js.map