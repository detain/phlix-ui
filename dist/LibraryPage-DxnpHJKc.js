...
import { n as a, r as o, t as s } from "./FilterBar-DGmX9FVM.js";
import { t as c } from "./MetadataMatchModal-DEJW4hCM.js";
import { t as l } from "./EmptyState-B2QnGIQT.js";
import { n as u, r as d } from "./useApiBase-CSECk0g8.js";
...
var L = { class: "library-page" }, R = {
	...
	__name: "LibraryPage",
	setup(e) {
		let t = u(), d = A(), f = j(), y = a(), b = i(), T = r(), M = w(null), N = w([]), F = null, H = p(() => N.value.some((e) => e.count > 0));
		async function U() {
		...
		function ne() {
			...
			let n = Array.isArray(d.query.match) ? d.query.match[0] : d.query.match;
...
//# sourceMappingURL=LibraryPage-DxnpHJKc.js.map