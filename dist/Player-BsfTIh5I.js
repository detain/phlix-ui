...
import { l as o, n as s } from "./Button-MsRePfWv.js";
import { i as c } from "./usePlayerStore-dMohDTWc.js";
...
function _e(e) {
	...
	let a = e.attach ?? G, o = e.pollIntervalMs ?? 1e3, c = e.maxWaitMs ?? 12e4, l = e.sleep ?? ((e) => new Promise((t) => setTimeout(t, e))), u = Math.max(1, Math.ceil(c / Math.max(1, o))), d = ve(), f = e.getToken ?? (() => ye(d)), p = null, m = !1;
	function h() {
...
var Nt = 8, Pt = 15, Ft = 2 * Math.PI * 15;
function It(e, t, n = Ft) {
	return t > 0 ? n * (1 - Math.max(0, Math.min(1, e / t))) : n;
}
//#endregion
//#region src/components/player/UpNext.vue?vue&type=script&setup=true&lang.ts
var Lt = ["aria-label"], Rt = ["src"], zt = { class: "upnext__body" }, Bt = { class: "upnext__eyebrow" }, Vt = { class: "upnext__title" }, Ht = {
	key: 0,
	class: "upnext__cd numeric"
}, Ut = { class: "upnext__actions" }, Wt = {
	key: 1,
	class: "upnext__ring",
	viewBox: "0 0 36 36",
	"aria-hidden": "true"
	...
	setup(e, { emit: n }) {
		let { t: r } = a(), i = e, o = n, s = w(() => i.posterUrl ?? i.media.poster_url ?? null), c = w(() => It(i.remaining, i.total));
		return (n, i) => (P(), D("aside", {
			...
			O("div", zt, [
				O("p", Bt, L(z(r)("player.upNext")), 1),
				O("h4", Vt, L(e.media.name), 1),
				e.counting ? (P(), D("p", Ht, L(z(r)("player.startsIn", { seconds: Math.max(0, e.remaining) })), 1)) : E("", !0),
				O("div", Ut, [O("button", {
					type: "button",
			...
			e.counting ? (P(), D("svg", Wt, [O("circle", {
				cx: "18",
				cy: "18",
				r: z(15),
				fill: "none",
				...
				"stroke-dasharray": z(Ft),
				"stroke-dashoffset": c.value,
				transform: "rotate(-90 18 18)"
			}, null, 8, Kt)])) : E("", !0)
		], 8, Lt));
	}
}), [["__scopeId", "data-v-c000ec99"]]), Jt = {
	class: "transcode",
	role: "alert"
}, Yt = { class: "transcode__card" }, Xt = { class: "transcode__heading" }, Zt = { class: "transcode__body" }, Qt = /*#__PURE__*/ e(/* @__PURE__ */ j({
	__name: "TranscodeNotice",
	props: { title: {} },
	emits: ["back"],
	setup(e, { emit: n }) {
		let r = n, { t: i } = a();
		return (n, a) => (P(), D("div", Jt, [O("div", Yt, [
			A(t, {
				name: "alert",
				class: "transcode__icon"
			}),
			O("h3", Xt, L(z(i)("player.transcodeHeading")), 1),
			O("p", Zt, L(e.title ? z(i)("player.transcodeBodyTitled", { title: e.title }) : z(i)("player.transcodeBodyUntitled")), 1),
			O("button", {
				type: "button",
...
}), [["__scopeId", "data-v-950c7b9d"]]), $t = {
	class: "prep",
	role: "status",
	"aria-live": "polite"
}, en = { class: "prep__card" }, tn = { class: "prep__heading" }, nn = { class: "prep__body" }, rn = ["aria-valuenow"], an = /*#__PURE__*/ e(/* @__PURE__ */ j({
	...
	setup(e) {
		...
		return (n, a) => (P(), D("div", $t, [O("div", en, [
			A(t, {
				name: "spinner",
				class: "prep__spinner"
			}),
			O("h3", tn, L(z(r)("player.transcodePreparingHeading")), 1),
			O("p", nn, L(e.title ? z(r)("player.transcodePreparingTitled", { title: e.title }) : z(r)("player.transcodePreparingUntitled")), 1),
			O("div", {
				class: "prep__bar",
				role: "progressbar",
				"aria-valuenow": i(),
...
}), [["__scopeId", "data-v-d91acff4"]]), on = /*#__PURE__*/ e(/* @__PURE__ */ j({
	__name: "SkipButton",
	props: {
		position: {},
		introMarker: {},
...
}), [["__scopeId", "data-v-6156ba5d"]]), sn = { class: "player__stage" }, cn = ["src", "poster"], ln = [
	"src",
	"srclang",
	"label",
	"default"
], un = { class: "player__meta" }, dn = ["aria-label"], fn = { class: "player__meta-text" }, pn = { class: "player__eyebrow" }, mn = { class: "player__title" }, hn = { class: "player__sub numeric" }, gn = {
	key: 0,
	class: "player__dot",
	"aria-hidden": "true"
}, _n = {
...
}, vn = ["aria-label"], yn = { class: "player__btnrow" }, bn = ["aria-label"], xn = ["aria-label"], Sn = ["aria-label"], Cn = { class: "player__time numeric" }, wn = ["aria-label"], Tn = ["aria-label", "aria-pressed"], En = ["aria-label", "aria-pressed"], Dn = ["aria-label"], On = /*#__PURE__*/ e(/* @__PURE__ */ j({
	__name: "Player",
	props: {
		media: {},
		streamUrl: {},
	...
	setup(e, { emit: n }) {
		...
		function xe() {
			if (R.value) return;
			let e = f.value, t = Mt(e) && (e?.currentTime ?? 0) === 0;
			(jt(e) || t) && (R.value = !0, ce());
		}
		...
		B(() => s.muted, (e) => {
			...
			e && (e.type === "seekTo" ? pe(e.value) : e.type === "seekBy" && pe(s.position + e.value));
		});
		function ot() {
		...
		return re(() => {
			...
			}, [A(t, { name: "arrow-left" })], 8, dn), O("div", fn, [
				O("p", pn, L(z(u)("player.nowPlaying")), 1),
				O("h2", mn, L(e.media.name), 1),
				O("div", hn, [(P(!0), D(S, null, I(Be.value, (e, t) => (P(), D(S, { key: t }, [t > 0 && !e.cert ? (P(), D("span", gn, "·")) : E("", !0), O("span", { class: M({ player__cert: e.cert }) }, L(e.text), 3)], 64))), 128))])
			])]),
			W.value ? E("", !0) : (P(), D("div", _n, [O("button", {
				type: "button",
				class: M(["player__bigplay", { "is-playing": z(s).playing }]),
				"aria-label": z(s).playing ? z(u)("player.pause") : z(u)("player.play"),
				onClick: H(Ke, ["stop"])
			}, [A(t, { name: z(s).playing ? "pause" : "play" }, null, 8, ["name"])], 10, vn)])),
			A(Re, {
				video: f.value,
			...
			W.value ? E("", !0) : (P(), D("div", {
				...
				e.prevEpisode ? (P(), D("button", {
					...
					onClick: We
				}, [A(t, { name: "skip-back" })], 8, bn)) : E("", !0),
				O("button", {
					type: "button",
					class: "player__iconbtn player__iconbtn--lg",
					"aria-label": z(s).playing ? z(u)("player.pause") : z(u)("player.play"),
					onClick: Ke
				}, [A(t, { name: z(s).playing ? "pause" : "play" }, null, 8, ["name"])], 8, xn),
				e.nextEpisode ? (P(), D("button", {
					...
					onClick: Ge
				}, [A(t, { name: "skip-forward" })], 8, Sn)) : E("", !0),
				O("span", Cn, [
				...
				O("button", {
					...
					onClick: at
				}, [A(t, { name: "theater" })], 10, En),
				O("button", {
					type: "button",
					class: "player__iconbtn",
					"aria-label": h.value ? z(u)("player.exitFullscreen") : z(u)("player.fullscreen"),
					onClick: ot
				}, [A(t, { name: h.value ? "fullscreen-exit" : "fullscreen" }, null, 8, ["name"])], 8, Dn)
			])])),
			W.value ? E("", !0) : (P(), T(on, {
				key: 2,
				position: z(s).position,
			...
			J.value && de.value && !W.value ? (P(), T(qt, {
				key: 4,
				media: de.value,
				remaining: le.value,
				total: z(8),
...
}), [["__scopeId", "data-v-c76e01d5"]]);
//#endregion
export { Fe as A, he as B, gt as C, Re as D, ut as E, we as F, de as G, pe as H, Ce as I, ce as J, fe as K, Te as L, xe as M, X as N, Le as O, be as P, _e as R, yt as S, ht as T, me as U, ue as V, ge as W, U as X, se as Y, ft as _, qt as a, vt as b, Nt as c, kt as d, jt as f, bt as g, Tt as h, Qt as i, Ne as j, Ie as k, Ft as l, It as m, on as n, Et as o, At as p, G as q, an as r, Dt as s, On as t, Pt as u, pt as v, _t as w, mt as x, dt as y, Y as z };

//# sourceMappingURL=Player-BsfTIh5I.js.map