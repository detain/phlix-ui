...
export declare const S513_PLAYBACK_FALLBACK_TOKEN = "S513FALLBACKX9P5";
/**
 ...
 */
export declare const PLAYBACK_FALLBACK_STALL_MS = 30000;
/**
 ...
 */
export declare function isHevcFamilyVideoCodec(codec: string | null | undefined): boolean;
/**
 ...
 */
export declare function playbackFallbackParams(opts: {
 ...
 */
export declare function isPlaybackStalled(nowMs: number, armedMs: number, currentTime: number, lastTime: number): boolean;
/**
