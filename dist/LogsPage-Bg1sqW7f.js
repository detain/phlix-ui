...
var ne = {
	...
	setup(e) {
		let v = [
			...
			baseUrl: F.value,
			tokenStore: new t()
		})), L = i(), R = w([]), z = w(""), B = w(200), V = w([]), H = w(!1), U = w(!1), W = w(!0), G = w(null), K = w(null), q = w(null), J = null, Y = d(() => R.value.length === 0 ? [{
			value: "",
			label: "(no log files)"
		}] : [{
			value: ee,
		...
		return E([z, B], () => void Z()), E([
			...
			z,
			B
		], ae), S(X), x(Q), (e, t) => (C(), m("section", ne, [
			t[8] ||= h("header", { class: "admin-logs__head" }, [h("h1", {
				id: "logs-heading",
				class: "admin-logs__title"
			}, "Logs")], -1),
			h("div", O, [
				h("label", k, [t[3] ||= h("span", { class: "admin-logs__label" }, "File", -1), _(s, {
					modelValue: z.value,
					"onUpdate:modelValue": t[0] ||= (e) => z.value = e,
					options: Y.value,
					label: "Log file"
				}, null, 8, ["modelValue", "options"])]),
				h("label", A, [t[4] ||= h("span", { class: "admin-logs__label" }, "Lines", -1), _(s, {
					"model-value": B.value,
					options: ie.value,
					label: "Line count",
			...
			H.value ? (C(), m("p", j, " Showing the most recent " + T(B.value) + " lines (" + T(z.value === te("__all__") ? "more lines available across files" : "file is larger") + "). ", 1)) : p("", !0),
			(W.value || U.value) && V.value.length === 0 ? (C(), m("div", M, [_(c, {
				variant: "text",
				lines: 8
			})])) : G.value ? (C(), f(l, {
				key: 2,
...
//# sourceMappingURL=LogsPage-Bg1sqW7f.js.map