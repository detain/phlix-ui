...
import { i } from "./client-CkSYnkSD.js";
import { n as a, r as ee } from "./useApiBase-CV_r-Kk4.js";
import { t as te } from "./useAuthStore-BwuHy-08.js";
import { t as ne } from "./useToastStore-BDoKlU6N.js";
import { n as re, t as ie } from "./ThumbRating-ClFY8tyW.js";
import { t as o } from "./Button-CsFYgW7R.js";
import { t as s } from "./Chip-BKTcATe3.js";
import { t as ae } from "./Modal-BbdR-K2V.js";
import { t as oe } from "./Menu-DRkKveJV.js";
import { n as se, r as ce } from "./MediaCard-CCE_8Vpm.js";
import { t as le } from "./mediaTypeIcon-Bde251Qi.js";
import { t as ue } from "./MediaRow-BbjEyA9G.js";
...
var he = { class: "media-detail" }, ge = {
	...
	setup(e, { emit: t }) {
		let g = e, E = t, D = re(), O = de("phlixConfig", null), _t = te(), k = l(() => D.isFavorite(g.item.id));
		function vt() {
		...
		return v(() => {
			...
			H.value ? (y(), f("div", ge, [p("img", {
				...
				fetchpriority: "high",
				onLoad: kt
			}, null, 42, _e), i[9] ||= p("div", { class: "media-detail__backdrop-scrim" }, null, -1)])) : d("", !0),
			J.value ? (y(), f("audio", {
				key: 1,
			...
			p("div", xe, [p("div", Se, [e.item.poster_url ? (y(), f("img", {
				...
				L.value.length ? (y(), f("div", Pe, [i[11] ||= p("span", { class: "media-detail__companies-label" }, "Studios", -1), p("div", Fe, [(y(!0), f(c, null, x(L.value, (e) => (y(), u(s, {
					key: e.name,
					size: "sm",
				...
				p("div", Re, [
					...
					z.value ? (y(), u(o, {
						...
						default: w(() => [i[13] ||= m(" Resume ", -1), p("span", ze, S(z.value), 1)]),
						_: 1
					})) : d("", !0),
					At.value ? (y(), u(o, {
						key: 1,
				...
				N.value.length ? (y(), f("div", Ve, [i[16] ||= p("span", { class: "media-detail__links-label" }, "Links", -1), p("div", He, [(y(!0), f(c, null, x(N.value, (e) => (y(), f("a", {
					key: e.key,
				...
				I.value.length || F.value.length ? (y(), f("div", We, [I.value.length ? (y(), f("section", Ge, [i[17] ||= p("h2", { class: "media-detail__credit-heading" }, "Crew", -1), p("ul", Ke, [(y(!0), f(c, null, x(I.value, (e, t) => (y(), f("li", { key: `crew-${t}-${e.name}` }, [p("button", {
					type: "button",
				...
				], 8, qe)]))), 128))])])) : d("", !0), F.value.length ? (y(), f("section", $e, [i[18] ||= p("h2", { class: "media-detail__credit-heading" }, "Cast", -1), p("ul", et, [(y(!0), f(c, null, x(F.value, (e, t) => (y(), f("li", { key: `cast-${t}-${e.name}` }, [p("button", {
					type: "button",
					class: "media-detail__person",
					"aria-label": `Show titles with ${e.name}`,
					onClick: (t) => E("actor", e.name)
			...
			e.item.files?.length ? (y(), f("section", st, [i[19] ||= p("h2", { class: "media-detail__files-heading" }, "Files", -1), p("ul", ct, [(y(!0), f(c, null, x(e.item.files, (e, t) => (y(), f("li", {
				key: t,
...
//# sourceMappingURL=MediaDetail-Bka8b4oQ.js.map