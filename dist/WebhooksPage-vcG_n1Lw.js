import { a as e, f as t, h as n, i as r, m as ee, n as te, o as ne, r as i, t as a } from "./Button-C86XulWV.js";
...
var fe = {
	...
	"aria-hidden": "true"
}, ke = { class: "admin-webhooks__test-status" }, Ae = { class: "admin-webhooks__test-message" }, O = /*#__PURE__*/ n(/* @__PURE__ */ h({
	__name: "WebhooksPage",
	props: { client: {} },
	setup(n) {
		let h = n, O = oe("apiBase", ""), je = c(() => typeof O == "string" ? O : O?.value ?? ""), k = new ae(h.client ?? new ne({
			baseUrl: je.value,
			tokenStore: new e()
		})), A = r();
		function Me(e) {
		...
		async function P() {
			...
			try {
				...
				N.value = t(e, "Failed to load webhooks."), A.error(N.value);
			} finally {
				M.value = !1;
			}
		}
		...
		async function q() {
			...
			try {
				...
				U.value = t(e, "Failed to save webhook.");
			} finally {
				H.value = !1;
			}
		}
		...
		async function Fe() {
			...
			if (e) try {
				...
				A.error(t(e, "Failed to delete webhook.")), J.value = null;
			}
		}
		...
		return ce(P), (e, t) => (g(), d("section", fe, [
			f("header", pe, [t[9] ||= f("h1", {
				id: "webhooks-heading",
				...
				default: x(() => [...t[8] ||= [p("Add webhook", -1)]]),
				_: 1
			})]),
			M.value ? (g(), d("div", me, [m(te, {
				variant: "text",
				lines: 6
			})])) : N.value ? (g(), l(i, {
				key: 1,
				...
				actions: x(() => [m(a, {
					...
					default: x(() => [...t[10] ||= [p("Retry", -1)]]),
					_: 1
				})]),
				_: 1
			}, 8, ["description"])) : j.value.length === 0 ? (g(), l(i, {
				key: 2,
				icon: "settings",
				...
				actions: x(() => [m(a, {
					...
					default: x(() => [...t[11] ||= [p("Add webhook", -1)]]),
					_: 1
				})]),
				_: 1
			})) : (g(), d("table", he, [t[15] ||= f("thead", null, [f("tr", null, [
				f("th", { scope: "col" }, "Name"),
				f("th", { scope: "col" }, "URL"),
			...
			m(o, {
				...
				default: x(() => [f("form", {
					...
					f("label", ve, [t[16] ||= f("span", { class: "admin-webhooks__label" }, "Name", -1), S(f("input", {
					...
					f("label", ye, [t[17] ||= f("span", { class: "admin-webhooks__label" }, "URL", -1), S(f("input", {
					...
					f("div", be, [
						f("span", xe, [t[18] ||= p(" Secret", -1), I.value ? u("", !0) : (g(), d("span", Se, " *"))]),
					...
					f("fieldset", Ee, [t[19] ||= f("legend", { class: "admin-webhooks__label" }, [p("Events"), f("span", { "aria-hidden": "true" }, " *")], -1), (g(!0), d(s, null, v(le(ie), (e) => (g(), d("div", {
						key: e.label,
			...
			m(o, {
				...
				footer: x(() => [m(a, {
					...
					default: x(() => [...t[24] ||= [p("Delete", -1)]]),
					_: 1
				})]),
				default: x(() => [f("p", null, [
					t[21] ||= p(" Delete webhook ", -1),
					f("strong", null, y(J.value?.name), 1),
					t[22] ||= p("? This cannot be undone. ", -1)
				])]),
				_: 1
			}, 8, ["model-value"]),
			m(o, {
				...
				}, [f("span", Oe, [m(ee, { name: X.value.success ? "success" : "error" }, null, 8, ["name"])]), f("div", null, [f("p", ke, y(X.value.success ? "Delivery succeeded" : "Delivery failed"), 1), f("p", Ae, y(X.value.message), 1)])], 2)) : u("", !0)]),
				_: 1
			}, 8, ["modelValue", "title"])
		]));
	}
...
//# sourceMappingURL=WebhooksPage-vcG_n1Lw.js.map