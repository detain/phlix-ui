...
var w = {
	...
	setup(n) {
		let _ = n, R = v("apiBase", ""), z = u(() => typeof R == "string" ? R : R?.value ?? ""), B = new c(_.client ?? new e({
			baseUrl: z.value,
			tokenStore: new t()
		})), V = i(), H = x(null), U = x(!0), W = x(!1), G = u(() => H.value?.configured === !1);
		async function K() {
			try {
		...
		return y(() => {
			...
			m("section", T, [m("div", E, [t[0] ||= m("h2", {
				...
				m("div", j, [H.value.connected ? (b(), d(a, {
					key: 1,
					variant: "outline",
					loading: W.value,
					onClick: J
			...
			])) : f("", !0), m("div", L, [Y.value.connected ? (b(), d(a, {
				key: 1,
				variant: "outline",
				loading: Z.value,
				onClick: ee
...
//# sourceMappingURL=ServicesPage-S46ctPv4.js.map