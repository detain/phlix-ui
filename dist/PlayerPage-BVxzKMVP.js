...
import { n as T, o as E, r as D, t as O } from "./episode-order-C2yqgMeX.js";
...
import { n as he, t as ge } from "./SyncPlayModal-DbHYqwvS.js";
...
var De = [
	...
	"aria-valuetext",
	"aria-label"
], Oe = { class: "scrubber__track" }, ke = ["title"], Ae = { class: "scrubber__time numeric" }, je = /*#__PURE__*/ e(/* @__PURE__ */ B({
	__name: "Scrubber",
	props: {
		position: {},
		duration: {},
	...
	setup(e, { expose: t, emit: n }) {
		...
		return t({
			...
			"aria-valuetext": J(Ee)(e.position),
			...
			(U(!0), I(M, null, G(ee.value, (e, t) => (U(), I("span", {
				key: t,
		...
		}, null, 4)) : F("", !0), L("span", Ae, K(J(Ee)(_.value)), 1)], 4)) : F("", !0)], 40, De));
	}
...
function We(e) {
	let t = W("idle"), n = W(0), r = W([]), i = W([]), a = W(-1), o = W(!0), s = W(null), c = W(null), u = W([]), d = W(-1);
	function p(e) {
		if (!w) return;
	...
	let b = e.attach ?? _, ee = e.pollIntervalMs ?? 1e3, x = e.maxWaitMs ?? 12e4, S = e.sleep ?? ((e) => new Promise((t) => setTimeout(t, e))), C = Math.max(1, Math.ceil(x / Math.max(1, ee))), te = Ge(), ne = e.getToken ?? (() => Ke(te)), w = null, T = null, E = null, D = !1, O = null;
	function re() {
	...
	async function ie(i, a, o, s) {
		k(), D = !1, O = new AbortController(), t.value = "preparing", n.value = 0, r.value = [], m();
		try {
			let r = re(), c = ze(await r.post(Le(a, o), void 0, O.signal));
			if (D) return;
			...
			for (let e = 0; !u && e < C; e++) {
				let e = Be(await r.get(Re(c.jobId), void 0, O.signal));
				if (D) return;
			...
			T = w.onLevelSwitched((e) => p(e)), E = w.onAudioTrackSwitched((e) => h(e)), p(), h();
			try {
				let e = f();
				e.hlsMasterUrl = l;
			} catch {}
	...
	function ce() {
		k(), t.value = "idle", n.value = 0, r.value = [], m(), g();
	}
	return {
		state: t,
		progress: n,
...
var Xe = ["aria-label"], Ze = { class: "shortcuts__head" }, Qe = { class: "shortcuts__title" }, $e = { class: "shortcuts__grid" }, et = { class: "shortcuts__keys" }, tt = {
...
}, rt = { class: "shortcuts__label" }, it = /*#__PURE__*/ e(/* @__PURE__ */ B({
	...
	setup(e, { emit: r }) {
		...
		return i(l, q(a, "open"), {
			...
			tabindex: "-1"
		}, [L("div", Ze, [L("h3", Qe, K(J(c)("player.keyboard")), 1), z(n, {
			name: "x",
			label: J(c)("common.close"),
			size: "sm",
			onClick: i[0] ||= (e) => s("close")
		}, null, 8, ["label"])]), L("ul", $e, [(U(!0), I(M, null, G(e.shortcuts, (e) => (U(), I("li", {
			key: e.id,
			class: "shortcuts__row"
		}, [L("span", et, [(U(!0), I(M, null, G(e.keys, (e, n) => (U(), I(M, { key: n }, [e === "–" ? (U(), I("span", tt, "–")) : (U(), I("kbd", nt, [J(y)[e] ? (U(), P(t, {
			key: 0,
			name: J(y)[e],
			label: J(g)[e] ?? e
		}, null, 8, ["name", "label"])) : (U(), I(M, { key: 1 }, [R(K(e), 1)], 64))]))], 64))), 128))]), L("span", rt, K(e.label), 1)]))), 128))])], 8, Xe)])) : F("", !0);
	}
}), [["__scopeId", "data-v-e41dfaaa"]]), at = { class: "volume" }, ot = /*#__PURE__*/ e(/* @__PURE__ */ B({
...
}), [["__scopeId", "data-v-e76a3b82"]]), st = /*#__PURE__*/ e(/* @__PURE__ */ B({
	__name: "SpeedMenu",
	setup(e) {
		let t = [
			.25,
...
var ht = /*#__PURE__*/ e(/* @__PURE__ */ B({
	...
	setup(e, { emit: t }) {
		let n = e, r = t, i = f(), s = a(), { t: c } = o(), l = N(() => dt(n.levels)), u = N(() => {
			...
			...h.value ? [h.value] : [],
			...d.value
		]), y = N(() => n.autoEnabled ? ct : h.value && n.currentLevel === m.value && (i.quality === "original" || s.defaultQuality === "original") ? lt : mt(n.levels, n.currentLevel));
		function b(e) {
			let t = String(e);
			if (t === "auto") {
...
}), [["__scopeId", "data-v-719cf103"]]), gt = /*#__PURE__*/ e(/* @__PURE__ */ B({
	...
	setup(e, { emit: r }) {
		...
		return Y(() => s.open, (e) => {
			typeof document > "u" || (e ? document.addEventListener("pointerdown", re, !0) : document.removeEventListener("pointerdown", re, !0));
		}, { immediate: !0 }), be(() => {
			typeof document < "u" && document.removeEventListener("pointerdown", re, !0);
		}), (r, i) => (U(), I("div", {
			ref_key: "rootEl",
			ref: p,
			class: "capmenu"
			...
			L("div", Pt, [
				L("div", Ft, [L("span", It, K(J(d)("player.size")), 1), z(C, {
				...
				L("div", Lt, [L("span", Rt, K(J(d)("player.color")), 1), z(C, {
				...
				L("div", zt, [L("span", Bt, K(J(d)("player.background")), 1), z(C, {
				...
				L("div", Vt, [L("span", Ht, K(J(d)("player.edge")), 1), z(C, {
...
var Xt = /*#__PURE__*/ e(/* @__PURE__ */ B({
	...
	setup(e, { expose: t }) {
		...
		return t({ sampleNow: m }), (e, t) => (U(), I("div", {
			...
			style: H(o.value ? te.value : void 0),
			"aria-hidden": "true"
		}, null, 6));
	}
...
var _n = ["aria-label"], vn = ["src"], yn = { class: "upnext__body" }, bn = { class: "upnext__eyebrow" }, xn = { class: "upnext__title" }, Sn = {
	...
	setup(e, { emit: t }) {
		...
		return (e, t) => s.value.length > 0 ? (U(), I("div", {
			...
			title: `${e.label} — ${J(Ee)(e.startSec)}`,
			"aria-label": `${e.label} at ${J(Ee)(e.startSec)}`,
			onClick: X((t) => d(e), ["stop"])
		}, [L("span", cr, [
			L("span", lr, K(e.label), 1),
			L("span", ur, K(J(Ee)(e.startSec)), 1),
			L("button", {
				type: "button",
	...
	setup(e, { emit: n }) {
		...
		let S = [
			...
			1.75,
			2
		], C = W(null), te = W(null), ne = W(!0), w = W(!1), T = W(!1), E = W(!1), D = W(!1), O = W(!1), re = W(!1), ie = W(null), ae = W(!1), se = N(() => D.value ? 1.35 : 1), k = W(an(i.streamUrl, i.media.path));
		async function ce() {
			if (k.value) return;
		...
		}), pe = Ye({ apiBase: () => i.apiBase ?? "" }), j = null;
		function _e(e) {
		...
		Y(() => A.levels.value, (e) => {
			...
			if (!t || t === "auto") return;
			let n = t === "original" ? pt(e, A.variants.value?.find((e) => e.id === "original") ?? null) : ft(e, t);
			n >= 0 && A.setNextLevel(n);
		});
		let ke = W(c.resumePositionFor(i.media.id) ?? 0), Ae = W(!k.value && ke.value > 0), Me = null, Z = W(!1), Ne = W(8), Pe, Fe = W(null), Ie = W(0), Le = W(!1), Re = W([]), ze = W(!1), Be = W(null);
		function Ve(e, t) {
		...
		let Xe = N(() => c.upNext);
		function Ze() {
			k.value = an(i.streamUrl, i.media.path), ce(), ke.value = c.resumePositionFor(i.media.id) ?? 0, Ae.value = !k.value && ke.value > 0, Me = null, zt = !1, Dt = !1, Ot = !1, bt.value = -1, Pt = null, Oe = !1, tt(), Z.value = !1, A.reset(), C.value && (C.value.currentTime = 0), k.value && Te(), _e(i.media.id);
		}
		function Qe(e) {
			let t = C.value;
		...
		let Q = W([]), ut = W([]), dt = W(-1), mt = W(!1), _t = N(() => A.state.value === "ready" && A.audioTracks.value.length > 0), vt = N(() => A.audioTracks.value.map((e) => ({
			index: e.index,
			...
			label: e.label,
			kind: "audio"
		}))), bt = W(-1), xt = N(() => !_t.value && !k.value && ut.value.length === 0 && yt.value.length > 1), St = N(() => _t.value ? vt.value : xt.value ? yt.value : ut.value), Ct = N(() => {
		...
		let jt = N(() => Q.value.some((e) => e.language === c.subtitleLang));
		function Mt() {
			let e = C.value;
			Q.value = me(e), ut.value = ue(e), dt.value = oe(e), kt(), At();
		}
		function Nt() {
		...
		function Ft(e) {
			if (_t.value) A.setAudioTrack(e);
				...
				bt.value = e, Pt = e, k.value = !0, Te(C.value?.currentTime ?? 0);
			} else fe(C.value, e), dt.value = e;
		}
		Y(_t, (e) => {
			if (!e || Pt === null) return;
			let t = Pt;
		...
		function Bt() {
			if (!i.autoplay || zt || Ae.value || q.value) return;
			let e = C.value;
		...
		}, { enabled: () => !E.value && !mt.value && !wt.value });
		function _n() {
			c.toggleMute();
		}
		function vn() {
			D.value = !D.value, s("theater", D.value);
		}
		Y(() => c.muted, (e) => {
			let t = C.value;
		...
		function Tn() {
			wn(), !(!c.playing || T.value) && (Lt = setTimeout(() => {
				c.playing && !T.value && (ne.value = !1);
			}, i.idleTimeout ?? 3e3));
		}
		function En() {
			ne.value = !0, Tn();
		...
		return xe(() => {
			...
			}), _.hydrate(i.media), typeof document < "u" && (document.addEventListener("fullscreenchange", bn), re.value = document.pictureInPictureEnabled === !0), On = c.bindMediaSession({
				onPlay: () => void C.value?.play()?.catch(() => {}),
				onPause: () => C.value?.pause(),
				onSeek: (e) => $(e)
			}), It = C.value?.textTracks ?? null, It?.addEventListener?.("addtrack", Mt), It?.addEventListener?.("removetrack", Mt), Mt(), k.value && Te(), _e(i.media.id);
		}), Y(() => i.media, (e) => {
			c.setCurrent(e, {
				resetPosition: !1,
				streamUrl: i.streamUrl
			...
			wn(), tt(), A.cleanup(), typeof document < "u" && document.removeEventListener("fullscreenchange", bn), On?.(), It?.removeEventListener?.("addtrack", Mt), It?.removeEventListener?.("removetrack", Mt), mn !== null && (clearInterval(mn), mn = null), j !== null && (clearTimeout(j), j = null);
		}), (n, i) => (U(), I("div", {
			...
			q.value ? F("", !0) : (U(), I("div", {
				...
				L("div", Qr, [
					...
					L("span", ni, [
						R(K(J(Ee)(J(c).position)), 1),
						i[13] ||= L("span", { class: "player__sep" }, " / ", -1),
						R(K(J(Ee)(J(c).duration)), 1)
					]),
					...
					L("button", {
						...
						"aria-haspopup": "dialog",
						onClick: i[4] ||= (e) => E.value = !0
					}, [z(t, { name: "info" })], 8, ai),
					re.value ? (U(), I("button", {
						key: 2,
						type: "button",
						class: V(["player__iconbtn", { "is-on": O.value }]),
						"aria-label": O.value ? J(d)("player.exitPip") : J(d)("player.pip"),
					...
					L("button", {
						...
						"aria-label": D.value ? J(d)("player.exitTheater") : J(d)("player.theater"),
					...
					L("button", {
						type: "button",
						class: "player__iconbtn",
						"aria-label": w.value ? J(d)("player.exitFullscreen") : J(d)("player.fullscreen"),
						onClick: yn
					}, [z(t, { name: w.value ? "fullscreen-exit" : "fullscreen" }, null, 8, ["name"])], 8, ci)
				])
			])),
			q.value ? F("", !0) : (U(), P(zn, {
				key: 2,
			...
			Ae.value && !q.value ? (U(), P(tn, {
				key: 4,
				seconds: ke.value,
				onResume: $e,
				onRestart: et
			}, null, 8, ["seconds"])) : F("", !0),
			Z.value && Xe.value && !q.value ? (U(), P(Dn, {
				key: 5,
				media: Xe.value,
				remaining: Ne.value,
				total: J(8),
			...
			z(r, {
				...
				default: Se(() => [L("div", li, [ze.value ? (U(), I("div", ui, [z(b, { label: "Finding similar media" })])) : Be.value ? (U(), I("div", di, [z(t, {
					name: "error",
					class: "similar-modal__state-icon"
				}), L("p", fi, K(Be.value), 1)])) : !ze.value && Re.value.length === 0 ? (U(), I("div", pi, [
					z(t, {
						name: "search",
						class: "similar-modal__state-icon"
					}),
				...
				])) : (U(), I("ul", mi, [(U(!0), I(M, null, G(Re.value, (e) => (U(), I("li", {
					key: e.id,
	...
	__name: "PlayerPage",
	setup(e) {
		let t = /* @__PURE__ */ new Map(), n = u(), i = d(), a = we(), o = Te(), s = f(), m = p(), h = W(null), g = W(""), _ = W([]), v = W(null), y = W(null), b = W([]), S = W([]), C = W(!0), oe = W(null), se = W(!1), k = W(null), ce = W(!1), le = W(null), ue = W(null), de = N(() => String(a.params.id ?? ""));
		ee(() => h.value?.name);
		let fe = N(() => {
		...
		async function G() {
			let e = de.value;
			if (A?.abort(), A = typeof AbortController < "u" ? new AbortController() : null, C.value = !0, oe.value = null, _.value = [], v.value = null, y.value = null, b.value = [], S.value = [], le.value = null, ue.value = null, s.hideMiniPlayer(), !e) {
				oe.value = "No media id provided", C.value = !1;
				return;
			}
			...
			t.get(`/api/v1/media/${encodeURIComponent(e)}/playback-info`, void 0, A?.signal).then((e) => {
				...
				})), v.value = he(e?.intro_marker), y.value = he(e?.outro_marker), b.value = cn(e?.audio_tracks), S.value = Fe(e?.subtitle_tracks));
			}).catch(() => null);
			...
			try {
				...
				if (e instanceof c && (e.status === 403 || e.status === 429)) {
					...
					if (t === "AccessSchedule" || t === "StreamLimitExceeded") {
						k.value = t === "AccessSchedule" ? "Playback blocked by access schedule. Try again during allowed hours." : "Stream limit reached. Stop another stream to continue watching.", ce.value = !0, C.value = !1;
						return;
					}
				}
				if (r) {
				...
				oe.value = e instanceof Error ? e.message : "Failed to load media", C.value = !1;
				return;
			}
			if (!pe) {
				if (!a) {
					...
					oe.value = "Failed to load media item", C.value = !1;
					return;
				}
				ae(e, a, i), q(t, a);
			}
		...
		function q(e, t) {
			h.value = t, m.hydrate(t), g.value = me(t), C.value = !1, ge(e, t), ye(e, t);
		}
		xe(G), Y(de, G), Ce(() => {
		...
		return (e, t) => (U(), I("div", { class: V(["player-page", { "is-theater": se.value }]) }, [
			fe.value && !C.value && !oe.value ? (U(), I("div", {
				key: 0,
				class: "player-page__ambient",
				style: H(fe.value),
				"aria-hidden": "true"
			}, null, 4)) : F("", !0),
			L("div", Ci, [C.value ? (U(), I("div", wi, [z(te, {
				variant: "rect",
...
//# sourceMappingURL=PlayerPage-BVxzKMVP.js.map