...
var O = "metadata.tmdb_unconfigured";
function k(e) {
...
var A = class {
	...
	instanceHeaders;
	constructor(e = {}) {
		this.baseUrl = e.baseUrl ?? (typeof window < "u" ? window.location.origin : ""), this.tokens = e.tokenStore ?? x(), this.doFetch = e.fetchImpl ?? globalThis.fetch.bind(globalThis), this.timeoutMs = e.timeoutMs ?? S, this.instanceHeaders = w(e.headers ?? {});
	}
...
}, P = { class: "phlix-btn__label" }, F = /*#__PURE__*/ e(/* @__PURE__ */ c({
	__name: "Button",
	props: {
	...
	setup(e) {
		...
		return (n, c) => (u(), a("button", {
			...
			e.loading ? (u(), a("span", N, [s(t, { name: "spinner" })])) : i("", !0),
			e.leftIcon && !e.loading ? (u(), r(t, {
				key: 1,
				name: e.leftIcon,
				class: "phlix-btn__icon"
			}, null, 8, ["name"])) : i("", !0),
			o("span", P, [d(n.$slots, "default", {}, void 0, !0)]),
			e.rightIcon ? (u(), r(t, {
				key: 2,
				name: e.rightIcon,
				class: "phlix-btn__icon"
...
//#endregion
export { E as a, T as c, p as d, m as f, j as i, b as l, g as m, A as n, k as o, h as p, O as r, D as s, F as t, f as u };

//# sourceMappingURL=Button-MsRePfWv.js.map