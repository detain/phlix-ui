...
import { t as a } from "./tokenStore-CGMYSpg6.js";
import { t as o } from "./Badge-D9Tdn6WP.js";
import { t as ee } from "./Modal-DLVWGUN9.js";
...
var T = {
	...
	role: "note"
}, L = /*#__PURE__*/ t(/* @__PURE__ */ v({
	__name: "HistoryPage",
	props: { client: {} },
	emits: ["continue"],
	setup(t, { emit: v }) {
		let L = t, R = v, z = y("apiBase", ""), B = d(() => typeof z == "string" ? z : z?.value ?? ""), V = new l(L.client ?? new n({
			baseUrl: B.value,
			tokenStore: new a()
		})), H = te(), U = S([]), W = S(!0), G = S(null), K = S(!1), q = S(!1);
		async function J() {
			W.value = !0, G.value = null;
			try {
				U.value = await V.getRecentlyWatched();
			} catch (t) {
				G.value = e(t, "Failed to load watch history."), H.error(G.value);
			} finally {
				W.value = !1;
			}
		}
		async function ce(t) {
			try {
				await V.removeFromHistory(t), H.success("Removed from watch history."), await J();
			} catch (t) {
				H.error(e(t, "Failed to remove item."));
			}
		}
		async function le() {
			q.value = !0;
			try {
				...
				H.error(e(t, "Failed to clear history."));
			} finally {
				q.value = !1;
			}
		}
		...
		return ne(J), (e, t) => (x(), m("section", T, [
			h("header", E, [t[5] ||= h("h1", {
				id: "history-heading",
				class: "admin-history__title"
			}, "Watch History", -1), $.value ? (x(), f(r, {
				key: 0,
				variant: "outline",
				size: "sm",
				"left-icon": "x",
			...
			W.value ? (x(), m("div", D, [_(s, {
				...
				}, null, 8, ie)) : (x(), m("span", ae, [_(i, { name: "film" })]))]),
				h("div", oe, [
					h("div", se, [h("span", A, C(Y(e)), 1), _(o, { tone: "neutral" }, {
				...
				h("div", F, [Z(e) ? (x(), f(r, {
					...
					default: w(() => [...t[7] ||= [g(" Continue ", -1)]]),
					_: 1
				}, 8, ["aria-label", "onClick"])) : p("", !0), _(r, {
					variant: "ghost",
					size: "sm",
					"left-icon": "x",
			...
			_(ee, {
				...
				footer: w(() => [_(r, {
					...
					default: w(() => [...t[10] ||= [g(" Clear All ", -1)]]),
					_: 1
				}, 8, ["loading"])]),
				default: w(() => [t[11] ||= h("p", null, "Clear all items from your watch history? This cannot be undone.", -1)]),
				_: 1
			}, 8, ["modelValue"])
		]));
	}
...
//# sourceMappingURL=HistoryPage-B1AVNz4b.js.map