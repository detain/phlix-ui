...
function n(n, r) {
	let i = typeof n.media_status == "object" && n.media_status !== null ? n.media_status : {}, a = e(n.transport_state ?? n.state) || (n.active === !0 ? "PLAYING" : "STOPPED");
	return {
		device_id: e(n.device_id) || r,
		media_title: e(n.media_title ?? i.media_title ?? i.title),
		media_item_id: typeof n.media_item_id == "string" ? n.media_item_id : null,
		transport_state: a,
		volume_level: t(n.volume_level ?? i.volume_level),
		muted: n.muted === !0,
		position_seconds: t(n.position_seconds ?? i.position_seconds ?? i.current_time),
		duration_seconds: t(n.duration_seconds ?? i.duration_seconds ?? i.duration)
	};
}
function r(n, r) {
	return {
		...
		media_item_id: typeof n.media_item_id == "string" ? n.media_item_id : null,
		transport_state: e(n.transport_state ?? n.state) || (n.active === !0 ? "PLAYING" : "STOPPED"),
		volume_level: t(n.volume_level),
		muted: n.muted === !0
	};
}
var i = class {
	...
	async getCastStatus(e) {
		return n(await this.client.get(`/api/v1/cast/devices/${encodeURIComponent(e)}/status`), e);
	}
	async castPlay(e) {
		return {
			success: !0,
	...
	async getAirPlayStatus(e) {
		return r(await this.client.get(`/api/v1/airplay/devices/${encodeURIComponent(e)}/status`), e);
	}
	async airPlayPlay(e) {
		return {
			success: !0,
...
//# sourceMappingURL=cast-BvFcBEB6.js.map