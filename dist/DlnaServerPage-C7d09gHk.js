import { a as e, h as t, i as n, n as r, o as i, r as a, t as o } from "./Button-C86XulWV.js";
...
}, k = { class: "admin-dlna__actions" }, A = /*#__PURE__*/ t(/* @__PURE__ */ _({
	__name: "DlnaServerPage",
	props: { client: {} },
	setup(t) {
		let _ = t, A = v("apiBase", ""), j = u(() => typeof A == "string" ? A : A?.value ?? ""), M = new c(_.client ?? new i({
			baseUrl: j.value,
			tokenStore: new e()
		})), N = n(), P = x(null), F = x(!0), I = x(!1), L = u(() => P.value?.running ?? !1), R = u(() => P.value?.enabled ?? !1);
		async function z() {
			F.value = !0;
			try {
...
//# sourceMappingURL=DlnaServerPage-C7d09gHk.js.map