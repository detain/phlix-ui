...
var O = {
	...
	props: { client: {} },
	setup(e) {
		let _ = e, P = v("apiBase", ""), oe = u(() => typeof P == "string" ? P : P?.value ?? ""), F = new l(_.client ?? new t({
			baseUrl: oe.value,
			tokenStore: new i()
		...
		return y(B), (e, t) => (b(), p("section", O, [
			...
			}, "SyncPlay"), m("p", { class: "admin-syncplay__subtitle" }, " Watch together with synchronized playback for multiple viewers. ")], -1), g(n, {
				variant: "solid",
				size: "sm",
				"left-icon": "plus",
				onClick: G
...
//# sourceMappingURL=SyncPlayPage-CqkvqDhz.js.map