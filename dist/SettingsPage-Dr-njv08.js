...
import { n as t, s as n, t as r, u as i } from "./Button-9cUUJmnN.js";
...
import { t as ae } from "./EmptyState-B2QnGIQT.js";
...
var de = {
	...
	props: { client: {} },
	setup(e) {
		let h = e, C = se("apiBase", ""), w = c(() => typeof C == "string" ? C : C?.value ?? ""), T = new oe(h.client ?? new t({
			baseUrl: w.value,
			tokenStore: new ee()
		})), E = re(), D = [
			{
		...
		async function Y() {
			...
			try {
				...
				z.value = i(e, "Failed to load settings."), E.error(z.value);
			} finally {
				R.value = !1;
			}
		}
