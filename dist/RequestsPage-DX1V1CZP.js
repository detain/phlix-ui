...
import { i as t, p as n } from "./client-BoVYipAG.js";
...
import { t as c } from "./PageHint-CJN_ODn2.js";
...
var E = {
	...
	props: { client: {} },
	setup(e) {
		let _ = e.client ?? t, H = r(), U = x([]), W = x(!0), G = x(null), K = x("pending"), q = x(/* @__PURE__ */ new Set());
		function J(e) {
			return {
				id: String(e.id ?? ""),
		...
		async function Y(e) {
			...
			try {
				...
				G.value = n(e, "Failed to load requests."), H.error(G.value);
			} finally {
				W.value = !1;
			}
		}
		async function X(e) {
			if (!q.value.has(e)) {
				...
				try {
					...
					H.error(n(e, "Failed to approve request."));
				} finally {
		...
		async function Z(e, t = "") {
			if (!q.value.has(e)) {
				q.value = /* @__PURE__ */ new Set([...q.value, e]);
				try {
					let n = t.trim() === "" ? {} : { reason: t };
					await _.post(`/api/v1/admin/requests/${e}/deny`, n), H.success("Request denied."), await Y(K.value);
				} catch (e) {
					H.error(n(e, "Failed to deny request."));
				} finally {
					q.value = new Set([...q.value].filter((t) => t !== e));
				}
			}
...
//# sourceMappingURL=RequestsPage-DX1V1CZP.js.map