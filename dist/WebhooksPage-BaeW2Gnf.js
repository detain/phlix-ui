import { a as e, f as t, h as n, i as r, m as ee, n as te, o as i, r as ne, t as a } from "./Button-C86XulWV.js";
import { t as o } from "./Modal-DaapuyD8.js";
import { t as re } from "./Badge-BiYXL5Nz.js";
import { r as ie, t as ae } from "./webhooks-BBTLnFKm.js";
import { Fragment as s, computed as c, createBlock as oe, createCommentVNode as l, createElementBlock as u, createElementVNode as d, createTextVNode as f, createVNode as p, defineComponent as m, inject as se, normalizeClass as ce, onMounted as le, openBlock as h, ref as g, renderList as _, toDisplayString as v, unref as ue, vModelDynamic as de, vModelText as y, withCtx as b, withDirectives as x, withModifiers as fe } from "vue";
...
var pe = {
...
}, S = { class: "admin-webhooks__secret-row" }, C = ["type", "placeholder"], w = { class: "admin-webhooks__events" }, T = { class: "admin-webhooks__events-category-label" }, E = ["checked", "onChange"], D = { class: "admin-webhooks__checkbox-label" }, O = { class: "admin-webhooks__event-id" }, k = {
	key: 0,
	...
	"aria-hidden": "true"
}, De = { class: "admin-webhooks__test-status" }, Oe = { class: "admin-webhooks__test-message" }, A = /*#__PURE__*/ n(/* @__PURE__ */ m({
	__name: "WebhooksPage",
	props: { client: {} },
	setup(n) {
		let m = n, A = se("apiBase", ""), ke = c(() => typeof A == "string" ? A : A?.value ?? ""), j = new ae(m.client ?? new i({
			baseUrl: ke.value,
			tokenStore: new e()
		})), M = r();
		function Ae(e) {
		...
		async function F() {
			P.value = !0;
			try {
				N.value = await j.list();
			} catch (e) {
				M.error(t(e, "Failed to load webhooks."));
			} finally {
				P.value = !1;
			}
		}
		...
		async function q() {
			...
			try {
				...
				if (e) {
					...
					B.value.trim() && (t.secret = B.value), await j.update(e.id, t), M.success("Webhook updated.");
				} else await j.create({
					name: R.value.trim(),
					url: z.value.trim(),
					secret: B.value,
				...
				W.value = t(e, "Failed to save webhook.");
			} finally {
				U.value = !1;
			}
		}
		...
		async function Pe() {
			let e = J.value;
			if (e) try {
				await j.remove(e.id), M.success("Webhook deleted."), J.value = null, await F();
			} catch (e) {
				M.error(t(e, "Failed to delete webhook.")), J.value = null;
			}
		}
		...
		async function Ie(e) {
			...
			try {
				let t = await j.test(e.id), n = t.success_count + t.failure_count, r = t.failure_count === 0 ? `Delivered successfully (${t.success_count}/${t.success_count} webhooks)` : `Delivery failed — ${t.failure_count} of ${n} webhook(s) failed`;
				X.value = {
					success: t.success,
					message: r
				};
				...
				X.value = {
					success: !1,
					message: t(e, "Failed to test webhook.")
				};
			} finally {
				Z.value = !1;
			}
		...
		return le(F), (e, t) => (h(), u("section", pe, [
			...
			P.value ? (h(), u("div", he, [p(te, {
				...
				actions: b(() => [p(a, {
					...
					default: b(() => [...t[10] ||= [f("Add webhook", -1)]]),
					_: 1
				})]),
				_: 1
			})) : (h(), u("table", ge, [t[14] ||= d("thead", null, [d("tr", null, [
				d("th", { scope: "col" }, "Name"),
				d("th", { scope: "col" }, "URL"),
			...
			p(o, {
				...
				default: b(() => [d("form", {
					...
					d("label", ye, [t[15] ||= d("span", { class: "admin-webhooks__label" }, "Name", -1), x(d("input", {
					...
					d("label", be, [t[16] ||= d("span", { class: "admin-webhooks__label" }, "URL", -1), x(d("input", {
					...
					d("div", xe, [
						d("span", Se, [t[17] ||= f(" Secret", -1), L.value ? l("", !0) : (h(), u("span", Ce, " *"))]),
						L.value ? (h(), u("p", we, "Leave blank to keep the current secret.")) : l("", !0),
						d("div", S, [x(d("input", {
					...
					d("fieldset", w, [t[18] ||= d("legend", { class: "admin-webhooks__label" }, [f("Events"), d("span", { "aria-hidden": "true" }, " *")], -1), (h(!0), u(s, null, _(ue(ie), (e) => (h(), u("div", {
						key: e.label,
						class: "admin-webhooks__events-category"
					}, [d("span", T, v(e.label), 1), (h(!0), u(s, null, _(e.events, (e) => (h(), u("label", {
						key: e.id,
						...
						d("span", D, v(e.label), 1),
						d("span", O, v(e.id), 1)
					]))), 128))]))), 128))]),
					W.value ? (h(), u("p", k, v(W.value), 1)) : l("", !0)
				], 32)]),
				_: 1
			}, 8, ["modelValue", "title"]),
			p(o, {
				...
				footer: b(() => [p(a, {
					...
					default: b(() => [...t[23] ||= [f("Delete", -1)]]),
					_: 1
				})]),
				default: b(() => [d("p", null, [
					t[20] ||= f(" Delete webhook ", -1),
					d("strong", null, v(J.value?.name), 1),
					t[21] ||= f("? This cannot be undone. ", -1)
				])]),
				_: 1
			}, 8, ["model-value"]),
			p(o, {
				...
				footer: b(() => [p(a, {
					...
					default: b(() => [...t[24] ||= [f("Close", -1)]]),
					_: 1
				}, 8, ["disabled"])]),
				default: b(() => [Z.value ? (h(), u("p", Te, "Sending test payload…")) : X.value ? (h(), u("div", {
					key: 1,
					class: ce(["admin-webhooks__test-result", X.value.success ? "admin-webhooks__test-result--ok" : "admin-webhooks__test-result--fail"])
				}, [d("span", Ee, [p(ee, { name: X.value.success ? "success" : "error" }, null, 8, ["name"])]), d("div", null, [d("p", De, v(X.value.success ? "Delivery succeeded" : "Delivery failed"), 1), d("p", Oe, v(X.value.message), 1)])], 2)) : l("", !0)]),
				_: 1
			}, 8, ["modelValue", "title"])
		]));
	}
}), [["__scopeId", "data-v-b06322e1"]]);
//#endregion
export { A as default };

//# sourceMappingURL=WebhooksPage-BaeW2Gnf.js.map