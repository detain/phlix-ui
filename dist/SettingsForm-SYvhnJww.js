import { d as e, i as t, t as n, u as r } from "./Button-C4PyCjLX.js";
import { t as i } from "./useAuthStore-D139Ow7E.js";
import { t as a } from "./Switch-R1pbcsd-.js";
import { r as o } from "./Select-CmN-4YbZ.js";
...
var O = { class: "phlix-tabs" }, k = ["aria-label"], A = [
	...
	setup(e, { emit: t }) {
		let n = e, i = t, a = E(), s = S(null), c = d(() => n.tabs.findIndex((e) => e.value === n.modelValue)), l = (e) => `${a}-tab-${e}`, _ = (e) => `${a}-panel-${e}`, v = d(() => n.tabs.map((e) => ({
			value: e.value,
			label: e.label,
			disabled: e.disabled
		})));
		...
		function M(e) {
			...
			t >= 0 && (e.preventDefault(), b(n.tabs[t].value), D(t));
		}
		return (t, n) => (x(), m("div", O, [h("div", {
			ref_key: "listEl",
			ref: s,
			...
			"aria-label": e.label,
			onKeydown: M
		}, [(x(!0), m(u, null, C(e.tabs, (t) => (x(), m("button", {
			id: l(t.value),
			key: t.value,
			type: "button",
			role: "tab",
			class: y(["phlix-tabs__tab", { "is-active": t.value === e.modelValue }]),
			"aria-selected": t.value === e.modelValue,
			"aria-controls": _(t.value),
		...
		}, null, 8, ["name"])) : p("", !0), g(" " + T(t.label), 1)], 10, A))), 128))], 40, k), e.modelValue ? (x(), m("div", {
			key: 0,
			id: _(e.modelValue),
			...
			tabindex: "0"
		}, [w(t.$slots, e.modelValue, {}, () => [w(t.$slots, "default", {}, void 0, !0)], !0)], 8, j)) : p("", !0)]));
	}
}), [["__scopeId", "data-v-95493097"]]), N = { class: "setform" }, P = {
	key: 0,
	...
	emits: ["saved"],
	setup(e, { emit: r }) {
		let o = e, v = r, w = i(), E = s(), O = S({}), k = S({}), A = S(!0), j = S(null), M = S(null), V = [
			"transcoding",
			"metadata",
			"markers",
			"subtitles",
...
//# sourceMappingURL=SettingsForm-SYvhnJww.js.map