...
import { t as c } from "./Badge-DypgiWDB.js";
...
var se = {
...
}, xe = { class: "admin-libraries__date" }, Se = { class: "admin-libraries__date" }, Ce = 2e3, T = /*#__PURE__*/ a(/* @__PURE__ */ v({
	...
	setup(a) {
		let v = a, T = ne("apiBase", ""), we = d(() => typeof T == "string" ? T : T?.value ?? ""), E = new te(v.client ?? new e({
			baseUrl: we.value,
			tokenStore: new t()
		})), D = r(), Te = d(() => v.pollIntervalMs ?? Ce);
		function O(e, t) {
		...
		return ie(R), re(() => {
			...
			_(o, {
				...
				default: C(() => [Q.value ? (y(), m("div", ye, [_(n, {
					variant: "text",
					lines: 4
...
//# sourceMappingURL=LibrariesPage-DE6bFfH3.js.map