...
import { t as s } from "./Spinner-C2cM1sTz.js";
import { t as c } from "./Button-AW4z0vv0.js";
import { t as l } from "./EmptyState-CLDEIm6E.js";
import { t as u } from "./MediaGrid-Cqw_-_qY.js";
import { r as d } from "./useResolvePlayable-wCiMWuME.js";
...
var w = { class: "recommendations-page" }, T = /*#__PURE__*/ e(/* @__PURE__ */ _({
	...
	setup(e) {
		...
		async function L() {
			...
			try {
				let e = await new t({ baseUrl: T.value }).get("/api/v1/me/recommendations", { limit: "20" });
				A.value = (e.recommendations ?? []).map(I), P.value = A.value.length, N.value = !1;
			} catch (e) {
...
//# sourceMappingURL=RecommendationsPage-BmNfyd9Y.js.map