...
var w = {
	...
	setup(a) {
		let _ = a, R = v("apiBase", ""), z = u(() => typeof R == "string" ? R : R?.value ?? ""), B = new c(_.client ?? new e({
			baseUrl: z.value,
			tokenStore: new t()
		})), V = r(), H = x(null), U = x(!0), W = x(!1), G = u(() => H.value?.configured === !1);
		async function K() {
			try {
		...
		return y(() => {
			...
			m("section", T, [m("div", E, [t[0] ||= m("h2", {
				...
				_: 1
			}, 8, ["tone", "label"]))]), m("div", D, [U.value ? (b(), p("div", O, [g(n, {
				variant: "text",
				lines: 2
			})])) : H.value === null ? (b(), d(o, {
				key: 1,
				...
				m("div", j, [H.value.connected ? (b(), d(i, {
					key: 1,
					variant: "outline",
					loading: W.value,
					onClick: J
			...
			m("section", M, [m("div", N, [t[4] ||= m("h2", {
				...
				_: 1
			}, 8, ["tone", "label"]))]), m("div", P, [X.value ? (b(), p("div", F, [g(n, {
				variant: "text",
				lines: 2
			})])) : Y.value === null ? (b(), d(o, {
				key: 1,
			...
			])) : f("", !0), m("div", L, [Y.value.connected ? (b(), d(i, {
				key: 1,
				variant: "outline",
				loading: Z.value,
				onClick: ee
...
//# sourceMappingURL=ServicesPage-AsN_xFlL.js.map