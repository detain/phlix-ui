...
}, te = { class: "admin-syncplay__name" }, N = { class: "admin-syncplay__media" }, ne = { class: "admin-syncplay__field" }, re = { class: "admin-syncplay__field" }, ie = { class: "admin-syncplay__field" }, ae = { class: "admin-syncplay__field" }, P = /*#__PURE__*/ n(/* @__PURE__ */ v({
	__name: "SyncPlayPage",
	props: { client: {} },
	setup(n) {
		let v = n, P = y("apiBase", ""), F = d(() => typeof P == "string" ? P : P?.value ?? ""), I = new u(v.client ?? new a({
			baseUrl: F.value,
			tokenStore: new e()
		})), L = r(), R = S([]), z = S(!0);
		async function B() {
		...
		return b(B), (e, t) => (x(), m("section", k, [
			...
			}, "SyncPlay"), h("p", { class: "admin-syncplay__subtitle" }, " Watch together with synchronized playback for multiple viewers. ")], -1), _(s, {
				variant: "solid",
				size: "sm",
				"left-icon": "plus",
				onClick: G
...
//# sourceMappingURL=SyncPlayPage-BJxbWLbM.js.map