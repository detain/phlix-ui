...
var O = {
	...
	props: { client: {} },
	setup(e) {
		let _ = e, P = v("apiBase", ""), oe = u(() => typeof P == "string" ? P : P?.value ?? ""), F = new l(_.client ?? new r({
			baseUrl: oe.value,
			tokenStore: new t()
		})), I = ee(), L = x([]), R = x(!0), z = x(null);
		async function B() {
		...
		return y(B), (e, t) => (b(), p("section", O, [
			...
			}, "SyncPlay"), m("p", { class: "admin-syncplay__subtitle" }, " Watch together with synchronized playback for multiple viewers. ")], -1), g(i, {
				variant: "solid",
				size: "sm",
				"left-icon": "plus",
				onClick: G
			...
			R.value ? (b(), p("div", A, [g(s, {
				...
				m("td", null, [m("span", M, C(e.name), 1), e.has_password ? (b(), d(a, {
					key: 0,
					tone: "warning"
				}, {
				...
				m("td", null, [g(a, { tone: e.is_playing ? "accent" : "neutral" }, {
...
//# sourceMappingURL=SyncPlayPage-BFfqNJuH.js.map