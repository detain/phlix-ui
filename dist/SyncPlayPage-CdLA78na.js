...
}, j = { class: "admin-syncplay__name" }, ne = { class: "admin-syncplay__media" }, M = { class: "admin-syncplay__field" }, re = { class: "admin-syncplay__field" }, ie = { class: "admin-syncplay__field" }, ae = { class: "admin-syncplay__field" }, N = /*#__PURE__*/ n(/* @__PURE__ */ g({
	__name: "SyncPlayPage",
	props: { client: {} },
	setup(n) {
		let g = n, N = _("apiBase", ""), P = te(() => typeof N == "string" ? N : N?.value ?? ""), F = new c(g.client ?? new e({
			baseUrl: P.value,
			tokenStore: new a()
		})), I = t();
		function L(e, t) {
		...
		return v(B), (e, t) => (y(), f("section", D, [
			...
			}, "SyncPlay"), p("p", { class: "admin-syncplay__subtitle" }, " Watch together with synchronized playback for multiple viewers. ")], -1), h(r, {
				variant: "solid",
				size: "sm",
				"left-icon": "plus",
				onClick: G
...
//# sourceMappingURL=SyncPlayPage-CdLA78na.js.map