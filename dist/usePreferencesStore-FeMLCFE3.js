...
var d = r("phlix-prefs", () => {
	let r = c(), l = t(r.theme), d = t(r.accent), f = t(r.density), p = t(r.cardSize), m = t(r.gridDensity), h = t(r.reducedMotion), g = t(r.autoplay), _ = t(r.defaultVolume), v = t(r.defaultQuality), y = t(r.defaultSubtitleLang), b = t(r.subtitlePreferenceSet), x = t({
		...i,
		...r.captionStyle
	}), S = t(r.atmosphere), C = t(r.tv), w = t(r.filterPresets ? [...r.filterPresets] : []), T = t(u()), E = null;
	...
	let D = e(() => h.value === "on" ? !0 : h.value === "off" ? !1 : T.value);
	function O() {
		return {
			theme: l.value,
			accent: d.value,
...
//# sourceMappingURL=usePreferencesStore-FeMLCFE3.js.map