...
var T = {
	...
	emits: ["continue"],
	setup(e, { emit: v }) {
		let L = e, R = v, z = y("apiBase", ""), B = d(() => typeof z == "string" ? z : z?.value ?? ""), V = new l(L.client ?? new n({
			baseUrl: B.value,
			tokenStore: new a()
		...
		async function J() {
			...
			try {
				...
				G.value = i(e, "Failed to load watch history."), H.error(G.value);
			} finally {
				W.value = !1;
			}
		}
		async function ce(e) {
			try {
				...
				H.error(i(e, "Failed to remove item."));
			}
		}
		async function le() {
			q.value = !0;
			try {
				...
				H.error(i(e, "Failed to clear history."));
			} finally {
				q.value = !1;
			}
		}
...
//# sourceMappingURL=HistoryPage-DPT7DJgD.js.map