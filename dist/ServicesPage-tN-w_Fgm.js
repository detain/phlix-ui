...
var T = {
	...
	key: 0,
	class: "admin-services__dl"
}, I = { class: "admin-services__actions" }, L = /*#__PURE__*/ t(/* @__PURE__ */ v({
	__name: "ServicesPage",
	props: { client: {} },
	setup(t) {
		let v = t, L = y("apiBase", ""), R = d(() => typeof L == "string" ? L : L?.value ?? ""), z = new l(v.client ?? new n({
			baseUrl: R.value,
			tokenStore: new i()
		...
		async function K() {
			...
			try {
				...
				U.value = e(t, "Failed to load Trakt status."), B.error(U.value);
			} finally {
				H.value = !1;
			}
		}
		...
		async function J() {
			if (!W.value) {
				...
				try {
					...
					B.error(e(t, "Failed to disconnect Trakt."));
				} finally {
					W.value = !1;
				}
			}
		...
		async function $() {
			...
			try {
				...
				Z.value = e(t, "Failed to load Last.fm status."), B.error(Z.value);
			} finally {
				X.value = !1;
			}
		}
		...
		async function re() {
			if (!Q.value) {
				...
				try {
					...
					B.error(e(t, "Failed to disconnect Last.fm."));
				} finally {
					Q.value = !1;
				}
			}
...
//# sourceMappingURL=ServicesPage-tN-w_Fgm.js.map