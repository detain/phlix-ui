...
import { t } from "./Icon-Bg-g-Bt8.js";
import { t as n } from "./IconButton-BOeFvG8i.js";
...
import { n as p, t as m } from "./ThumbRating-D7P1izO-.js";
import { a as h, n as g, o as _, r as v, s as y, t as b } from "./shortcuts-C7eaVLrT.js";
import { t as x } from "./Spinner-B7pgGbot.js";
import { i as S } from "./usePageTitle-BO3GGF3M.js";
import { t as C } from "./Button-CNxZ08Xj.js";
import { t as w } from "./Badge-BHfjZVBp.js";
import { t as T } from "./Slider-LnnvB5jy.js";
import { t as E } from "./Chip-ysRwRSXF.js";
import { t as D } from "./Select-CeV48FIl.js";
import { t as ee } from "./Modal-Y_WFD5LO.js";
import { t as O } from "./Skeleton-DhQmxeNg.js";
import { t as k } from "./EmptyState-C0gWPlCE.js";
...
import { n as ge, t as _e } from "./SyncPlayModal-CRKdPV8Q.js";
...
var Me = [
	...
	setup(e, { expose: t, emit: n }) {
		let { t: r } = a(), i = e, o = n, s = K(null), c = K(!1), l = K(!1), u = K(0), d = K(0), f = (e) => Math.min(1, Math.max(0, e)), p = I(() => c.value ? u.value : i.duration > 0 ? f(i.position / i.duration) : 0), m = I(() => i.duration > 0 ? f(i.buffered / i.duration) : 0), h = I(() => (c.value || l.value) && i.duration > 0), g = I(() => c.value ? u.value : d.value), _ = I(() => g.value * i.duration), v = I(() => h.value ? i.thumbnailAt?.(_.value) ?? null : null), y = I(() => v.value ? `url("${v.value.replace(/[\\"]/g, "\\$&").replace(/[\r\n]/g, "")}")` : "none"), b = I(() => `${Math.min(96, Math.max(4, g.value * 100))}%`), x = I(() => i.duration > 0 ? i.chapters.filter((e) => e.start > 0 && e.start < i.duration).map((e) => ({
			...e,
...
var tt = ["aria-label"], nt = { class: "shortcuts__head" }, rt = { class: "shortcuts__title" }, it = { class: "shortcuts__grid" }, at = { class: "shortcuts__keys" }, ot = {
	...
	setup(e, { emit: i }) {
		...
		}, [B("span", at, [(G(!0), z(F, null, q(e.keys, (e, n) => (G(), z(F, { key: n }, [e === "–" ? (G(), z("span", ot, "–")) : (G(), z("kbd", st, [Y(b)[e] ? (G(), L(t, {
			key: 0,
			name: Y(b)[e],
			label: Y(g)[e] ?? e
	...
	setup(e) {
		let t = d(), r = i(), { t: o } = a(), s = I(() => t.muted ? 0 : t.volume), c = I(() => t.muted || t.volume <= 0 ? "mute" : t.volume < .5 ? "volume-low" : "volume");
		function l(e) {
...
var Ct = /*#__PURE__*/ e(/* @__PURE__ */ U({
	...
	setup(e, { expose: t, emit: n }) {
		...
		let l = n, u = d(), f = i(), { t: p } = a(), m = I(() => _t(r.levels)), h = I(() => {
			...
			...y.value ? [y.value] : [],
			...g.value
		]), C = I(() => r.autoEnabled ? pt : y.value && r.currentLevel === v.value && (u.quality === "original" || f.defaultQuality === "original") ? mt : St(r.levels, r.currentLevel));
		function w(e) {
			let t = String(e);
			if (t === "auto") {
		...
		return t({ toggleMenu: c }), (e, t) => b.value || o.value ? (G(), L(D, {
			key: 0,
			ref_key: "selectRef",
			ref: s,
			class: "quality-menu",
	...
	setup(e, { emit: o }) {
		let s = e, c = o, l = d(), u = i(), { t: f } = a(), p = K(null), m = K(null), h = I(() => l.subtitleLang), g = I(() => s.tracks.some((e) => e.language === h.value)), _ = I(() => g.value ? "captions" : "captions-off"), v = I(() => g.value ? s.tracks.findIndex((e) => e.language === h.value) + 1 : 0), y = I(() => s.activeAudio >= 0 ? s.activeAudio : 0);
		function b(e) {
			c("update:open", e);
		}
		function x() {
		...
		return X(() => s.open, (e) => {
			...
			B("div", Dt, [B("h3", Ot, J(Y(f)("player.subtitles")), 1), H(n, {
				name: "x",
			...
			B("div", {
				...
				key: 0,
				name: "check"
			}))]), B("span", Mt, J(Y(f)("player.off")), 1)], 8, At), (G(!0), z(F, null, q(e.tracks, (e, n) => (G(), z("button", {
				key: e.language,
				type: "button",
				class: "capmenu__opt",
				role: "radio",
			...
			B("button", {
				...
				class: "capmenu__add",
				onClick: w
			}, [B("span", It, [H(t, { name: "plus" })]), B("span", Lt, J(Y(f)("player.addSubtitles")), 1)]),
			e.audioTracks.length > 1 ? (G(), z(F, { key: 0 }, [B("h3", Rt, J(Y(f)("player.audio")), 1), B("div", {
				class: "capmenu__group",
				role: "radiogroup",
			...
			B("h3", Ut, J(Y(f)("player.captionStyle")), 1),
			B("div", Wt, [
				B("div", Gt, [B("span", Kt, J(Y(f)("player.size")), 1), H(D, {
				...
				B("div", qt, [B("span", Jt, J(Y(f)("player.color")), 1), H(D, {
				...
				B("div", Yt, [B("span", Xt, J(Y(f)("player.background")), 1), H(D, {
				...
				B("div", Zt, [B("span", Qt, J(Y(f)("player.edge")), 1), H(D, {
	...
	setup(e, { emit: n }) {
		...
		let D = I(() => [...y.value].sort((e, t) => t.rating - e.rating || t.downloadCount - e.downloadCount)), O = I(() => m.value.size > 0 && !_.value);
		function A() {
		...
		return X(() => r.open, (e) => {
			...
			footer: Z(() => [H(C, {
				...
				default: Z(() => [V(J(Y(o)("common.close")), 1)]),
				_: 1
			})]),
			default: Z(() => [B("div", en, [
				B("fieldset", tn, [B("legend", nn, J(Y(o)("player.subtitleSearchLanguages")), 1), B("div", rn, [(G(!0), z(F, null, q(p.value, (e) => (G(), L(E, {
					key: e,
				...
				B("div", an, [H(C, {
					...
					default: Z(() => [V(J(Y(o)("player.subtitleSearchAction")), 1)]),
					_: 1
				}, 8, ["loading", "disabled"])]),
				_.value ? (G(), z("div", on, [H(x, { label: Y(o)("player.subtitleSearching") }, null, 8, ["label"]), B("span", null, J(Y(o)("player.subtitleSearching")), 1)])) : v.value && D.value.length === 0 ? (G(), L(k, {
					key: 1,
					icon: "captions",
					title: Y(o)("player.subtitleSearchEmpty"),
					description: Y(o)("player.subtitleSearchEmptyHint")
				}, null, 8, ["title", "description"])) : v.value ? (G(), z("ul", cn, [(G(!0), z(F, null, q(D.value, (e) => (G(), z("li", {
					key: T(e),
					...
					H(w, {
						...
						default: Z(() => [V(J(d(e.language)), 1)]),
						_: 2
					}, 1024),
					e.hearingImpaired ? (G(), L(w, {
						key: 0,
						tone: "info",
						size: "sm",
						label: Y(o)("player.subtitleHearingImpairedFull")
					}, {
						default: Z(() => [V(J(Y(o)("player.subtitleHearingImpaired")), 1)]),
						_: 1
					}, 8, ["label"])) : R("", !0),
					...
					e.downloadCount > 0 ? (G(), z("span", mn, J(Y(o)("player.subtitleDownloads", { count: e.downloadCount })), 1)) : R("", !0),
					e.fps ? (G(), z("span", hn, J(Y(o)("player.subtitleFps", { fps: e.fps })), 1)) : R("", !0)
				])]), H(C, {
					variant: "outline",
					size: "sm",
					...
					default: Z(() => [V(J(b.value.has(T(e)) ? Y(o)("player.subtitleAdding") : Y(o)("player.subtitleAdd")), 1)]),
					_: 2
				}, 1032, [
					"left-icon",
					"loading",
					...
					"aria-label",
					"onClick"
				])]))), 128))])) : (G(), z("p", sn, J(Y(o)("player.subtitleSearchPrompt")), 1))
			])]),
			_: 1
		}, 8, ["model-value", "title"]));
	}
...
var Sn = /*#__PURE__*/ e(/* @__PURE__ */ U({
	...
	setup(e, { emit: n }) {
		let r = n, { t: i } = a(), o = I(() => i("player.resumeFrom").split("{time}"));
		return (n, a) => (G(), z("div", {
			class: "resume",
			role: "region",
...
var Un = ["aria-label"], Wn = ["src"], Gn = { class: "upnext__body" }, Kn = { class: "upnext__eyebrow" }, qn = { class: "upnext__title" }, Jn = {
	...
	setup(e, { emit: n }) {
		let { t: r } = a(), i = e, o = n, s = I(() => i.posterUrl ?? i.media.poster_url ?? null), c = I(() => In(i.remaining, i.total));
	...
	props: { apiBase: {} },
	setup(e) {
		let n = e, { t: r } = a(), i = ge(), o = l(), s = I(() => n.apiBase ?? o.value), c = I(() => i.currentRoom?.name ?? "SyncPlay"), u = I(() => i.onlineMembers.length), d = I(() => i.syncStatus), f = I(() => {
			switch (d.value) {
		...
		return (e, n) => Y(i).isInRoom ? (G(), z("div", Wr, [
			...
			B("div", Jr, [B("span", Yr, [H(t, { name: "user" }), V(" " + J(u.value) + " " + J(Y(r)("syncplay.members", { count: u.value })), 1)]), B("ul", Xr, [(G(!0), z(F, null, q(Y(i).onlineMembers.slice(0, 5), (e) => (G(), z("li", {
				key: e.id,
	...
	setup(e, { emit: n }) {
		let r = e, i = n, { t: o } = a(), s = ge(), c = l(), u = I(() => r.apiBase ?? c.value), d = K(!1), f = K([]), p = I(() => d.value || s.syncStatus === "re-syncing");
		async function m() {
			if (s.isInRoom) try {
		...
		return X(() => s.syncStatus, (e) => {
			...
			p.value ? (G(), z("div", {
				...
				B("span", ni, J(Y(o)("syncplay.waitingForMembers")), 1),
			...
			}, null, 8, ["name"]), B("span", li, J(Y(s).syncStatus === "synced" ? Y(o)("syncplay.synced") : Y(s).syncStatus === "outOfSync" ? Y(o)("syncplay.outOfSync") : Y(o)("syncplay.reSyncing")), 1)], 2)
		])) : R("", !0);
	}
	...
	setup(e, { emit: n }) {
		let r = e, o = n, s = d(), l = i(), { t: u } = a(), g = ge(), _ = p(), v = I(() => _.isFavorite(r.media.id)), y = I(() => _.likeLevel(r.media.id));
		function b() {
			_.toggleFavorite(r.media.id, me());
		}
		function S(e) {
			_.setLike(r.media.id, e, me());
		}
		let C = [
			.25,
			.5,
			...
			1.75,
			2
		], w = K(null), T = K(null), E = K(!0), D = K(!1), O = K(!1), k = K(!1), A = K(!1), j = K(!1), M = K(!1), te = K(null), ne = K(null), re = K(!1), ie = f(), ae = K(!1), se = I(() => A.value ? 1.35 : 1), N = K(jn(r.streamUrl, r.media.path));
		async function ce() {
			if (N.value) return;
			let e = r.playbackAudioTracks ?? [];
			e.length !== 0 && await Hn([r.streamUrl, r.media.path], e) && (N.value = !0);
		}
		...
		}), ve = et({ apiBase: () => r.apiBase ?? "" }), U = null;
		function be(e) {
			U !== null && clearTimeout(U), U = setTimeout(() => {
				U = null, ve.fetch(e);
			}, 0);
		}
		let Se = I(() => r.thumbnailAt ?? ve.thumbnailAt), Te = I(() => N.value ? void 0 : r.streamUrl), Ee = I(() => N.value && P.state.value !== "ready"), Oe = I(() => N.value && (P.state.value === "preparing" || P.state.value === "idle")), ke = I(() => N.value && P.state.value === "error");
		function Ae(e = 0) {
			let t = w.value;
			t && P.start(t, r.media.id, void 0, e);
		}
		function Me(e) {
		...
		let Le = K(s.resumePositionFor(r.media.id) ?? 0), Q = K(!N.value && Le.value > 0), Re = null, ze = K(!1), Be = K(8), Ve, He = K(null), Ue = K(0), We = K(!1), Ge = K([]), Ke = K(!1), qe = K(null);
		function Je(e, t) {
		...
		function $e() {
			let e = r.apiBase ?? "";
			return (Ze === null || Qe !== e) && (Ze = new c({ baseUrl: e }), Qe = e), Ze;
		}
		...
		let rt = I(() => s.upNext);
		function it() {
			N.value = jn(r.streamUrl, r.media.path), ce(), Le.value = s.resumePositionFor(r.media.id) ?? 0, Q.value = !N.value && Le.value > 0, Re = null, tn = !1, Ht = !1, zt.value = [], Rt.value = !1, Ut = !1, jt.value = -1, Yt = null, Ne = !1, pe = !1, ct(), ze.value = !1, P.reset(), w.value && (w.value.currentTime = 0), N.value && Ae(), be(r.media.id);
		}
		function at(e) {
			let t = w.value;
		...
		function ot() {
			at(Le.value), Q.value = !1, w.value?.play()?.catch(() => {});
		}
		function st() {
			Re = null, at(0), s.clearResume(r.media.id), Q.value = !1, w.value?.play()?.catch(() => {});
		}
		function ct() {
		...
		function ht() {
			pe || (pe = !0, de?.finish()), zn(), E.value = !0, s.upNext && (ze.value = !0, l.autoplay && ut());
		}
		function gt() {
			ct(), ze.value = !1;
		...
		let St = K([]), Tt = K([]), Et = K(-1), Dt = K(!1), Ot = I(() => P.state.value === "ready" && P.audioTracks.value.length > 0), kt = I(() => P.audioTracks.value.map((e) => ({
			...
			kind: "audio"
		}))), At = I(() => (r.playbackAudioTracks ?? []).map((e) => ({
			index: e.index,
			...
			return Et.value;
		}), Ft = K(!1), It = s.subtitleLang, Lt = I(() => {
			let e = N.value ? P.subtitleTracks.value : r.playbackSubtitleTracks ?? [];
			if (zt.value.length === 0) return e;
			let t = (e) => e.url.split("?")[0], n = new Set(e.map(t)), i = zt.value.filter((e) => !n.has(t(e)));
		...
		function Wt() {
			...
			t && (s.setSubtitle(t.language), It = t.language, Ht = !0);
		}
		function Gt() {
			if (Ut) return;
		...
		let Kt = I(() => St.value.some((e) => e.language === s.subtitleLang));
		function qt() {
			let e = w.value;
			St.value = he(e), Tt.value = ue(e), Et.value = oe(e), Wt(), Gt();
		}
		function Jt() {
			if (Kt.value) It = s.subtitleLang, s.setSubtitle(null);
			else {
		...
		function Xt(e) {
			if (Ot.value) P.setAudioTrack(e);
				...
				jt.value = e, Yt = e, N.value = !0, Ae(w.value?.currentTime ?? 0);
			} else fe(w.value, e), Et.value = e;
		}
		X(Ot, (e) => {
			if (!e || Yt === null) return;
			let t = Yt;
		...
		function nn() {
			if (!r.autoplay || tn || Q.value || Ee.value) return;
			let e = w.value;
		...
		function dn() {
			let e = w.value;
			e && s.updateProgress(e.currentTime, e.duration, cn(e));
		}
		function fn() {
			let e = w.value;
			e && (e.volume = s.volume, e.muted = s.muted, e.playbackRate = s.rate, Re !== null && (e.currentTime = e.duration ? Math.min(e.duration, Re) : Re, Re = null), s.updateProgress(e.currentTime, e.duration, cn(e)), s.setMediaPositionState(), qt());
		}
		function pn() {
			let e = w.value;
			e && s.updateProgress(e.currentTime, e.duration, cn(e));
		...
		function On() {
			...
			let t = .05;
			En = setInterval(() => {
				e.volume > t ? e.volume = Math.max(0, e.volume - t) : (clearInterval(En), En = null, e.volume = 0, e.pause(), s.pause());
			}, 50);
		}
		h({
			playPause: sn,
		...
		}, { enabled: () => !k.value && !Dt.value && !Ft.value });
		function kn() {
			s.toggleMute();
		}
		function An() {
		...
		X(() => s.muted, (e) => {
			...
			e && (e.type === "seekTo" ? at(e.value) : e.type === "seekBy" && at(s.position + e.value));
		});
		function Pn() {
		...
		function Bn() {
			zn(), !(!s.playing || O.value) && (Qt = setTimeout(() => {
				s.playing && !O.value && (E.value = !1);
			}, r.idleTimeout ?? 3e3));
		}
		function Vn() {
			E.value = !0, Bn();
		...
		X(() => s.playing, (e) => {
			e ? (Q.value = !1, _t(), Bn()) : (zn(), E.value = !0);
		});
		let Un = null;
		return we(() => {
			...
			}), _.hydrate(r.media), typeof document < "u" && (document.addEventListener("fullscreenchange", Fn), M.value = document.pictureInPictureEnabled === !0), Un = s.bindMediaSession({
				onPlay: () => void w.value?.play()?.catch(() => {}),
				onPause: () => w.value?.pause(),
				onSeek: (e) => $(e)
			}), Zt = w.value?.textTracks ?? null, Zt?.addEventListener?.("addtrack", qt), Zt?.addEventListener?.("removetrack", qt), qt(), N.value && Ae(), be(r.media.id);
		}), X(() => r.media, (e) => {
			s.setCurrent(e, {
				resetPosition: !1,
				streamUrl: r.streamUrl
			...
			e && (e.state === "playing" ? (w.value?.play(), s.play()) : e.state === "paused" && (w.value?.pause(), s.pause()), g.updateLocalPosition(s.position), Math.abs(g.driftAmount) > 2 && at(e.playbackPosition));
		}), Ce(() => {
			...
			B("div", hi, [B("button", {
				...
				B("p", vi, J(Y(u)("player.nowPlaying")), 1),
			...
			Ee.value ? R("", !0) : (G(), z("div", Si, [B("button", {
				type: "button",
				class: W(["player__bigplay", { "is-playing": Y(s).playing }]),
				"aria-label": Y(s).playing ? Y(u)("player.pause") : Y(u)("player.play"),
				onClick: De(sn, ["stop"])
			}, [H(t, { name: Y(s).playing ? "pause" : "play" }, null, 8, ["name"])], 10, Ci)])),
			H(wt, {
				video: w.value,
			...
			Ee.value ? R("", !0) : (G(), z("div", {
				...
				Y(l).showMarkerTimeline && e.markers && e.markers.length > 0 ? (G(), L(Rr, {
					key: 0,
					position: Y(s).position,
					duration: Y(s).duration,
					markers: e.markers,
				...
				B("div", wi, [
					...
					B("button", {
						...
						"aria-label": Y(s).playing ? Y(u)("player.pause") : Y(u)("player.play"),
						onClick: sn
					}, [H(t, { name: Y(s).playing ? "pause" : "play" }, null, 8, ["name"])], 8, Ei),
					...
					B("span", Oi, [
						V(J(Y(je)(Y(s).position)), 1),
						r[16] ||= B("span", { class: "player__sep" }, " / ", -1),
						V(J(Y(je)(Y(s).duration)), 1)
					]),
					r[17] ||= B("span", { class: "player__grow" }, null, -1),
					B("button", {
						type: "button",
						class: W(["player__iconbtn player__favorite", { "is-on": v.value }]),
						"aria-label": v.value ? "Remove from favorites" : "Add to favorites",
						"aria-pressed": v.value ? "true" : "false",
						onClick: b
					}, [H(t, { name: v.value ? "bookmark" : "bookmark-plus" }, null, 8, ["name"])], 10, ki),
					H(m, {
						level: y.value,
						onCycle: S
					}, null, 8, ["level"]),
					...
					}, J(Y(u)("player.directStream")), 9, Ai)),
					H($t, {
						open: Dt.value,
						...
						onSelectAudio: Xt,
						onAddSubtitles: r[3] ||= (e) => Rt.value = !0
					}, null, 8, [
						"open",
						"tracks",
						"audio-tracks",
					...
					H(Ar, {
						open: Ft.value,
						"onUpdate:open": r[4] ||= (e) => Ft.value = e,
						chapters: e.chapters ?? [],
						onSeek: $
					...
					B("button", {
						type: "button",
						class: W(["player__iconbtn player__syncplay", { "is-on": Y(g).isInRoom }]),
					...
					B("button", {
						type: "button",
						class: W(["player__iconbtn", { "is-on": A.value }]),
					...
					B("button", {
						...
						onClick: Pn
					}, [H(t, { name: D.value ? "fullscreen-exit" : "fullscreen" }, null, 8, ["name"])], 8, Fi)
				])
			])),
			Ee.value ? R("", !0) : (G(), L(dr, {
				key: 2,
			...
			H(ee, {
				modelValue: We.value,
				"onUpdate:modelValue": r[8] ||= (e) => We.value = e,
				title: `Similar ${He.value ?? "marker"}s`,
				size: "lg",
				onClose: nt
			}, {
				default: Z(() => [B("div", Ii, [Ke.value ? (G(), z("div", Li, [H(x, { label: "Finding similar media" })])) : qe.value ? (G(), z("div", Ri, [H(t, {
					name: "error",
					...
					r[18] ||= B("p", { class: "similar-modal__state-title" }, "No similar media found", -1),
					r[19] ||= B("p", { class: "similar-modal__state-hint" }, "Try a different marker or position.", -1)
			...
			H(gn, {
				open: Rt.value,
				"onUpdate:open": r[15] ||= (e) => Rt.value = e,
				"media-id": e.media.id,
				"api-base": e.apiBase ?? "",
	...
	__name: "PlayerPage",
	setup(e) {
		let t = /* @__PURE__ */ new Map(), n = l(), r = u(), i = ke(), a = Ae(), o = d(), f = p(), m = _(), h = K(null), g = K(""), v = K([]), y = K(null), b = K(null), x = K([]), w = K([]), T = K(!0), E = K(null), D = K(!1), oe = K(null), se = K(!1), N = K(null), ce = K(null), le = I(() => String(i.params.id ?? ""));
		S(() => h.value?.name);
		let ue = I(() => {
		...
		async function ye() {
			let e = le.value;
			if (de?.abort(), de = typeof AbortController < "u" ? new AbortController() : null, T.value = !0, E.value = null, v.value = [], y.value = null, b.value = null, x.value = [], w.value = [], N.value = null, ce.value = null, o.hideMiniPlayer(), !e) {
			...
			t.get(`/api/v1/media/${encodeURIComponent(e)}/playback-info`, void 0, de?.signal).then((e) => {
				...
				})), y.value = P(e?.intro_marker), b.value = P(e?.outro_marker), x.value = Pn(e?.audio_tracks), w.value = Be(e?.subtitle_tracks));
			}).catch(() => null);
		...
		async function be(e, t) {
			h.value = t, f.hydrate(t), g.value = me(t), T.value = !1, !((t.episode_number ?? null) !== null && (await U(e, t), ce.value)) && he(e, t);
		}
		we(ye), X(le, ye), Oe(() => {
		...
		return (e, t) => (G(), z("div", { class: W(["player-page", { "is-theater": D.value }]) }, [
			ue.value && !T.value && !E.value ? (G(), z("div", {
				key: 0,
				class: "player-page__ambient",
				style: Se(ue.value),
				"aria-hidden": "true"
			}, null, 4)) : R("", !0),
			B("div", Xi, [T.value ? (G(), z("div", Zi, [H(O, {
				variant: "rect",
...
//# sourceMappingURL=PlayerPage-Ci6m8NZu.js.map