...
import { t as n } from "./client-C0AMSEun.js";
import { n as r } from "./useApiBase-CV_r-Kk4.js";
import { t as i } from "./useAuthStore-DWTuTW8p.js";
import { n as a, o } from "./media-query-BdY2RILB.js";
import { t as s } from "./useToastStore-BDoKlU6N.js";
import { n as c } from "./ThumbRating-DGyicxT5.js";
import { i as ee } from "./usePageTitle-BO3GGF3M.js";
import { t as l } from "./Button-btm-GCUN.js";
import { t as u } from "./Skeleton-DhQmxeNg.js";
import { t as te } from "./EmptyState-CfyGawh7.js";
import { t as ne } from "./MediaCard-CJqS3fwx.js";
import { t as d } from "./MediaDetail-CSDFFNzb.js";
import { t as re } from "./MetadataMatchModal-jiZc23NT.js";
import { t as ie } from "./PosterPicker-iC40tMe-.js";
import { s as f } from "./episode-order-C2yqgMeX.js";
import { i as ae, n as oe, t as se } from "./useResolvePlayable-DoBQlt-O.js";
...
var D = { class: "series-detail" }, O = {
	...
	setup(e, { emit: n }) {
		...
		let ee = p(() => r.seasons.length > 0), l = t(), u = p(() => l.cardSize ?? 200);
		return (t, n) => (S(), g("div", D, [y(d, {
			...
			"resume-seconds",
			"can-match"
		]), _("section", O, [n[10] ||= _("h2", { class: "series-detail__seasons-title" }, "Seasons", -1), e.loading ? (S(), g("div", k)) : ee.value ? (S(), g("ul", {
			key: 1,
			class: "series-detail__grid",
			style: x({ gridTemplateColumns: `repeat(auto-fill, minmax(${u.value}px, 1fr))` })
	...
	setup(e) {
		let t = r(), ne = fe("phlixConfig", void 0), f = p(() => ne?.routerBase || "/app"), b = ge(), x = _e(), w = o(), D = s(), O = i(), k = c(), A = C(null), j = C([]), M = C([]), N = C(!0), P = C(!1), F = C(!1), I = C(null), L = p(() => String(b.params.id ?? "")), R = p(() => w.resumePositionFor(L.value)), Ce = p(() => A.value?.type === "series");
		ee(() => A.value?.name);
		let z = null, B = !1;
		function V(e) {
		...
		return (e, t) => (S(), g("div", ye, [
			N.value ? (S(), g("div", be, [_("div", xe, [y(u, {
				variant: "rect",
...
//# sourceMappingURL=MediaDetailPage-Ch4Bv0hG.js.map