import { n as e, s as t } from "./plural-DMM7pLFA.js";
...
function s(e) {
	let t = a(e);
	return (e, n) => {
		let r = e.indexOf("."), i = r === -1 ? "" : e.slice(0, r), a = r === -1 ? "" : e.slice(r + 1), s = t[i], l = s ? s[a] : void 0;
		return typeof l == "string" ? o(c(l, n), n) : e;
	};
}
function c(n, r) {
	if (!e(n)) return n;
	let i = r?.count, a = typeof i == "number" ? i : Number(i);
...
function l() {
	return { t: s(n("phlixConfig", null)?.messages) };
}
//#endregion
export { a as i, r as n, s as r, l as t };

//# sourceMappingURL=useMessages-CMi9c10n.js.map