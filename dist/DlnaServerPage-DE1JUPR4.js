...
}, A = { class: "admin-dlna__actions" }, j = /*#__PURE__*/ t(/* @__PURE__ */ v({
	__name: "DlnaServerPage",
	props: { client: {} },
	setup(t) {
		let v = t, j = y("apiBase", ""), M = d(() => typeof j == "string" ? j : j?.value ?? ""), N = new l(v.client ?? new n({
			baseUrl: M.value,
			tokenStore: new i()
		...
		async function V() {
			...
			try {
				...
				L.value = e(t, "Failed to load DLNA server status."), P.error(L.value);
			} finally {
				I.value = !1;
			}
		}
		async function H() {
			if (!R.value) {
				...
				try {
					...
					P.error(e(t, "Failed to start DLNA server."));
				} finally {
					R.value = !1;
				}
			}
		...
		async function U() {
			if (!R.value) {
				...
				try {
					...
					P.error(e(t, "Failed to stop DLNA server."));
				} finally {
					R.value = !1;
				}
			}
...
//# sourceMappingURL=DlnaServerPage-DE1JUPR4.js.map