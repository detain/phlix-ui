import { a as e, d as t, i as n, m as ee, n as te, r as ne, t as r } from "./Button-DjEQ9y17.js";
import { t as i } from "./Modal-BkSAbwHm.js";
import { t as re } from "./EmptyState-bbKd8GNA.js";
import { t as ie } from "./Select-BPlN5xaU.js";
import { t as a } from "./Badge-DobVc76J.js";
import { t as ae } from "./Switch-BNdBMUaS.js";
...
var pe = {
	...
	key: 4,
	class: "admin-users__subform"
}, Ve = { class: "admin-users__subform-title" }, He = { class: "admin-users__field" }, Ue = { class: "admin-users__subform-actions" }, We = 5, x = /*#__PURE__*/ ee(/* @__PURE__ */ le({
	__name: "UsersPage",
	props: { client: {} },
	setup(ee) {
		let le = ee, x = ue("apiBase", ""), Ge = s(() => typeof x == "string" ? x : x?.value ?? ""), S = new ce(le.client ?? new e({
			baseUrl: Ge.value,
			tokenStore: new n()
		})), C = ne(), Ke = s(() => se.map((e) => ({
			value: e.value,
...
//# sourceMappingURL=UsersPage-CWCqgIBR.js.map