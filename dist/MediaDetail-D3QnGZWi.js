...
import { t as n } from "./useAuthStore-CJrazXSP.js";
import { n as r, t as i } from "./LoveButton-Cfe3jzXL.js";
import { t as a } from "./Button-k7aQagzg.js";
import { t as o } from "./Chip-2HcSZF4a.js";
import { a as ee, r as te } from "./MetadataMatchModal-vCPqVr65.js";
import { t as ne } from "./MediaRow-Cq5cr38I.js";
import { Fragment as s, computed as c, createBlock as l, createCommentVNode as u, createElementBlock as d, createElementVNode as f, createTextVNode as p, createVNode as m, defineComponent as h, inject as re, normalizeClass as g, normalizeStyle as ie, onMounted as ae, openBlock as _, ref as v, renderList as y, toDisplayString as b, withCtx as x } from "vue";
	...
	setup(e, { emit: h }) {
		...
		return ae(() => {
			...
			f("div", se, [e.showBack ? (_(), l(a, {
				...
				default: x(() => [...r[8] ||= [p("Back", -1)]]),
				_: 1
			})) : u("", !0)]),
			f("div", ce, [f("div", le, [e.item.poster_url ? (_(), d("img", {
				key: 0,
				ref_key: "imgEl",
				ref: $,
				...
				decoding: "async",
				onLoad: Ie
			}, null, 42, ue)) : (_(), d("div", de, [m(t, { name: Fe.value }, null, 8, ["name"])]))]), f("div", fe, [
				f("h1", pe, b(e.item.name), 1),
				f("div", me, [
					e.item.year ? (_(), d("span", he, [m(t, {
						name: "calendar",
						class: "media-detail__meta-icon"
					}), p(b(e.item.year), 1)])) : u("", !0),
					e.item.rating ? (_(), d("span", S, b(e.item.rating), 1)) : u("", !0),
					e.item.runtime ? (_(), d("span", C, b(e.item.runtime) + "m", 1)) : u("", !0),
					f("span", w, b(e.item.type), 1)
				]),
				e.item.genres?.length ? (_(), d("div", T, [(_(!0), d(s, null, y(e.item.genres, (e) => (_(), d("button", {
					key: e,
					type: "button",
				...
				Y.value.length ? (_(), d("div", D, [r[9] ||= f("span", { class: "media-detail__companies-label" }, "Studios", -1), f("div", O, [(_(!0), d(s, null, y(Y.value, (e) => (_(), d("button", {
					key: e.name,
					type: "button",
					...
					default: x(() => [e.logoUrl ? (_(), d("img", {
						...
						loading: "lazy",
						decoding: "async"
					}, null, 8, A)) : u("", !0), f("span", null, b(e.name), 1)]),
					_: 2
				}, 1024)], 8, k))), 128))])])) : u("", !0),
				f("p", j, b(e.item.overview || "No overview available."), 1),
				f("div", M, [
					m(a, {
						variant: "solid",
						"left-icon": "play",
					...
					Z.value ? (_(), l(a, {
						...
						default: x(() => [r[11] ||= p(" Resume ", -1), f("span", N, b(Z.value), 1)]),
						_: 1
					})) : u("", !0),
					m(a, {
						variant: "ghost",
					...
					m(ee, {
						open: G.value,
						"onUpdate:open": r[3] ||= (e) => G.value = e,
						items: Ne.value,
						onSelect: Pe
					}, {
						default: x(() => [f("button", P, [m(t, { name: "more" })])]),
						_: 1
					}, 8, ["open", "items"]),
					e.canMatch ? (_(), l(a, {
						key: 1,
						variant: "ghost",
						"left-icon": "search",
						onClick: r[4] ||= (t) => B("match", e.item)
					}, {
						default: x(() => [...r[12] ||= [p("Match metadata", -1)]]),
						_: 1
					})) : u("", !0)
				]),
				J.value.length || q.value.length ? (_(), d("div", F, [J.value.length ? (_(), d("section", I, [r[13] ||= f("h2", { class: "media-detail__credit-heading" }, "Crew", -1), f("ul", L, [(_(!0), d(s, null, y(J.value, (e, t) => (_(), d("li", { key: `crew-${t}-${e.name}` }, [f("button", {
					type: "button",
				...
				], 8, R)]))), 128))])])) : u("", !0), q.value.length ? (_(), d("section", xe, [r[14] ||= f("h2", { class: "media-detail__credit-heading" }, "Cast", -1), f("ul", Se, [(_(!0), d(s, null, y(q.value, (e, t) => (_(), d("li", { key: `cast-${t}-${e.name}` }, [f("button", {
					type: "button",
					class: "media-detail__person",
					"aria-label": `Show titles with ${e.name}`,
					onClick: (t) => B("actor", e.name)
			...
			e.similarLoading || e.similar.length ? (_(), l(ne, {
				...
				"hide-when-empty": "",
				onPlay: r[5] ||= (e) => B("play", e),
				onWatchlist: r[6] ||= (e) => B("watchlist", e),
				onInfo: r[7] ||= (e) => B("info", e)
			}, null, 8, ["items", "loading"])) : u("", !0)
		]));
	}
}), [["__scopeId", "data-v-4adc5ca4"]]);
//#endregion
export { z as t };

//# sourceMappingURL=MediaDetail-D3QnGZWi.js.map