import { a as e, i as t, m as n, n as r, p as i, r as a, t as o } from "./Button-DjEQ9y17.js";
...
var ie = {
	...
	role: "note"
}, I = /*#__PURE__*/ n(/* @__PURE__ */ g({
	__name: "HistoryPage",
	props: { client: {} },
	emits: ["continue"],
	setup(n, { emit: g }) {
		let I = n, L = g, R = _("apiBase", ""), z = l(() => typeof R == "string" ? R : R?.value ?? ""), B = new ne(I.client ?? new e({
			baseUrl: z.value,
			tokenStore: new t()
		})), V = a();
		function H(e, t) {
		...
		return y(q), (e, t) => (b(), f("section", ie, [
			...
			W.value ? (b(), f("div", T, [h(r, {
				...
				}, null, 8, O)) : (b(), f("span", ae, [h(i, { name: "film" })]))]),
				p("div", oe, [
...
//# sourceMappingURL=HistoryPage-ChwY8JKW.js.map