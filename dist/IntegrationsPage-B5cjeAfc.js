...
var pe = {
	...
	setup(e) {
		let h = {
			oidc: "OIDC",
			ldap: "LDAP"
		}, w = ["oidc", "ldap"], Xe = e, T = se("apiBase", ""), Ze = oe(() => typeof T == "string" ? T : T?.value ?? ""), E = new ae(Xe.client ?? new ee({
			baseUrl: Ze.value,
			tokenStore: new n()
		...
		return le(() => {
			...
			f("section", me, [f("div", he, [n[17] ||= f("h2", {
				id: "arr-sync-heading",
				...
				_: 1
			}, 8, ["tone"])) : u("", !0)]), f("div", ge, [k.value ? (g(), d("div", _e, [m(ne, {
				variant: "text",
				lines: 3
			})])) : A.value ? (g(), l(re, {
				key: 1,
				...
				_: 1
			}, 8, ["description"])) : O.value === null ? (g(), d("p", ve, " No sync status available. ")) : (g(), d(c, { key: 3 }, [f("dl", ye, [
			...
			f("section", Ce, [n[23] ||= f("div", { class: "admin-integrations__section-head" }, [f("h2", {
				id: "auth-providers-heading",
				class: "admin-integrations__section-title"
			}, " Authentication providers ")], -1), I.value ? (g(), d("div", we, [m(ne, {
				variant: "text",
				lines: 4
			})])) : L.value ? (g(), l(re, {
				key: 1,
				...
				_: 1
			}, 8, ["description"])) : (g(), d("div", Te, [(g(), d(c, null, ue(w, (e) => f("div", {
				key: e,
				class: "admin-integrations__provider"
			}, [f("div", Ee, [f("span", De, v(h[e]), 1), m(a, { tone: V(e) ? "success" : "neutral" }, {
				default: x(() => [p(v(V(e) ? "Enabled" : "Disabled"), 1)]),
				_: 2
			}, 1032, ["tone"])]), f("div", Oe, [m(o, {
				"model-value": V(e),
				label: `Enable ${h[e]}`,
			...
			m(t, {
				...
				default: x(() => [f("form", {
					...
					f("label", ke, [n[24] ||= f("span", { class: "admin-integrations__label" }, "Provider URL", -1), S(f("input", {
					...
					f("label", Ae, [n[25] ||= f("span", { class: "admin-integrations__label" }, "Client ID", -1), S(f("input", {
					...
					f("label", je, [
						...
						}, null, 8, Pe), [[de, U.value.client_secret]]), m(i, {
							variant: "ghost",
							size: "sm",
					...
					f("label", Fe, [n[27] ||= f("span", { class: "admin-integrations__label" }, "Scopes", -1), S(f("input", {
			...
			m(t, {
				...
				default: x(() => [f("form", {
					...
					f("label", Le, [n[30] ||= f("span", { class: "admin-integrations__label" }, "Host", -1), S(f("input", {
					...
					f("label", Re, [n[31] ||= f("span", { class: "admin-integrations__label" }, "Port", -1), f("input", {
						value: J.value.port,
						type: "number",
						min: "1",
						max: "65535",
						class: "admin-integrations__input",
						autocomplete: "off",
						onInput: n[7] ||= (e) => ct(e.target.value)
					}, null, 40, ze)]),
					m(o, {
					...
					f("label", Be, [n[32] ||= f("span", { class: "admin-integrations__label" }, "Base DN", -1), S(f("input", {
					...
					f("label", Ve, [n[33] ||= f("span", { class: "admin-integrations__label" }, "Bind DN", -1), S(f("input", {
					...
					f("label", He, [
						...
						f("div", We, [S(f("input", {
							...
							"data-bwignore": "",
							"data-form-type": "other"
						}, null, 8, Ge), [[de, J.value.bind_pw]]), m(i, {
							variant: "ghost",
							size: "sm",
					...
					f("label", Ke, [n[35] ||= f("span", { class: "admin-integrations__label" }, "User filter", -1), S(f("input", {
					...
					f("label", qe, [n[36] ||= f("span", { class: "admin-integrations__label" }, "Admin group DN", -1), S(f("input", {
...
//# sourceMappingURL=IntegrationsPage-B5cjeAfc.js.map