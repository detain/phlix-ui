...
var te = { class: "media-card__poster" }, ne = ["href", "aria-label"], re = { class: "visually-hidden" }, ie = [
...
}, be = ["aria-label", "aria-pressed"], xe = ["aria-label", "aria-pressed"], Se = { class: "media-card__caption" }, Ce = ["title"], we = { class: "media-card__caption-sub numeric" }, $ = /*#__PURE__*/ e(/* @__PURE__ */ S({
	__name: "MediaCard",
	props: {
		item: {},
		to: {},
	...
	setup(e, { emit: n }) {
		let r = e, i = n, a = c(), u = o(), d = s(), p = C("phlixConfig", null), m = h(() => d.isFavorite(r.item.id)), g = h(() => d.likeLevel(r.item.id)), S = h(() => u.isAdmin), w = h(() => d.isWatched(r.item.id)), D = A(!1), P = h(() => Q(r.item, {
			isAdmin: S.value,
			isWatched: w.value,
		...
		function B() {
			d.toggleWatched(r.item.id, p?.apiBase ?? ""), i("mark-watched", r.item);
		}
		let V = h(() => r.to ?? `/app/media/${r.item.id}`), { prefetch: H } = K();
		function U() {
			H(V.value);
		}
		let W = A(!1), q = A(null);
		...
		O(() => {
			q.value?.complete && (W.value = !0);
		});
		let Y = h(() => ee(r.posterSrcset ?? r.item.poster_srcset, r.posterSizes)), X = h(() => {
		...
		return (n, r) => (k(), v("article", {
			...
			e.item.poster_url ? (k(), v("img", {
				...
				ref_key: "imgEl",
				ref: q,
				class: T(["media-card__img", { "is-loaded": W.value }]),
			...
			Z.value > 0 ? (k(), v("div", {
				...
				role: "progressbar",
				"aria-valuenow": Math.round(Z.value * 100),
				"aria-valuemin": "0",
				"aria-valuemax": "100",
				"aria-label": `Resume ${e.item.name}`
			}, [y("i", { style: E({ width: `${Z.value * 100}%` }) }, null, 4)], 8, le)) : _("", !0),
			y("div", ue, [
				...
				$.value.length ? (k(), v("div", ve, [(k(!0), v(f, null, j($.value, (e) => (k(), v("span", { key: e }, N(e), 1))), 128))])) : _("", !0),
				e.hideActions ? _("", !0) : (k(), v("div", ye, [
					y("button", {
						type: "button",
					...
					}, [x(t, { name: w.value ? "eye" : "eye-off" }, null, 8, ["name"])], 10, xe),
					y("button", {
						type: "button",
			...
			title: e.item.name
		}, N(e.item.name), 9, Ce), y("div", we, [e.subtitle == null ? (k(), v(f, { key: 1 }, [
		...
		], 64)) : (k(), v(f, { key: 0 }, [b(N(e.subtitle), 1)], 64))])])], 32));
	}
}), [["__scopeId", "data-v-fd3014dc"]]), Te = { class: "match-modal" }, Ee = {
	key: 0,
...
}, je = { class: "match-modal__source-body" }, Me = {
	key: 0,
	class: "match-modal__source-filename"
}, Ne = ["title"], Pe = ["innerHTML"], Fe = {
	key: 2,
	...
	class: "match-modal__state",
	role: "alert"
}, Re = { class: "match-modal__state-title" }, ze = {
	key: 4,
	...
	role: "alert"
}, He = { class: "match-modal__results" }, Ue = { class: "match-modal__poster" }, We = ["src", "alt"], Ge = {
	key: 1,
	class: "match-modal__poster-fallback",
	"aria-hidden": "true"
}, Ke = { class: "match-modal__result-body" }, qe = { class: "match-modal__result-title" }, Je = {
	key: 0,
	class: "match-modal__result-year numeric"
}, Ye = { class: "match-modal__result-type" }, Xe = {
	key: 0,
	class: "match-modal__result-overview"
}, Ze = /*#__PURE__*/ e(/* @__PURE__ */ S({
	...
	setup(e, { emit: n }) {
		...
		return I(() => s.modelValue, (e) => {
			...
			default: L(() => [y("div", Te, [
				...
				P.value && (P.value.original_filename || P.value.path || P.value.tags && Object.keys(P.value.tags).length) ? (k(), v("details", Ae, [r[10] ||= y("summary", { class: "match-modal__source-summary" }, "Source info", -1), y("div", je, [
					P.value.original_filename ? (k(), v("p", Me, [r[8] ||= y("span", { class: "match-modal__source-label" }, "File:", -1), y("code", null, N(P.value.original_filename), 1)])) : _("", !0),
					P.value.path ? (k(), v("p", {
						key: 1,
						class: "match-modal__source-path",
						title: P.value.path
					}, [r[9] ||= y("span", { class: "match-modal__source-label" }, "Path:", -1), y("span", { innerHTML: K(P.value.path) }, null, 8, Pe)], 8, Ne)) : _("", !0),
					P.value.tags && Object.keys(P.value.tags).length ? (k(), v("dl", Fe, [(k(!0), v(f, null, j(P.value.tags, (e, t) => (k(), v(f, { key: String(t) }, [y("dt", null, N(t), 1), y("dd", null, N(e), 1)], 64))), 128))])) : _("", !0)
				])])) : _("", !0),
				E.value ? (k(), v("div", Ie, [
					x(t, {
						name: "alert",
				...
				])) : C.value ? (k(), v("div", ze, [x(H, { label: "Searching TMDB" })])) : w.value && S.value.length === 0 ? (k(), v("div", Be, [
					x(t, {
						name: "search",
						class: "match-modal__state-icon"
					}),
				...
				])) : S.value.length ? (k(), v(f, { key: 6 }, [M.value ? (k(), v("p", Ve, N(M.value), 1)) : _("", !0), y("ul", He, [(k(!0), v(f, null, j(S.value, (e) => (k(), v("li", {
					key: q(e),
					class: "match-modal__result"
				}, [
					y("div", Ue, [e.poster_url ? (k(), v("img", {
						key: 0,
						src: e.poster_url,
						alt: e.title,
						loading: "lazy",
						decoding: "async"
					}, null, 8, We)) : (k(), v("div", Ge, [x(t, { name: e.type === "tv" ? "tv" : "film" }, null, 8, ["name"])]))]),
					y("div", Ke, [y("p", qe, [
						b(N(e.title) + " ", 1),
						e.year ? (k(), v("span", Je, N(e.year), 1)) : _("", !0),
						y("span", Ye, N(e.type), 1)
					]), e.overview ? (k(), v("p", Xe, N(e.overview), 1)) : _("", !0)]),
					x(u, {
						variant: "solid",
						size: "sm",
						loading: O.value === q(e),
...
//#endregion
export { G as a, K as i, $ as n, H as o, Q as r, Ze as t };

//# sourceMappingURL=MetadataMatchModal-DHRbr1am.js.map