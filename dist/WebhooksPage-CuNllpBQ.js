...
var fe = {
	...
	props: { client: {} },
	setup(e) {
		let h = e, O = oe("apiBase", ""), je = c(() => typeof O == "string" ? O : O?.value ?? ""), k = new ae(h.client ?? new ee({
			baseUrl: je.value,
			tokenStore: new n()
		})), A = ne();
		function Me(e) {
		...
		async function P() {
			...
			try {
				...
				N.value = r(e, "Failed to load webhooks."), A.error(N.value);
			} finally {
				M.value = !1;
			}
		}
		...
		async function q() {
			...
			try {
				...
				U.value = r(e, "Failed to save webhook.");
			} finally {
				H.value = !1;
			}
		}
		...
		async function Fe() {
			...
			if (e) try {
				...
				A.error(r(e, "Failed to delete webhook.")), J.value = null;
			}
		}
...
//# sourceMappingURL=WebhooksPage-CuNllpBQ.js.map