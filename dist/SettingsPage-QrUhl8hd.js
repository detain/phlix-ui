import { a as e, c as t, i as n, m as r, n as i, r as ee, t as a } from "./Button-DjEQ9y17.js";
...
}, Ce = { class: "admin-settings__actions" }, T = /*#__PURE__*/ r(/* @__PURE__ */ g({
	__name: "SettingsPage",
	props: { client: {} },
	setup(r) {
		let g = r, T = re("apiBase", ""), E = l(() => typeof T == "string" ? T : T?.value ?? ""), D = new ne(g.client ?? new e({
			baseUrl: E.value,
			tokenStore: new n()
		})), O = ee(), k = [
			{
		...
		async function Ee() {
			...
			try {
				...
				O.error(e instanceof t ? e.message : "Failed to load settings.");
			} finally {
				B.value = !1;
			}
		}
...
//# sourceMappingURL=SettingsPage-QrUhl8hd.js.map