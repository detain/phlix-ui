import { a as e, i as t, l as n, n as r, r as ee, t as i, u as te } from "./Button-DFtuAYup.js";
import { t as ne } from "./Modal-3-gao3sJ.js";
import { t as re } from "./Badge-DypgiWDB.js";
...
var fe = {
	...
	setup(te) {
		...
		return se(() => {
			...
			}, null, 8, ["name"])]), u("span", ve, h(at.value), 1)], 8, ge), x.value.hub ? (p(), l("div", ye, [w.value ? (p(), l("div", be, [f(r, {
				variant: "text",
				lines: 3
			...
			u("section", we, [u("button", {
				...
				class: "admin-remote__chevron"
			}, null, 8, ["name"])]), u("span", De, h(dt.value), 1)], 8, Te), x.value.subdomain ? (p(), l("div", Oe, [L.value ? (p(), l("div", ke, [f(r, {
				variant: "text",
				lines: 2
			...
			u("section", Ne, [u("button", {
				...
				class: "admin-remote__chevron"
			}, null, 8, ["name"])]), u("span", Ie, h(mt.value), 1)], 8, Pe), x.value.relay ? (p(), l("div", Le, [H.value ? (p(), l("div", Re, [f(r, {
				variant: "text",
				lines: 2
			...
			u("section", He, [u("button", {
				...
				class: "admin-remote__chevron"
			}, null, 8, ["name"])]), u("span", Ge, h(yt.value), 1)], 8, Ue), x.value.portforward ? (p(), l("div", Ke, [Y.value ? (p(), l("div", qe, [f(r, {
				variant: "text",
				lines: 3
...
//# sourceMappingURL=RemoteAccessPage-B7nkXFPC.js.map