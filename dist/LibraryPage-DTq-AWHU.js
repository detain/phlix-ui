...
import { n as o } from "./ThumbRating-DL3IV5ps.js";
import { t as s } from "./useLibrariesStore-CLVbLTvE.js";
import { i as ee } from "./usePageTitle-BO3GGF3M.js";
import { t as te } from "./Button-CnyfCnhY.js";
import { n as ne, t as re } from "./FilterBar-oS9O2Zux.js";
import { t as c } from "./EmptyState-588Z_81C.js";
import { t as ie } from "./MediaGrid-C028D51Q.js";
import { t as ae } from "./MetadataMatchModal-55LHSAXt.js";
import { t as oe } from "./PosterPicker-9PSCTnwn.js";
import { n as l } from "./useResolvePlayable-Dnhx822M.js";
...
var N = { class: "library-page" }, P = {
	...
	setup(e) {
		...
		function we(e) {
			A.toggleFavorite(e.id, u.value), A.isFavorite(e.id) ? k.success(`Marked "${e.name}" as watched`) : k.info(`Marked "${e.name}" as unwatched`);
		}
		function Te(e) {
			V.value = e, H.value = !0;
		}
...
}), [["__scopeId", "data-v-21417d6f"]]);
//#endregion
export { R as default };

//# sourceMappingURL=LibraryPage-DTq-AWHU.js.map