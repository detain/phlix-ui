	...
	setup(a) {
		...
		return oe(I, (e) => {
			...
			p("section", ue, [p("header", de, [t[2] ||= p("h2", {
				...
				_: 1
			}, 8, ["label"])) : d("", !0)]), H.value ? (_(), f("div", fe, [h(n, {
				variant: "text",
				lines: 4
			...
			p("section", be, [t[4] ||= p("header", { class: "admin-dash__card-head" }, [p("h2", {
				id: "tu-heading",
				class: "admin-dash__card-title"
			}, "Top Users")], -1), U.value ? (_(), f("div", xe, [h(n, {
				variant: "text",
				lines: 4
			...
			p("section", we, [t[5] ||= p("header", { class: "admin-dash__card-head" }, [p("h2", {
				id: "tm-heading",
				class: "admin-dash__card-title"
			}, "Top Media")], -1), W.value ? (_(), f("div", Te, [h(n, {
				variant: "text",
				lines: 4
			...
			p("section", E, [t[6] ||= p("header", { class: "admin-dash__card-head" }, [p("h2", {
				id: "st-heading",
				class: "admin-dash__card-title"
			}, "Storage")], -1), G.value ? (_(), f("div", D, [h(n, {
				variant: "text",
				lines: 3
			...
			p("section", je, [t[8] ||= p("header", { class: "admin-dash__card-head" }, [p("h2", {
				id: "act-heading",
				class: "admin-dash__card-title"
			}, "Recent Activity")], -1), K.value ? (_(), f("div", Me, [h(n, {
				variant: "text",
				lines: 5
...
//# sourceMappingURL=DashboardPage-Xyg1jzSG.js.map