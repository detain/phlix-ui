...
import { d as t, n as ee, s as n, t as r } from "./Button-C1kpaQyo.js";
...
var O = {
	...
	props: { client: {} },
	setup(e) {
		let _ = e, N = v("apiBase", ""), P = u(() => typeof N == "string" ? N : N?.value ?? ""), F = new l(_.client ?? new ee({
			baseUrl: P.value,
			tokenStore: new n()
...
//# sourceMappingURL=SyncPlayPage-B0XZl43f.js.map