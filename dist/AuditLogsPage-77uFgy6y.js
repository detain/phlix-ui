...
import { i as t, t as n, u as r } from "./Button-9cUUJmnN.js";
	...
	setup(e) {
		...
		async function B(e = 1) {
			...
			try {
				...
				L.value = r(e, "Failed to load audit logs."), P.error(L.value);
			} finally {
				I.value = !1;
			}
		}
...
//# sourceMappingURL=AuditLogsPage-77uFgy6y.js.map