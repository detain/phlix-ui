...
import { n, t as r } from "./Button-MsRePfWv.js";
import { t as i } from "./useAuthStore-BNs-pZEK.js";
import { i as a } from "./usePlayerStore-BMGj8146.js";
...
import { t as l } from "./MetadataMatchModal-HXVG4hcc.js";
import { t as ee } from "./EmptyState-B2QnGIQT.js";
import { a as u, n as te } from "./useApiBase-DhSHB6Qp.js";
import { t as d } from "./MediaDetail-CwORNScs.js";
import { a as f, n as ne } from "./series-grouping-BTZK8Agh.js";
import { t as p } from "./useSeriesSeasons-BYY54zt4.js";
...
var A = { class: "series-detail" }, j = {
	...
	setup(e) {
		let t = te(), f = re("phlixConfig", void 0), S = h(() => f?.routerBase || "/app"), T = se(), E = ce(), D = a(), A = s(), j = i(), M = w(null), N = w([]), P = w([]), F = w(!0), I = w(!1), L = w(!1), R = w(null), z = h(() => String(T.params.id ?? "")), B = h(() => D.resumePositionFor(z.value)), V = h(() => M.value?.type === "series");
		o(() => M.value?.name);
		let H = null, U = !1;
		function W(e) {
...
//# sourceMappingURL=MediaDetailPage-n3hcAUko.js.map