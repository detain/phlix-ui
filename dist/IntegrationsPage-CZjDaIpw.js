...
var de = {
	...
	setup(e) {
		let h = {
			oidc: "OIDC",
			ldap: "LDAP"
		}, w = ["oidc", "ldap"], Je = e, T = oe("apiBase", ""), Ye = ae(() => typeof T == "string" ? T : T?.value ?? ""), E = new ie(Je.client ?? new ee({
			baseUrl: Ye.value,
			tokenStore: new n()
		...
		async function P() {
			...
			try {
				...
				A.value = r(e, "Failed to load sync status."), D.error(A.value);
			} finally {
				k.value = !1;
			}
		}
		async function Xe() {
			...
			try {
				...
				if (N(), e) return;
				D.error(r(t, "Sync request failed."));
			} finally {
				e || (j.value = !1);
			}
		}
		async function Ze(e) {
			try {
				...
				D.error(r(e, "Failed to update sync setting."));
			}
		}
		...
		async function B() {
			...
			try {
				...
				L.value = r(e, "Failed to load auth providers."), D.error(L.value);
			} finally {
				I.value = !1;
			}
		}
		...
		async function Qe(e, t) {
			try {
				...
				D.error(r(t, `Failed to update ${h[e]}.`));
			}
		}
		let H = _(!1), U = _({
			provider_url: "",
		...
		async function $e() {
			...
			try {
				...
				D.error(r(e, "Failed to load OIDC settings."));
			}
			H.value = !0;
		}
		function et() {
		...
		async function tt() {
			...
			try {
				...
				G.value = r(e, "Failed to save OIDC settings.");
			} finally {
				W.value = !1;
			}
		}
		...
		async function nt() {
			...
			try {
				...
				D.error(r(e, "Failed to load LDAP settings."));
			}
			q.value = !0;
		}
		function rt() {
		...
		async function $() {
			...
			try {
				...
				Z.value = r(e, "Failed to save LDAP settings.");
			} finally {
				Y.value = !1;
			}
		}
		async function at() {
			...
			try {
				...
				D.error(r(e, "LDAP connection test failed."));
			} finally {
				X.value = !1;
			}
		}
		...
		return ce(() => {
			P(), B();
		}), se(N), (e, n) => (g(), d("section", de, [
			n[40] ||= f("header", { class: "admin-integrations__head" }, [f("h1", {
				id: "integrations-heading",
				class: "admin-integrations__title"
			}, "Integrations")], -1),
			m(re, { title: "What's on this page" }, {
				default: x(() => [...n[16] ||= [
			...
			f("section", fe, [f("div", pe, [n[17] ||= f("h2", {
				id: "arr-sync-heading",
				class: "admin-integrations__section-title"
			}, "Arr sync (TRaSH-Guides)", -1), O.value ? (g(), l(a, {
				key: 0,
				...
				actions: x(() => [m(i, {
					...
					default: x(() => [...n[18] ||= [p("Retry", -1)]]),
					_: 1
				})]),
				_: 1
			}, 8, ["description"])) : O.value === null ? (g(), d("p", ge, " No sync status available. ")) : (g(), d(c, { key: 3 }, [f("dl", _e, [
				n[19] ||= f("dt", { class: "admin-integrations__dt" }, "Last sync", -1),
				f("dd", ve, v(O.value.last_sync_at ?? "Never synced"), 1),
				n[20] ||= f("dt", { class: "admin-integrations__dt" }, "Auto-sync", -1),
				f("dd", ye, [m(o, {
			...
			f("section", xe, [n[23] ||= f("div", { class: "admin-integrations__section-head" }, [f("h2", {
				...
				actions: x(() => [m(i, {
					...
					default: x(() => [...n[21] ||= [p("Retry", -1)]]),
					_: 1
				})]),
				_: 1
			}, 8, ["description"])) : (g(), d("div", Ce, [(g(), d(c, null, le(w, (e) => f("div", {
				key: e,
				class: "admin-integrations__provider"
			}, [f("div", we, [f("span", Te, v(h[e]), 1), m(a, { tone: V(e) ? "success" : "neutral" }, {
				default: x(() => [p(v(V(e) ? "Enabled" : "Disabled"), 1)]),
				_: 2
			}, 1032, ["tone"])]), f("div", Ee, [m(o, {
				"model-value": V(e),
				label: `Enable ${h[e]}`,
			...
			m(t, {
				...
				default: x(() => [f("form", {
					...
					f("label", De, [n[24] ||= f("span", { class: "admin-integrations__label" }, "Provider URL", -1), S(f("input", {
						"onUpdate:modelValue": n[0] ||= (e) => U.value.provider_url = e,
						type: "text",
					...
					f("label", Oe, [n[25] ||= f("span", { class: "admin-integrations__label" }, "Client ID", -1), S(f("input", {
						"onUpdate:modelValue": n[1] ||= (e) => U.value.client_id = e,
						type: "text",
						class: "admin-integrations__input",
						autocomplete: "off",
						required: ""
			...
			m(t, {
				modelValue: q.value,
				"onUpdate:modelValue": n[15] ||= (e) => q.value = e,
				...
				footer: x(() => [
					...
					m(i, {
						...
						default: x(() => [...n[38] ||= [p(" Test connection ", -1)]]),
						_: 1
					}, 8, ["loading", "disabled"]),
					m(i, {
						variant: "solid",
				...
				default: x(() => [f("form", {
					...
					f("label", Fe, [n[30] ||= f("span", { class: "admin-integrations__label" }, "Host", -1), S(f("input", {
						"onUpdate:modelValue": n[6] ||= (e) => J.value.host = e,
						type: "text",
						class: "admin-integrations__input",
					...
					f("label", Ie, [n[31] ||= f("span", { class: "admin-integrations__label" }, "Port", -1), f("input", {
						value: J.value.port,
						type: "number",
						min: "1",
						max: "65535",
						class: "admin-integrations__input",
						autocomplete: "off",
						onInput: n[7] ||= (e) => ot(e.target.value)
					}, null, 40, Le)]),
					m(o, {
						modelValue: J.value.ssl,
						"onUpdate:modelValue": n[8] ||= (e) => J.value.ssl = e,
						label: "Use SSL"
					}, null, 8, ["modelValue"]),
					f("label", Re, [n[32] ||= f("span", { class: "admin-integrations__label" }, "Base DN", -1), S(f("input", {
						"onUpdate:modelValue": n[9] ||= (e) => J.value.base_dn = e,
						type: "text",
						class: "admin-integrations__input",
					...
					f("label", ze, [n[33] ||= f("span", { class: "admin-integrations__label" }, "Bind DN", -1), S(f("input", {
						"onUpdate:modelValue": n[10] ||= (e) => J.value.bind_dn = e,
						type: "text",
						class: "admin-integrations__input",
					...
					f("label", Be, [
						n[34] ||= f("span", { class: "admin-integrations__label" }, "Bind password", -1),
						f("span", Ve, v(z.value?.configured ? "Leave blank to keep the current password." : "Required when configuring for the first time."), 1),
						f("div", He, [S(f("input", {
							"onUpdate:modelValue": n[11] ||= (e) => J.value.bind_pw = e,
							type: Q.value ? "text" : "password",
							class: "admin-integrations__input",
							placeholder: z.value?.configured ? "(unchanged)" : "Bind password",
							autocomplete: "new-password"
						}, null, 8, Ue), [[y, J.value.bind_pw]]), m(i, {
							variant: "ghost",
							size: "sm",
							"left-icon": Q.value ? "eye-off" : "eye",
							"aria-label": Q.value ? "Hide password" : "Show password",
							onClick: n[12] ||= (e) => Q.value = !Q.value
						}, {
							default: x(() => [p(v(Q.value ? "Hide" : "Show"), 1)]),
							_: 1
						}, 8, ["left-icon", "aria-label"])])
					]),
					f("label", We, [n[35] ||= f("span", { class: "admin-integrations__label" }, "User filter", -1), S(f("input", {
						"onUpdate:modelValue": n[13] ||= (e) => J.value.user_filter = e,
						type: "text",
						class: "admin-integrations__input",
						placeholder: "(uid=%s)",
						autocomplete: "off"
					}, null, 512), [[b, J.value.user_filter]])]),
					f("label", Ge, [n[36] ||= f("span", { class: "admin-integrations__label" }, "Admin group DN", -1), S(f("input", {
						"onUpdate:modelValue": n[14] ||= (e) => J.value.admin_group = e,
						type: "text",
						class: "admin-integrations__input",
...
//# sourceMappingURL=IntegrationsPage-CZjDaIpw.js.map