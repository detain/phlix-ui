...
import { t as a } from "./useMessages-CLrAkqxK.js";
import { c as o, t as s } from "./client-cUL8r-1I.js";
import { n as c, o as l, t as u } from "./useUserItemDataStore-q9SuHhBR.js";
...
var Bt = ["aria-label"], Vt = ["src"], Ht = { class: "upnext__body" }, Ut = { class: "upnext__eyebrow" }, Wt = { class: "upnext__title" }, Gt = {
	...
	setup(e, { emit: n }) {
		let r = e, o = n, s = l(), d = i(), { t: f } = a(), p = u(), m = w(() => p.isFavorite(r.media.id)), h = w(() => p.likeLevel(r.media.id));
		function g() {
...
//# sourceMappingURL=Player-Bx0fnf06.js.map