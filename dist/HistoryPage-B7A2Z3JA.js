import { a as e, f as t, h as n, i as r, m as i, n as a, o, r as ee, t as s } from "./Button-C86XulWV.js";
import { t as te } from "./Modal-DaapuyD8.js";
import { t as ne } from "./Badge-BiYXL5Nz.js";
...
var T = {
	...
	role: "note"
}, R = /*#__PURE__*/ n(/* @__PURE__ */ _({
	__name: "HistoryPage",
	props: { client: {} },
	emits: ["continue"],
	setup(n, { emit: _ }) {
		let R = n, z = _, B = v("apiBase", ""), V = u(() => typeof B == "string" ? B : B?.value ?? ""), H = new c(R.client ?? new o({
			baseUrl: V.value,
			tokenStore: new e()
		})), U = r(), W = S([]), G = S(!0), K = S(!1), q = S(!1);
		async function J() {
			G.value = !0;
			try {
		...
		return b(J), (e, t) => (x(), p("section", T, [
			...
			G.value ? (x(), p("div", D, [g(a, {
				...
				}, null, 8, ie)) : (x(), p("span", ae, [g(i, { name: "film" })]))]),
				m("div", oe, [
			...
			]))), 128))]), W.value.length >= 50 ? (x(), p("p", L, " Showing " + C(W.value.length) + " items. Older items are not shown. ", 1)) : f("", !0)], 64)) : (x(), d(ee, {
				key: 1,
				icon: "film",
...
//# sourceMappingURL=HistoryPage-B7A2Z3JA.js.map