import { a as e, i as t, l as n, n as r, r as ee, t as i, u as a } from "./Button-DFtuAYup.js";
import { t as o } from "./Modal-3-gao3sJ.js";
import { t as te } from "./EmptyState-DPlVvQLn.js";
import { t as ne } from "./Badge-DypgiWDB.js";
...
var fe = {
...
}, we = { class: "admin-webhooks__secret-row" }, Te = ["type", "placeholder"], Ee = { class: "admin-webhooks__events" }, S = { class: "admin-webhooks__events-category-label" }, C = ["checked", "onChange"], w = { class: "admin-webhooks__checkbox-label" }, T = { class: "admin-webhooks__event-id" }, E = {
	key: 0,
	...
	"aria-hidden": "true"
}, Oe = { class: "admin-webhooks__test-status" }, ke = { class: "admin-webhooks__test-message" }, O = /*#__PURE__*/ a(/* @__PURE__ */ m({
	__name: "WebhooksPage",
	props: { client: {} },
	setup(a) {
		let m = a, O = oe("apiBase", ""), Ae = c(() => typeof O == "string" ? O : O?.value ?? ""), k = new ie(m.client ?? new e({
			baseUrl: Ae.value,
			tokenStore: new t()
		})), A = ee();
		function j(e, t) {
		...
		return ce(F), (e, t) => (h(), u("section", fe, [
			d("header", pe, [t[9] ||= d("h1", {
				id: "webhooks-heading",
			...
			P.value ? (h(), u("div", me, [p(r, {
				...
				_: 1
			})) : (h(), u("table", he, [t[14] ||= d("thead", null, [d("tr", null, [
				d("th", { scope: "col" }, "Name"),
				d("th", { scope: "col" }, "URL"),
			...
			p(o, {
				...
				default: b(() => [d("form", {
					...
					d("label", ve, [t[15] ||= d("span", { class: "admin-webhooks__label" }, "Name", -1), x(d("input", {
					...
					d("label", ye, [t[16] ||= d("span", { class: "admin-webhooks__label" }, "URL", -1), x(d("input", {
					...
					d("div", be, [
						d("span", xe, [t[17] ||= f(" Secret", -1), L.value ? l("", !0) : (h(), u("span", Se, " *"))]),
					...
					d("fieldset", Ee, [t[18] ||= d("legend", { class: "admin-webhooks__label" }, [f("Events"), d("span", { "aria-hidden": "true" }, " *")], -1), (h(!0), u(s, null, _(le(re), (e) => (h(), u("div", {
						key: e.label,
						class: "admin-webhooks__events-category"
					}, [d("span", S, v(e.label), 1), (h(!0), u(s, null, _(e.events, (e) => (h(), u("label", {
						key: e.id,
						...
						d("span", w, v(e.label), 1),
						d("span", T, v(e.id), 1)
					]))), 128))]))), 128))]),
					W.value ? (h(), u("p", E, v(W.value), 1)) : l("", !0)
				], 32)]),
				_: 1
			}, 8, ["modelValue", "title"]),
			p(o, {
			...
			p(o, {
				...
				default: b(() => [Z.value ? (h(), u("p", D, "Sending test payload…")) : X.value ? (h(), u("div", {
					key: 1,
					class: se(["admin-webhooks__test-result", X.value.success ? "admin-webhooks__test-result--ok" : "admin-webhooks__test-result--fail"])
				}, [d("span", De, [p(n, { name: X.value.success ? "success" : "error" }, null, 8, ["name"])]), d("div", null, [d("p", Oe, v(X.value.success ? "Delivery succeeded" : "Delivery failed"), 1), d("p", ke, v(X.value.message), 1)])], 2)) : l("", !0)]),
				_: 1
			}, 8, ["modelValue", "title"])
		]));
	}
...
//# sourceMappingURL=WebhooksPage-DBsokdnV.js.map