...
import { o as r, p as i, u as ee } from "./client-CkSYnkSD.js";
import { t as te } from "./useAuthStore-BwuHy-08.js";
import { t as ne } from "./Spinner-D26_4u3_.js";
import { t as a } from "./Button-CsFYgW7R.js";
import { t as re } from "./Modal-BbdR-K2V.js";
...
var le = { class: "match-modal" }, ue = {
	...
	setup(e, { emit: t }) {
		let f = e, P = t, F = te(), I = m(""), L = m(""), R = m([]), z = m(!1), B = m(!1), V = m(null), H = m(!1), U = m(null), W = m(null), G = m(null), K = m(!1), q = ie({
			get: () => f.modelValue,
		...
		async function Te(e) {
			if (!(!f.item || U.value)) {
				...
				try {
					...
					r(e) ? H.value = !0 : e instanceof ee && e.status === 422 ? W.value = "No match details were found for that result. Try another." : W.value = i(e, "Could not apply that match. Please try again.");
				} finally {
					U.value = null;
				}
			}
		...
		return se(() => f.modelValue, (e) => {
			...
			default: v(() => [l("div", le, [
				...
				])) : z.value ? (p(), c("div", S, [d(ne, { label: "Searching TMDB" })])) : B.value && R.value.length === 0 ? (p(), c("div", C, [
					d(n, {
						name: "search",
						class: "match-modal__state-icon"
					}),
...
//# sourceMappingURL=MetadataMatchModal-bmNxmbOT.js.map