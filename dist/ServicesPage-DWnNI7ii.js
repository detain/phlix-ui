...
var w = {
	...
	key: 0,
	class: "admin-services__dl"
}, L = { class: "admin-services__actions" }, R = /*#__PURE__*/ t(/* @__PURE__ */ _({
	__name: "ServicesPage",
	props: { client: {} },
	setup(t) {
		let _ = t, R = v("apiBase", ""), z = u(() => typeof R == "string" ? R : R?.value ?? ""), B = new c(_.client ?? new i({
			baseUrl: z.value,
			tokenStore: new e()
		})), V = n(), H = x(null), U = x(!0), W = x(!1), G = u(() => H.value?.configured === !1);
		async function K() {
			try {
		...
		return y(() => {
			...
			m("section", T, [m("div", E, [t[0] ||= m("h2", {
				...
				m("div", j, [H.value.connected ? (b(), d(o, {
					key: 1,
					variant: "outline",
					loading: W.value,
					onClick: J
			...
			])) : f("", !0), m("div", L, [Y.value.connected ? (b(), d(o, {
				key: 1,
				variant: "outline",
				loading: Z.value,
				onClick: ee
...
//# sourceMappingURL=ServicesPage-DWnNI7ii.js.map