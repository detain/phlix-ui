...
var X = class {
...
}, Fn = new X(), Z = "access_token", Q = "refresh_token", $ = "user", In = class {
	storage;
	...
	setup(t) {
		return (n, r) => t.variant === "text" ? (d(), i("div", Rn, [(d(!0), i(e, null, te(t.lines, (e) => (d(), i("span", {
			key: e,
...
}, Hn = { class: "phlix-btn__label" }, Un = /*#__PURE__*/ f(/* @__PURE__ */ s({
	__name: "Button",
	props: {
	...
	setup(e) {
		...
		return (t, s) => (d(), i("button", {
			...
			e.loading ? (d(), i("span", Vn, [o(q, { name: "spinner" })])) : r("", !0),
			e.leftIcon && !e.loading ? (d(), n(q, {
				key: 1,
				name: e.leftIcon,
				class: "phlix-btn__icon"
			}, null, 8, ["name"])) : r("", !0),
			a("span", Hn, [ne(t.$slots, "default", {}, void 0, !0)]),
			e.rightIcon ? (d(), n(q, {
				key: 2,
				name: e.rightIcon,
				class: "phlix-btn__icon"
...
//#endregion
export { X as a, Y as c, In as i, q as l, zn as n, J as o, Ln as r, Fn as s, Un as t, f as u };

//# sourceMappingURL=Button-DFtuAYup.js.map