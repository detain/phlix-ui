...
import { r as n, t as r } from "./client-DbgRjcPy.js";
...
var N = {
...
}, P = ["open"], F = { class: "series-seasons__summary" }, I = { class: "series-seasons__season-label" }, L = { class: "series-seasons__season-count numeric" }, R = { class: "series-seasons__episodes" }, z = ["aria-label", "onClick"], B = ["onClick"], V = { class: "series-seasons__episode-title" }, H = {
	key: 0,
...
}), [["__scopeId", "data-v-cc16aadc"]]), Z = { class: "season-page" }, Q = {
	key: 0,
	...
	setup(e) {
		...
		let G = f(() => A.value?.seasonPoster ?? T.value?.poster_url ?? null), K = f(() => A.value?.seasonItem?.overview ?? null);
		return (e, r) => (C(), h("div", Z, [N.value ? (C(), h("div", Q, [v(s, {
			...
			onClick: W
		}, [v(t, { name: "arrow-left" }), g("span", null, E(T.value.name), 1)]), g("div", ee, [g("div", te, [G.value ? (C(), h("img", {
			key: 0,
			...
			K.value ? (C(), h("p", ce, E(K.value), 1)) : m("", !0)
...
}), [["__scopeId", "data-v-229a99cc"]]);
//#endregion
export { ue as default };

//# sourceMappingURL=SeasonPage-Cp2_ZLbd.js.map