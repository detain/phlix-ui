...
import { c as n, f as r, t as te } from "./client-BzWwyWKr.js";
...
var ve = {
	...
	props: { client: {} },
	setup(e) {
		let ce = e, b = le("apiBase", ""), Ft = l(() => typeof b == "string" ? b : b?.value ?? ""), x = new ae(ce.client ?? new te({
			baseUrl: Ft.value,
			tokenStore: new n()
		})), It = new re(ce.client ?? new te({
			baseUrl: Ft.value,
			tokenStore: new n()
		})), S = ne();
		function C(e) {
...
//# sourceMappingURL=RemoteAccessPage-B3vv7N2F.js.map