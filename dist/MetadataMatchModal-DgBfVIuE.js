...
import { a as r, c as i, d as a, t as o } from "./Button-C1kpaQyo.js";
import { t as s } from "./useAuthStore-DmWD93w-.js";
...
var G = { class: "media-card__poster" }, K = ["href", "aria-label"], q = { class: "visually-hidden" }, J = [
	...
	setup(e, { emit: n }) {
		let r = e, i = n, a = c(), o = d(() => r.to ?? `/app/media/${r.item.id}`), { prefetch: s } = R();
		function l() {
			s(o.value);
		}
		let f = T(!1), v = T(null);
	...
	role: "alert"
}, $ = { class: "match-modal__results" }, Ee = { class: "match-modal__poster" }, De = ["src", "alt"], Oe = {
	key: 1,
	...
	setup(e, { emit: n }) {
		let c = e, v = n, y = s(), b = T(""), x = T(""), C = T([]), D = T(!1), k = T(!1), F = T(null), I = T(!1), R = T(null), z = T(null), B = d({
			get: () => c.modelValue,
		...
		async function K() {
			...
			try {
				...
				if (t() || H(e)) return;
				C.value = [], r(e) ? I.value = !0 : F.value = a(e, "Search failed. Please try again.");
			} finally {
				t() || (D.value = !1);
			}
		}
		...
		async function J(e) {
			if (!(!c.item || R.value)) {
				...
				try {
					...
					r(e) ? I.value = !0 : e instanceof i && e.status === 422 ? z.value = "No match details were found for that result. Try another." : z.value = a(e, "Could not apply that match. Please try again.");
				} finally {
					R.value = null;
				}
			}
		...
		return j(() => c.modelValue, (e) => {
			e && c.item ? (G(), b.value = c.item.name ?? "", x.value = c.item.year == null ? "" : String(c.item.year), K()) : e || (W(), G());
			...
			default: M(() => [h("div", he, [
				...
				])) : C.value.length ? (w(), m(u, { key: 5 }, [z.value ? (w(), m("p", Te, O(z.value), 1)) : p("", !0), h("ul", $, [(w(!0), m(u, null, E(C.value, (e) => (w(), m("li", {
					key: U(e),
...
//# sourceMappingURL=MetadataMatchModal-DgBfVIuE.js.map