...
var ae = {
	...
	setup(e) {
		let _ = [{
			...
			label: "AirPlay",
			icon: "tv"
		}], A = e, j = ie("apiBase", ""), Ce = u(() => typeof j == "string" ? j : j?.value ?? ""), M = new c(A.client ?? new n({
			baseUrl: Ce.value,
			tokenStore: new ee()
		})), N = re();
		function P(e) {
		...
		async function X() {
			...
			try {
				...
				V.value = i(e, "Failed to load Chromecast devices."), N.error(V.value);
			} finally {
				z.value = !1;
			}
		}
		async function Z() {
			...
			try {
				...
				H.value = i(e, "Failed to load AirPlay devices."), N.error(H.value);
			} finally {
				B.value = !1;
			}
		}
		...
		async function Q(e, t) {
			...
			try {
				...
				N.error(i(e, "Failed to load playback state."));
			} finally {
				G.value = !1;
			}
		}
...
//# sourceMappingURL=CastDevicesPage-C2JUOVfw.js.map