...
var T = {
	...
	setup(e) {
		...
		return le(F), (e, r) => (_(), f("section", T, [
			p("header", fe, [r[9] ||= p("h1", {
				id: "webhooks-heading",
			...
			N.value ? (_(), f("div", pe, [h(re, {
				...
				actions: C(() => [h(a, {
					...
					default: C(() => [...r[12] ||= [m("Add webhook", -1)]]),
					_: 1
				})]),
				_: 1
			})) : (_(), f("table", me, [r[16] ||= p("thead", null, [p("tr", null, [
				p("th", { scope: "col" }, "Name"),
				p("th", { scope: "col" }, "URL"),
			...
			h(n, {
				...
				default: C(() => [p("form", {
					...
					p("label", _e, [r[17] ||= p("span", { class: "admin-webhooks__label" }, "Name", -1), w(p("input", {
					...
					p("label", ve, [r[18] ||= p("span", { class: "admin-webhooks__label" }, "URL", -1), w(p("input", {
					...
					p("div", ye, [
						p("span", be, [r[19] ||= m(" Secret", -1), L.value ? d("", !0) : (_(), f("span", xe, " *"))]),
						L.value ? (_(), f("p", Se, "Leave blank to keep the current secret.")) : d("", !0),
						p("div", Ce, [w(p("input", {
					...
					p("fieldset", Te, [r[20] ||= p("legend", { class: "admin-webhooks__label" }, [m("Events"), p("span", { "aria-hidden": "true" }, " *")], -1), (_(!0), f(c, null, y(x(ae), (e) => (_(), f("div", {
						key: e.label,
			...
			h(n, {
				...
				footer: C(() => [h(a, {
					...
					default: C(() => [...r[25] ||= [m("Delete", -1)]]),
					_: 1
				})]),
				default: C(() => [p("p", null, [
					r[22] ||= m(" Delete webhook ", -1),
					p("strong", null, b(J.value?.name), 1),
					r[23] ||= m("? This cannot be undone. ", -1)
				])]),
				_: 1
			}, 8, ["model-value"]),
			h(n, {
...
}), [["__scopeId", "data-v-6642ed11"]]);
//#endregion
export { k as default };

//# sourceMappingURL=WebhooksPage-CpqrYtSF.js.map