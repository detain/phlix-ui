...
import { l as t, p as n, t as r } from "./client-CkSYnkSD.js";
import { t as i } from "./useToastStore-BDoKlU6N.js";
import { t as a } from "./Button-CsFYgW7R.js";
import { t as ee } from "./Badge-WQUcXG1J.js";
import { t as o } from "./Modal-BbdR-K2V.js";
import { t as s } from "./Skeleton-DhQmxeNg.js";
import { t as c } from "./EmptyState-CxJYcONU.js";
import { t as te } from "./PageHint-D0LGuRfG.js";
...
var se = { class: "admin-backup" }, ce = {
	...
	props: { client: {} },
	setup(e) {
		let _ = e, E = ie("apiBase", ""), Ae = re(() => typeof E == "string" ? E : E?.value ?? ""), D = new ne(_.client ?? new r({
			baseUrl: Ae.value,
			tokenStore: new t()
		})), O = i();
		function je(e) {
		...
		async function N() {
			...
			try {
				...
				j.value = n(e, "Failed to load backups."), O.error(j.value);
			} finally {
				A.value = !1;
			}
		}
		...
		async function z() {
			...
			try {
				...
				O.error(n(e, "Failed to create backup."));
			} finally {
				I.value = !1;
			}
		}
		...
		async function Fe() {
			...
			if (e) {
				...
				try {
					...
					O.error(n(e, "Failed to delete backup.")), G();
				}
			}
		}
		async function Ie(e) {
		...
		async function Q() {
			...
			try {
				...
				J.value = n(e, "Failed to load schedule."), O.error(J.value);
			} finally {
				q.value = !1;
			}
		}
		async function $() {
			...
			try {
				...
				O.error(n(e, "Failed to save schedule."));
			} finally {
				Z.value = !1;
			}
		}
		return ae(() => {
			...
			m("section", ce, [
				m("header", le, [t[5] ||= m("h1", {
					...
					default: C(() => [...t[4] ||= [h("Create backup", -1)]]),
					_: 1
				})]),
				g(te, {
				...
				A.value ? (v(), p("div", ue, [g(s, {
					...
					actions: C(() => [g(a, {
						...
						default: C(() => [...t[8] ||= [h("Create backup", -1)]]),
						_: 1
					})]),
					_: 1
				})) : (v(), p("table", de, [t[12] ||= m("thead", null, [m("tr", null, [
					...
					m("td", null, [m("div", _e, [
						...
						e.is_s3 ? f("", !0) : (v(), d(a, {
							...
							default: C(() => [...t[10] ||= [h(" Upload to S3 ", -1)]]),
							_: 1
						}, 8, [
							"loading",
							"aria-label",
						...
						g(a, {
							...
							default: C(() => [...t[11] ||= [h(" Delete ", -1)]]),
							_: 1
						}, 8, ["aria-label", "onClick"])
					])])
				]))), 128))])]))
			]),
			m("section", ve, [t[18] ||= m("header", { class: "admin-backup__head" }, [m("h2", {
				id: "schedule-heading",
				...
				actions: C(() => [g(a, {
					...
					default: C(() => [...t[13] ||= [h("Retry", -1)]]),
					_: 1
				})]),
				_: 1
			}, 8, ["description"])) : K.value ? (v(), p("div", be, [m("p", xe, [t[14] ||= m("span", { class: "admin-backup__next-label" }, "Next scheduled backup:", -1), K.value.next_scheduled_backup === null ? (v(), p("span", we, "Not scheduled")) : (v(), p(u, { key: 0 }, [m("span", { title: K.value.next_scheduled_backup_iso ?? "" }, b(Ne(K.value.next_scheduled_backup)), 9, Se), K.value.next_scheduled_backup_iso ? (v(), p("span", Ce, " (" + b(K.value.next_scheduled_backup_iso) + ") ", 1)) : f("", !0)], 64))]), m("form", {
				class: "admin-backup__form",
				onSubmit: T($, ["prevent"])
			}, [m("div", Te, [m("label", Ee, [t[15] ||= m("span", { class: "admin-backup__label" }, "Backup interval (days)", -1), w(m("input", {
				"onUpdate:modelValue": t[0] ||= (e) => Y.value = e,
				type: "number",
				min: "0",
				class: "admin-backup__input",
				required: ""
			}, null, 512), [[S, Y.value]])]), m("label", De, [t[16] ||= m("span", { class: "admin-backup__label" }, "Retention count", -1), w(m("input", {
				"onUpdate:modelValue": t[1] ||= (e) => X.value = e,
				type: "number",
				min: "1",
				class: "admin-backup__input",
				required: ""
			}, null, 512), [[S, X.value]])])]), m("div", Oe, [g(a, {
				variant: "solid",
				size: "sm",
				loading: Z.value,
				onClick: $
			}, {
				default: C(() => [...t[17] ||= [h(" Save schedule ", -1)]]),
				_: 1
			}, 8, ["loading"])])], 32)])) : f("", !0)]),
			g(o, {
				modelValue: P.value,
				...
				footer: C(() => [g(a, {
					...
					default: C(() => [...t[21] ||= [h("Create", -1)]]),
					_: 1
				}, 8, ["loading"])]),
				default: C(() => [m("form", {
					class: "admin-backup__form",
					onSubmit: T(z, ["prevent"])
				}, [m("label", ke, [t[19] ||= m("span", { class: "admin-backup__label" }, "Label (optional)", -1), w(m("input", {
			...
			g(o, {
				...
				footer: C(() => [g(a, {
					...
					default: C(() => [...t[23] ||= [h(" Restore ", -1)]]),
					_: 1
				}, 8, ["loading"])]),
				default: C(() => [t[24] ||= m("p", null, [h("This will overwrite your current data. "), m("strong", null, "Continue?")], -1)]),
				_: 1
			}, 8, ["model-value"]),
			g(o, {
				...
				footer: C(() => [g(a, {
					...
					default: C(() => [...t[28] ||= [h(" Delete ", -1)]]),
					_: 1
				}, 8, ["loading"])]),
				default: C(() => [m("p", null, [
					t[25] ||= h(" Are you sure you want to delete backup ", -1),
					m("strong", null, b(U.value?.label || U.value?.id), 1),
					t[26] ||= h("? This cannot be undone. ", -1)
				])]),
				_: 1
			}, 8, ["model-value"])
		]));
...
//# sourceMappingURL=BackupPage-D24ZP3Xr.js.map