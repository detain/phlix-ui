...
import { n as s } from "./media-query-DtVaZzBp.js";
import { t as c } from "./MediaDetail-CScmfNhc.js";
...
var E = { class: "media-detail-page" }, D = {
	...
	setup(e) {
		let g = _("apiBase", ""), A = l(() => typeof g == "string" ? g : g?.value ?? ""), j = w(), M = T(), N = r(), P = i(), F = x(null), I = x([]), L = x(!0), R = x(!1), z = x(null), B = l(() => String(j.params.id ?? "")), V = l(() => N.resumePositionFor(B.value)), H = null, U = !1;
		function W(e) {
		...
		async function G(e, t) {
			...
			try {
				...
				if (i()) return;
				I.value = (o.items ?? []).filter((e) => e.id !== t.id).slice(0, 12);
			} catch (e) {
				if (i() || W(e)) return;
				I.value = [];
			} finally {
		...
		return (e, t) => (b(), f("div", E, [L.value ? (b(), f("div", D, [p("div", O, [h(a, {
			variant: "rect",
...
//# sourceMappingURL=MediaDetailPage-3i1Hh5MR.js.map