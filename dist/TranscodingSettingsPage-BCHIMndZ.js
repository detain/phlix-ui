...
import { t } from "./useMessages-nO4j4SSL.js";
import { l as n, p as ee, t as r, u as te } from "./client-COHWZ2KC.js";
...
import { t as ie } from "./Skeleton-jlFj-j5t.js";
...
var de = class {
	...
	props: { client: {} },
	setup(e) {
		let g = e, N = oe("apiBase", ""), P = u(() => typeof N == "string" ? N : N?.value ?? ""), F = new de(g.client ?? new r({
			baseUrl: P.value,
			tokenStore: new n()
		})), I = ne(), { t: L } = t(), ye = [
			{
		...
		async function xe() {
			...
			try {
				...
				I.error(e instanceof te ? e.message : "Failed to save transcoding settings.");
			} finally {
				W.value = !1;
			}
		}
...
//# sourceMappingURL=TranscodingSettingsPage-BCHIMndZ.js.map