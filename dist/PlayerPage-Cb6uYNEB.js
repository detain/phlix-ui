...
import { t as s } from "./Player-C_rJOD0T.js";
...
var O = { class: "player-page__stage" }, k = {
	...
	__name: "PlayerPage",
	setup(e) {
		let h = g("apiBase", ""), A = c(() => typeof h == "string" ? h : h?.value ?? ""), j = E(), M = D(), N = i(), P = S(null), F = S(""), I = S([]), L = S(null), R = S(null), z = S(!0), B = S(null), V = S(!1), H = c(() => String(j.params.id ?? "")), U = c(() => {
		...
		return (e, t) => (x(), d("div", { class: _(["player-page", { "is-theater": V.value }]) }, [U.value && !z.value && !B.value ? (x(), d("div", {
			...
			style: v(U.value),
			"aria-hidden": "true"
		}, null, 4)) : u("", !0), f("div", O, [z.value ? (x(), d("div", k, [m(a, {
			variant: "rect",
...
}), [["__scopeId", "data-v-13d94d02"]]);
//#endregion
export { A as default };

//# sourceMappingURL=PlayerPage-Cb6uYNEB.js.map