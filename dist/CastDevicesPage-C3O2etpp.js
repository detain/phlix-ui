...
var oe = {
	...
	role: "group",
	"aria-label": "Seek"
}, M = { class: "admin-cast__time" }, N = { class: "admin-cast__time" }, P = { class: "admin-cast__buttons" }, F = /*#__PURE__*/ n(/* @__PURE__ */ m({
	...
	setup(n) {
		let m = [{
			...
			label: "AirPlay",
			icon: "tv"
		}], F = n, I = h("apiBase", ""), L = c(() => typeof I == "string" ? I : I?.value ?? ""), R = new re(F.client ?? new e({
			baseUrl: L.value,
			tokenStore: new t()
		})), z = ee();
		function B(e, t) {
		...
		return ae(() => {
			...
			d("div", {
				...
				}, [d("span", me, [p(i, { name: ve.value }, null, 8, ["name"])]), d("span", he, [d("span", {
...
//# sourceMappingURL=CastDevicesPage-C3O2etpp.js.map