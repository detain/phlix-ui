...
var D = {
	...
	emits: ["success"],
	setup(n, { emit: g }) {
		let A = g, j = a(), M = s(), N = E(), { t: P } = i(), F = _("phlixConfig", null), I = l(() => F?.home ?? F?.routerBase ?? "/app"), L = l(() => `${F?.routerBase ?? "/app"}/signup`), R = y(""), z = y(""), B = y(null), V = y(null);
		function H() {
...
//# sourceMappingURL=LoginForm-B1e_o90G.js.map