...
import { t as s } from "./Switch-V3wRpG4-.js";
	...
	setup(n) {
		...
		return oe(() => {
			...
			d("section", le, [d("div", ue, [t[16] ||= d("h2", {
				...
				_: 1
			}, 8, ["tone"])) : l("", !0)]), d("div", de, [A.value ? (h(), u("div", fe, [p(i, {
				variant: "text",
				lines: 3
			...
			d("section", ve, [t[20] ||= d("div", { class: "admin-integrations__section-head" }, [d("h2", {
				...
				class: "admin-integrations__section-title"
			}, " Authentication providers ")], -1), I.value ? (h(), u("div", ye, [p(i, {
				variant: "text",
				lines: 4
...
//# sourceMappingURL=IntegrationsPage-By_R_AGK.js.map