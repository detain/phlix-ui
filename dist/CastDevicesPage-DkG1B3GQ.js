...
import { n as ne, t as re } from "./cast-BZACqu1l.js";
...
var oe = {
	...
	role: "group",
	"aria-label": "Seek"
}, M = { class: "admin-cast__time" }, N = { class: "admin-cast__time" }, P = { class: "admin-cast__buttons" }, F = /*#__PURE__*/ r(/* @__PURE__ */ m({
	...
	setup(r) {
		let m = [{
			...
			label: "AirPlay",
			icon: "tv"
		}], F = r, I = h("apiBase", ""), L = c(() => typeof I == "string" ? I : I?.value ?? ""), R = new re(F.client ?? new e({
			baseUrl: L.value,
			tokenStore: new ee()
		})), z = n();
		function B(e, t) {
		...
		return ae(() => {
			...
			n[6] ||= d("header", { class: "admin-cast__head" }, [d("h1", {
				id: "cast-heading",
			...
			d("div", {
				...
				}, [d("span", me, [p(t, { name: ve.value }, null, 8, ["name"])]), d("span", he, [d("span", {
				...
				q.value ? (_(), u("section", C, [n[5] ||= d("h2", {
					id: "transport-heading",
					class: "admin-cast__subtitle"
				}, "Playback Controls", -1), Y.value ? (_(), u("div", w, [...n[0] ||= [d("p", {
					role: "status",
					...
					d("div", P, [
						...
						p(i, {
							...
							default: x(() => [...n[4] ||= [f(" Stop ", -1)]]),
							_: 1
						}, 8, ["disabled"])
					])
				])) : (_(), u("div", T, [...n[1] ||= [d("p", { class: "admin-cast__muted" }, "Select a device to view playback controls.", -1)]]))])) : l("", !0)
			], 8, le)
		]));
	}
...
//# sourceMappingURL=CastDevicesPage-DkG1B3GQ.js.map