...
import { t as n } from "./useMessages-ClxxG1xp.js";
import { a as r, f as i, l as a } from "./client-7SOKWho6.js";
import { t as o } from "./useAuthStore-TsBE0ENb.js";
import { i as s } from "./usePlayerStore-DmNlaYQc.js";
import { t as c } from "./Button-k7aQagzg.js";
import { t as l } from "./Modal-DQiZ0eAJ.js";
import { Fragment as u, computed as d, createBlock as f, createCommentVNode as p, createElementBlock as m, createElementVNode as h, createTextVNode as g, createVNode as _, defineComponent as v, inject as y, normalizeClass as b, normalizeStyle as x, onBeforeUnmount as S, onMounted as C, openBlock as w, ref as T, renderList as E, renderSlot as D, toDisplayString as O, unref as k, vModelText as A, watch as j, withCtx as M, withDirectives as N, withModifiers as P } from "vue";
import { routerKey as F } from "vue-router";
//#region src/components/ui/Spinner.vue?vue&type=script&setup=true&lang.ts
var I = ["aria-label"], L = /*#__PURE__*/ e(/* @__PURE__ */ v({
	__name: "Spinner",
	props: {
		size: {},
		label: {}
...
function R() {
	let e = y(F, null), t = /* @__PURE__ */ new WeakSet();
	function n(n) {
		if (!e) return;
		let r;
		try {
...
var G = { class: "media-card__poster" }, K = ["href", "aria-label"], q = { class: "visually-hidden" }, J = [
	"src",
	"srcset",
	"sizes",
	"alt"
	...
	setup(e, { emit: n }) {
		let r = e, i = n, a = s(), o = d(() => r.to ?? `/app/media/${r.item.id}`), { prefetch: c } = R();
		function l() {
			c(o.value);
		}
		let f = T(!1), v = T(null);
		...
		let S = d(() => W(r.posterSrcset ?? r.item.poster_srcset, r.posterSizes)), k = d(() => {
		...
		return (n, r) => (w(), m("article", {
			...
			e.item.poster_url ? (w(), m("img", {
				...
				decoding: "async",
				onLoad: y
			}, null, 42, J)) : (w(), m("div", ee, [_(t, { name: e.item.type === "audio" ? "music" : e.item.type === "image" ? "image" : e.item.type === "series" ? "tv" : "film" }, null, 8, ["name"])])),
			h("div", te, [
			...
			h("div", Q, [
				...
				h("div", ue, [
					h("button", {
						...
						"aria-label": "Play",
						onClick: r[0] ||= P((t) => i("play", e.item), ["stop", "prevent"])
					}, [_(t, { name: "play" })]),
					h("button", {
						type: "button",
						class: "media-card__iconbtn",
						"aria-label": "Add to watchlist",
						onClick: r[1] ||= P((t) => i("watchlist", e.item), ["stop", "prevent"])
					}, [_(t, { name: "bookmark-plus" })]),
					h("button", {
						type: "button",
						class: "media-card__iconbtn",
						"aria-label": "More info",
						onClick: r[2] ||= P((t) => i("info", e.item), ["stop", "prevent"])
					}, [_(t, { name: "info" })]),
					e.canMatch ? (w(), m("button", {
						...
						onClick: r[3] ||= P((t) => i("match", e.item), ["stop", "prevent"])
					}, [_(t, { name: "search" })])) : p("", !0),
...
}), [["__scopeId", "data-v-ee50582c"]]), he = { class: "match-modal" }, ge = {
	key: 0,
	...
	role: "alert"
}, Ee = { class: "match-modal__results" }, $ = { class: "match-modal__poster" }, De = ["src", "alt"], Oe = {
	key: 1,
	...
	setup(e, { emit: n }) {
		let s = e, v = n, y = o(), b = T(""), x = T(""), C = T([]), D = T(!1), k = T(!1), F = T(null), I = T(!1), R = T(null), z = T(null), B = d({
			get: () => s.modelValue,
		...
		function G() {
			C.value = [], D.value = !1, k.value = !1, F.value = null, I.value = !1, R.value = null, z.value = null;
		}
		async function K() {
			if (!s.item) return;
			V?.abort();
			...
			V = e;
			let t = () => V !== e;
			D.value = !0, k.value = !0, F.value = null, I.value = !1, z.value = null;
			try {
				let n = await y.client.matchSearch(s.item.id, {
				...
				if (t() || H(e)) return;
				C.value = [], r(e) ? I.value = !0 : F.value = i(e, "Search failed. Please try again.");
			} finally {
				t() || (D.value = !1);
			}
		}
		...
		async function J(e) {
			if (!(!s.item || R.value)) {
				R.value = U(e), z.value = null;
				try {
					v("applied", (await y.client.matchApply(s.item.id, {
						tmdb_id: e.tmdb_id,
						type: e.type
					})).item), B.value = !1;
				} catch (e) {
					r(e) ? I.value = !0 : e instanceof a && e.status === 422 ? z.value = "No match details were found for that result. Try another." : z.value = i(e, "Could not apply that match. Please try again.");
				} finally {
					R.value = null;
				}
			}
		}
		return j(() => s.modelValue, (e) => {
			e && s.item ? (G(), b.value = s.item.name ?? "", x.value = s.item.year == null ? "" : String(s.item.year), K()) : e || (W(), G());
		}, { immediate: !0 }), S(W), (n, r) => (w(), f(l, {
			modelValue: B.value,
			...
			default: M(() => [h("div", he, [
				...
				I.value ? (w(), m("div", be, [
				...
				])) : D.value ? (w(), m("div", Ce, [_(L, { label: "Searching TMDB" })])) : k.value && C.value.length === 0 ? (w(), m("div", we, [
					_(t, {
						name: "search",
						class: "match-modal__state-icon"
					}),
				...
				])) : C.value.length ? (w(), m(u, { key: 5 }, [z.value ? (w(), m("p", Te, O(z.value), 1)) : p("", !0), h("ul", Ee, [(w(!0), m(u, null, E(C.value, (e) => (w(), m("li", {
					key: U(e),
					class: "match-modal__result"
				}, [
					h("div", $, [e.poster_url ? (w(), m("img", {
						key: 0,
						src: e.poster_url,
						alt: e.title,
						loading: "lazy",
					...
					_(c, {
						...
						size: "sm",
						loading: R.value === U(e),
						disabled: R.value !== null && R.value !== U(e),
						onClick: (t) => J(e)
					}, {
...
//#endregion
export { L as i, me as n, R as r, Pe as t };

//# sourceMappingURL=MetadataMatchModal-A_zEqVV0.js.map