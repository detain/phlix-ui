import { d as e, n as t, t as n } from "./Button-C4PyCjLX.js";
...
import { t as c } from "./MediaDetail-BYiRtjC7.js";
...
var E = { class: "media-detail-page" }, D = {
	...
	setup(e) {
		let g = _("apiBase", ""), A = l(() => typeof g == "string" ? g : g?.value ?? ""), j = w(), M = T(), N = r(), P = a(), F = x(null), I = x([]), L = x(!0), R = x(!1), z = x(null), B = l(() => String(j.params.id ?? "")), V = l(() => N.resumePositionFor(B.value)), H = null, U = !1;
		function W(e) {
...
//# sourceMappingURL=MediaDetailPage-CdmLOmmN.js.map