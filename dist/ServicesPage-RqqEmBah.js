...
var w = {
	...
	key: 0,
	class: "admin-services__dl"
}, L = { class: "admin-services__actions" }, R = /*#__PURE__*/ n(/* @__PURE__ */ _({
	__name: "ServicesPage",
	props: { client: {} },
	setup(n) {
		let _ = n, R = v("apiBase", ""), z = u(() => typeof R == "string" ? R : R?.value ?? ""), B = new c(_.client ?? new e({
			baseUrl: z.value,
			tokenStore: new a()
		...
		return y(() => {
			...
			m("section", T, [m("div", E, [t[0] ||= m("h2", {
				...
				_: 1
			}, 8, ["tone", "label"]))]), m("div", D, [U.value ? (b(), p("div", O, [g(i, {
				variant: "text",
				lines: 2
			})])) : H.value === null ? (b(), d(o, {
				key: 1,
				...
				m("div", j, [H.value.connected ? (b(), d(r, {
					key: 1,
					variant: "outline",
					loading: W.value,
					onClick: J
			...
			m("section", M, [m("div", N, [t[4] ||= m("h2", {
				...
				_: 1
			}, 8, ["tone", "label"]))]), m("div", P, [X.value ? (b(), p("div", F, [g(i, {
				variant: "text",
				lines: 2
			})])) : Y.value === null ? (b(), d(o, {
				key: 1,
			...
			])) : f("", !0), m("div", L, [Y.value.connected ? (b(), d(r, {
				key: 1,
				variant: "outline",
				loading: Z.value,
				onClick: ee
...
//# sourceMappingURL=ServicesPage-RqqEmBah.js.map