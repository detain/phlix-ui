...
var ae = { class: "admin-backup" }, oe = {
	...
	key: 1,
	class: "admin-backup__muted"
}, Ce = { class: "admin-backup__form-row" }, we = { class: "admin-backup__field" }, Te = { class: "admin-backup__field" }, w = { class: "admin-backup__form-actions" }, T = { class: "admin-backup__field" }, E = /*#__PURE__*/ n(/* @__PURE__ */ h({
	__name: "BackupPage",
	props: { client: {} },
	setup(n) {
		let h = n, E = re("apiBase", ""), D = c(() => typeof E == "string" ? E : E?.value ?? ""), O = new ne(h.client ?? new e({
			baseUrl: D.value,
			tokenStore: new t()
		})), k = i();
		function A(e, t) {
		...
		return ie(() => {
			...
			f("section", ge, [t[15] ||= f("header", { class: "admin-backup__head" }, [f("h2", {
				...
				class: "admin-backup__input",
				required: ""
			}, null, 512), [[b, Z.value]])])]), f("div", w, [m(a, {
				variant: "solid",
				size: "sm",
				loading: Q.value,
				onClick: $
...
//# sourceMappingURL=BackupPage-B7Dm374m.js.map