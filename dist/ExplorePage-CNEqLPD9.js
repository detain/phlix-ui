	...
	setup(e) {
		...
		async function H() {
			...
			if (e) {
				...
				try {
					let n = await new t({ baseUrl: k.value }).get(`/api/v1/media/${encodeURIComponent(e)}/similar`, { limit: "20" });
					F.value = (n.items ?? []).map(V), z.value = F.value.length, R.value = !1;
				} catch (e) {
...
//# sourceMappingURL=ExplorePage-CNEqLPD9.js.map