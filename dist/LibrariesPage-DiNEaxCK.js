import { a as e, i as t, l as n, n as r, r as i, t as ee } from "./tokenStore-SjxKwmod.js";
import { t as a } from "./Modal-D0ntqq7y.js";
import { t as o } from "./EmptyState-sJb64K4c.js";
import { t as te } from "./Select-CfjCFQKH.js";
import { t as s } from "./Badge-wMoO7SFO.js";
import { n as c, t as ne } from "./libraries-CXAz_kXs.js";
...
var se = {
...
}, xe = { class: "admin-libraries__date" }, Se = { class: "admin-libraries__date" }, Ce = 2e3, T = /*#__PURE__*/ n(/* @__PURE__ */ _({
	...
	setup(n) {
		let _ = n, T = re("apiBase", ""), we = u(() => typeof T == "string" ? T : T?.value ?? ""), E = new ne(_.client ?? new e({
			baseUrl: we.value,
			tokenStore: new ee()
		...
		return ae(R), ie(() => {
			...
			N.value ? (v(), p("div", le, [g(i, {
				variant: "text",
				lines: 6
			})])) : M.value.length === 0 ? (v(), d(o, {
				key: 1,
				icon: "film",
			...
			])], -1), m("tbody", null, [(v(!0), p(l, null, b(M.value, (e) => (v(), p("tr", { key: e.id }, [
			...
			g(a, {
				...
				default: C(() => [Q.value ? (v(), p("div", ye, [g(i, {
					variant: "text",
					lines: 4
				})])) : Z.value.length === 0 ? (v(), d(o, {
					key: 1,
					icon: "list",
					title: "No scans yet"
...
//# sourceMappingURL=LibrariesPage-DiNEaxCK.js.map