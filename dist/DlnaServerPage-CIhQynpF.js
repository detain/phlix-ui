...
}, k = { class: "admin-dlna__actions" }, A = /*#__PURE__*/ a(/* @__PURE__ */ _({
	__name: "DlnaServerPage",
	props: { client: {} },
	setup(a) {
		let _ = a, A = v("apiBase", ""), j = u(() => typeof A == "string" ? A : A?.value ?? ""), M = new c(_.client ?? new e({
			baseUrl: j.value,
			tokenStore: new t()
		})), N = r(), P = x(null), F = x(!0), I = x(!1), L = u(() => P.value?.running ?? !1), R = u(() => P.value?.enabled ?? !1);
		async function z() {
			F.value = !0;
			try {
...
//# sourceMappingURL=DlnaServerPage-CIhQynpF.js.map