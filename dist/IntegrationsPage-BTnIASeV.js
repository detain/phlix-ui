...
var ue = {
	...
	setup(e) {
		let m = {
			oidc: "OIDC",
			ldap: "LDAP"
		}, w = ["oidc", "ldap"], qe = e, T = oe("apiBase", ""), Je = ae(() => typeof T == "string" ? T : T?.value ?? ""), E = new ie(qe.client ?? new n({
			baseUrl: Je.value,
			tokenStore: new ee()
		})), D = re(), O = g(null), k = g(!0), A = g(null), j = g(!1), M = null;
		function N() {
		...
		return ce(() => {
			...
			d("section", be, [t[22] ||= d("div", { class: "admin-integrations__section-head" }, [d("h2", {
				...
				class: "admin-integrations__section-title"
			}, " Authentication providers ")], -1), I.value ? (h(), u("div", xe, [p(a, {
				variant: "text",
				lines: 4
			})])) : L.value ? (h(), c(o, {
				key: 1,
			...
			}, [d("div", Ce, [d("span", we, _(m[e]), 1), p(te, { tone: V(e) ? "success" : "neutral" }, {
				default: b(() => [f(_(V(e) ? "Enabled" : "Disabled"), 1)]),
				_: 2
			}, 1032, ["tone"])]), d("div", Te, [p(i, {
				"model-value": V(e),
				label: `Enable ${m[e]}`,
...
//# sourceMappingURL=IntegrationsPage-BTnIASeV.js.map