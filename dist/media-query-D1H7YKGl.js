...
var u = r("phlix-player", () => {
	...
	function j(e, t = {}) {
		i.value = e, t.streamUrl !== void 0 && (a.value = t.streamUrl), t.resetPosition !== !1 && (d.value = 0, f.value = 0, p.value = 0), K(e);
	}
	function M(e, t, n) {
...
function f(e, t = {}) {
	return `${e}/api/v1/media?${d(t)}`;
}
//#endregion
export { c as a, i, f as n, u as o, a as r, d as t };

//# sourceMappingURL=media-query-D1H7YKGl.js.map