...
import { c as n, f as r, t as i } from "./client-cUL8r-1I.js";
...
var ie = {
	...
	setup(e) {
		let v = [{
			...
			label: "AirPlay",
			icon: "tv"
		}], A = e, j = re("apiBase", ""), Ce = d(() => typeof j == "string" ? j : j?.value ?? ""), M = new ne(A.client ?? new i({
			baseUrl: Ce.value,
			tokenStore: new n()
		})), N = ee();
		function P(e) {
		...
		return b(() => {
			...
			h("div", {
				...
				U.value ? (x(), m("section", he, [n[6] ||= h("h2", {
					...
					h("div", ye, [h("p", be, w(W.value.mediaTitle || "No media"), 1), h("p", xe, [_(te, { tone: W.value.isPlaying ? "success" : "neutral" }, {
...
//# sourceMappingURL=CastDevicesPage-CyamFERt.js.map