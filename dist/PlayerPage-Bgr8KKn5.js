...
import { t as x } from "./Spinner-B4iosRsg.js";
...
import { t as D } from "./Select-D5GWWuWl.js";
import { t as ee } from "./Modal-BUR3rht6.js";
...
var Jn = ["aria-label"], Yn = ["src"], Xn = { class: "upnext__body" }, Zn = { class: "upnext__eyebrow" }, Qn = { class: "upnext__title" }, $n = {
	...
	setup(e) {
		...
		return (e, n) => Y(i).isInRoom ? (G(), R("div", Yr, [
			...
			z("div", $r, [z("span", ei, [V(t, { name: "user" }), B(" " + J(u.value) + " " + J(Y(r)("syncplay.members", { count: u.value })), 1)]), z("ul", ti, [(G(!0), R(P, null, q(Y(i).onlineMembers.slice(0, 5), (e) => (G(), R("li", {
				key: e.id,
