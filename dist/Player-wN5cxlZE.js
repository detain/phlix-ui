...
import { t as a } from "./useMessages-CLMH99Oy.js";
...
import { t as u } from "./Select-Ia95mIJq.js";
...
function me(e) {
	let t = I("idle"), n = I(0), r = e.attach ?? q, i = e.pollIntervalMs ?? 1e3, a = e.maxWaitMs ?? 12e4, s = e.sleep ?? ((e) => new Promise((t) => setTimeout(t, e))), c = Math.max(1, Math.ceil(a / Math.max(1, i))), l = he(), u = e.getToken ?? (() => ge(l)), d = null, f = !1;
	function p() {
	...
	async function m(a, o, l = "web") {
		...
		try {
			let m = p(), h = ue(await m.post(ce(o, l)));
			if (f) return;
			if (!h.jobId || !h.masterUrl) throw Error("transcode start returned no job");
			let g = X(e.apiBase(), h.masterUrl), _ = h.status === "completed";
			for (let e = 0; !_ && e < c; e++) {
				let e = de(await m.get(le(h.jobId)));
				if (f) return;
				if (n.value = e.progress, pe(e.status)) throw Error(`transcode ${e.status}`);
				if (fe(e)) {
					_ = !0;
					break;
				}
...
function Se(e, t) {
	switch (e.key) {
		case " ": return be(e.target) ? !1 : (t.playPause(), !0);
		case "k":
...
function Ce(e, t = {}) {
	function n(n) {
		t.enabled && !t.enabled() || n.ctrlKey || n.metaKey || n.altKey || xe(n.target) || Se(n, e) && n.preventDefault();
	}
	te(() => {
...
var we = ["aria-label"], Te = { class: "shortcuts__head" }, Ee = { class: "shortcuts__title" }, Z = { class: "shortcuts__grid" }, De = { class: "shortcuts__keys" }, Oe = {
	key: 0,
...
}, Ae = { class: "shortcuts__label" }, je = /*#__PURE__*/ e(/* @__PURE__ */ j({
	__name: "ShortcutsHelp",
	props: {
		open: { type: Boolean },
		shortcuts: { default: () => _e }
	},
	emits: ["close"],
	setup(e, { emit: i }) {
		...
		return r(l, z(o, "open"), {
			...
			tabindex: "-1"
		}, [O("div", Te, [O("h3", Ee, R(B(c)("player.keyboard")), 1), A(n, {
			name: "x",
			label: B(c)("common.close"),
			size: "sm",
			onClick: i[0] ||= (e) => s("close")
		}, null, 8, ["label"])]), O("ul", Z, [(F(!0), D(S, null, L(e.shortcuts, (e) => (F(), D("li", {
			key: e.id,
			class: "shortcuts__row"
		}, [O("span", De, [(F(!0), D(S, null, L(e.keys, (e, n) => (F(), D(S, { key: n }, [e === "–" ? (F(), D("span", Oe, "–")) : (F(), D("kbd", ke, [B(ve)[e] ? (F(), T(t, {
			key: 0,
			name: B(ve)[e],
			label: B(ye)[e] ?? e
		}, null, 8, ["name", "label"])) : (F(), D(S, { key: 1 }, [k(R(e), 1)], 64))]))], 64))), 128))]), O("span", Ae, R(e.label), 1)]))), 128))])], 8, we)])) : E("", !0);
	}
}), [["__scopeId", "data-v-f3720b12"]]), Me = { class: "volume" }, Ne = /*#__PURE__*/ e(/* @__PURE__ */ j({
...
}), [["__scopeId", "data-v-b3fb9c33"]]), Pe = /*#__PURE__*/ e(/* @__PURE__ */ j({
	__name: "SpeedMenu",
	setup(e) {
		let t = [
			.25,
...
}), [["__scopeId", "data-v-5b5c018e"]]), Fe = /*#__PURE__*/ e(/* @__PURE__ */ j({
	__name: "QualityMenu",
...
}), [["__scopeId", "data-v-4de62ece"]]), Ie = /*#__PURE__*/ e(/* @__PURE__ */ j({
...
}), [["__scopeId", "data-v-15a0f3c5"]]), Le = ["aria-label", "aria-expanded"], Re = ["aria-label"], ze = { class: "capmenu__head" }, Be = { class: "capmenu__title" }, Ve = ["aria-label"], He = ["aria-checked", "tabindex"], Ue = { class: "capmenu__check" }, We = { class: "capmenu__optlabel" }, Ge = [
	"aria-checked",
	"tabindex",
	"onClick"
], Q = { class: "capmenu__check" }, Ke = { class: "capmenu__optlabel" }, qe = { class: "capmenu__title capmenu__title--sub" }, Je = ["aria-label"], Ye = [
	"aria-checked",
	"tabindex",
	"onClick"
], Xe = { class: "capmenu__check" }, Ze = { class: "capmenu__optlabel" }, Qe = { class: "capmenu__title capmenu__title--sub" }, $e = { class: "capmenu__style" }, et = { class: "capmenu__field" }, tt = { class: "capmenu__fieldlabel" }, nt = { class: "capmenu__field" }, rt = { class: "capmenu__fieldlabel" }, $ = { class: "capmenu__field" }, it = { class: "capmenu__fieldlabel" }, at = { class: "capmenu__field" }, ot = { class: "capmenu__fieldlabel" }, st = /*#__PURE__*/ e(/* @__PURE__ */ j({
	__name: "CaptionsMenu",
	props: {
		tracks: { default: () => [] },
		audioTracks: { default: () => [] },
	...
	setup(e, { emit: o }) {
		...
		return V(() => s.open, (e) => {
		...
		}, [A(t, { name: ee.value }, null, 8, ["name"])], 10, Le), e.open ? (F(), D("div", {
			key: 0,
			ref_key: "panelEl",
			ref: g,
			...
			O("div", ze, [O("h3", Be, R(B(p)("player.subtitles")), 1), A(n, {
				name: "x",
			...
			}, [O("span", Ue, [y.value ? E("", !0) : (F(), T(t, {
				key: 0,
				name: "check"
			}))]), O("span", We, R(B(p)("player.off")), 1)], 8, He), (F(!0), D(S, null, L(e.tracks, (e, n) => (F(), D("button", {
				key: e.language,
				type: "button",
				class: "capmenu__opt",
				role: "radio",
			...
			}, [O("span", Q, [v.value === e.language ? (F(), T(t, {
				key: 0,
				name: "check"
			})) : E("", !0)]), O("span", Ke, R(e.label), 1)], 8, Ge))), 128))], 40, Ve),
			e.audioTracks.length > 1 ? (F(), D(S, { key: 0 }, [O("h3", qe, R(B(p)("player.audio")), 1), O("div", {
				...
				onClick: (e) => H(n.index)
			}, [O("span", Xe, [e.activeAudio === n.index ? (F(), T(t, {
				key: 0,
				name: "check"
			})) : E("", !0)]), O("span", Ze, R(n.label), 1)], 8, Ye))), 128))], 40, Je)], 64)) : E("", !0),
			O("h3", Qe, R(B(p)("player.captionStyle")), 1),
			O("div", $e, [
				O("div", et, [O("span", tt, R(B(p)("player.size")), 1), A(u, {
				...
				O("div", nt, [O("span", rt, R(B(p)("player.color")), 1), A(u, {
				...
				O("div", $, [O("span", it, R(B(p)("player.background")), 1), A(u, {
...
var Pt = ["aria-label"], Ft = ["src"], It = { class: "upnext__body" }, Lt = { class: "upnext__eyebrow" }, Rt = { class: "upnext__title" }, zt = {
...
}, mn = ["aria-label"], hn = { class: "player__btnrow" }, gn = ["aria-label"], _n = { class: "player__time numeric" }, vn = ["aria-label"], yn = ["aria-label", "aria-pressed"], bn = ["aria-label", "aria-pressed"], xn = ["aria-label"], Sn = /*#__PURE__*/ e(/* @__PURE__ */ j({
	__name: "Player",
	props: {
		media: {},
		streamUrl: {},
	...
	setup(e, { emit: n }) {
		let r = e, o = n, s = c(), l = i(), { t: u } = a(), d = [
			...
			1.75,
			2
		], f = I(null), p = I(null), m = I(!0), h = I(!1), _ = I(!1), b = I(!1), x = I(!1), C = I(!1), j = I(!1), N = w(() => x.value ? 1.35 : 1), z = I(Ot(r.streamUrl, r.media.path)), H = me({ apiBase: () => r.apiBase ?? "" }), ne = w(() => z.value ? void 0 : r.streamUrl), G = w(() => z.value && H.state.value !== "ready"), re = w(() => z.value && (H.state.value === "preparing" || H.state.value === "idle")), ie = w(() => z.value && H.state.value === "error");
		function K() {
			let e = f.value;
			e && H.start(e, r.media.id);
		}
		let q = I(s.resumePositionFor(r.media.id) ?? 0), oe = I(!z.value && q.value > 0), J = null, Y = I(!1), se = I(8), ce, le = w(() => s.upNext);
		function ue() {
			z.value = Ot(r.streamUrl, r.media.path), q.value = s.resumePositionFor(r.media.id) ?? 0, oe.value = !z.value && q.value > 0, J = null, X(), Y.value = !1, H.reset(), z.value && K();
		}
		function de(e) {
			let t = f.value;
		...
		function fe() {
			de(q.value), oe.value = !1, f.value?.play()?.catch(() => {});
		}
		function pe() {
			J = null, de(0), s.clearResume(r.media.id), oe.value = !1, f.value?.play()?.catch(() => {});
		}
		function X() {
			ce &&= (clearInterval(ce), void 0);
		}
		function he() {
			se.value = 8, X(), ce = setInterval(() => {
				--se.value, se.value <= 0 && (X(), _e());
			}, 1e3);
		}
		function ge() {
			s.upNext && (Y.value = !0, l.autoplay && he());
		}
		function _e() {
			X(), Y.value = !1;
		...
		let be = I([]), xe = I([]), Se = I(-1), we = I(!1), Te = s.subtitleLang, Ee = w(() => be.value.some((e) => e.language === s.subtitleLang));
		function Z() {
			let e = f.value;
			be.value = g(e), xe.value = y(e), Se.value = v(e);
		}
		function De() {
			if (Ee.value) Te = s.subtitleLang, s.setSubtitle(null);
			else {
				let e = Te && be.value.some((e) => e.language === Te) ? Te : be.value[0]?.language ?? null;
				s.setSubtitle(e);
			}
			o("captions");
		}
		function Oe(e) {
			ee(f.value, e), Se.value = e;
		}
		let ke = null, Ae, Me = w(() => {
			let e = [];
		...
		function Ve() {
			let e = f.value;
			e && (s.updateProgress(e.currentTime, e.duration, Re(e)), s.setMediaPositionState());
		}
		function He() {
			let e = f.value;
			e && (e.volume = s.volume, e.muted = s.muted, e.playbackRate = s.rate, J !== null && (e.currentTime = e.duration ? Math.min(e.duration, J) : J, J = null), s.updateProgress(e.currentTime, e.duration, Re(e)), s.setMediaPositionState(), Z());
		}
		function Ue() {
			let e = f.value;
			e && s.updateProgress(e.currentTime, e.duration, Re(e));
		}
		function We() {
			let e = f.value;
		...
		function rt() {
			nt(), !(!s.playing || _.value) && (Ae = setTimeout(() => {
		...
		V(() => s.playing, (e) => {
			e ? (oe.value = !1, ve(), rt()) : (nt(), m.value = !0);
		});
		let it = null;
		return te(() => {
			...
			}), typeof document < "u" && (document.addEventListener("fullscreenchange", Qe), j.value = document.pictureInPictureEnabled === !0), it = s.bindMediaSession({
				onPlay: () => void f.value?.play()?.catch(() => {}),
				onPause: () => f.value?.pause(),
				onSeek: (e) => Q(e)
			}), ke = f.value?.textTracks ?? null, ke?.addEventListener?.("addtrack", Z), ke?.addEventListener?.("removetrack", Z), Z(), z.value && K();
		}), V(() => r.media, (e) => {
			s.setCurrent(e, {
				resetPosition: !1,
				streamUrl: r.streamUrl
			...
			nt(), X(), H.cleanup(), typeof document < "u" && document.removeEventListener("fullscreenchange", Qe), it?.(), ke?.removeEventListener?.("addtrack", Z), ke?.removeEventListener?.("removetrack", Z);
		}), (n, r) => (F(), D("div", {
			...
			O("video", {
				...
				onEnded: ge,
				onError: ye,
				onEnterpictureinpicture: et,
				onLeavepictureinpicture: tt,
				onClick: Le
			}, null, 40, an),
			r[9] ||= O("div", {
			...
			O("div", on, [O("button", {
				...
				O("div", dn, [(F(!0), D(S, null, L(Me.value, (e, t) => (F(), D(S, { key: t }, [t > 0 && !e.cert ? (F(), D("span", fn, "·")) : E("", !0), O("span", { class: M({ player__cert: e.cert }) }, R(e.text), 3)], 64))), 128))])
			])]),
			...
			G.value ? E("", !0) : (F(), D("div", {
				...
				O("button", {
					...
					"aria-label": B(s).playing ? B(u)("player.pause") : B(u)("player.play"),
					onClick: Le
				}, [A(t, { name: B(s).playing ? "pause" : "play" }, null, 8, ["name"])], 8, gn),
				O("span", _n, [
				...
				A(Ne),
				A(Pe),
				A(Fe, { qualities: e.qualities }, null, 8, ["qualities"]),
				A(st, {
					open: we.value,
					"onUpdate:open": r[1] ||= (e) => we.value = e,
					tracks: be.value,
					"audio-tracks": xe.value,
				...
				O("button", {
					...
					onClick: Xe
				}, [A(t, { name: "theater" })], 10, bn),
				O("button", {
					type: "button",
					class: "player__iconbtn",
					"aria-label": h.value ? B(u)("player.exitFullscreen") : B(u)("player.fullscreen"),
					onClick: Ze
				}, [A(t, { name: h.value ? "fullscreen-exit" : "fullscreen" }, null, 8, ["name"])], 8, xn)
			])])),
			G.value ? E("", !0) : (F(), T(nn, {
				key: 2,
				position: B(s).position,
			...
			oe.value && !G.value ? (F(), T(Ct, {
				key: 3,
				seconds: q.value,
				onResume: fe,
				onRestart: pe
			}, null, 8, ["seconds"])) : E("", !0),
			Y.value && le.value && !G.value ? (F(), T(Wt, {
				key: 4,
				media: le.value,
				remaining: se.value,
				total: B(8),
...
}), [["__scopeId", "data-v-1504f81d"]]);
//#endregion
export { Ne as A, fe as B, mt as C, Ie as D, st as E, Se as F, le as G, de as H, xe as I, ae as J, q as K, Ce as L, ve as M, ye as N, Fe as O, _e as P, me as R, _t as S, pt as T, X as U, ue as V, ce as W, W as Y, lt as _, Wt as a, gt as b, At as c, Dt as d, kt as f, vt as g, Ct as h, Yt as i, je as j, Pe as k, Mt as l, Nt as m, nn as n, wt as o, Ot as p, K as q, tn as r, Tt as s, Sn as t, jt as u, ut as v, ht as w, ft as x, ct as y, pe as z };

//# sourceMappingURL=Player-wN5cxlZE.js.map