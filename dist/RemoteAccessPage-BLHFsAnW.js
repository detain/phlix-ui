import { c as e, d as t, n as ee, t as n, u as r } from "./Button-C4PyCjLX.js";
import { t as te } from "./tokenStore-CGMYSpg6.js";
import { t as ne } from "./Badge-D9Tdn6WP.js";
import { t as re } from "./Modal-DLVWGUN9.js";
import { t as ie } from "./useToastStore-BDoKlU6N.js";
import { n as i, t as a } from "./EmptyState-BEMIpc2l.js";
...
}, tt = { class: "admin-remote__claim-code" }, nt = { class: "admin-remote__field" }, rt = { class: "admin-remote__field" }, v = /*#__PURE__*/ t(/* @__PURE__ */ oe({
	__name: "RemoteAccessPage",
	props: { client: {} },
	setup(t) {
		let oe = t, v = se("apiBase", ""), it = s(() => typeof v == "string" ? v : v?.value ?? ""), y = new ae(oe.client ?? new ee({
			baseUrl: it.value,
			tokenStore: new te()
		})), b = ie();
		function at(e) {
		...
		async function P() {
			...
			try {
				...
				T.value = e(t, "Failed to load hub status."), b.error(T.value);
			} finally {
				w.value = !1;
			}
		}
		...
		async function ut() {
			if (!M.value) {
				...
				try {
					...
					b.error(e(t, "Failed to initiate pairing."));
				} finally {
					M.value = !1;
				}
			}
		...
		async function dt() {
			if (!(j.value === null || k.value === "") && !N.value) {
				...
				try {
					...
					b.error(e(t, "Failed to poll pairing status."));
				} finally {
					N.value = !1;
				}
			}
		...
		async function ft() {
			if (!E.value) {
				...
				try {
					...
					b.error(e(t, "Failed to unenroll."));
				} finally {
					E.value = !1;
				}
			}
		...
		async function pt() {
			if (!D.value) {
				...
				try {
					...
					b.error(e(t, "Failed to send heartbeat."));
				} finally {
					D.value = !1;
				}
			}
		...
		async function B() {
			...
			try {
				...
				L.value = e(t, "Failed to load subdomain status."), b.error(L.value);
			} finally {
				I.value = !1;
			}
		}
		async function ht() {
			if (!R.value) {
				...
				try {
					...
					b.error(e(t, "Failed to claim subdomain."));
				} finally {
					R.value = !1;
				}
			}
		...
		async function gt() {
			if (!z.value) {
				...
				try {
					...
					b.error(e(t, "Failed to release subdomain."));
				} finally {
					z.value = !1;
				}
			}
		...
		async function J() {
			...
			try {
				...
				U.value = e(t, "Failed to load relay status."), b.error(U.value);
			} finally {
				H.value = !1;
			}
		}
		async function yt() {
			if (!W.value) {
				...
				try {
					...
					b.error(e(t, "Failed to enable relay."));
				} finally {
					W.value = !1;
				}
			}
		...
		async function bt() {
			if (!G.value) {
				...
				try {
					...
					b.error(e(t, "Failed to disable relay."));
				} finally {
					G.value = !1;
				}
			}
		...
		async function xt() {
			if (!K.value) {
				...
				try {
					...
					b.error(e(t, "Failed to ping relay."));
				} finally {
					K.value = !1;
				}
			}
		...
		async function $() {
			...
			try {
				...
				X.value = e(t, "Failed to load port-forward status."), b.error(X.value);
			} finally {
				St.value = !1;
			}
		}
		async function Et() {
			if (!Z.value) {
				...
				try {
					...
					b.error(e(t, "Failed to enable port forwarding."));
				} finally {
					Z.value = !1;
				}
			}
		...
		async function Dt() {
			if (!Q.value) {
				...
				try {
					...
					b.error(e(t, "Failed to disable port forwarding."));
				} finally {
					Q.value = !1;
				}
			}
		...
		return ce(() => {
			...
			d("section", ge, [d("button", {
				...
				onClick: t[0] ||= (e) => S("hub")
			}, [d("span", ve, [t[8] ||= d("h2", { id: "remote-hub-heading" }, "Hub Pairing", -1), p(r, {
			...
			])) : l("", !0), d("div", we, [C.value.paired ? (m(), u(o, { key: 1 }, [p(n, {
				variant: "outline",
				size: "sm",
				loading: D.value,
				onClick: pt
			...
			d("section", Te, [d("button", {
			...
			}, [d("span", De, [t[16] ||= d("h2", { id: "remote-subdomain-heading" }, "Subdomain", -1), p(r, {
				...
				_: 1
			}, 8, ["description"])) : F.value === null ? (m(), u("p", je, " No subdomain status available. ")) : (m(), u(o, { key: 3 }, [F.value.claimed ? (m(), u("dl", Me, [F.value.subdomain ? (m(), u(o, { key: 0 }, [t[18] ||= d("dt", null, "Subdomain", -1), d("dd", null, g(F.value.subdomain), 1)], 64)) : l("", !0), F.value.fqdn ? (m(), u(o, { key: 1 }, [t[19] ||= d("dt", null, "FQDN", -1), d("dd", null, g(F.value.fqdn), 1)], 64)) : l("", !0)])) : l("", !0), d("div", Ne, [F.value.claimed ? (m(), c(n, {
				key: 1,
				variant: "ghost",
				size: "sm",
				loading: z.value,
			...
			d("section", Pe, [d("button", {
			...
			}, [d("span", Ie, [t[22] ||= d("h2", { id: "remote-relay-heading" }, "Relay Tunnel", -1), p(r, {
				...
				_: 1
			}, 8, ["loading", "disabled"]), V.value.connected ? (m(), c(n, {
				key: 1,
				variant: "ghost",
				size: "sm",
				loading: G.value,
			...
			}, [d("span", Ge, [t[30] ||= d("h2", { id: "remote-portforward-heading" }, "Port Forward", -1), p(r, {
...
//# sourceMappingURL=RemoteAccessPage-BLHFsAnW.js.map