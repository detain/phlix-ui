import { n as e, t } from "./AuthField-CJ9qJ7tS.js";
import { n, t as r } from "./Icon-ax5k7_G2.js";
import { t as i } from "./useMessages-CLrAkqxK.js";
import { t as a } from "./useAuthStore-BDivyavD.js";
...
var D = {
	...
	emits: ["success"],
	setup(n, { emit: g }) {
		let A = g, j = a(), M = s(), N = E(), { t: P } = i(), F = _("phlixConfig", null), I = l(() => F?.home ?? F?.routerBase ?? "/app"), L = l(() => `${F?.routerBase ?? "/app"}/login`), R = /^[^\s@]+@[^\s@]+\.[^\s@]+$/, z = y(""), B = y(""), V = y(""), H = y(""), U = y(null), W = y(null), G = y(null), K = y(null);
		function q() {
...
//# sourceMappingURL=SignupForm-CFXdLvvu.js.map