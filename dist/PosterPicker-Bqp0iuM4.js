...
import { a as n, f as r } from "./client-D80As4Gx.js";
import { t as i } from "./useAuthStore-D2BCcJAK.js";
import { t as a } from "./Spinner-Cu31rC4d.js";
...
var te = { class: "poster-picker" }, ne = {
	...
	setup(e, { emit: m }) {
		let M = e, N = m, P = i(), F = v([]), I = v([]), L = v(!1), R = v(!1), z = v(null), B = v(!1), V = v(null), H = v(null), U = v(null), W = v(0), G = v(-1), K = c({
			get: () => M.modelValue,
		...
		return x(() => M.modelValue, (e) => {
			...
			default: S(() => [f("div", te, [e.item ? (_(), d("p", ne, [r[1] ||= ee(" Select a poster for ", -1), f("strong", null, b(e.item.name), 1)])) : u("", !0), L.value ? (_(), d("div", re, [p(a, { label: "Loading posters" })])) : B.value ? (_(), d("div", ie, [
				p(t, {
					name: "alert",
					class: "poster-picker__state-icon"
				}),
				r[2] ||= f("p", { class: "poster-picker__state-title" }, "TMDB is not configured", -1),
				r[3] ||= f("p", { class: "poster-picker__state-hint" }, " Configure a TMDB API key in admin settings to search for poster alternatives. ", -1)
				...
				r[4] ||= f("p", { class: "poster-picker__state-title" }, "No posters available", -1),
				r[5] ||= f("p", { class: "poster-picker__state-hint" }, "No poster alternatives were found for this item.", -1)
			])) : u("", !0)])]),
			_: 1
		}, 8, ["modelValue"]));
	}
...
//# sourceMappingURL=PosterPicker-Bqp0iuM4.js.map