...
import { n as ne, t as re } from "./cast-D50-b0ZQ.js";
...
var oe = {
	...
	role: "group",
	"aria-label": "Seek"
}, P = { class: "admin-cast__time" }, F = { class: "admin-cast__time" }, I = { class: "admin-cast__buttons" }, L = /*#__PURE__*/ r(/* @__PURE__ */ h({
	...
	setup(r) {
		let h = [{
			...
			label: "AirPlay",
			icon: "tv"
		}], L = r, R = g("apiBase", ""), ge = l(() => typeof R == "string" ? R : R?.value ?? ""), z = new re(L.client ?? new e({
			baseUrl: ge.value,
			tokenStore: new n()
		})), B = ee();
		function V(e) {
		...
		return ae(() => {
			...
			f("div", {
				...
				}, [f("span", me, [m(a, { name: ve.value }, null, 8, ["name"])]), f("span", he, [f("span", {
...
//# sourceMappingURL=CastDevicesPage-C0GgKdb1.js.map