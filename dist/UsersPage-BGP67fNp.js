...
var he = {
	...
	setup(e) {
		...
		return fe(O), (e, n) => (h(), d("section", he, [
			f("header", ge, [n[17] ||= f("h1", {
				id: "users-heading",
			...
			E.value ? (h(), d("div", _e, [m(ie, {
				...
				actions: b(() => [m(i, {
					...
					default: b(() => [...n[20] ||= [p("Add user", -1)]]),
					_: 1
				})]),
				_: 1
			})) : (h(), d(s, { key: 3 }, [A.value.length > 0 ? (h(), d("section", ve, [f("h2", ye, [n[21] ||= p(" Pending approval ", -1), m(a, { tone: "warning" }, {
				default: b(() => [p(v(A.value.length), 1)]),
				_: 1
			})]), f("table", be, [n[24] ||= f("thead", null, [f("tr", null, [
				...
				f("td", null, [f("div", Se, [m(i, {
					variant: "solid",
					size: "sm",
					"aria-label": `Approve ${e.username}`,
					onClick: (t) => j(e)
				}, {
					default: b(() => [...n[22] ||= [p(" Approve ", -1)]]),
					_: 1
					...
					default: b(() => [...n[23] ||= [p(" Reject ", -1)]]),
					_: 1
				}, 8, ["aria-label", "onClick"])])])
			]))), 128))])])])) : u("", !0), f("table", Ce, [n[33] ||= f("thead", null, [f("tr", null, [
				f("th", { scope: "col" }, "Username"),
				f("th", { scope: "col" }, "Email"),
				f("th", { scope: "col" }, "Role"),
				...
				f("td", null, [f("div", Te, [
					k(e) === "pending" ? (h(), l(i, {
						...
						default: b(() => [...n[25] ||= [p(" Approve ", -1)]]),
						_: 1
					}, 8, ["aria-label", "onClick"])) : k(e) === "disabled" ? (h(), l(i, {
						key: 1,
						variant: "ghost",
						size: "sm",
					...
					m(i, {
						...
						default: b(() => [...n[30] ||= [p(" Reset Password ", -1)]]),
						_: 1
					}, 8, ["aria-label", "onClick"]),
					m(i, {
						variant: "ghost",
			...
			m(t, {
				...
				default: b(() => [f("form", {
					...
					f("label", Ee, [n[34] ||= f("span", { class: "admin-users__label" }, "Username", -1), x(f("input", {
					...
					f("label", De, [n[35] ||= f("span", { class: "admin-users__label" }, "Email", -1), x(f("input", {
			...
			m(t, {
				...
				title: "Delete user",
				size: "sm",
				"onUpdate:modelValue": n[6] ||= (e) => B.value = null
			}, {
				footer: b(() => [m(i, {
					variant: "ghost",
					size: "sm",
					onClick: n[5] ||= (e) => B.value = null
				}, {
					default: b(() => [...n[39] ||= [p("Cancel", -1)]]),
					_: 1
				}), m(i, {
					variant: "solid",
					size: "sm",
					...
					default: b(() => [...n[40] ||= [p("Delete", -1)]]),
					_: 1
				})]),
				default: b(() => [f("p", null, [
					n[37] ||= p(" Delete user ", -1),
					f("strong", null, v(B.value?.username), 1),
					n[38] ||= p("? This cannot be undone. ", -1)
				])]),
				_: 1
			}, 8, ["model-value"]),
			m(t, {
				...
				title: "Disable user",
				size: "sm",
				"onUpdate:modelValue": n[8] ||= (e) => M.value = null
			}, {
				footer: b(() => [m(i, {
					variant: "ghost",
					size: "sm",
					onClick: n[7] ||= (e) => M.value = null
				}, {
					default: b(() => [...n[43] ||= [p("Cancel", -1)]]),
					_: 1
				}), m(i, {
					variant: "solid",
					size: "sm",
					...
					default: b(() => [...n[44] ||= [p("Disable", -1)]]),
					_: 1
				})]),
				default: b(() => [f("p", null, [
					n[41] ||= p(" Disable ", -1),
					f("strong", null, v(M.value?.username), 1),
					n[42] ||= p("? They will be signed out and blocked from signing in until re-enabled. ", -1)
				])]),
				_: 1
			}, 8, ["model-value"]),
			m(t, {
				...
				title: "Reject signup",
				size: "sm",
				"onUpdate:modelValue": n[10] ||= (e) => N.value = null
			}, {
				footer: b(() => [m(i, {
					variant: "ghost",
					size: "sm",
					onClick: n[9] ||= (e) => N.value = null
				}, {
					default: b(() => [...n[47] ||= [p("Cancel", -1)]]),
					_: 1
				}), m(i, {
					variant: "solid",
					size: "sm",
					...
					default: b(() => [...n[48] ||= [p("Reject", -1)]]),
					_: 1
				})]),
				default: b(() => [f("p", null, [
					n[45] ||= p(" Reject ", -1),
					f("strong", null, v(N.value?.username), 1),
					n[46] ||= p("'s signup request? This removes the pending account. ", -1)
				])]),
				_: 1
			}, 8, ["model-value"]),
			m(t, {
				...
				footer: b(() => [m(i, {
					...
					default: b(() => [...n[53] ||= [p("Close", -1)]]),
					_: 1
				})]),
				default: b(() => [H.value ? (h(), d("div", je, [f("p", null, v(H.value.message), 1), f("label", Me, [n[50] ||= f("span", { class: "admin-users__label" }, "New password", -1), f("div", Ne, [f("input", {
					...
					default: b(() => [...n[49] ||= [p("Copy", -1)]]),
					_: 1
				})])])])) : (h(), d("p", Fe, [
					n[51] ||= p(" Resetting password for ", -1),
			...
			m(t, {
				modelValue: yt.value,
				"onUpdate:modelValue": n[15] ||= (e) => yt.value = e,
				title: vt.value,
				size: "lg"
			}, {
				default: b(() => [_t.value ? (h(), d("div", Ie, [m(ie, {
					...
					})) : (h(), d("table", Re, [n[58] ||= f("thead", null, [f("tr", null, [
						f("th", { scope: "col" }, "Name"),
					...
					q.value ? (h(), d("div", Be, [f("h3", Ve, v(J.value ? "Edit profile" : "Add profile"), 1), f("form", {
						...
						f("label", He, [n[59] ||= f("span", { class: "admin-users__label" }, "Name", -1), x(f("input", {
						...
						f("label", Ue, [n[60] ||= f("span", { class: "admin-users__label" }, "Rating", -1), m(re, {
							"model-value": X.value,
							options: $e.value,
							label: "Rating",
					...
					Z.value ? (h(), d("div", Ge, [f("p", null, [
						n[62] ||= p(" Delete profile ", -1),
						f("strong", null, v(Z.value.name), 1),
						n[63] ||= p("? This cannot be undone. ", -1)
					]), f("div", Ke, [m(i, {
						variant: "ghost",
						size: "sm",
						onClick: n[13] ||= (e) => Z.value = null
					}, {
						default: b(() => [...n[64] ||= [p("Cancel", -1)]]),
						_: 1
					}), m(i, {
						variant: "solid",
						size: "sm",
						...
						default: b(() => [...n[65] ||= [p("Delete", -1)]]),
						_: 1
					})])])) : u("", !0),
					Q.value ? (h(), d("div", qe, [f("h3", Je, "Set PIN — " + v(Q.value.name), 1), f("form", {
						class: "admin-users__form",
						onSubmit: me(jt, ["prevent"])
					}, [f("label", Ye, [n[66] ||= f("span", { class: "admin-users__label" }, "PIN (4 or 6 digits)", -1), x(f("input", {
						...
						required: ""
					}, null, 512), [[y, $.value]])]), f("div", Xe, [m(i, {
						variant: "ghost",
						size: "sm",
						onClick: At
					}, {
						default: b(() => [...n[67] ||= [p("Cancel", -1)]]),
						_: 1
					}), m(i, {
						variant: "solid",
						size: "sm",
...
}), [["__scopeId", "data-v-91a8531d"]]);
//#endregion
export { S as default };

//# sourceMappingURL=UsersPage-BGP67fNp.js.map