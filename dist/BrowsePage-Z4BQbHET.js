...
import { n as i, o as ee } from "./ThumbRating-CDDVfYEs.js";
...
import { o as ie, t as ae } from "./MetadataMatchModal-Cd3M7_Wl.js";
import { t as a } from "./EmptyState-0XgHKEGf.js";
import { t as o } from "./MediaRow-KSnh27b4.js";
import { t as s } from "./HomeRow-XjqRddVp.js";
import { n as oe, r as se } from "./useResolvePlayable-Dvi5ysCP.js";
...
var _e = { class: "browse-page" }, ve = { class: "browse-toolbar" }, ye = {
	...
	setup(e) {
		...
		function Y(e) {
			T.toggleFavorite(e.id, m.value), T.isFavorite(e.id) ? C.success(`Marked "${e.name}" as watched`) : C.info(`Marked "${e.name}" as unwatched`);
		}
		function X(e) {
			D.value = e, O.value = !0;
		}
...
}), [["__scopeId", "data-v-e3c3b2a5"]]);
//#endregion
export { b as default };

//# sourceMappingURL=BrowsePage-Z4BQbHET.js.map