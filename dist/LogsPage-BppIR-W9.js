...
import { t as o } from "./Select-DLwgQInL.js";
...
var O = {
	...
	setup(e) {
		let v = [
			...
			1e3,
			2e3
		], N = e, P = y("apiBase", ""), F = d(() => typeof P == "string" ? P : P?.value ?? ""), I = new u(N.client ?? new t({
			baseUrl: F.value,
			tokenStore: new i()
		...
		async function X() {
			...
			try {
				...
				G.value = r(e, "Failed to list logs."), L.error(G.value);
			} finally {
				W.value = !1;
			}
		}
		async function Z() {
			...
			if (e !== "") {
				...
				try {
					...
					K.value = r(e, "Failed to read log."), L.error(K.value);
				} finally {
					U.value = !1;
				}
			}
...
//# sourceMappingURL=LogsPage-BppIR-W9.js.map