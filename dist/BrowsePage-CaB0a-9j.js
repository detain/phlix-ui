...
var O = { class: "browse-page" }, k = { class: "browse-toolbar" }, A = {
	...
	setup(e) {
		...
		return (e, n) => (b(), p("div", O, [
			...
			(b(!0), p(l, null, S(N.value, (e) => (b(), d(o, {
				key: e.id,
				row: e,
				"api-base": j.value,
			...
			(b(!0), p(l, null, S(R.value, (e) => (b(), d(o, {
				key: e.id,
				row: e,
				"api-base": j.value,
				onItemsLoaded: B,
...
//# sourceMappingURL=BrowsePage-CaB0a-9j.js.map