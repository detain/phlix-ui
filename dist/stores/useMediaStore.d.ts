...
export declare const useMediaStore: import("pinia").StoreDefinition<"media", Pick<{
    ...
    clearFilters: () => void;
}, "search" | "sort" | "error" | "loading" | "order" | "yearFrom" | "yearTo" | "limit" | "offset" | "libraryId" | "topLevel" | "items" | "total" | "minRating" | "maxRating" | "serverFacets" | "selectedGenres" | "selectedRatings" | "selectedTypes" | "matchStatus" | "selectedActors" | "selectedCompanies" | "availableRatings" | "availableTypes">, Pick<{
    items: import("vue").Ref<{
        stream_url?: string | null | undefined;
        duration?: number | null | undefined;
        cast?: {
    ...
    setTopLevel: (v: boolean) => void;
    clearFilters: () => void;
}, "reset" | "prefetch" | "fetchMedia" | "scheduleFetch" | "loadMore" | "ensureRange" | "clearCache" | "cancelScheduled" | "loadFacets" | "toQuery" | "applyQuery" | "setSearch" | "setGenres" | "setYearRange" | "setRatings" | "setTypes" | "setMatchStatus" | "setActors" | "setCompanies" | "setMinRating" | "setMaxRating" | "setSort" | "setLibraryId" | "setTopLevel" | "clearFilters">>;
