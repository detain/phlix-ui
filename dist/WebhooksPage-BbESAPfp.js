...
import { t as a } from "./Modal-BB_vB1RK.js";
import { t as ne } from "./useToastStore-BDoKlU6N.js";
import { n as re, t as o } from "./EmptyState-Ds4WcVdG.js";
...
var fe = {
	...
	props: { client: {} },
	setup(e) {
		let h = e, O = oe("apiBase", ""), je = c(() => typeof O == "string" ? O : O?.value ?? ""), k = new ae(h.client ?? new r({
			baseUrl: je.value,
			tokenStore: new ee()
		})), A = ne();
		function Me(e) {
		...
		async function P() {
			...
			try {
				...
				N.value = n(e, "Failed to load webhooks."), A.error(N.value);
			} finally {
				M.value = !1;
			}
		}
		...
		async function q() {
			...
			try {
				...
				U.value = n(e, "Failed to save webhook.");
			} finally {
				H.value = !1;
			}
		}
		...
		async function Fe() {
			...
			if (e) try {
				...
				A.error(n(e, "Failed to delete webhook.")), J.value = null;
			}
		}
		...
		async function Le(e) {
			...
			try {
				...
				X.value = {
					success: !1,
					message: n(e, "Failed to test webhook.")
				};
			} finally {
				Z.value = !1;
			}
...
//# sourceMappingURL=WebhooksPage-BbESAPfp.js.map