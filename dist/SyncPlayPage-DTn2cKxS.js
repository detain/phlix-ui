...
import { c as t, f as n, t as r } from "./client-DbgRjcPy.js";
...
import { Fragment as ee, computed as d, createBlock as f, createCommentVNode as te, createElementBlock as p, createElementVNode as m, createTextVNode as h, createVNode as g, defineComponent as _, inject as v, onMounted as y, openBlock as b, ref as x, renderList as S, toDisplayString as C, vModelText as w, withCtx as T, withDirectives as E, withModifiers as D } from "vue";
...
}, M = { class: "admin-syncplay__name" }, N = { class: "admin-syncplay__media" }, ne = { class: "admin-syncplay__field" }, re = { class: "admin-syncplay__field" }, ie = { class: "admin-syncplay__field" }, ae = { class: "admin-syncplay__field" }, P = /*#__PURE__*/ e(/* @__PURE__ */ _({
	__name: "SyncPlayPage",
	props: { client: {} },
	setup(e) {
		let _ = e, P = v("apiBase", ""), oe = d(() => typeof P == "string" ? P : P?.value ?? ""), F = new u(_.client ?? new r({
			baseUrl: oe.value,
			tokenStore: new t()
		...
		return y(B), (e, t) => (b(), p("section", O, [
			...
			R.value ? (b(), p("div", A, [g(c, {
				...
				_: 1
			}, 8, ["description"])) : L.value.length === 0 ? (b(), f(l, {
				key: 2,
				icon: "tv",
				title: "No groups yet",
			...
			])], -1), m("tbody", null, [(b(!0), p(ee, null, S(L.value, (e) => (b(), p("tr", { key: e.id }, [
...
//# sourceMappingURL=SyncPlayPage-DTn2cKxS.js.map