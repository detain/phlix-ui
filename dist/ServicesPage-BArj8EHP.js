...
var T = {
...
}, M = { class: "admin-services__actions" }, ee = {
	class: "admin-services__section",
	"aria-labelledby": "lastfm-heading"
}, te = { class: "admin-services__section-head" }, N = { class: "admin-services__card" }, P = {
	key: 0,
	class: "admin-services__loading",
	"aria-hidden": "true"
}, F = {
	key: 0,
	class: "admin-services__dl"
}, I = { class: "admin-services__actions" }, L = /*#__PURE__*/ n(/* @__PURE__ */ v({
	__name: "ServicesPage",
	props: { client: {} },
	setup(n) {
		let v = n, L = y("apiBase", ""), R = d(() => typeof L == "string" ? L : L?.value ?? ""), z = new l(v.client ?? new a({
			baseUrl: R.value,
			tokenStore: new e()
		})), B = r(), V = S(null), H = S(!0), U = S(null), W = S(!1), G = d(() => V.value?.configured === !1);
		async function K() {
		...
		return b(() => {
			...
			h("section", E, [h("div", D, [t[0] ||= h("h2", {
			...
			}, "Trakt.tv", -1), V.value === null ? p("", !0) : (x(), f(c, {
				key: 0,
				...
				_: 1
			}, 8, ["tone", "label"]))]), h("div", O, [H.value ? (x(), m("div", k, [_(i, {
				variant: "text",
				lines: 2
			})])) : V.value === null ? (x(), f(o, {
				key: 1,
				...
				h("div", M, [V.value.connected ? (x(), f(s, {
					key: 1,
					variant: "outline",
					loading: W.value,
					onClick: J
			...
			h("section", ee, [h("div", te, [t[5] ||= h("h2", {
				id: "lastfm-heading",
				class: "admin-services__section-title"
			}, "Last.fm", -1), Y.value === null ? p("", !0) : (x(), f(c, {
				key: 0,
				...
				_: 1
			}, 8, ["tone", "label"]))]), h("div", N, [X.value ? (x(), m("div", P, [_(i, {
				variant: "text",
				lines: 2
			})])) : Y.value === null ? (x(), f(o, {
				key: 1,
			...
			])) : p("", !0), h("div", I, [Y.value.connected ? (x(), f(s, {
				key: 1,
				variant: "outline",
				loading: Q.value,
				onClick: re
...
}), [["__scopeId", "data-v-84ec3fa8"]]);
//#endregion
export { L as default };

//# sourceMappingURL=ServicesPage-BArj8EHP.js.map