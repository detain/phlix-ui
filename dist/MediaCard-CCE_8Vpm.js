...
import { i as n } from "./client-CkSYnkSD.js";
...
import { n as ne, t as re } from "./ThumbRating-ClFY8tyW.js";
...
var ue = { class: "media-card__poster" }, de = [
...
}, Te = ["aria-label", "aria-pressed"], Ee = ["aria-label", "aria-pressed"], De = ["aria-expanded", "onClick"], Oe = {
	key: 0,
	class: "media-card__caption"
}, ke = ["title"], Ae = { class: "media-card__caption-sub numeric" }, z = /*#__PURE__*/ e(/* @__PURE__ */ p({
	__name: "MediaCard",
	props: {
		item: {},
		to: {},
	...
	setup(e, { emit: p }) {
		...
		return (n, r) => (g(), l("article", {
			...
			u("div", R, [e.hideCaption ? c("", !0) : (g(), l(a, { key: 0 }, [
			...
			], 64)), Be.value ? (g(), l("div", we, [f(i, { text: "Play" }, {
				default: x(() => [u("button", {
					type: "button",
		...
		]), e.hideCaption ? c("", !0) : (g(), l("div", Oe, [u("div", {
...
}), [["__scopeId", "data-v-464e1022"]]);
//#endregion
export { T as i, j as n, M as r, z as t };

//# sourceMappingURL=MediaCard-CCE_8Vpm.js.map