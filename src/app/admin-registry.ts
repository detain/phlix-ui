...
let resolveAdminLabel: AdminLabelResolver | null = null;
 ...
 */
export function setAdminLabelResolver(resolver: AdminLabelResolver | null): void {
  resolveAdminLabel = resolver;
}
 ...
 */
export function adminLabelFor(name: string | null | undefined): string | null {
  if (!name) return null;
  return resolveAdminLabel?.(name) ?? null;
}
