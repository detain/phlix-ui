 ...
 */
export const TABLE_ROW_POSTER_WIDTH = LIST_ROW_POSTER_WIDTH;
 ...
 */
export const TABLE_ROW_HEIGHT = TABLE_ROW_POSTER_WIDTH * POSTER_RATIO;
 ...
 */
export const TABLE_ROW_TEMPLATE_COLUMNS = TABLE_COLUMNS.map((c) => c.track).join(' ');
