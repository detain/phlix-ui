...
export interface Library {
   ...
   * default.
   */
  auto_collections?: { enabled: boolean };
  [k: string]: unknown;
}
...
export class AdminLibrariesApi {
  ...
  refreshMetadata(id: string): Promise<ScanQueuedResult> {
    return this.client.post<ScanQueuedResult>(
      `/api/v1/libraries/${encodeURIComponent(id)}/refresh-metadata`,
    );
  }
  ...
  prune(id: string): Promise<ScanQueuedResult> {
    return this.client.post<ScanQueuedResult>(
      `/api/v1/libraries/${encodeURIComponent(id)}/prune`,
    );
  }
  ...
  clearMetadata(id: string): Promise<ScanQueuedResult> {
    return this.client.post<ScanQueuedResult>(
      `/api/v1/libraries/${encodeURIComponent(id)}/clear-metadata`,
    );
  }
  ...
  clearArtwork(id: string): Promise<ScanQueuedResult> {
    return this.client.post<ScanQueuedResult>(
      `/api/v1/libraries/${encodeURIComponent(id)}/clear-artwork`,
    );
  }
  ...
  deleteAll(id: string): Promise<ScanQueuedResult> {
    return this.client.post<ScanQueuedResult>(
      `/api/v1/libraries/${encodeURIComponent(id)}/delete-all?confirm=true`,
      { confirm: true },
    );
  }
  ...
  regenerateAssets(id: string): Promise<ScanQueuedResult> {
    return this.client.post<ScanQueuedResult>(
      `/api/v1/libraries/${encodeURIComponent(id)}/regenerate-assets`,
    );
  }
