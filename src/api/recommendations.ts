 ...
 */
export function recommendationToMediaItem(r: UserRecommendation): MediaItem {
  return {
    id: r.id,
    name: r.title,
    type: 'movie',
...
export async function fetchRecommendations(
  ...
  return (Array.isArray(data.recommendations) ? data.recommendations : []).map(
    recommendationToMediaItem,
  );
}
